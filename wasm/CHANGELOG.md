...
* Implemented `clock_res_get`, `fd_advise`, `fd_datasync`, `fd_fdstat_set_rights`, `fd_filestat_set_size`, `fd_pread`, `fd_pwrite`, `fd_renumber`, `fd_sync` and `fd_tell` in `wasi_snapshot_preview1`.
