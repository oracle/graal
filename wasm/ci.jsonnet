...

{
  builds: [
    ...
    common.jdk8_gate_linux_wabt        + common.gate_graalwasm_jvmci        + {environment+: {SUITE: 'wasm', GATE_TAGS: 'build,wasmconstantspolicytest'}} + {name: 'gate-graalwasm-unittest-linux-amd64'},
