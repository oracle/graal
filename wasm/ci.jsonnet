{
  ...
  builds: [
    ...
    common.jdk8_gate_linux_wabt        + common.gate_graalwasm_jvmci        + {environment+: {GATE_TAGS: 'build,wasmconstantspolicytest'}}         + {name: 'gate-graalwasm-constantspolicy-unittest-linux-amd64'},
    ...
    common.jdk8_gate_linux_wabt_emsdk  + common.gate_graalwasm_emsdk_jvmci  + {environment+: {GATE_TAGS: 'buildall,wasmconstantspolicyextratest'}} + {name: 'gate-graalwasm-constantspolicy-extra-unittest-linux-amd64'},
    common.jdk8_gate_linux_wabt_emsdk  + common.gate_graalwasm_emsdk_jvmci  + {environment+: {GATE_TAGS: 'buildall,wasmbenchtest'}}                + {name: 'gate-graalwasm-benchtest-linux-amd64'},
    common.jdk8_gate_windows_wabt      + common.gate_graalwasm_jvmci        + {environment+: {GATE_TAGS: 'build,wasmtest'}}                        + {name: 'gate-graalwasm-unittest-windows-amd64', packages: {msvc: '==10.0'}},
