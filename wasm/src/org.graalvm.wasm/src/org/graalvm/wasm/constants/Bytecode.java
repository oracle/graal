...
public class Bytecode {
    ...
    public static final int RETURN_CALL_U8 = 0x15;
    public static final int RETURN_CALL_I32 = 0x16;

    public static final int RETURN_CALL_INDIRECT_U8 = 0x17;
    public static final int RETURN_CALL_INDIRECT_I32 = 0x18;

    public static final int DROP = 0x19;
    public static final int DROP_OBJ = 0x1A;

    public static final int SELECT = 0x1B;
    public static final int SELECT_OBJ = 0x1C;

    public static final int LOCAL_GET_U8 = 0x1D;
    public static final int LOCAL_GET_OBJ_U8 = 0x1E;

    public static final int LOCAL_SET_U8 = 0x1F;
    public static final int LOCAL_SET_OBJ_U8 = 0x20;

    public static final int LOCAL_TEE_U8 = 0x21;
    public static final int LOCAL_TEE_OBJ_U8 = 0x22;

    public static final int GLOBAL_GET_U8 = 0x23;
    public static final int GLOBAL_GET_I32 = 0x24;
    public static final int GLOBAL_SET_U8 = 0x25;
    public static final int GLOBAL_SET_I32 = 0x26;

    public static final int I32_LOAD = 0x27;
    public static final int I32_LOAD_U8 = 0x28;
    public static final int I32_LOAD_I32 = 0x29;
    public static final int I64_LOAD = 0x2A;
    public static final int I64_LOAD_U8 = 0x2B;
    public static final int I64_LOAD_I32 = 0x2C;
    public static final int F32_LOAD = 0x2D;
    public static final int F32_LOAD_U8 = 0x2E;
    public static final int F32_LOAD_I32 = 0x2F;
    public static final int F64_LOAD = 0x30;
    public static final int F64_LOAD_U8 = 0x31;
    public static final int F64_LOAD_I32 = 0x32;
    public static final int I32_LOAD8_S = 0x33;
    public static final int I32_LOAD8_S_U8 = 0x34;
    public static final int I32_LOAD8_S_I32 = 0x35;
    public static final int I32_LOAD8_U = 0x36;
    public static final int I32_LOAD8_U_U8 = 0x37;
    public static final int I32_LOAD8_U_I32 = 0x38;
    public static final int I32_LOAD16_S = 0x39;
    public static final int I32_LOAD16_S_U8 = 0x3A;
    public static final int I32_LOAD16_S_I32 = 0x3B;
    public static final int I32_LOAD16_U = 0x3C;
    public static final int I32_LOAD16_U_U8 = 0x3D;
    public static final int I32_LOAD16_U_I32 = 0x3E;
    public static final int I64_LOAD8_S = 0x3F;
    public static final int I64_LOAD8_S_U8 = 0x40;
    public static final int I64_LOAD8_S_I32 = 0x41;
    public static final int I64_LOAD8_U = 0x42;
    public static final int I64_LOAD8_U_U8 = 0x43;
    public static final int I64_LOAD8_U_I32 = 0x44;
    public static final int I64_LOAD16_S = 0x45;
    public static final int I64_LOAD16_S_U8 = 0x46;
    public static final int I64_LOAD16_S_I32 = 0x47;
    public static final int I64_LOAD16_U = 0x48;
    public static final int I64_LOAD16_U_U8 = 0x49;
    public static final int I64_LOAD16_U_I32 = 0x4A;
    public static final int I64_LOAD32_S = 0x4B;
    public static final int I64_LOAD32_S_U8 = 0x4C;
    public static final int I64_LOAD32_S_I32 = 0x4D;
    public static final int I64_LOAD32_U = 0x4E;
    public static final int I64_LOAD32_U_U8 = 0x4F;
    public static final int I64_LOAD32_U_I32 = 0x50;

    public static final int I32_STORE = 0x51;
    public static final int I32_STORE_U8 = 0x52;
    public static final int I32_STORE_I32 = 0x53;
    public static final int I64_STORE = 0x54;
    public static final int I64_STORE_U8 = 0x55;
    public static final int I64_STORE_I32 = 0x56;
    public static final int F32_STORE = 0x57;
    public static final int F32_STORE_U8 = 0x58;
    public static final int F32_STORE_I32 = 0x59;
    public static final int F64_STORE = 0x5A;
    public static final int F64_STORE_U8 = 0x5B;
    public static final int F64_STORE_I32 = 0x5C;
    public static final int I32_STORE_8 = 0x5D;
    public static final int I32_STORE_8_U8 = 0x5E;
    public static final int I32_STORE_8_I32 = 0x5F;
    public static final int I32_STORE_16 = 0x60;
    public static final int I32_STORE_16_U8 = 0x61;
    public static final int I32_STORE_16_I32 = 0x62;
    public static final int I64_STORE_8 = 0x63;
    public static final int I64_STORE_8_U8 = 0x64;
    public static final int I64_STORE_8_I32 = 0x65;
    public static final int I64_STORE_16 = 0x66;
    public static final int I64_STORE_16_U8 = 0x67;
    public static final int I64_STORE_16_I32 = 0x68;
    public static final int I64_STORE_32 = 0x69;
    public static final int I64_STORE_32_U8 = 0x6A;
    public static final int I64_STORE_32_I32 = 0x6B;

    public static final int MEMORY_SIZE = 0x6C;
    public static final int MEMORY_GROW = 0x6D;

    public static final int I32_CONST_I8 = 0x6E;
    public static final int I32_CONST_I32 = 0x6F;

    public static final int I64_CONST_I8 = 0x70;
    public static final int I64_CONST_I64 = 0x71;

    public static final int F32_CONST = 0x72;

    public static final int F64_CONST = 0x73;

    public static final int I32_EQZ = 0x74;
    public static final int I32_EQ = 0x75;
    public static final int I32_NE = 0x76;
    public static final int I32_LT_S = 0x77;
    public static final int I32_LT_U = 0x78;
    public static final int I32_GT_S = 0x79;
    public static final int I32_GT_U = 0x7A;
    public static final int I32_LE_S = 0x7B;
    public static final int I32_LE_U = 0x7C;
    public static final int I32_GE_S = 0x7D;
    public static final int I32_GE_U = 0x7E;

    public static final int I64_EQZ = 0x7F;
    public static final int I64_EQ = 0x80;
    public static final int I64_NE = 0x81;
    public static final int I64_LT_S = 0x82;
    public static final int I64_LT_U = 0x83;
    public static final int I64_GT_S = 0x84;
    public static final int I64_GT_U = 0x85;
    public static final int I64_LE_S = 0x86;
    public static final int I64_LE_U = 0x87;
    public static final int I64_GE_S = 0x88;
    public static final int I64_GE_U = 0x89;

    public static final int F32_EQ = 0x8A;
    public static final int F32_NE = 0x8B;
    public static final int F32_LT = 0x8C;
    public static final int F32_GT = 0x8D;
    public static final int F32_LE = 0x8E;
    public static final int F32_GE = 0x8F;

    public static final int F64_EQ = 0x90;
    public static final int F64_NE = 0x91;
    public static final int F64_LT = 0x92;
    public static final int F64_GT = 0x93;
    public static final int F64_LE = 0x94;
    public static final int F64_GE = 0x95;

    public static final int I32_CLZ = 0x96;
    public static final int I32_CTZ = 0x97;
    public static final int I32_POPCNT = 0x98;
    public static final int I32_ADD = 0x99;
    public static final int I32_SUB = 0x9A;
    public static final int I32_MUL = 0x9B;
    public static final int I32_DIV_S = 0x9C;
    public static final int I32_DIV_U = 0x9D;
    public static final int I32_REM_S = 0x9E;
    public static final int I32_REM_U = 0x9F;
    public static final int I32_AND = 0xA0;
    public static final int I32_OR = 0xA1;
    public static final int I32_XOR = 0xA2;
    public static final int I32_SHL = 0xA3;
    public static final int I32_SHR_S = 0xA4;
    public static final int I32_SHR_U = 0xA5;
    public static final int I32_ROTL = 0xA6;
    public static final int I32_ROTR = 0xA7;

    public static final int I64_CLZ = 0xA8;
    public static final int I64_CTZ = 0xA9;
    public static final int I64_POPCNT = 0xAA;
    public static final int I64_ADD = 0xAB;
    public static final int I64_SUB = 0xAC;
    public static final int I64_MUL = 0xAD;
    public static final int I64_DIV_S = 0xAE;
    public static final int I64_DIV_U = 0xAF;
    public static final int I64_REM_S = 0xB0;
    public static final int I64_REM_U = 0xB1;
    public static final int I64_AND = 0xB2;
    public static final int I64_OR = 0xB3;
    public static final int I64_XOR = 0xB4;
    public static final int I64_SHL = 0xB5;
    public static final int I64_SHR_S = 0xB6;
    public static final int I64_SHR_U = 0xB7;
    public static final int I64_ROTL = 0xB8;
    public static final int I64_ROTR = 0xB9;

    public static final int F32_ABS = 0xBA;
    public static final int F32_NEG = 0xBB;
    public static final int F32_CEIL = 0xBC;
    public static final int F32_FLOOR = 0xBD;
    public static final int F32_TRUNC = 0xBE;
    public static final int F32_NEAREST = 0xBF;
    public static final int F32_SQRT = 0xC0;
    public static final int F32_ADD = 0xC1;
    public static final int F32_SUB = 0xC2;
    public static final int F32_MUL = 0xC3;
    public static final int F32_DIV = 0xC4;
    public static final int F32_MIN = 0xC5;
    public static final int F32_MAX = 0xC6;
    public static final int F32_COPYSIGN = 0xC7;

    public static final int F64_ABS = 0xC8;
    public static final int F64_NEG = 0xC9;
    public static final int F64_CEIL = 0xCA;
    public static final int F64_FLOOR = 0xCB;
    public static final int F64_TRUNC = 0xCC;
    public static final int F64_NEAREST = 0xCD;
    public static final int F64_SQRT = 0xCE;
    public static final int F64_ADD = 0xCF;
    public static final int F64_SUB = 0xD0;
    public static final int F64_MUL = 0xD1;
    public static final int F64_DIV = 0xD2;
    public static final int F64_MIN = 0xD3;
    public static final int F64_MAX = 0xD4;
    public static final int F64_COPYSIGN = 0xD5;

    public static final int I32_WRAP_I64 = 0xD6;
    public static final int I32_TRUNC_F32_S = 0xD7;
    public static final int I32_TRUNC_F32_U = 0xD8;
    public static final int I32_TRUNC_F64_S = 0xD9;
    public static final int I32_TRUNC_F64_U = 0xDA;
    public static final int I64_EXTEND_I32_S = 0xDB;
    public static final int I64_EXTEND_I32_U = 0xDC;
    public static final int I64_TRUNC_F32_S = 0xDD;
    public static final int I64_TRUNC_F32_U = 0xDE;
    public static final int I64_TRUNC_F64_S = 0xDF;
    public static final int I64_TRUNC_F64_U = 0xE0;

    public static final int F32_CONVERT_I32_S = 0xE1;
    public static final int F32_CONVERT_I32_U = 0xE2;
    public static final int F32_CONVERT_I64_S = 0xE3;
    public static final int F32_CONVERT_I64_U = 0xE4;
    public static final int F32_DEMOTE_F64 = 0xE5;

    public static final int F64_CONVERT_I32_S = 0xE6;
    public static final int F64_CONVERT_I32_U = 0xE7;
    public static final int F64_CONVERT_I64_S = 0xE8;
    public static final int F64_CONVERT_I64_U = 0xE9;
    public static final int F64_PROMOTE_F32 = 0xEA;

    public static final int I32_REINTERPRET_F32 = 0xEB;
    public static final int I64_REINTERPRET_F64 = 0xEC;
    public static final int F32_REINTERPRET_I32 = 0xED;
    public static final int F64_REINTERPRET_I64 = 0xEE;

    public static final int I32_EXTEND8_S = 0xEF;
    public static final int I32_EXTEND16_S = 0xF0;
    public static final int I64_EXTEND8_S = 0xF1;
    public static final int I64_EXTEND16_S = 0xF2;
    public static final int I64_EXTEND32_S = 0xF3;

    public static final int REF_NULL = 0xF4;
    public static final int REF_IS_NULL = 0xF5;
    public static final int REF_FUNC = 0xF6;

    public static final int CALL_REF_U8 = 0xF7;
    public static final int CALL_REF_I32 = 0xF8;

    public static final int RETURN_CALL_REF_U8 = 0xF9;
    public static final int RETURN_CALL_REF_I32 = 0xFA;
    ...
    public static final int MEMORY64_INIT = 0x09;
    public static final int DATA_DROP = 0x0A;
    public static final int MEMORY_COPY = 0x0B;
    public static final int MEMORY64_COPY_D32_S64 = 0x0C;
    public static final int MEMORY64_COPY_D64_S32 = 0x0D;
    public static final int MEMORY64_COPY_D64_S64 = 0x0E;
    public static final int MEMORY_FILL = 0x0F;
    public static final int MEMORY64_FILL = 0x10;

    public static final int MEMORY64_SIZE = 0x11;
    public static final int MEMORY64_GROW = 0x12;
    public static final int TABLE_INIT = 0x13;
    public static final int ELEM_DROP = 0x14;
    public static final int TABLE_COPY = 0x15;
    public static final int TABLE_GROW = 0x16;
    public static final int TABLE_SIZE = 0x17;
    public static final int TABLE_FILL = 0x18;

    // Misc - Wide arithmetic opcodes
    public static final int I64_ADD128 = 0x19;
    public static final int I64_SUB128 = 0x1A;
    public static final int I64_MUL_WIDE_S = 0x1B;
    public static final int I64_MUL_WIDE_U = 0x1C;

    // Misc - Locals -- must match their U8 counterparts
    public static final int LOCAL_GET_I32 = 0x1D;
    public static final int LOCAL_GET_OBJ_I32 = 0x1E;

    public static final int LOCAL_SET_I32 = 0x1F;
    public static final int LOCAL_SET_OBJ_I32 = 0x20;

    public static final int LOCAL_TEE_I32 = 0x21;
    public static final int LOCAL_TEE_OBJ_I32 = 0x22;

    // Misc - Exception opcodes
    public static final int THROW = 0x23;
    public static final int THROW_REF = 0x24;
    public static final int RETHROW = 0x25;
    public static final int LEGACY_CATCH_DROP = 0x26;
    ...
    public static final int TABLE_GET = 0x2B;
    public static final int TABLE_SET = 0x2C;
    public static final int REF_AS_NON_NULL = 0x2D;
    public static final int BR_ON_NULL_U8 = 0x2E;
    public static final int BR_ON_NULL_I32 = 0x2F;
    public static final int BR_ON_NON_NULL_U8 = 0x30;
    public static final int BR_ON_NON_NULL_I32 = 0x31;

    // Misc - GC opcodes
    public static final int REF_EQ = 0x32;

    // Misc - Tail calls
    public static final int BR_RETURN_CALL = 0x33;
    ...
    private static boolean checkBytecodes() {
        // Bytecode generation requires these opcode to be identical
        assert LOCAL_GET_U8 == LOCAL_GET_I32 : "local get instructions do not match";
        assert LOCAL_GET_OBJ_U8 == LOCAL_GET_OBJ_I32 : "local get object instructions do not match";
        assert LOCAL_SET_U8 == LOCAL_SET_I32 : "local set instructions do not match";
        assert LOCAL_SET_OBJ_U8 == LOCAL_SET_OBJ_I32 : "local set object instructions do not match";
        assert LOCAL_TEE_U8 == LOCAL_TEE_I32 : "local tee instructions do not match";
        assert LOCAL_TEE_OBJ_U8 == LOCAL_TEE_OBJ_I32 : "local tee object instructions do not match";
        return true;
    }
