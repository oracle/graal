...
final class ByteBufferWasmMemory extends UnsafeWasmMemory {
    ...
    private ByteBufferWasmMemory(long declaredMinSize, long declaredMaxSize, long initialSize, long maxAllowedSize, boolean indexType64) {
    ...
    ByteBufferWasmMemory(long declaredMinSize, long declaredMaxSize, long maxAllowedSize, boolean indexType64) {
    ...
    public void copyFrom(WasmMemory source, long sourceOffset, long destinationOffset, long length) {
        assert source instanceof ByteBufferWasmMemory;
        assert destinationOffset + length < byteSize();
        final ByteBufferWasmMemory s = (ByteBufferWasmMemory) source;
        unsafe.copyMemory(s.startAddress + sourceOffset, this.startAddress + destinationOffset, length);
    }

    @Override
    public WasmMemory duplicate() {
        final ByteBufferWasmMemory other = new ByteBufferWasmMemory(declaredMinSize, declaredMaxSize, size, maxAllowedSize, indexType64);
