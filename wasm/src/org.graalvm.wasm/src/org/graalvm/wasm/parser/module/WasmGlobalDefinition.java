...
public class WasmGlobalDefinition {
    private final byte mutability;
    private final byte valueType;
    @CompilationFinal private boolean initialized;
    @CompilationFinal private long valueOrIndex;

    public WasmGlobalDefinition(byte mutability, byte valueType, boolean initialized, long valueOrIndex) {
    ...
    public long getValueOrIndex() {
        return valueOrIndex;
    }

    public void initialize(long value) {
        this.initialized = true;
        this.valueOrIndex = value;
    }
}
