...
public record FieldType(StorageType storageType, byte mutability) {

    public boolean isSubtypeOf(FieldType that) {
        if (this.mutability != that.mutability) {
            return false;
        }
    ...
    @Override
    public int hashCode() {
        return Objects.hash(storageType, mutability);
    }

    @Override
    public String toString() {
        CompilerAsserts.neverPartOfCompilation();
        return mutability == Mutability.MUTABLE ? "(mut " + storageType + ")" : storageType.toString();
    }
}
