...
public final class WasiFdPwriteNode extends WasmBuiltinRootNode {

    public WasiFdPwriteNode(WasmLanguage language, WasmModule module) {
    ...
    private int fdPwrite(WasmStore store, WasmMemory memory, int fd, int iov, int iovcnt, long offset, int sizeAddress) {
        ...
        return handle.pwrite(this, memory, iov, iovcnt, offset, sizeAddress).ordinal();
    }

    @Override
    public String builtinNodeName() {
        return "__wasi_fd_pwrite";
    }
