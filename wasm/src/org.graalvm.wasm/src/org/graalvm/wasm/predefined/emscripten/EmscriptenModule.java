...
public class EmscriptenModule extends BuiltinModule {
    ...
    protected WasmModule createModule(WasmLanguage language, WasmContext context, String name) {
        ...
        defineFunction(context, module, "_emscripten_memcpy_big", types(I32_TYPE, I32_TYPE, I32_TYPE), types(I32_TYPE), new EmscriptenMemcpyBig(language, module));
        defineFunction(context, module, "_emscripten_get_heap_size", types(), types(I32_TYPE), new EmscriptenGetHeapSize(language, module));
        defineFunction(context, module, "_emscripten_resize_heap", types(I32_TYPE), types(I32_TYPE), new EmscriptenResizeHeap(language, module));
        defineFunction(context, module, "_gettimeofday", types(I32_TYPE, I32_TYPE), types(I32_TYPE), new GetTimeOfDay(language, module));
        defineFunction(context, module, "_llvm_exp2_f64", types(F64_TYPE), types(F64_TYPE), new LLVMExp2F64(language, module));
        defineFunction(context, module, "___wasi_fd_write", types(I32_TYPE, I32_TYPE, I32_TYPE, I32_TYPE), types(I32_TYPE), new WasiFdWrite(language, module));
        defineFunction(context, module, "___lock", types(I32_TYPE), types(), new Lock(language, module));
        defineFunction(context, module, "___unlock", types(I32_TYPE), types(), new Unlock(language, module));
        defineFunction(context, module, "___setErrNo", types(I32_TYPE), types(), new SetErrNo(language, module));
        defineFunction(context, module, "___syscall140", types(I32_TYPE, I32_TYPE), types(I32_TYPE), new UnimplementedNode("___syscall140", language, module));
        defineFunction(context, module, "___syscall146", types(I32_TYPE, I32_TYPE), types(I32_TYPE), new UnimplementedNode("___syscall146", language, module));
