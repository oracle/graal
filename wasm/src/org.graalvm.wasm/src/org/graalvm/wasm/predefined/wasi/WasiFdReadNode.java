...
public final class WasiFdReadNode extends WasmBuiltinRootNode {
    ...
    public WasiFdReadNode(WasmLanguage language, WasmModule module) {
    ...
    public Object executeWithInstance(VirtualFrame frame, WasmInstance instance) {
        ...
        return fdRead(instance.store(), memory(frame),
    ...
    @TruffleBoundary
    private int fdRead(WasmStore store, WasmMemory memory, int fd, int iov, int iovcnt, int sizeAddress) {
