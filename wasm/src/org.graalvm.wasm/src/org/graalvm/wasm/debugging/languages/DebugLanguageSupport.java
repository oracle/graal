...
package org.graalvm.wasm.debugging.languages;

import org.graalvm.wasm.debugging.data.DebugObjectFactory;
import org.graalvm.wasm.debugging.encoding.Languages;
import org.graalvm.wasm.debugging.languages.c.CObjectFactory;
...
public final class DebugLanguageSupport {
    ...
    public static DebugObjectFactory getObjectFactory(int languageId) {
        switch (languageId) {
            ...
            case Languages.C_PLUS_PLUS_03:
            case Languages.C_PLUS_PLUS_11:
            case Languages.C_PLUS_PLUS_14:
            case Languages.C_PLUS_PLUS_17:
            case Languages.C_PLUS_PLUS_20:
                return new CppObjectFactory();
            case Languages.RUST:
                return new RustObjectFactory();
            default:
                return null;
        }
    }
