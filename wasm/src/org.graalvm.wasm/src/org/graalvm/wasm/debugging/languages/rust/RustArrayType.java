...
public class RustArrayType extends DebugArrayType {
    ...
    public String asTypeName() {
        ...
        buildName(dimensionSizes.length - 1, builder);
        return builder.toString();
    }

    private void buildName(int dimension, StringBuilder builder) {
        builder.append("[");
        if (dimension == 0) {
            builder.append(elementType.asTypeName());
        } else {
            buildName(dimension - 1, builder);
        }
        builder.append("; ");
        builder.append(dimensionSizes[dimension]);
        builder.append("]");
    }
}
