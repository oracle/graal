...
public class SExprParser extends Parser {
    ...
    public static final int RULE_root = 0, RULE_sexpr = 1, RULE_list = 2, RULE_atom = 3;
    ...
    public static class RootContext extends ParserRuleContext {
        ...
        public TerminalNode EOF() {
            return getToken(SExprParser.EOF, 0);
        }
    ...
    public static class ListContext extends ParserRuleContext {
        ...
        public TerminalNode LPAREN() {
            return getToken(SExprParser.LPAREN, 0);
        }

        public TerminalNode RPAREN() {
            return getToken(SExprParser.RPAREN, 0);
        }
    ...
    public static class AtomContext extends ParserRuleContext {
        ...
        public TerminalNode STRING() {
            return getToken(SExprParser.STRING, 0);
        }

        public TerminalNode SYMBOL() {
            return getToken(SExprParser.SYMBOL, 0);
        }

        public TerminalNode INTEGER() {
            return getToken(SExprParser.INTEGER, 0);
        }

        public TerminalNode FLOATING() {
            return getToken(SExprParser.FLOATING, 0);
        }
    ...
    public static final String _serializedATN = "\3\u608b\ua72a\u8133\ub9ed\u417c\u3be7\u7786\u5964\3\13\64\4\2\t\2\4\3" +
