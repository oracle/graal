...
(module
    ...
    (func (export "_main") (result i32) (local $ret i32)
        ...
        ;; Set fdflags to 2 (dsync flag set)
        (local.set $ret (call $fd_fdstat_set_flags (i32.load (i32.const 8)) (i32.const 2)))
        ;; Exit in case of error
        (if (i32.ne (local.get $ret) (i32.const 0)) (then (return (local.get $ret))))
        ...
        ;; Check that fdflags equal 2
        (if (i32.ne (i32.load16_u (i32.const 14)) (i32.const 2)) (then (return (i32.const -1))))
