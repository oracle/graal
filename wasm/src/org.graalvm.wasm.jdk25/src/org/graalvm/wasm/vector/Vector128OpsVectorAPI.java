...
final class Vector128OpsVectorAPI implements Vector128Ops<ByteVector> {
    ...
    public ByteVector binary(ByteVector xVec, ByteVector yVec, int vectorOpcode) {
        ...
        return castByte128(switch (vectorOpcode) {
            ...
            case Bytecode.VECTOR_I8X16_ADD_SAT_U -> binop(x, y, I8X16, VectorOperators.SUADD);
            ...
            case Bytecode.VECTOR_I8X16_SUB_SAT_U -> binop(x, y, I8X16, VectorOperators.SUSUB);
            ...
            case Bytecode.VECTOR_I16X8_ADD_SAT_U -> binop(x, y, I16X8, VectorOperators.SUADD);
            ...
            case Bytecode.VECTOR_I16X8_SUB_SAT_U -> binop(x, y, I16X8, VectorOperators.SUSUB);
