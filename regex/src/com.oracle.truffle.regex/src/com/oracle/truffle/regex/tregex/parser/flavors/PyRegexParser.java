...
public final class PyRegexParser implements RegexParser {
    ...
    public PyRegexParser(RegexLanguage language, RegexSource source, CompilationBuffer compilationBuffer) throws RegexSyntaxException {
