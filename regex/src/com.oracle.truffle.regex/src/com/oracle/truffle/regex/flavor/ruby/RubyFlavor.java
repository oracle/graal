 ...
 * capture groups are resolved. Also, in {@code JSRegexParser}, an optimization that drops forward
 ...
 *
 * In unrolled loops, we disable empty checks altogether (in {@code JSRegexParser}, in the calls to
 ...
 * {@code JSRegexParser}. we also disable an optimization that drops zero-width groups and
