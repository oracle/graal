...
public abstract class RegexFlavor {
    ...
    protected static final int LOOKBEHINDS_REQUIRE_FIXED_WIDTH_PATTERN = 1 << 11;
    ...
    public abstract RegexLexer createLexer(RegexSource source, CompilationBuffer compilationBuffer);
    ...
    public boolean lookBehindsRequireFixedWidthPattern() {
        return hasTrait(LOOKBEHINDS_REQUIRE_FIXED_WIDTH_PATTERN);
    }
