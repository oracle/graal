...
public class TRegexOptions {
    ...
    /**
     * Maximum number of NFA states involved in one DFA transition. This number must not be higher that
     * 255, because the maximum number of NFA states in one DFA transition determines the number of
