...
public class TRegexOptions {
     ...
     */
    public static final int TRegexParserTreeMaxSize = 1_000_000;

    /**
     * Bailout threshold for recursive parser constructs, such as nested groups and character
     * classes.
     */
    public static final int TRegexParserTreeMaxNestingLevel = 128;
     ...
     * {@code graal/com.oracle.truffle.js.test/js/trufflejs/regexp/npm_extracted/hungry-regexp*.js}
     */
    public static final int TRegexMaxDFASize = 1_300;

    /**
     * Bailout threshold for number of transitions in the DFA ({@link TRegexDFAExecutorNode}
     * generated by {@link DFAGenerator}).
     */
    public static final int TRegexMaxDFATransitions = 1_300;

    /**
     * Maximum {@link TRegexDFAExecutorNode#getCGTrackingCost() capture group tracking cost} of
     * eager capture group tracking DFA matchers.
     */
    public static final int TRegexMaxEagerCGDFACost = 3_000;
    ...
    /**
     * Maximum number of elements in the backtracking executor's {@code int[]} stack.
     */
    public static final int TRegexMaxBacktrackingStackSize = 1 << 24;
    ...
    static {
        ...
        assert TRegexParserTreeMaxNestingLevel > 0;
        ...
        assert Integer.bitCount(TRegexMaxBacktrackingStackSize) == 1 : "TRegexMaxBacktrackingStackSize must be a power of 2";
