...
class JavaCharacter {
    ...
    static final CodePointSet ALPHABETIC = JavaGc.UPPERCASE_LETTER.union(JavaGc.LOWERCASE_LETTER).union(JavaGc.TITLECASE_LETTER).union(JavaGc.MODIFIER_LETTER).union(JavaGc.OTHER_LETTER).union(JavaGc.LETTER_NUMBER).union(JavaPropList.OTHER_ALPHABETIC);
    ...
    static final CodePointSet JAVA_IDENTIFIER_PART = LETTER.union(JavaGc.CURRENCY_SYMBOL).union(JavaGc.CONNECTOR_PUNCTUATION).union(DIGIT).union(JavaGc.LETTER_NUMBER).union(JavaGc.COMBINING_SPACING_MARK).union(JavaGc.NON_SPACING_MARK).union(IDENTIFIER_IGNORABLE);
    ...
    static final CodePointSet UNICODE_IDENTIFIER_PART = LETTER.union(JavaGc.CONNECTOR_PUNCTUATION).union(DIGIT).union(JavaGc.LETTER_NUMBER).union(JavaGc.COMBINING_SPACING_MARK).union(JavaGc.NON_SPACING_MARK).union(IDENTIFIER_IGNORABLE).union(JavaPropList.OTHER_ID_START).union(JavaPropList.OTHER_ID_CONTINUE);
