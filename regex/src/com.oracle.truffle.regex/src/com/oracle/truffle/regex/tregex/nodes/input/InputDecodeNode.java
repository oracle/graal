...
@GenerateUncached
public abstract class InputDecodeNode extends Node {

    public static InputDecodeNode create() {
        return InputDecodeNodeGen.create();
    }
    ...
    public static char charAtWithMask(TruffleObject input, int indexInput, StringUTF16 mask, int indexMask, InputDecodeNode charAtNode) {
