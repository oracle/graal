...
public class RegexOptionsParserTest {

    private static RegexOptions parse(String options) {
        Source source = Source.newBuilder("regex", options + "/./", "optionsTest").build();
        RegexOptions.Builder optionsBuilder = RegexOptions.builder(source, source.getCharacters().toString());
        optionsBuilder.parseOptions();
