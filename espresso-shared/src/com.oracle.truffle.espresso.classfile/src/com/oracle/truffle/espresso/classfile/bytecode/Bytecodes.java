...
import static com.oracle.truffle.espresso.classfile.bytecode.Bytecodes.Flags.BRANCH;
import static com.oracle.truffle.espresso.classfile.bytecode.Bytecodes.Flags.COMMUTATIVE;
import static com.oracle.truffle.espresso.classfile.bytecode.Bytecodes.Flags.FALL_THROUGH;
import static com.oracle.truffle.espresso.classfile.bytecode.Bytecodes.Flags.FIELD_READ;
import static com.oracle.truffle.espresso.classfile.bytecode.Bytecodes.Flags.FIELD_WRITE;
import static com.oracle.truffle.espresso.classfile.bytecode.Bytecodes.Flags.INVOKE;
import static com.oracle.truffle.espresso.classfile.bytecode.Bytecodes.Flags.LOAD;
import static com.oracle.truffle.espresso.classfile.bytecode.Bytecodes.Flags.PRODUCE_FOREIGN;
import static com.oracle.truffle.espresso.classfile.bytecode.Bytecodes.Flags.QUICKENABLE;
import static com.oracle.truffle.espresso.classfile.bytecode.Bytecodes.Flags.QUICKENED;
import static com.oracle.truffle.espresso.classfile.bytecode.Bytecodes.Flags.RECEIVE_FOREIGN;
import static com.oracle.truffle.espresso.classfile.bytecode.Bytecodes.Flags.STOP;
import static com.oracle.truffle.espresso.classfile.bytecode.Bytecodes.Flags.STORE;
import static com.oracle.truffle.espresso.classfile.bytecode.Bytecodes.Flags.TRAP;
...
public final class Bytecodes {
    ...
    static {
         ...
         * Espresso special bytecodes.
         */
        def(RETURN_VALUE        , "returnvalue"     , "b"    ,  0, TRAP | STOP);
        def(THROW_VALUE         , "throwvalue"      , "b"    ,  0, TRAP | STOP);
    }
    // @formatter:on
    // Checkstyle: resume
