  ...
  "distributions" : {
    ...
    "SULONG_NATIVE_AND_LLVM_TOOLCHAIN": {
      ...
      "layout": {
        ...
        "lib/sulong/native/bin/": "dependency:graalvm-native-tool",

        "lib/sulong/native/bin/<exe:graalvm-native-clang>": "link:graalvm-native-tool",
        "lib/sulong/native/bin/<exe:graalvm-clang>": "link:graalvm-native-clang",
        "lib/sulong/native/bin/<exe:clang>": "link:graalvm-native-clang",
        "lib/sulong/native/bin/<exe:cc>": "link:clang",
        "lib/sulong/native/bin/<exe:gcc>": "link:clang",

        "lib/sulong/native/bin/<exe:graalvm-native-clang++>": "link:graalvm-native-tool",
        "lib/sulong/native/bin/<exe:graalvm-clang++>": "link:graalvm-native-clang++",
        "lib/sulong/native/bin/<exe:clang++>": "link:graalvm-native-clang++",
        "lib/sulong/native/bin/<exe:c++>": "link:clang++",
        "lib/sulong/native/bin/<exe:g++>": "link:clang++",

        "lib/sulong/native/bin/<exe:graalvm-native-clang-cl>": "link:graalvm-native-tool",
        "lib/sulong/native/bin/<exe:graalvm-clang-cl>": "link:graalvm-native-clang-cl",
        "lib/sulong/native/bin/<exe:clang-cl>": "link:graalvm-native-clang-cl",
        "lib/sulong/native/bin/<exe:cl>": "link:clang-cl",

        "lib/sulong/native/bin/<exe:graalvm-native-ld>": "link:graalvm-native-tool",
        "lib/sulong/native/bin/<exe:ld>": "link:graalvm-native-tool",
        "lib/sulong/native/bin/<exe:ld.lld>": "link:graalvm-native-tool",
        "lib/sulong/native/bin/<exe:lld>": "link:graalvm-native-tool",
        "lib/sulong/native/bin/<exe:lld-link>": "link:graalvm-native-tool",
        "lib/sulong/native/bin/<exe:ld64>": "link:graalvm-native-tool",

        "lib/sulong/native/bin/<exe:graalvm-native-flang>": "link:graalvm-native-tool",
        "lib/sulong/native/bin/<exe:graalvm-flang>": "link:graalvm-native-flang",
        "lib/sulong/native/bin/<exe:flang-new>": "link:graalvm-native-flang",
        "lib/sulong/native/bin/<exe:flang>": "link:graalvm-native-flang",

        "lib/sulong/native/bin/<exe:llvm-ar>": "link:graalvm-native-tool",
        "lib/sulong/native/bin/<exe:ar>": "link:llvm-ar",
        "lib/sulong/native/bin/<exe:llvm-nm>": "link:graalvm-native-tool",
        "lib/sulong/native/bin/<exe:nm>": "link:llvm-nm",
        "lib/sulong/native/bin/<exe:llvm-objcopy>": "link:graalvm-native-tool",
        "lib/sulong/native/bin/<exe:objcopy>": "link:llvm-objcopy",
        "lib/sulong/native/bin/<exe:llvm-objdump>": "link:graalvm-native-tool",
        "lib/sulong/native/bin/<exe:objdump>": "link:llvm-objdump",
        "lib/sulong/native/bin/<exe:llvm-ranlib>": "link:graalvm-native-tool",
        "lib/sulong/native/bin/<exe:ranlib>": "link:llvm-ranlib",
        "lib/sulong/native/bin/<exe:llvm-readelf>": "link:graalvm-native-tool",
        "lib/sulong/native/bin/<exe:readelf>": "link:llvm-readelf",
        "lib/sulong/native/bin/<exe:llvm-readobj>": "link:graalvm-native-tool",
        "lib/sulong/native/bin/<exe:readobj>": "link:llvm-readobj",
        "lib/sulong/native/bin/<exe:llvm-strip>": "link:graalvm-native-tool",
        "lib/sulong/native/bin/<exe:strip>": "link:llvm-strip",
      },
      "defaultBuild": False,
    },
