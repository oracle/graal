...
local sc = (import "ci_common/sulong-common.jsonnet");
{
  ...
  regular_builds:: [
    ...
    sc.gate + $.sulong + sc.labsjdk21 + sc.darwin_amd64 + sc.llvmBundled + sc.gateTags(basicTagsToolchain) + { name: "gate-sulong-basic-nwcc-llvm-toolchain-jdk21-darwin-amd64", timelimit: "0:45:00" },
  ...
  standalone_builds::
    ...
    [
      ...
      { name: "gate-sulong-test-ce-standalones-jvm-jdk21-darwin-amd64",   timelimit: "1:00:00" },
      ...
      { name: "gate-sulong-test-ce-standalones-native-jdk21-darwin-amd64",   timelimit: "1:00:00" },
