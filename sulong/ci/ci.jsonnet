...
local sc = (import "ci_common/sulong-common.jsonnet");
{
  ...
  regular_builds:: [
    ...
    sc.gate + $.sulong + sc.labsjdk_ce_17 + sc.windows_amd64 + sc.llvmBundled + sc.gateTags("build,sulongBasic,nwcc,llvm,toolchain") + { name: "gate-sulong-basic-nwcc-llvm-toolchain-jdk17-windows-amd64" },
  ],
