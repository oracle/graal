...
local sc = (import "ci_common/sulong-common.jsonnet");
{
  ...
  regular_builds:: [
    ...
    sc.gate + $.sulong + sc.labsjdk21 + sc.darwin_amd64 + sc.llvmBundled + sc.gateTags(basicTagsToolchain) + { name: "gate-sulong-basic-nwcc-llvm-toolchain-jdk21-darwin-amd64", timelimit: "0:45:00", capabilities+: ["ram16gb"] },
