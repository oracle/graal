...
local sc = (import "ci_common/sulong-common.jsonnet");
{
  ...
  standalone_builds::
    ...
    [
      ...
      # GR-50165, GR-73510
      # { name: "daily-sulong-test-ce-standalones-jvm-jdk-latest-windows-amd64",  timelimit: "1:00:00", targets: [] } + sc.daily,
      ...
      # GR-50165, GR-73510
      # { name: "daily-sulong-test-ce-standalones-native-jdk-latest-windows-amd64",  timelimit: "1:00:00", targets: [] } + sc.daily,
