...
declare x86_fp80 @llvm.experimental.constrained.fpext.f64(double, metadata)

; Function Attrs: nounwind ssp uwtable
define i32 @main() {
	%X = fpext double 1.25 to x86_fp80
	call void (x86_fp80) @printFP80(x86_fp80 %X)

	%Y = call x86_fp80 @llvm.experimental.constrained.fpext.f64(double 1.25, metadata !"fpexcept.strict")
	call void (x86_fp80) @printFP80(x86_fp80 %Y)
