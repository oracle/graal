...
define i32 @u1_zext(float) #0 {
  %c = fptoui float %0 to i1
  %c_ext = zext i1 %c to i32
  %r = select i1 %c, i32 %c_ext, i32 23
  ret i32 %r
}

define i32 @u1(float) #0 {
  %c = fptoui float %0 to i1
  %c_ext = zext i1 %c to i32
  ret i32 %c_ext
}
...
define i32 @main() {
  ...
  %u1_zext_249 = tail call i32 @u1_zext(float -4.000000e+00)
  ...
  %u1_zext_251 = tail call i32 @u1_zext(float -3.000000e+00)
  ...
  %u1_zext_253 = tail call i32 @u1_zext(float -2.000000e+00)
  ...
  %u1_zext_255 = tail call i32 @u1_zext(float -1.000000e+00)
  ...
  %u1_zext_257 = tail call i32 @u1_zext(float 0xBFE99999A0000000)
  ...
  %u1_zext_259 = tail call i32 @u1_zext(float -5.000000e-01)
  ...
  %u1_zext_261 = tail call i32 @u1_zext(float 0xBFD3333340000000)
  ...
  %u1_zext_263 = tail call i32 @u1_zext(float 0.000000e+00)
  ...
  %u1_zext_265 = tail call i32 @u1_zext(float 0x3FD3333340000000)
  ...
  %u1_zext_267 = tail call i32 @u1_zext(float 5.000000e-01)
  ...
  %u1_zext_269 = tail call i32 @u1_zext(float 0x3FE99999A0000000)
  ...
  %u1_zext_271 = tail call i32 @u1_zext(float 1.000000e+00)
  ...
  %u1_zext_273 = tail call i32 @u1_zext(float 2.000000e+00)
  ...
  %u1_zext_275 = tail call i32 @u1_zext(float 3.000000e+00)
  ...
  %u1_zext_277 = tail call i32 @u1_zext(float 4.000000e+00)
