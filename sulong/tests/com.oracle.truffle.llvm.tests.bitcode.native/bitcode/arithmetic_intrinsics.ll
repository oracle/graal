...
define i32 @main() #0 {
  ...
  tail call void @testI8_ssub_sat(i8 127, i8 -1)
  ...
  tail call void @testI16_ssub_sat(i16 32767, i16 -1)
  ...
  tail call void @testI32_ssub_sat(i32 2147483647, i32 -1)
  ...
  tail call void @testI64_ssub_sat(i64 9223372036854775807, i64 -1)
