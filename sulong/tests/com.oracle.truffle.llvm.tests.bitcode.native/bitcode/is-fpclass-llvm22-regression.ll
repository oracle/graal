...
define i32 @main() {
  ...
  ; A signed NaN must not match a mask containing every negative finite/infinite class.
  %negative.nan80 = call i1 @llvm.is.fpclass.f80(x86_fp80 0xKFFFFC000000000000000, i32 28)
  %negative.nan80.ok = xor i1 %negative.nan80, true
  ...
  %fp.ok = and i1 %f32.ok, %f64.ok
  %ok = and i1 %fp.ok, %negative.nan80.ok
