...
define i32 @i1_zext(x86_fp80) #0 {
  %2 = fptosi x86_fp80 %0 to i1
  %3 = zext i1 %2 to i32
  %4 = select i1 %2, i32 %3, i32 23
  ret i32 %4
}

define i32 @i1_sext(x86_fp80) #0 {
  %2 = fptosi x86_fp80 %0 to i1
  %3 = sext i1 %2 to i32
  %4 = select i1 %2, i32 %3, i32 23
  ret i32 %4
...
define i32 @main() {
  ...
  %i1_zext_94  = tail call i32 @i1_zext(x86_fp80 0xKC0018000000000000000)
  ...
  %i1_zext_96  = tail call i32 @i1_zext(x86_fp80 0xKC000C000000000000000)
  ...
  %i1_zext_98  = tail call i32 @i1_zext(x86_fp80 0xKC0008000000000000000)
  ...
  %i1_zext_100 = tail call i32 @i1_zext(x86_fp80 0xKBFFF8000000000000000)
  ...
  %i1_zext_102 = tail call i32 @i1_zext(x86_fp80 0xKBFFECCCCCCCCCCCCD000)
  ...
  %i1_zext_104 = tail call i32 @i1_zext(x86_fp80 0xKBFFE8000000000000000)
  ...
  %i1_zext_106 = tail call i32 @i1_zext(x86_fp80 0xKBFFD9999999999999800)
  ...
  %i1_zext_108 = tail call i32 @i1_zext(x86_fp80 0xK00000000000000000000)
  ...
  %i1_zext_110 = tail call i32 @i1_zext(x86_fp80 0xK3FFD9999999999999800)
  ...
  %i1_zext_112 = tail call i32 @i1_zext(x86_fp80 0xK3FFE8000000000000000)
  ...
  %i1_zext_114 = tail call i32 @i1_zext(x86_fp80 0xK3FFECCCCCCCCCCCCD000)
  ...
  %i1_zext_116 = tail call i32 @i1_zext(x86_fp80 0xK3FFF8000000000000000)
  ...
  %i1_zext_118 = tail call i32 @i1_zext(x86_fp80 0xK40008000000000000000)
  ...
  %i1_zext_120 = tail call i32 @i1_zext(x86_fp80 0xK4000C000000000000000)
  ...
  %i1_zext_122 = tail call i32 @i1_zext(x86_fp80 0xK40018000000000000000)
  ...
  %i1_sext_94  = tail call i32 @i1_sext(x86_fp80 0xKC0018000000000000000)
  ...
  %i1_sext_96  = tail call i32 @i1_sext(x86_fp80 0xKC000C000000000000000)
  ...
  %i1_sext_98  = tail call i32 @i1_sext(x86_fp80 0xKC0008000000000000000)
  ...
  %i1_sext_100 = tail call i32 @i1_sext(x86_fp80 0xKBFFF8000000000000000)
  ...
  %i1_sext_102 = tail call i32 @i1_sext(x86_fp80 0xKBFFECCCCCCCCCCCCD000)
  ...
  %i1_sext_104 = tail call i32 @i1_sext(x86_fp80 0xKBFFE8000000000000000)
  ...
  %i1_sext_106 = tail call i32 @i1_sext(x86_fp80 0xKBFFD9999999999999800)
  ...
  %i1_sext_108 = tail call i32 @i1_sext(x86_fp80 0xK00000000000000000000)
  ...
  %i1_sext_110 = tail call i32 @i1_sext(x86_fp80 0xK3FFD9999999999999800)
  ...
  %i1_sext_112 = tail call i32 @i1_sext(x86_fp80 0xK3FFE8000000000000000)
  ...
  %i1_sext_114 = tail call i32 @i1_sext(x86_fp80 0xK3FFECCCCCCCCCCCCD000)
  ...
  %i1_sext_116 = tail call i32 @i1_sext(x86_fp80 0xK3FFF8000000000000000)
  ...
  %i1_sext_118 = tail call i32 @i1_sext(x86_fp80 0xK40008000000000000000)
  ...
  %i1_sext_120 = tail call i32 @i1_sext(x86_fp80 0xK4000C000000000000000)
  ...
  %i1_sext_122 = tail call i32 @i1_sext(x86_fp80 0xK40018000000000000000)
