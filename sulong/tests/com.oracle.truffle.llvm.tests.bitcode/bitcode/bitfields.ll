...
@string = local_unnamed_addr global i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), align 8
@values = local_unnamed_addr global [7 x i128] [i128 0, i128 1, i128 -1, i128 -1000, i128 1000, i128 -1, i128 9223372036854775807], align 16

define void @test17(i64, i64) local_unnamed_addr #0 {
...
define void @test113(i128, i128) local_unnamed_addr #0 {
  %format = load i8*, i8** @string, align 8
...
define void @test(i128, i128) local_unnamed_addr #0 {
