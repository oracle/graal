...
public class TypeDefinitionClientCapabilities extends JSONBase {
    ...
    TypeDefinitionClientCapabilities(JSONObject jsonData) {
        super(jsonData);
    }
    ...
    public TypeDefinitionClientCapabilities setDynamicRegistration(Boolean dynamicRegistration) {
    ...
    public TypeDefinitionClientCapabilities setLinkSupport(Boolean linkSupport) {
    ...
    public boolean equals(Object obj) {
        ...
        TypeDefinitionClientCapabilities other = (TypeDefinitionClientCapabilities) obj;
    ...
    public int hashCode() {
        ...
        if (this.getDynamicRegistration() != null) {
            hash = 61 * hash + Boolean.hashCode(this.getDynamicRegistration());
        }
        if (this.getLinkSupport() != null) {
            hash = 61 * hash + Boolean.hashCode(this.getLinkSupport());
        }
        return hash;
    }

    public static TypeDefinitionClientCapabilities create() {
        final JSONObject json = new JSONObject();
        return new TypeDefinitionClientCapabilities(json);
    }
}
