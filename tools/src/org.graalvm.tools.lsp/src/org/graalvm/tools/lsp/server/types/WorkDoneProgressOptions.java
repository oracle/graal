...
public class WorkDoneProgressOptions extends JSONBase {
    ...
    WorkDoneProgressOptions(JSONObject jsonData) {
        super(jsonData);
    }
    ...
    public WorkDoneProgressOptions setWorkDoneProgress(Boolean workDoneProgress) {
    ...
    public boolean equals(Object obj) {
        ...
        WorkDoneProgressOptions other = (WorkDoneProgressOptions) obj;
    ...
    public static WorkDoneProgressOptions create() {
        final JSONObject json = new JSONObject();
        return new WorkDoneProgressOptions(json);
    }
}
