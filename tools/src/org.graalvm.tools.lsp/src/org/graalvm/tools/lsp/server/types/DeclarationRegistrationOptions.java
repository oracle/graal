...
public class DeclarationRegistrationOptions extends DeclarationOptions {

    DeclarationRegistrationOptions(JSONObject jsonData) {
        super(jsonData);
    }
    ...
    public DeclarationRegistrationOptions setDocumentSelector(List<Object> documentSelector) {
    ...
    public DeclarationRegistrationOptions setId(String id) {
    ...
    public int hashCode() {
        ...
        if (this.getDocumentSelector() != null) {
            hash = 89 * hash + Objects.hashCode(this.getDocumentSelector());
        }
        if (this.getId() != null) {
