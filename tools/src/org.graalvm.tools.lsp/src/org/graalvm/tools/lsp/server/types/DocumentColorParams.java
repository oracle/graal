 ...
 */
public class DocumentColorParams extends WorkDoneProgressParams {

    DocumentColorParams(JSONObject jsonData) {
        super(jsonData);
    }
    ...
    public DocumentColorParams setTextDocument(TextDocumentIdentifier textDocument) {
    ...
    public DocumentColorParams setPartialResultToken(Object partialResultToken) {
    ...
    public int hashCode() {
        ...
        if (this.getPartialResultToken() != null) {
            hash = 59 * hash + Objects.hashCode(this.getPartialResultToken());
        }
