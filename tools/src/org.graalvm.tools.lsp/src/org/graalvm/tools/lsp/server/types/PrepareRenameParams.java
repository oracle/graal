...
public class PrepareRenameParams extends TextDocumentPositionParams {
    ...
    PrepareRenameParams(JSONObject jsonData) {
        super(jsonData);
    }
    ...
    public PrepareRenameParams setWorkDoneToken(Object workDoneToken) {
    ...
    public boolean equals(Object obj) {
        ...
        PrepareRenameParams other = (PrepareRenameParams) obj;
    ...
    public int hashCode() {
        ...
        if (this.getWorkDoneToken() != null) {
            hash = 71 * hash + Objects.hashCode(this.getWorkDoneToken());
        }
        hash = 71 * hash + Objects.hashCode(this.getTextDocument());
        hash = 71 * hash + Objects.hashCode(this.getPosition());
        return hash;
    }

    public static PrepareRenameParams create(TextDocumentIdentifier textDocument, Position position) {
        final JSONObject json = new JSONObject();
        json.put("textDocument", textDocument.jsonData);
        json.put("position", position.jsonData);
        return new PrepareRenameParams(json);
    }
}
