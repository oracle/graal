 ...
 */
public class ShowMessageParams extends JSONBase {

    ShowMessageParams(JSONObject jsonData) {
        super(jsonData);
    }
    ...
    public ShowMessageParams setType(MessageType type) {
    ...
    public ShowMessageParams setMessage(String message) {
