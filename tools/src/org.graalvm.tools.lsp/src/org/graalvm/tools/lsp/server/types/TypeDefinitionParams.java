...
public class TypeDefinitionParams extends TextDocumentPositionParams {
    ...
    TypeDefinitionParams(JSONObject jsonData) {
        super(jsonData);
    }
    ...
    public TypeDefinitionParams setWorkDoneToken(Object workDoneToken) {
    ...
    public TypeDefinitionParams setPartialResultToken(Object partialResultToken) {
    ...
    public boolean equals(Object obj) {
        ...
        TypeDefinitionParams other = (TypeDefinitionParams) obj;
    ...
    public int hashCode() {
        ...
        if (this.getWorkDoneToken() != null) {
            hash = 31 * hash + Objects.hashCode(this.getWorkDoneToken());
        }
        if (this.getPartialResultToken() != null) {
            hash = 31 * hash + Objects.hashCode(this.getPartialResultToken());
        }
        hash = 31 * hash + Objects.hashCode(this.getTextDocument());
        hash = 31 * hash + Objects.hashCode(this.getPosition());
        return hash;
    }

    public static TypeDefinitionParams create(TextDocumentIdentifier textDocument, Position position) {
        final JSONObject json = new JSONObject();
        json.put("textDocument", textDocument.jsonData);
        json.put("position", position.jsonData);
        return new TypeDefinitionParams(json);
    }
}
