...
public class DidChangeWorkspaceFoldersParams extends JSONBase {
    ...
    public WorkspaceFoldersChangeEvent getEvent() {
        return new WorkspaceFoldersChangeEvent(jsonData.getJSONObject("event"));
    }

    public DidChangeWorkspaceFoldersParams setEvent(WorkspaceFoldersChangeEvent event) {
        jsonData.put("event", event.jsonData);
        return this;
    }
