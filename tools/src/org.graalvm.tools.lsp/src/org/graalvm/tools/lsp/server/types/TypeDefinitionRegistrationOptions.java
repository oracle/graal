...
public class TypeDefinitionRegistrationOptions extends TypeDefinitionOptions {
    ...
    TypeDefinitionRegistrationOptions(JSONObject jsonData) {
        super(jsonData);
    }
    ...
    public TypeDefinitionRegistrationOptions setId(String id) {
    ...
    public int hashCode() {
        ...
        if (this.getDocumentSelector() != null) {
            hash = 59 * hash + Objects.hashCode(this.getDocumentSelector());
        }
        if (this.getId() != null) {
