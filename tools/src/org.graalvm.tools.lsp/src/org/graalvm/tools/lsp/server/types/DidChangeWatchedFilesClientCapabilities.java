...
public class DidChangeWatchedFilesClientCapabilities extends JSONBase {

    DidChangeWatchedFilesClientCapabilities(JSONObject jsonData) {
        super(jsonData);
    }
    ...
    public DidChangeWatchedFilesClientCapabilities setDynamicRegistration(Boolean dynamicRegistration) {
    ...
    public boolean equals(Object obj) {
        ...
        DidChangeWatchedFilesClientCapabilities other = (DidChangeWatchedFilesClientCapabilities) obj;
    ...
    public static DidChangeWatchedFilesClientCapabilities create() {
        final JSONObject json = new JSONObject();
        return new DidChangeWatchedFilesClientCapabilities(json);
    }
}
