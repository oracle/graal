...
public class TypeDefinitionOptions extends WorkDoneProgressOptions {
    ...
    TypeDefinitionOptions(JSONObject jsonData) {
        super(jsonData);
    }
    ...
    public boolean equals(Object obj) {
        ...
        TypeDefinitionOptions other = (TypeDefinitionOptions) obj;
    ...
    public static TypeDefinitionOptions create() {
        final JSONObject json = new JSONObject();
        return new TypeDefinitionOptions(json);
    }
}
