...
public class ImplementationRegistrationOptions extends ImplementationOptions {

    ImplementationRegistrationOptions(JSONObject jsonData) {
        super(jsonData);
    }
    ...
    public ImplementationRegistrationOptions setId(String id) {
    ...
    public int hashCode() {
        ...
        if (this.getDocumentSelector() != null) {
            hash = 11 * hash + Objects.hashCode(this.getDocumentSelector());
        }
        if (this.getId() != null) {
            hash = 11 * hash + Objects.hashCode(this.getId());
        }
        if (this.getWorkDoneProgress() != null) {
            hash = 11 * hash + Boolean.hashCode(this.getWorkDoneProgress());
        }
        return hash;
    }

    public static ImplementationRegistrationOptions create(List<Object> documentSelector) {
        ...
        return new ImplementationRegistrationOptions(json);
    }
}
