...
public class DocumentFormattingOptions extends WorkDoneProgressOptions {
    ...
    DocumentFormattingOptions(JSONObject jsonData) {
        super(jsonData);
    }
    ...
    public boolean equals(Object obj) {
        ...
        DocumentFormattingOptions other = (DocumentFormattingOptions) obj;
    ...
    public static DocumentFormattingOptions create() {
        final JSONObject json = new JSONObject();
        return new DocumentFormattingOptions(json);
    }
}
