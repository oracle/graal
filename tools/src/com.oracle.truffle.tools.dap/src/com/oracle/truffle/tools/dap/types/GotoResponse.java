...
public class GotoResponse extends Response {
    ...
    GotoResponse(JSONObject jsonData) {
        super(jsonData);
    }
    ...
    public boolean equals(Object obj) {
        ...
        GotoResponse other = (GotoResponse) obj;
    ...
    public static GotoResponse create(Integer requestSeq, Boolean success, String command, Integer seq) {
