...
public class CancelResponse extends Response {
    ...
    CancelResponse(JSONObject jsonData) {
        super(jsonData);
    }
    ...
    public static CancelResponse create(Integer requestSeq, Boolean success, String command, Integer seq) {
        ...
        json.put("seq", seq);
        return new CancelResponse(json);
    }
}
