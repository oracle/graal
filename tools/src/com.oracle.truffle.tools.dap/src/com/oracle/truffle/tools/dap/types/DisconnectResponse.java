...
public class DisconnectResponse extends Response {
    ...
    DisconnectResponse(JSONObject jsonData) {
        super(jsonData);
    }
    ...
    public static DisconnectResponse create(Integer requestSeq, Boolean success, String command, Integer seq) {
        ...
        json.put("seq", seq);
        return new DisconnectResponse(json);
    }
}
