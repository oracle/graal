...
public class CompletionsResponse extends Response {
    ...
    CompletionsResponse(JSONObject jsonData) {
        super(jsonData);
    }
    ...
    public CompletionsResponse setBody(ResponseBody body) {
    ...
    public static class ResponseBody extends JSONBase {
         ...
         */
        public List<CompletionItem> getTargets() {
        ...
        public ResponseBody setTargets(List<CompletionItem> targets) {
            final JSONArray json = new JSONArray();
            for (CompletionItem completionItem : targets) {
        ...
        public int hashCode() {
            int hash = 7;
            hash = 61 * hash + Objects.hashCode(this.getTargets());
            return hash;
        }

        public static ResponseBody create(List<CompletionItem> targets) {
            final JSONObject json = new JSONObject();
            JSONArray targetsJsonArr = new JSONArray();
            for (CompletionItem completionItem : targets) {
                targetsJsonArr.put(completionItem.jsonData);
            }
