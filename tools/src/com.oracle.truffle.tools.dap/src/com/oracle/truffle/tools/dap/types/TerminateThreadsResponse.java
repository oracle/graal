 ...
 * required.
 */
public class TerminateThreadsResponse extends Response {

    TerminateThreadsResponse(JSONObject jsonData) {
        super(jsonData);
    }
    ...
    public boolean equals(Object obj) {
        ...
        TerminateThreadsResponse other = (TerminateThreadsResponse) obj;
    ...
    public static TerminateThreadsResponse create(Integer requestSeq, Boolean success, String command, Integer seq) {
        ...
        json.put("seq", seq);
        return new TerminateThreadsResponse(json);
    }
}
