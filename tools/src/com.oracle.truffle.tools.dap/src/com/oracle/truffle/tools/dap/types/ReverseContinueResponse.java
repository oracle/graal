...
public class ReverseContinueResponse extends Response {
    ...
    ReverseContinueResponse(JSONObject jsonData) {
        super(jsonData);
    }
    ...
    public boolean equals(Object obj) {
        ...
        ReverseContinueResponse other = (ReverseContinueResponse) obj;
    ...
    public static ReverseContinueResponse create(Integer requestSeq, Boolean success, String command, Integer seq) {
        ...
        json.put("seq", seq);
        return new ReverseContinueResponse(json);
    }
}
