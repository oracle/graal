...
public class ConfigurationDoneResponse extends Response {
    ...
    ConfigurationDoneResponse(JSONObject jsonData) {
        super(jsonData);
    }
    ...
    public boolean equals(Object obj) {
        ...
        ConfigurationDoneResponse other = (ConfigurationDoneResponse) obj;
    ...
    public static ConfigurationDoneResponse create(Integer requestSeq, Boolean success, String command, Integer seq) {
        ...
        json.put("seq", seq);
        return new ConfigurationDoneResponse(json);
    }
}
