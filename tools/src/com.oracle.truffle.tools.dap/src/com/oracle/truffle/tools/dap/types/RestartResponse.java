...
public class RestartResponse extends Response {
    ...
    RestartResponse(JSONObject jsonData) {
        super(jsonData);
    }
    ...
    public static RestartResponse create(Integer requestSeq, Boolean success, String command, Integer seq) {
        ...
        json.put("seq", seq);
        return new RestartResponse(json);
    }
}
