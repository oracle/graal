...
public class PauseResponse extends Response {
    ...
    PauseResponse(JSONObject jsonData) {
        super(jsonData);
    }
    ...
    public boolean equals(Object obj) {
        ...
        PauseResponse other = (PauseResponse) obj;
    ...
    public static PauseResponse create(Integer requestSeq, Boolean success, String command, Integer seq) {
