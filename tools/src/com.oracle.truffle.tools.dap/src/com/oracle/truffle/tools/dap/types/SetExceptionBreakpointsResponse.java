...
/**
 * Response to 'setExceptionBreakpoints' request. This is just an acknowledgement, so no body field
 * is required.
 */
public class SetExceptionBreakpointsResponse extends Response {

    SetExceptionBreakpointsResponse(JSONObject jsonData) {
        super(jsonData);
    }
    ...
    public int hashCode() {
        ...
        hash = 47 * hash + Integer.hashCode(this.getRequestSeq());
        hash = 47 * hash + Boolean.hashCode(this.isSuccess());
    ...
    public static SetExceptionBreakpointsResponse create(Integer requestSeq, Boolean success, String command, Integer seq) {
        ...
        json.put("seq", seq);
        return new SetExceptionBreakpointsResponse(json);
    }
}
