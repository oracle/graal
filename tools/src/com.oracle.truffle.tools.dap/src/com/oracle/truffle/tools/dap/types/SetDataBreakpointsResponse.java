...
public class SetDataBreakpointsResponse extends Response {
    ...
    SetDataBreakpointsResponse(JSONObject jsonData) {
        super(jsonData);
    }
    ...
    public SetDataBreakpointsResponse setBody(ResponseBody body) {
    ...
    public static SetDataBreakpointsResponse create(ResponseBody body, Integer requestSeq, Boolean success, String command, Integer seq) {
        ...
        json.put("seq", seq);
        return new SetDataBreakpointsResponse(json);
    }
