 ...
 */
public class BuggyLanguageInspectDebugLegacyTest {
    ...
    private void testBuggyCalls(AtomicReference<ProxyLanguage> language, String prefix, boolean haveScope, BugVerifier bugVerifier) throws Exception {
        ...
        assertPaused(haveScope ? prefix + "2" : "A TruffleException", haveScope, haveScope ? 3 : 2, sourceURI, 1);
        ...
        public void verifyMessages(InspectorTester tester, int errNum) throws InterruptedException {
            ...
            assertTrue(tester.compareReceivedMessages(
                            "{\"result\":{\"result\":[{\"isOwn\":true,\"enumerable\":true,\"name\":\"a\",\"value\":{\"description\":\"" + errNum + "\",\"type\":\"number\",\"value\":" + errNum + "},\"configurable\":true,\"writable\":true}," +
                                                     "{\"isOwn\":true,\"enumerable\":true,\"name\":\"o\",\"value\":{\"description\":\"" + errObject + "\",\"className\":\"" + errObject + "\",\"type\":\"function\",\"objectId\":\"" + (2 * errNum) + "\"},\"configurable\":true,\"writable\":true}]," +
    ...
    @SuppressWarnings("deprecation")
    Iterable<com.oracle.truffle.api.Scope> buggyProxyScopes(Iterable<com.oracle.truffle.api.Scope> scopes, Runnable throwErr, String errMessage) {
        return new Iterable<com.oracle.truffle.api.Scope>() {
            @Override
            public Iterator<com.oracle.truffle.api.Scope> iterator() {
                Iterator<com.oracle.truffle.api.Scope> iterator = scopes.iterator();
    ...
    @SuppressWarnings("deprecation")
    com.oracle.truffle.api.Scope buggyProxyScope(com.oracle.truffle.api.Scope scope, Runnable throwErr, String errMessage) {
        com.oracle.truffle.api.Scope.Builder builder = com.oracle.truffle.api.Scope.newBuilder(scope.getName(), new BuggyProxyVars(scope.getVariables(), throwErr, errMessage));
