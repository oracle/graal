 ...
 */
public class LazyAccessInspectDebugLegacyTest {
    ...
    static class ReadWithSideEffectsLanguage extends ProxyLanguage {
        ...
        protected Iterable<com.oracle.truffle.api.Scope> findTopScopes(LanguageContext context) {
            return Collections.singletonList(com.oracle.truffle.api.Scope.newBuilder("top", new LazyReadObject()).build());
        }

        final class TestRootNode extends RootNode {

            @Node.Child private TestStatementLegacyNode statement;
            ...
            TestRootNode(TruffleLanguage<?> language, com.oracle.truffle.api.source.Source source) {
                ...
                statement = new TestStatementLegacyNode(statementSection);
                insert(statement);
            }
        ...
        @GenerateWrapper
        static class TestStatementLegacyNode extends Node implements InstrumentableNode {

            private final SourceSection sourceSection;

            TestStatementLegacyNode(SourceSection sourceSection) {
            ...
            public InstrumentableNode.WrapperNode createWrapper(ProbeNode probe) {
                return new TestStatementLegacyNodeWrapper(sourceSection, this, probe);
            }
