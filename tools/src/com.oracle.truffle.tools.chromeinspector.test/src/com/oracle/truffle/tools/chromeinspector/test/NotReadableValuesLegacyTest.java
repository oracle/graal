 ...
 */
public class NotReadableValuesLegacyTest {
    ...
    static class NotReadableValuesLanguage extends ProxyLanguage {
        ...
        protected Iterable<com.oracle.truffle.api.Scope> findTopScopes(LanguageContext context) {
            return Collections.singletonList(com.oracle.truffle.api.Scope.newBuilder("top", new VariablesObject()).build());
        }
        ...
        final class TestRootNode extends RootNode {
            ...
            @Node.Child private NrStatementLegacyNode statement;
            ...
            TestRootNode(TruffleLanguage<?> language, com.oracle.truffle.api.source.Source source) {
                ...
                statement = new NrStatementLegacyNode(statementSection);
                insert(statement);
            }
        ...
        @GenerateWrapper
        static class NrStatementLegacyNode extends Node implements InstrumentableNode {

            private final SourceSection sourceSection;

            NrStatementLegacyNode(SourceSection sourceSection) {
            ...
            public InstrumentableNode.WrapperNode createWrapper(ProbeNode probe) {
                return new NrStatementLegacyNodeWrapper(sourceSection, this, probe);
            }
