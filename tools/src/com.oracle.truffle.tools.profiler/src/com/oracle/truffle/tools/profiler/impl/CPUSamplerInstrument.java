...
import static com.oracle.truffle.tools.profiler.impl.CPUSamplerCLI.SAMPLE_LANGUAGE_INIT;
...
public class CPUSamplerInstrument extends TruffleInstrument {
    ...
    protected void onCreate(Env env) {
        ...
        if (env.getOptions().get(CPUSamplerCLI.ENABLED)) {
            ...
            sampler.setSampleLanguageInit(env.getOptions().get(SAMPLE_LANGUAGE_INIT));
