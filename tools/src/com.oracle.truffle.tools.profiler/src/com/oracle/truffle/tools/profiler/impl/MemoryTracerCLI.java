...
class MemoryTracerCLI extends ProfilerCLI {
    ...
    @Option(name = "FilterRootName", help = "Wildcard filter for program roots. (for example, Math.*) (default: no filter).", usageSyntax = "<filter>", category = OptionCategory.USER) //
    ...
    @Option(name = "FilterFile", help = "Wildcard filter for source file paths. (for example, *program*.sl) (default: no filter).", usageSyntax = "<filter>", category = OptionCategory.USER) //
    ...
    @Option(name = "FilterMimeType", help = "Only profile languages with mime-type. (for example, application/javascript). (default: no filter)", usageSyntax = "<mime-type>", category = OptionCategory.USER) //
    static final OptionKey<String> FILTER_MIME_TYPE = new OptionKey<>("");

    @Option(name = "FilterLanguage", help = "Only profile languages with given ID. (for example js) (default: no filter).", usageSyntax = "<languageId>", category = OptionCategory.USER)//
