...
class MemoryTracerCLI extends ProfilerCLI {
    ...
    @Option(name = "TraceInternal", help = "Capture internal elements (default:false).", category = OptionCategory.DEBUG) static final OptionKey<Boolean> TRACE_INTERNAL = new OptionKey<>(false);
