...
public class ThermometerInstrument extends TruffleInstrument {
    ...
    @Option(help = "Raise an interrupt after stable and empty queue for time (s)", category = OptionCategory.USER, stability = OptionStability.STABLE)
    static final OptionKey<Integer> InterruptAfterStable = new OptionKey<>(0);
    ...
    protected void onCreate(Env env) {
        ...
        if (Enabled.getValue(options)) {
            ...
            thermometer.start(new ThermometerConfig(
                    ...
                    options.get(InterruptAfterStable),
