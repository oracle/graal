...
* Several CPUSampler APIs were deprecated in favor of new ones to simplify consideration of samples taken in code compiled with multipe compilation tiers.
