...
mx_benchmark.java_vm_registry.add_vm(EspressoVm('shape-checks', ['--vm.Dcom.oracle.truffle.api.staticobject.ArrayBasedStorage=true', '--vm.Dcom.oracle.truffle.api.staticobject.ShapeChecks=true']), _suite)
