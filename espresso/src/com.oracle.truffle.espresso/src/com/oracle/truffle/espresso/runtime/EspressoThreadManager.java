...
class EspressoThreadManager implements ContextAccess {
    ...
    public void unregisterThread(StaticObject thread) {
        ...
        Thread hostThread = (Thread) thread.getKlass().getMeta().HIDDEN_HOST_THREAD.getHiddenObjectField(thread);
    ...
    public StaticObject createGuestThreadFromHost(Thread hostThread, Meta meta, VM vm, String name, StaticObject threadGroup) {
        ...
        synchronized (activeThreadLock) {
            ...
            meta.java_lang_Thread_priority.setIntField(guestThread, Thread.NORM_PRIORITY);
            meta.HIDDEN_HOST_THREAD.setHiddenObjectField(guestThread, Thread.currentThread());
            meta.HIDDEN_DEATH.setHiddenObjectField(guestThread, Target_java_lang_Thread.KillStatus.NORMAL);
            ...
            meta.java_lang_Thread_threadStatus.setIntField(guestThread, Target_java_lang_Thread.State.RUNNABLE.value);
    ...
    public void createMainThread(Meta meta) {
        ...
        // Allow guest Thread.currentThread() to work.
        meta.java_lang_Thread_priority.setIntField(mainThread, Thread.NORM_PRIORITY);
        meta.HIDDEN_HOST_THREAD.setHiddenObjectField(mainThread, hostThread);
        meta.HIDDEN_DEATH.setHiddenObjectField(mainThread, Target_java_lang_Thread.KillStatus.NORMAL);
        ...
        meta.java_lang_Thread // public Thread(ThreadGroup group, String name)
                        ...
                        .invokeDirect(mainThread,
                                        ...
                                        /* name */ meta.toGuestString("main"));
        meta.java_lang_Thread_threadStatus.setIntField(mainThread, Target_java_lang_Thread.State.RUNNABLE.value);
