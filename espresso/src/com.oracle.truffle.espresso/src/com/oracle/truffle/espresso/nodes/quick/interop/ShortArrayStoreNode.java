...
public abstract class ShortArrayStoreNode extends QuickNode {
    protected static final int LIMIT = 3;

    protected ShortArrayStoreNode(int top, int callerBCI) {
        super(top, callerBCI);
    }
    ...
    public final int execute(VirtualFrame frame, long[] primitives, Object[] refs) {
        ...
        return Bytecodes.stackEffectOf(Bytecodes.SASTORE);
    }

    abstract void executeStore(StaticObject array, int index, short value);

    @Specialization(guards = "array.isForeignObject()")
    void doForeign(StaticObject array, int index, short value,
    ...
    void doEspresso(StaticObject array, int index, short value) {
        getBytecodesNode().getInterpreterToVM().setArrayShort(value, index, array);
    }
