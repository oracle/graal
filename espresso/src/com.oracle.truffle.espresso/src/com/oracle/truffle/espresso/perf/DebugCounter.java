...
public abstract class DebugCounter {
    ...
    public static DebugCounter create(String name) {
        return EspressoOptions.DebugCounters ? DebugCounterImpl.createImpl(name) : Dummy.INSTANCE;
    }

    public static void dumpCounters() {
        if (EspressoOptions.DebugCounters) {
    ...
    private static final class DebugCounterImpl extends DebugCounter {
        ...
        static {
            assert EspressoOptions.DebugCounters;
            if (EspressoOptions.DumpDebugCounters) {
