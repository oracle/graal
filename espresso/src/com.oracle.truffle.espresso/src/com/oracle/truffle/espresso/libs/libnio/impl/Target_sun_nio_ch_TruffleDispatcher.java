...
public final class Target_sun_nio_ch_TruffleDispatcher {
    ...
    public static int read0(@JavaType(FileDescriptor.class) StaticObject fd, long address, int len,
         ...
         * documentation of the syscall read. Additionally native method reads the memory in plain
         * mode.
         */
    ...
    @Substitution
    @Throws(IOException.class)
    public static long readv0(@JavaType(FileDescriptor.class) StaticObject fd, long address, int len, @Inject TruffleIO io) {
        return io.readv(fd, FDAccess.forFileDescriptor(), address, len);
    ...
    public static int write0(@JavaType(FileDescriptor.class) StaticObject fd, long address, int len, @Inject TruffleIO io) {
        /*
         * This might not write the full requested length which is acceptable according to the
         * documentation of the syscall write. Additionally native method accesses the memory in
         * plain mode.
         */
    ...
    @Substitution
    @Throws(IOException.class)
    public static long writev0(@JavaType(FileDescriptor.class) StaticObject fd, long address, int len, @Inject TruffleIO io) {
        return io.writev(fd, FDAccess.forFileDescriptor(), address, len);
    }
