...
public final class DefaultLinkedKlassProvider extends KlassProviderImpl implements LinkedKlassProvider {

    public DefaultLinkedKlassProvider(TruffleLogger logger) {
        super(logger);
    }
