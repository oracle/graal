 ...
 * questions.
 */
package com.oracle.truffle.espresso.impl.generics.parser;
...
import com.oracle.truffle.espresso.impl.generics.tree.BaseType;
...
import com.oracle.truffle.espresso.impl.generics.tree.FieldTypeSignature;
...
import com.oracle.truffle.espresso.impl.generics.tree.Wildcard;

/**
 * This class is copied from the JDK, more specifically sun.reflect.generics.parser.SignatureParser.
 *
 * Parser for type signatures, as defined in the Java Virtual Machine Specification (JVMS) chapter
 * 4. Converts the signatures into an abstract syntax tree (AST) representation. See the package
 * sun.reflect.generics.tree for details of the AST.
 */
public final class SignatureParser {
    ...
    /**
     * Parses a class signature (as defined in the JVMS, chapter 4) and produces an abstract syntax
     * tree representing it.
     * 
     * @param s a string representing the input class signature
     * @return An abstract syntax tree for a class signature corresponding to the input string
     * @throws GenericSignatureFormatError if the input is not a valid class signature
     */
    ...
    /**
     * Parses a method signature (as defined in the JVMS, chapter 4) and produces an abstract syntax
     * tree representing it.
     * 
     * @param s a string representing the input method signature
     * @return An abstract syntax tree for a method signature corresponding to the input string
     ...
     * @return An abstract syntax tree for a type signature corresponding to the input string
     * @throws GenericSignatureFormatError if the input is not a valid type signature
     */
    ...
    /*
     * Note on grammar conventions: a trailing "*" matches zero or more occurrences, a trailing "+"
     * matches one or more occurrences, "_opt" indicates an optional component.
     */
    ...
    private TypeArgument parseTypeArgument() {
        FieldTypeSignature[] ub;
        FieldTypeSignature[] lb;
    ...
    /*
     * MethodTypeSignature: FormalTypeParameters_opt "(" TypeSignature* ")" ReturnType
     * ThrowsSignature*
     */
