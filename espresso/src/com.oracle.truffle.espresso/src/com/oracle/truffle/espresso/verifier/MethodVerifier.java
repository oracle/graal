...
import static com.oracle.truffle.espresso.shared.classfile.ConstantPool.Tag.CLASS;
import static com.oracle.truffle.espresso.shared.classfile.ConstantPool.Tag.INTERFACE_METHOD_REF;
...
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.AALOAD;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.AASTORE;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.ACONST_NULL;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.ALOAD;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.ALOAD_0;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.ALOAD_1;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.ALOAD_2;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.ALOAD_3;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.ANEWARRAY;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.ARETURN;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.ARRAYLENGTH;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.ASTORE;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.ASTORE_0;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.ASTORE_1;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.ASTORE_2;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.ASTORE_3;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.ATHROW;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.BALOAD;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.BASTORE;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.BIPUSH;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.BREAKPOINT;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.CALOAD;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.CASTORE;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.CHECKCAST;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.D2F;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.D2I;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.D2L;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.DADD;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.DALOAD;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.DASTORE;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.DCMPG;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.DCMPL;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.DCONST_0;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.DCONST_1;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.DDIV;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.DLOAD;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.DLOAD_0;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.DLOAD_1;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.DLOAD_2;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.DLOAD_3;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.DMUL;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.DNEG;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.DREM;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.DRETURN;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.DSTORE;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.DSTORE_0;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.DSTORE_1;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.DSTORE_2;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.DSTORE_3;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.DSUB;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.DUP;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.DUP2;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.DUP2_X1;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.DUP2_X2;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.DUP_X1;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.DUP_X2;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.F2D;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.F2I;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.F2L;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.FADD;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.FALOAD;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.FASTORE;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.FCMPG;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.FCMPL;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.FCONST_0;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.FCONST_1;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.FCONST_2;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.FDIV;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.FLOAD;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.FLOAD_0;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.FLOAD_1;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.FLOAD_2;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.FLOAD_3;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.FMUL;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.FNEG;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.FREM;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.FRETURN;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.FSTORE;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.FSTORE_0;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.FSTORE_1;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.FSTORE_2;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.FSTORE_3;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.FSUB;
...
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.GOTO;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.GOTO_W;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.I2B;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.I2C;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.I2D;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.I2F;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.I2L;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.I2S;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.IADD;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.IALOAD;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.IAND;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.IASTORE;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.ICONST_0;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.ICONST_1;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.ICONST_2;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.ICONST_3;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.ICONST_4;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.ICONST_5;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.ICONST_M1;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.IDIV;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.IFEQ;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.IFGE;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.IFGT;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.IFLE;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.IFLT;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.IFNE;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.IFNONNULL;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.IFNULL;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.IF_ACMPEQ;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.IF_ACMPNE;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.IF_ICMPEQ;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.IF_ICMPGE;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.IF_ICMPGT;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.IF_ICMPLE;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.IF_ICMPLT;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.IF_ICMPNE;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.IINC;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.ILOAD;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.ILOAD_0;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.ILOAD_1;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.ILOAD_2;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.ILOAD_3;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.IMUL;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.INEG;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.INSTANCEOF;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.INVOKEDYNAMIC;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.INVOKEINTERFACE;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.INVOKESPECIAL;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.INVOKESTATIC;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.INVOKEVIRTUAL;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.IOR;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.IREM;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.IRETURN;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.ISHL;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.ISHR;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.ISTORE;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.ISTORE_0;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.ISTORE_1;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.ISTORE_2;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.ISTORE_3;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.ISUB;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.IUSHR;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.IXOR;
...
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.L2D;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.L2F;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.L2I;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.LADD;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.LALOAD;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.LAND;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.LASTORE;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.LCMP;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.LCONST_0;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.LCONST_1;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.LDC;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.LDC2_W;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.LDC_W;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.LDIV;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.LLOAD;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.LLOAD_0;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.LLOAD_1;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.LLOAD_2;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.LLOAD_3;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.LMUL;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.LNEG;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.LOOKUPSWITCH;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.LOR;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.LREM;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.LRETURN;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.LSHL;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.LSHR;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.LSTORE;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.LSTORE_0;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.LSTORE_1;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.LSTORE_2;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.LSTORE_3;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.LSUB;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.LUSHR;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.LXOR;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.MONITORENTER;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.MONITOREXIT;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.MULTIANEWARRAY;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.NEW;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.NEWARRAY;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.NOP;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.POP;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.POP2;
...
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.QUICK;
...
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.SALOAD;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.SASTORE;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.SIPUSH;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.SLIM_QUICK;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.SWAP;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.TABLESWITCH;
import static com.oracle.truffle.espresso.shared.bytecode.Bytecodes.WIDE;
...
import com.oracle.truffle.espresso.shared.constantpool.MemberRefConstant;
