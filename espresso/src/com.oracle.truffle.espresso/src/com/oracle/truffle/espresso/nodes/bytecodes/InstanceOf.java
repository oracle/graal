...
public abstract class InstanceOf extends Node {
    ...
    static abstract class ArrayClass extends InstanceOf {
    ...
    static abstract class ConstantClass extends InstanceOf {
    ...
    static abstract class ConstantInterface extends InstanceOf {
    ...
    static abstract class InlineCache extends InstanceOf {
