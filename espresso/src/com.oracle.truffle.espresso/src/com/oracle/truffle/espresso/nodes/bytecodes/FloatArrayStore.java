...
/**
 * FASTORE bytecode with interop extensions.
 *
 * <h3>Extensions</h3>
 * <ul>
 * <li>For {@link InteropLibrary#hasArrayElements(Object) array-like} foreign objects, FASTORE is
 ...
 */
@GenerateUncached
@NodeInfo(shortName = "FASTORE")
public abstract class FloatArrayStore extends EspressoNode {
    ...
    @GenerateUncached
    @NodeInfo(shortName = "FASTORE !nullcheck")
    public abstract static class WithoutNullCheck extends EspressoNode {
        ...
        void doEspresso(StaticObject array, int index, float value) {
            ...
            getContext().getInterpreterToVM().setArrayFloat(getLanguage(), value, index, array);
        }

        @Specialization(guards = "array.isForeignObject()")
        void doArrayLike(StaticObject array, int index, float value,
