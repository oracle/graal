...
public final class Target_sun_management_MemoryPoolImpl {
    ...
    public static @JavaType(MemoryUsage.class) StaticObject getUsage0(@JavaType(internalName = "Lsun/management/MemoryPoolImpl;") StaticObject self, @Inject InformationLeak iL, @Inject Meta meta,
                    @Inject LibsState libsState) {
        Management management = libsState.checkAndGetManagement();
        StaticObject memUsage = iL.getMemoryPoolUsage(self, management);
