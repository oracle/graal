 ...
 * questions.
 */
package com.oracle.truffle.espresso.substitutions.jdwp;
...
public final class Target_sun_misc_ProxyGenerator {
    ...
    abstract static class GenerateProxyClass extends SubstitutionNode {
        ...
        StaticObject doCached(
                        ...
                        @Cached("create(context.getMeta().sun_misc_ProxyGenerator_generateProxyClass.getCallTargetNoSubstitution())") DirectCallNode original) {
