 ...
 * <h3>Extensions</h3>
 * <ul>
 * <li>For {@link InteropLibrary#hasArrayElements(Object) array-like} foreign objects, IALOAD is
 ...
 * <li>Throws guest {@link ClassCastException} if the result cannot be converted to int.</li>
 * </ul>
 */
@GenerateUncached
@NodeInfo(shortName = "IALOAD")
public abstract class IntArrayLoad extends EspressoNode {
    ...
    @GenerateUncached
    @NodeInfo(shortName = "IALOAD !nullcheck")
    public abstract static class WithoutNullCheck extends EspressoNode {
        ...
        int doEspresso(StaticObject array, int index) {
            ...
            return getContext().getInterpreterToVM().getArrayInt(getLanguage(), index, array);
        }

        @Specialization(guards = "array.isForeignObject()")
        int doArrayLike(StaticObject array, int index,
            ...
            try {
                return elemInterop.asInt(result);
