...
public abstract class ShortArrayLoadNode extends QuickNode {
    protected static final int LIMIT = 3;

    protected ShortArrayLoadNode(int top, int callerBCI) {
        super(top, callerBCI);
    }
    ...
    public final int execute(VirtualFrame frame, long[] primitives, Object[] refs) {
        ...
        return Bytecodes.stackEffectOf(Bytecodes.SALOAD);
    }

    abstract short executeLoad(StaticObject array, int index);

    @Specialization(guards = "array.isForeignObject()")
    short doForeign(StaticObject array, int index,
