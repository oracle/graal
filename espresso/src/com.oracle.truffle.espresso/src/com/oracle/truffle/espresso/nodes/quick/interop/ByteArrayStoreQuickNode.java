 ...
 * @see ByteArrayStore
 */
public final class ByteArrayStoreQuickNode extends QuickNode {

    static final int stackEffectOf_BASTORE = Bytecodes.stackEffectOf(Bytecodes.BASTORE);

    @Child ByteArrayStore.WithoutNullCheck byteArrayStore;

    public ByteArrayStoreQuickNode(int top, int callerBCI) {
        super(top, callerBCI);
        this.byteArrayStore = ByteArrayStoreNodeGen.WithoutNullCheckNodeGen.create();
    }
