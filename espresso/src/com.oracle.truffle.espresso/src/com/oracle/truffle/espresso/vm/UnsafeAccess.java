...
public final class UnsafeAccess {
    ...
    public static void initializeGuestUnsafeConstants(Meta meta, NativeMemory nativeMemory) {
        /*
        ...
        meta.jdk_internal_misc_UnsafeConstants_ADDRESS_SIZE0.set(staticStorage, nativeMemory.addressSize());
        meta.jdk_internal_misc_UnsafeConstants_PAGE_SIZE.set(staticStorage, InformationLeak.pageSize());
