...
public final class Target_java_lang_ProcessImpl {
    ...
    public static int forkAndExec(int mode, @JavaType(byte[].class) StaticObject helperpath,
        ...
        // set environment
        Map<String, String> environment = decodeEnv(envBlockArr, envc, ctx, jnu);
    ...
    private static Map<String, String> decodeEnv(byte[] envBlockArr, int envc, EspressoContext ctx, JNU jnu) {
