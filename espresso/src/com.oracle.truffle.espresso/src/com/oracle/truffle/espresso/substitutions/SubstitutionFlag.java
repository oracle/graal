...
/**
 * Provides additional flags to a {@link JavaSubstitution}, through the annotation attribute
 * {@code Substitution#flags()}.
 *
 * Must be kept in sync with its espresso processor project counterpart.
 */
public final class SubstitutionFlag {
     ...
     * annotation {@link InlineInBytecode}.
     */
