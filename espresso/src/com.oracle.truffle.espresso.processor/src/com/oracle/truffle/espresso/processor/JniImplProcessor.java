...
public class JniImplProcessor extends IntrinsicsProcessor {
    ...
    private static final String ENV_PACKAGE = "com.oracle.truffle.espresso.jni";
    private static final String JNI_IMPL = ENV_PACKAGE + "." + "JniImpl";
    private static final String JNI_ENV = "JniEnv";
    private static final String ENV_NAME = "jniEnv";
    ...
    public JniImplProcessor() {
        super(ENV_NAME, JNI_ENV, JNI_IMPL, ENV_PACKAGE, COLLECTOR, COLLECTOR_INSTANCE_NAME);
    }
}
