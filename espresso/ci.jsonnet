{
  ...
  builds: common.builds + [
    ...
    common.jdk17_weekly_bench_linux + common.scala_dacapo_benchmark('jvm-ce-llvm'                                       , guest_jvm_config='single-tier'    , extra_args=['--vm.XX:ReservedCodeCacheSize=1g']) + {name: 'weekly-bench-espresso-jvm-ce-scala_dacapo-single_tier-jdk17-linux-amd64'},
    common.jdk17_weekly_bench_linux + common.scala_dacapo_benchmark('native-ce-llvm'                                    , guest_jvm_config='single-tier')                                                      + {name: 'weekly-bench-espresso-native-ce-scala_dacapo-single_tier-jdk17-linux-amd64'},
    ...
    // DaCapo benchmarks
    common.jdk17_weekly_bench_linux + common.dacapo_benchmark('jvm-ce-llvm'                                             , guest_jvm_config='single-tier'    , extra_args=['--vm.XX:ReservedCodeCacheSize=1g']) + {name: 'weekly-bench-espresso-jvm-ce-dacapo-single_tier-jdk17-linux-amd64'},
    common.jdk17_weekly_bench_linux + common.dacapo_benchmark('native-ce-llvm'                                          , guest_jvm_config='single-tier')                                                      + {name: 'weekly-bench-espresso-native-ce-dacapo-single_tier-jdk17-linux-amd64'},
