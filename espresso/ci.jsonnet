{
  ...
  builds: common.builds + [
    ...
    common.jdk11_weekly_bench_linux    + common.espresso_benchmark('jvm-ce', 'awfy:*'                                                                                                 , extra_args=['--vm.Xmx1g', '--vm.Xms1g'])         + {name: 'weekly-bench-espresso-jvm-ce-awfy-jdk11-linux-amd64'},
    common.jdk11_weekly_bench_linux    + common.espresso_benchmark('jvm-ce', 'awfy:*'                                                            , guest_jvm_config='safe'            , extra_args=['--vm.Xmx1g', '--vm.Xms1g'])         + {name: 'weekly-bench-espresso-jvm-ce-awfy-safe-jdk11-linux-amd64'},
    common.jdk11_weekly_bench_linux    + common.espresso_benchmark('jvm-ce', 'awfy:*'                                                            , guest_jvm_config='array-based'     , extra_args=['--vm.Xmx1g', '--vm.Xms1g'])         + {name: 'weekly-bench-espresso-jvm-ce-awfy-array-based-jdk11-linux-amd64'},
    common.jdk11_weekly_bench_linux    + common.espresso_benchmark('jvm-ce', 'awfy:*'                                                            , guest_jvm_config='array-based-safe', extra_args=['--vm.Xmx1g', '--vm.Xms1g'])         + {name: 'weekly-bench-espresso-jvm-ce-awfy-array-based-safe-jdk11-linux-amd64'},
    common.jdk11_weekly_bench_linux    + common.espresso_benchmark('native-ce', 'awfy:*'                                                                                              , extra_args=['--vm.Xmx1g', '--vm.Xms1g'])         + {name: 'weekly-bench-espresso-native-ce-awfy-jdk11-linux-amd64'},
    common.jdk11_weekly_bench_linux    + common.espresso_benchmark('native-ce', 'awfy:*'                                                         , guest_jvm_config='safe'            , extra_args=['--vm.Xmx1g', '--vm.Xms1g'])         + {name: 'weekly-bench-espresso-native-ce-awfy-safe-jdk11-linux-amd64'},

    // AWFY interpreter benchmarks
    common.jdk11_weekly_bench_linux    + common.espresso_interpreter_benchmark('jvm-ce', 'awfy:*')                                                                                                                                       + {name: 'weekly-bench-espresso-jvm-ce-awfy_interpreter-jdk11-linux-amd64'},
    common.jdk11_weekly_bench_linux    + common.espresso_interpreter_benchmark('native-ce', 'awfy:*')                                                                                                                                    + {name: 'weekly-bench-espresso-native-ce-awfy_interpreter-jdk11-linux-amd64'},
