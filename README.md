...
## Supported languages
GralVM allows running of following languages which are being developed and tested in parallel with GraalVM core to run on top of it using Truffle and Graal compiler. These are:
* [Graal.JS](https://github.com/graalvm/graaljs) - JavaScript (ECMAScript 2017 compatible) and node.js 8.11.1
* [FastR](https://github.com/graalvm/graaljs) - R Language 3.4.0
