...
import com.oracle.graal.options.PathOptionValue;
...
public class GraalDebugConfig implements DebugConfig {
    ...
    public static class Options {
        ...
        public static final PathOptionValue PrintCFGFileName = new PathOptionValue("compilations", ".cfg", DumpPath);
        ...
        @Option(help = "Base filename when dumping Ideal graphs to files.", type = OptionType.Debug)
        public static final PathOptionValue PrintIdealGraphFileName = new PathOptionValue("runtime-graphs", DumpPath) {
            @Override
        ...
        @Option(help = "Base filename when dumping Ideal graphs to files.", type = OptionType.Debug)
        public static final PathOptionValue PrintCanonicalGraphStringsFileName = new PathOptionValue("graph-strings", ".gstr", DumpPath);
