...
import static com.oracle.graal.java.LIRBuilderPhase.RuntimeCalls.*;
 ...
 */
public class LIRBuilderPhase extends BasePhase<HighTierContext> {
    ...
    /**
     * The minimum value to which {@link GraphBuilderPhase.Options#TraceBytecodeParserLevel} must be
     * set to trace the bytecode instructions as they are parsed.
     */
    public static final int TRACELEVEL_INSTRUCTIONS = 1;

    /**
     * The minimum value to which {@link GraphBuilderPhase.Options#TraceBytecodeParserLevel} must be
     * set to trace the frame state before each bytecode instruction as it is parsed.
     */
    public static final int TRACELEVEL_STATE = 2;

    private final GraphBuilderConfiguration graphBuilderConfig;

    public LIRBuilderPhase(GraphBuilderConfiguration graphBuilderConfig) {
    ...
    public static class Instance extends Phase {
        ...
        private final int traceLevel = GraphBuilderPhase.Options.TraceBytecodeParserLevel.getValue();
