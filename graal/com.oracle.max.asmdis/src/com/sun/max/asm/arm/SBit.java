...
/**
 * An optional (suffix) argument to a data processing instruction that, if present, indicates that form of the
 * instruction that updates the condition code flags.
 */
public final class SBit extends OptionSuffixSymbolicArgument {

    private SBit(int value, String externalMnemonicSuffix) {
        super(value, externalMnemonicSuffix);
    }

    /**
     * The S bit is not set.
     */
