...
// @formatter:off
public final class AMD64LibmOp extends AMD64LIRInstruction {
    public static final LIRInstructionClass<AMD64LibmOp> TYPE = LIRInstructionClass.create(AMD64LibmOp.class);
    public enum StubOpcode  {
        SIN_STUB, COS_STUB, TAN_STUB,
        LOG_STUB, LOG10_STUB
    }

    @Opcode private final StubOpcode opcode;
    ...
    public AMD64LibmOp(LIRGeneratorTool tool, StubOpcode opcode, Value result, Value input) {
        super(TYPE);
        this.opcode = opcode;
        this.result = result;
        this.input = input;
    ...
    public void emitCode(CompilationResultBuilder crb, AMD64MacroAssembler masm) {
        switch(opcode) {
            case LOG_STUB:   logStub(asRegister(result, AMD64Kind.DOUBLE), asRegister(input, AMD64Kind.DOUBLE), crb, masm); break;
            case LOG10_STUB: log10Stub(asRegister(result, AMD64Kind.DOUBLE), asRegister(input, AMD64Kind.DOUBLE), crb, masm); break;
            case SIN_STUB:   masm.fsin(asRegister(result, AMD64Kind.DOUBLE), asRegister(input, AMD64Kind.DOUBLE)); break;
            case COS_STUB:   masm.fcos(asRegister(result, AMD64Kind.DOUBLE), asRegister(input, AMD64Kind.DOUBLE)); break;
            case TAN_STUB:   masm.ftan(asRegister(result, AMD64Kind.DOUBLE), asRegister(input, AMD64Kind.DOUBLE)); break;
            default:    throw GraalError.shouldNotReachHere();
        }
    }

    public int[] logTwoTable = {
    ...
    public int[] logTwoData = {
                    0xfefa3800, 0x3fa62e42, 0x93c76730, 0x3ceef357
    };

    public int[] coeffLogTwoData = {
    ...
    public void logStub(Register dest, Register value, CompilationResultBuilder crb, AMD64MacroAssembler masm) {
        ...
        masm.movdq(new AMD64Address(AMD64.rsp, 0), value);
        ...
        masm.movdq(temp6, (AMD64Address) crb.recordDataReferenceInCode(logTwoDataPtr));       // 0xfefa3800, 0x3fa62e42
        masm.movdqu(temp3, (AMD64Address) crb.recordDataReferenceInCode(coeffLogTwoDataPtr)); // 0x92492492, 0x3fc24924, 0x00000000, 0xbfd00000
        ...
        masm.movdqu(temp4, new AMD64Address(gpr4, 16));                                       // 0x3d6fb175, 0xbfc5555e, 0x55555555, 0x3fd55555
        masm.addsd(temp1, temp5);
        masm.movdqu(temp2, new AMD64Address(gpr4, 32));                                       // 0x9999999a, 0x3fc99999, 0x00000000, 0xbfe00000
        ...
        masm.mulsd(temp7, new AMD64Address(gpr4, 8));                                         // 0x93c76730, 0x3ceef357
        ...
        masm.bind(bb0);
        masm.movdq(dest, new AMD64Address(AMD64.rsp, 0));
        masm.movdq(temp1, new AMD64Address(AMD64.rsp, 0));
        masm.addl(gpr1, 16);
    ...
    public int[] logTwoLogTenData = {
                    0x509f7800, 0x3f934413, 0x1f12b358, 0x3cdfef31
    };

    public int[] coeffLogTenData = {
    ...
    public void log10Stub(Register dest, Register value, CompilationResultBuilder crb, AMD64MacroAssembler masm) {
        ...
        masm.movdqu(temp5, (AMD64Address) crb.recordDataReferenceInCode(highmaskLogTenPtr));  // 0xf8000000, 0xffffffff, 0x00000000, 0xffffe000
        ...
        masm.movl(gpr2, 16352);
        masm.psrlq(dest, 27);
        masm.movdqu(temp2, (AMD64Address) crb.recordDataReferenceInCode(logTenEPtr));         // 0x00000000, 0x3fdbc000, 0xbf2e4108, 0x3f5a7a6c
        masm.psrld(dest, 2);
        masm.rcpps(dest, dest);
        masm.psllq(temp1, 12);
        ...
        masm.paddd(dest, temp4);
        masm.movdqu(temp3, (AMD64Address) crb.recordDataReferenceInCode(coeffLogTenDataPtr)); // 0xc1a5f12e, 0x40358874, 0x64d4ef0d, 0xc0089309
        masm.leaq(gpr4, (AMD64Address) crb.recordDataReferenceInCode(coeffLogTenDataPtr));
        masm.movdqu(temp4, new AMD64Address(gpr4, 16));                                       // 0x385593b1, 0xc025c917, 0xdc963467, 0x3ffc6a02
        masm.subsd(temp1, temp5);
        masm.movdl(gpr3, dest);
        masm.psllq(dest, 29);
        masm.andpd(dest, temp6);
        masm.movdq(temp6, (AMD64Address) crb.recordDataReferenceInCode(logTwoLogTenDataPtr)); // 0x509f7800, 0x3f934413
        masm.andl(gpr1, 32752);
        masm.subl(gpr1, gpr2);
        masm.cvtsi2sdl(temp7, gpr1);
        masm.mulpd(temp5, dest);
        masm.mulsd(temp1, dest);
        masm.subsd(temp5, temp2);
        masm.movdqu(temp2, new AMD64Address(gpr4, 32));                                       // 0x7f9d3aa1, 0x4016ab9f, 0xdc77b115, 0xbff27af2
        ...
        masm.mulsd(temp7, new AMD64Address(gpr4, 8));                                         // 0x1f12b358, 0x3cdfef31
        masm.mulsd(temp3, temp1);
        masm.addsd(dest, temp6);
        masm.mulpd(temp4, temp5);
        masm.leaq(gpr4, (AMD64Address) crb.recordDataReferenceInCode(logTenEPtr));
        masm.movdq(temp6, new AMD64Address(gpr4, 8));                                         // 0xbf2e4108, 0x3f5a7a6c
        masm.mulpd(temp5, temp5);
        masm.addpd(temp4, temp2);
        masm.mulpd(temp3, temp5);
