    ...
    public Node canonical(CanonicalizerTool tool) {
        if (getX().isConstant() && getY().isConstant()) {
            ...
            if (getX() instanceof ShiftNode) {
                ...
                if (other.getY().isConstant()) {
                    ...
                    if (other instanceof UnsignedRightShiftNode) {
                        ...
                        return graph().unique(new UnsignedRightShiftNode(stamp(), other.getX(), ConstantNode.forInt(total, graph())));
            ...
            if (originalAmout != amount) {
                return graph().unique(new UnsignedRightShiftNode(stamp(), getX(), ConstantNode.forInt(amount, graph())));
            }
        }
        return this;
    }
