...
public enum Condition {
     ...
     *         false
     */
    public boolean foldCondition(Constant lt, Constant rt, MetaAccessProvider metaAccess, boolean unorderedIsTrue) {
        switch (lt.getKind()) {
            case Boolean:
            case Byte:
            case Char:
            ...
            case Object: {
                switch (this) {
                    case EQ:
                        return metaAccess.constantEquals(lt, rt);
                    case NE:
                        return !metaAccess.constantEquals(lt, rt);
                    default:
                        throw new GraalInternalError("expected condition: %s", this);
