...
/**
 * API extracted from FilterChain, which only allow access to contained filters.
 * @author sdedic
 * @param <T> subclass type
 */
public interface FilterSequence<T extends FilterSequence> extends ChangedEventProvider<T> {
    @Override
