...
public class MainCallback {
    public static void main(String[] args) throws IOException {
        ...
        oos = new ObjectOutputStream(new FileOutputStream(new File(userDir, "props")));
    ...
    public static Properties getProperties(File userDir) throws IOException, ClassNotFoundException {
        ObjectInputStream ois = new ObjectInputStream(new FileInputStream(new File(userDir, "props")));
