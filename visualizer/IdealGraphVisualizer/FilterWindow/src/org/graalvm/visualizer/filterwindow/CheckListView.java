...
public class CheckListView extends ListView {
    ...
    protected NodeListModel createModel() {
        ...
        return model = new CheckNodeListModel();
    }
    ...
    protected JList<Object> createList() {
        ...
        final CheckRenderer renderer = new CheckRenderer();
        tmpList.setCellRenderer(renderer);
        tmpList.addMouseListener(
            new MouseAdapter() {
                @Override
                public void mouseClicked(MouseEvent e) {
                    ...
                    Rectangle r = new Rectangle(p2.x, p2.y, prefSize.height, prefSize.height);
