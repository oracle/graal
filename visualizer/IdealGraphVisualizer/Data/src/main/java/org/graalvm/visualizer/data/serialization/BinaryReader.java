...
import static org.graalvm.visualizer.data.serialization.BinaryStreamDefs.BEGIN_GRAPH;
import static org.graalvm.visualizer.data.serialization.BinaryStreamDefs.BEGIN_GROUP;
import static org.graalvm.visualizer.data.serialization.BinaryStreamDefs.CLOSE_GROUP;
import static org.graalvm.visualizer.data.serialization.BinaryStreamDefs.ENUM_KLASS;
import static org.graalvm.visualizer.data.serialization.BinaryStreamDefs.KLASS;
import static org.graalvm.visualizer.data.serialization.BinaryStreamDefs.POOL_CLASS;
import static org.graalvm.visualizer.data.serialization.BinaryStreamDefs.POOL_ENUM;
import static org.graalvm.visualizer.data.serialization.BinaryStreamDefs.POOL_FIELD;
import static org.graalvm.visualizer.data.serialization.BinaryStreamDefs.POOL_METHOD;
import static org.graalvm.visualizer.data.serialization.BinaryStreamDefs.POOL_NEW;
import static org.graalvm.visualizer.data.serialization.BinaryStreamDefs.POOL_NODE;
import static org.graalvm.visualizer.data.serialization.BinaryStreamDefs.POOL_NODE_CLASS;
import static org.graalvm.visualizer.data.serialization.BinaryStreamDefs.POOL_NODE_SOURCE_POSITION;
import static org.graalvm.visualizer.data.serialization.BinaryStreamDefs.POOL_NULL;
import static org.graalvm.visualizer.data.serialization.BinaryStreamDefs.POOL_SIGNATURE;
import static org.graalvm.visualizer.data.serialization.BinaryStreamDefs.POOL_STRING;
import static org.graalvm.visualizer.data.serialization.BinaryStreamDefs.PROPERTY_ARRAY;
import static org.graalvm.visualizer.data.serialization.BinaryStreamDefs.PROPERTY_DOUBLE;
import static org.graalvm.visualizer.data.serialization.BinaryStreamDefs.PROPERTY_FALSE;
import static org.graalvm.visualizer.data.serialization.BinaryStreamDefs.PROPERTY_FLOAT;
import static org.graalvm.visualizer.data.serialization.BinaryStreamDefs.PROPERTY_INT;
import static org.graalvm.visualizer.data.serialization.BinaryStreamDefs.PROPERTY_LONG;
import static org.graalvm.visualizer.data.serialization.BinaryStreamDefs.PROPERTY_POOL;
import static org.graalvm.visualizer.data.serialization.BinaryStreamDefs.PROPERTY_SUBGRAPH;
import static org.graalvm.visualizer.data.serialization.BinaryStreamDefs.PROPERTY_TRUE;
import static org.graalvm.visualizer.data.serialization.BinaryStreamDefs.STREAM_PROPERTIES;
...
public class BinaryReader implements GraphParser, ModelControl {
    ...
    private InputGraph parseGraph(int dumpId, String format, Object[] args, boolean toplevel) throws IOException {
        ...
        try {
            ...
            reportLoadingError(Bundle.ERROR_LoadingGraph(ex.toString()));
            throw ex;
        } finally {
