...
Early global value numbering and loop invariant code motion are disabled per default.
Enable early global value numbering with `-Dgraal.EarlyGVN=true`.
Enable early loop invariant code motion with  `-Dgraal.EarlyLICM=true`.
