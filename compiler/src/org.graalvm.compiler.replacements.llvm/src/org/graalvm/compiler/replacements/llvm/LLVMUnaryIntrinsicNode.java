...
public abstract class LLVMUnaryIntrinsicNode extends LLVMIntrinsicNode {
    ...
    public void generate(NodeLIRBuilderTool builder, ArithmeticLIRGeneratorTool gen) {
        builder.setResult(this, emitIntrinsic((ArithmeticLLVMGenerator) gen, builder.operand(arg)));
    }

    protected abstract Value emitIntrinsic(ArithmeticLLVMGenerator gen, Value value);
}
