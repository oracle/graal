...
import static org.graalvm.compiler.core.llvm.LLVMUtils.LLVMIntrinsicOperation.COPYSIGN;
...
public class LLVMCopySignNode extends LLVMBinaryIntrinsicNode {
    ...
    public LLVMCopySignNode(JavaKind kind, ValueNode arg1, ValueNode arg2) {
        super(TYPE, COPYSIGN, kind, arg1, arg2);
    }
    ...
    public static ConstantNode fold(JavaConstant constant1, JavaConstant constant2) {
        ...
        if (constant1.getJavaKind() == JavaKind.Float) {
            return ConstantNode.forFloat(Math.copySign(constant1.asFloat(), constant2.asFloat()));
        } else {
            return ConstantNode.forDouble(Math.copySign(constant1.asDouble(), constant2.asDouble()));
        }
    }
}
