...
import org.graalvm.compiler.core.llvm.LLVMGenerator.ArithmeticLLVMGenerator;
...
public abstract class LLVMBinaryIntrinsicNode extends LLVMIntrinsicNode {
    ...
    public void generate(NodeLIRBuilderTool builder, ArithmeticLIRGeneratorTool gen) {
        builder.setResult(this, emitIntrinsic((ArithmeticLLVMGenerator) gen, builder.operand(arg1), builder.operand(arg2)));
    }

    protected abstract Value emitIntrinsic(ArithmeticLLVMGenerator gen, Value value1, Value value2);
}
