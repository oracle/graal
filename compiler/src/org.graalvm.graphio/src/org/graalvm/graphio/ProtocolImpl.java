...
final class ProtocolImpl<Graph, Node, NodeClass, Port, Block, ResolvedJavaMethod, ResolvedJavaField, Signature, NodeSourcePosition, Location>
    ...
    ProtocolImpl(int major, int minor, boolean buffered, boolean writeProlog, GraphStructure<Graph, Node, NodeClass, Port> structure, GraphTypes enums, GraphBlocks<Graph, Block, Node> blocks,
        ...
        super(channel, major, minor, buffered, writeProlog);
