...
public final class AMD64ArrayRegionCompareToStub extends SnippetStub {
    ...
    private static final HotSpotForeignCallDescriptor STUB_GENERIC = new HotSpotForeignCallDescriptor(LEAF, REEXECUTABLE, NO_LOCATIONS, "stubGeneric",
    ...
    public static ForeignCallDescriptor getStub(ArrayRegionCompareToNode node) {
        ...
        return directStubCallIndex < 0 ? STUB_GENERIC : STUBS[directStubCallIndex];
    }
    ...
    @Snippet
    private static int stubGeneric(Object arrayA, long offsetA, Object arrayB, long offsetB, int length, int stride) {
        return ArrayRegionCompareToNode.compare(arrayA, offsetA, arrayB, offsetB, length, stride);
    }
}
