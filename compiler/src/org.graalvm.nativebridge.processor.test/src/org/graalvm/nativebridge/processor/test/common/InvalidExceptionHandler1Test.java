...
abstract class InvalidExceptionHandler1Test extends HSObject implements Service {

    InvalidExceptionHandler1Test(JNIEnv env, JObject handle) {
        super(env, handle);
    }

    @ExceptionHandler
    @SuppressWarnings("unused")
    static boolean handleException1(ExceptionHandlerContext exceptionHandlerContext) {
        return false;
    }
