...
abstract class InvalidExceptionHandler2Test extends HSObject implements Service {

    InvalidExceptionHandler2Test(JNIEnv env, JObject handle) {
        super(env, handle);
    }
    ...
    final boolean handleException(ExceptionHandlerContext exceptionHandlerContext) {
        return false;
    }
