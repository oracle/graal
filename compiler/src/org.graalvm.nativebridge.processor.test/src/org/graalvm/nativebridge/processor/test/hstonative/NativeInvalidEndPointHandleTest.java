...
abstract class NativeInvalidEndPointHandleTest extends AbstractService {
    ...
    @ExpectError("Field annotated by `EndPointHandle` must be a non private field of `NativeObject` type.%n" +
                    "Change signature to `final NativeObject delegate`.") @EndPointHandle final Object delegate;
