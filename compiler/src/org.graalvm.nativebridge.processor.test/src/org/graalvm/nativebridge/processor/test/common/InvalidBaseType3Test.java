...
@ExpectError("The annotated type must have a non `Object` super class or implement a single interface.%n" +
                "Introduce a new bridged base class extending `AbstractService` and implementing `Service` and extend it.")
