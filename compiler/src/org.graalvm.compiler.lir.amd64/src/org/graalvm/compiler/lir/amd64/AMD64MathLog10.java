...
// Code generated by Intel C compiler for LIBM library
    ...
    void generate(AMD64MacroAssembler masm, CompilationResultBuilder crb, Value result) {
        ...
        masm.movl(rcx, 16352);
        masm.psrlq(xmm0, 27);
        masm.movdqu(xmm2, recordExternalAddress(crb, log10E));    // 0x00000000, 0x3fdbc000, 0xbf2e4108,
                                                            // 0x3f5a7a6c
        masm.psrld(xmm0, 2);
        ...
        masm.movq(xmm6, recordExternalAddress(crb, log2));    // 0x509f7800, 0x3f934413, 0x1f12b358,
                                                        // 0x3cdfef31
        masm.movdqu(xmm3, recordExternalAddress(crb, coeff));    // 0xc1a5f12e, 0x40358874, 0x64d4ef0d,
                                                           // 0xc0089309
        masm.subsd(xmm5, xmm2);
        masm.andl(rdx, 16711680);
        masm.shrl(rdx, 12);
        masm.movdqu(xmm0, new AMD64Address(r11, rdx, AMD64Address.Scale.Times1, -1504));
        masm.movdqu(xmm4, recordExternalAddress(crb, coeff16));    // 0x385593b1, 0xc025c917, 0xdc963467,
                                                             // 0x3ffc6a02
        masm.addsd(xmm1, xmm5);
        masm.movdqu(xmm2, recordExternalAddress(crb, coeff32));    // 0x7f9d3aa1, 0x4016ab9f, 0xdc77b115,
                                                             // 0xbff27af2
