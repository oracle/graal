...
/**
 * Processor for the {@code jdk.compiler.graal.lir.GenerateStub} and
 * {@code jdk.compiler.graal.lir.GeneratedStubsHolder} annotation.
 */
public class IntrinsicStubProcessor extends AbstractProcessor {
    ...
    private static final String NODE_INTRINSIC_CLASS_NAME = "jdk.compiler.graal.graph.Node.NodeIntrinsic";
    private static final String GENERATE_STUB_CLASS_NAME = "jdk.compiler.graal.lir.GenerateStub";
    private static final String GENERATE_STUBS_CLASS_NAME = "jdk.compiler.graal.lir.GenerateStubs";
    private static final String GENERATED_STUBS_HOLDER_CLASS_NAME = "jdk.compiler.graal.lir.GeneratedStubsHolder";
    private static final String CONSTANT_NODE_PARAMETER_CLASS_NAME = "jdk.compiler.graal.graph.Node.ConstantNodeParameter";
                ...
                switch (targetVM) {
                    case hotspot:
                        imports.addAll(List.of(
                                        "jdk.compiler.graal.api.replacements.Snippet",
                                        "jdk.compiler.graal.hotspot.HotSpotForeignCallLinkage",
                                        "jdk.compiler.graal.hotspot.meta.HotSpotProviders",
                                        "jdk.compiler.graal.options.OptionValues",
                                        "jdk.compiler.graal.hotspot.stubs.SnippetStub"));
                        break;
                    case substrate:
                        imports.addAll(List.of(
                                        ...
                                        "jdk.compiler.graal.api.replacements.Fold",
                                        "jdk.compiler.graal.debug.GraalError",
