...
public class GraphNodeVerifier {
    ...
    public GraphNodeVerifier(AbstractProcessor processor) {
        ...
        this.Input = getTypeElement("jdk.compiler.graal.graph.Node.Input");
        this.OptionalInput = getTypeElement("jdk.compiler.graal.graph.Node.OptionalInput");
        this.Successor = getTypeElement("jdk.compiler.graal.graph.Node.Successor");
        this.Node = getTypeElement("jdk.compiler.graal.graph.Node");
        this.NodeInputList = getTypeElement("jdk.compiler.graal.graph.NodeInputList");
        this.NodeSuccessorList = getTypeElement("jdk.compiler.graal.graph.NodeSuccessorList");
