...
public final class LoopExitNode extends BeginStateSplitNode implements IterableNodeType, Simplifiable {
    ...
    public static final String ErrorMessagePredecessorSplit = "Predecessor '%s' must not be a control split node that can be used as value node as that could mean scheduling of proxy nodes goes wrong";
    ...
    public boolean verify() {
        ...
        assert !(predecessor() instanceof InvokeWithExceptionNode) : String.format(ErrorMessagePredecessorSplit, predecessor());
        return super.verify();
    }
}
