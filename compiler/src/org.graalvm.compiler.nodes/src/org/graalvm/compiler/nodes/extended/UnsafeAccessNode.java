        ...
        if (!isAnyLocationForced() && getLocationIdentity().isAny()) {
            if (offset().isConstant()) {
                ...
                if (receiverType != null) {
                    ...
                    // Field access semantics are encoded in the field. By using VarHandles, it's possible to access
                    // volatile fields using non-volatile semantics (i.e. without memory barriers).
