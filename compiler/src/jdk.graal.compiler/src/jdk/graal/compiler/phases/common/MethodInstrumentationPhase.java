...
public class MethodInstrumentationPhase extends BasePhase<HighTierContext> {
    ...
    protected void run(StructuredGraph graph, HighTierContext context) {
        ...
        // // Joonhwan TODO Could return NULL if root method is not existant
        // JavaConstant methodNameConstant = context.getConstantReflection().forObject(graph.method().getName());
        // ValueNode mNameNode = graph.addWithoutUnique(new ConstantNode(methodNameConstant, StampFactory.forKind(JavaKind.Object)));
        // TODO RENAME returnNode to something that makes more sense
