...
/**
 * A small bytecode forward data flow analyzer. Abstract program states, represented by {@link S},
 ...
 * through variables, or more complex algorithms where {@link S} is an abstract representation of
 ...
 *            {@link S} should override {@link Object#equals(Object)} in order to allow a fixed
...
public abstract class DataFlowAnalyzer<S> {
     ...
     *         before the execution of that instruction.
     * @throws DataFlowAnalysisException Is thrown in case the analyzed method contains unsupported
     *             opcodes such as JSR and RET.
     */
