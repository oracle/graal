...
import jdk.graal.compiler.asm.aarch64.AArch64MacroAssembler.AArch64ExceptionCode;
...
public class AArch64BreakpointOp extends AArch64LIRInstruction {
     ...
     */
    @LIRInstruction.Use({LIRInstruction.OperandFlag.REG, LIRInstruction.OperandFlag.STACK}) private Value[] parameters;
