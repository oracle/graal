...
import static jdk.graal.compiler.lir.amd64.AMD64KyberSupport.DIM_HALF_INVERSE;
import static jdk.graal.compiler.lir.amd64.AMD64KyberSupport.INVERSE_NTT_PERMS;
...
import static jdk.graal.compiler.lir.amd64.AMD64KyberSupport.XMM29_29;
...
// @formatter:off
@SyncPort(from = "https://github.com/openjdk/jdk25u/blob/d8d51f3327b133af4f21cd6dd248324e4fc2a482/src/hotspot/cpu/x86/stubGenerator_x86_64_kyber.cpp#L464-L581",
          sha1 = "8ae83ce5be3da4a970fa233eddaea8a07a11543c")
// @formatter:on
public final class AMD64KyberInverseNttOp extends AMD64LIRInstruction {
    public static final LIRInstructionClass<AMD64KyberInverseNttOp> TYPE = LIRInstructionClass.create(AMD64KyberInverseNttOp.class);
    ...
    public AMD64KyberInverseNttOp(AllocatableValue resultValue, AllocatableValue polyValue, AllocatableValue zetasValue) {
        super(TYPE);
    ...
    public void emitCode(CompilationResultBuilder crb, AMD64MacroAssembler masm) {
        ...
        masm.evmovdqu16(xmm12, recordExternalAddress(crb, INVERSE_NTT_PERMS[0]));
        masm.evmovdqu16(xmm16, recordExternalAddress(crb, INVERSE_NTT_PERMS[1]));
        ...
        EVPBROADCASTQ.emit(masm, AVXSize.ZMM, xmm29, recordExternalAddress(crb, DIM_HALF_INVERSE));

        load4regs(masm, XMM0_3, coeffs, 0);
        load4regs(masm, XMM4_7, coeffs, 256);

        load4regs(masm, XMM8_11, zetas, 0);
        permute(masm, XMM12_15, XMM0246, XMM1357, xmm16);
        masm.evmovdqu16(xmm1, recordExternalAddress(crb, INVERSE_NTT_PERMS[2]));
        masm.evmovdqu16(xmm20, recordExternalAddress(crb, INVERSE_NTT_PERMS[3]));
        subAdd(masm, XMM16_19, XMM0246, XMM0246, XMM12_15);
        montmul(masm, XMM12_15, XMM16_19, XMM8_11, XMM12_15, XMM8_11);

        load4regs(masm, XMM8_11, zetas, 256);
        permute(masm, XMM1357, XMM0246, XMM12_15, xmm20);
        subAdd(masm, XMM16_19, XMM0246, XMM1357, XMM0246);
        masm.evmovdqu16(xmm1, recordExternalAddress(crb, INVERSE_NTT_PERMS[4]));
        masm.evmovdqu16(xmm20, recordExternalAddress(crb, INVERSE_NTT_PERMS[5]));
        montmul(masm, XMM12_15, XMM16_19, XMM8_11, XMM12_15, XMM8_11);

        load4regs(masm, XMM8_11, zetas, 512);
        permute(masm, XMM1357, XMM0246, XMM12_15, xmm20);
        subAdd(masm, XMM16_19, XMM0246, XMM1357, XMM0246);
        masm.evmovdqu16(xmm1, recordExternalAddress(crb, INVERSE_NTT_PERMS[6]));
        masm.evmovdqu16(xmm20, recordExternalAddress(crb, INVERSE_NTT_PERMS[7]));
        montmul(masm, XMM12_15, XMM16_19, XMM8_11, XMM12_15, XMM8_11);
        ...
        load4regs(masm, XMM8_11, zetas, 768);
        subAdd(masm, XMM16_19, XMM0246, XMM1357, XMM0246);
        masm.evmovdqu16(xmm1, recordExternalAddress(crb, INVERSE_NTT_PERMS[8]));
        masm.evmovdqu16(xmm20, recordExternalAddress(crb, INVERSE_NTT_PERMS[9]));
        montmul(masm, XMM12_15, XMM16_19, XMM8_11, XMM12_15, XMM8_11);
        permute(masm, XMM1357, XMM0246, XMM12_15, xmm20);

        load4regs(masm, XMM8_11, zetas, 1024);
        EVPBROADCASTQ.emit(masm, AVXSize.ZMM, xmm16, recordExternalAddress(crb, BARRETT_MULTIPLIER));
        EVPBROADCASTQ.emit(masm, AVXSize.ZMM, xmm17, recordExternalAddress(crb, Q));
        subAdd(masm, XMM12_15, XMM0246, XMM0246, XMM1357);
        montmul(masm, XMM1357, XMM12_15, XMM8_11, XMM1357, XMM8_11);
        barrettReduce(masm);

        load4regs(masm, XMM8_11, zetas, 1280);
        subAdd(masm, XMM12_15, XMM0145, XMM0145, XMM2367);
        montmul(masm, XMM2367, XMM12_15, XMM8_11, XMM2367, XMM8_11);

        load4regs(masm, XMM8_11, zetas, 1536);
        subAdd(masm, XMM12_15, XMM0_3, XMM0_3, XMM4_7);
        montmul(masm, XMM4_7, XMM12_15, XMM8_11, XMM4_7, XMM8_11);

        montmul(masm, XMM8_11, XMM29_29, XMM0_3, XMM8_11, XMM0_3);
        montmul(masm, XMM12_15, XMM29_29, XMM4_7, XMM12_15, XMM4_7);

        store4regs(masm, coeffs, 0, XMM8_11);
        store4regs(masm, coeffs, 256, XMM12_15);
