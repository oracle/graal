...
// @formatter:off
@SyncPort(from = "https://github.com/openjdk/jdk25u/blob/2fe611a2a3386d097f636c15bd4d396a82dc695e/src/hotspot/cpu/aarch64/stubGenerator_aarch64.cpp#L5930-L6019",
          sha1 = "aad898716c36a66ccb0fcc53ec999945a2f1b185")
// @formatter:on
public final class AArch64KyberAddPoly3Op extends AArch64LIRInstruction {
    public static final LIRInstructionClass<AArch64KyberAddPoly3Op> TYPE = LIRInstructionClass.create(AArch64KyberAddPoly3Op.class);

    @Def private Value resultValue;
    @Use private Value resultPointerValue;
    @Use private Value aValue;
    @Use private Value bValue;
    @Use private Value cValue;
    @Temp private Value[] temps;

    public AArch64KyberAddPoly3Op(AllocatableValue resultValue, AllocatableValue resultPointerValue, AllocatableValue aValue, AllocatableValue bValue, AllocatableValue cValue) {
        super(TYPE);
        ...
        guaranteeFixedRegister(cValue, r3, "cValue");
    ...
    public void emitCode(CompilationResultBuilder crb, AArch64MacroAssembler masm) {
        ...
        masm.fldr(128, vcC, createImmediateAddress(128, IMMEDIATE_UNSIGNED_SCALED, kyberConsts, 16));
        for (int i = 0; i < 3; i++) {
            ...
            // load 80 or 88 values from c into vs2A/2/3
            vsLdpqPost(masm, vs2A, c);
            vsLdpqPost(masm, vs2B, c);
            if (i < 2) {
                masm.fldr(128, vs2C, createImmediateAddress(128, IMMEDIATE_POST_INDEXED, c, 16));
            }
            // sum 80 or 88 values across vs1 and vs2 into vs1
            vsAddv(masm, vs1A, vs1A, vs2A);
            vsAddv(masm, vs1B, vs1B, vs2B);
