...
/**
 * Resolve {@link ConflictedAllocationState} occurrences based
 * on internal set of rules.
 *
 * <p>
 * In-case comparison of {@link ValueAllocationState} fails, it
 * also might get resolved by this.
 * </p>
 */
public interface ConflictResolver {
    /**
     * {@link ConflictResolver} can prepare its own internal state here
    ...
    /**
     * Resolve an issue stemming from {@link ValueAllocationState} not having the correct value
    ...
    /**
     * Resolve a {@link ConflictedAllocationState} to {@link ValueAllocationState} based on the target variable.
     *
     * @param target          Variable we are looking to resolve to
