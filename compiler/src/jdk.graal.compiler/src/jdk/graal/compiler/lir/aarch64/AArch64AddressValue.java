...
import static jdk.graal.compiler.asm.aarch64.AArch64Address.isImmediateScaled;
...
import static jdk.graal.compiler.asm.aarch64.AArch64Address.AddressingMode.REGISTER_OFFSET;
...
public final class AArch64AddressValue extends CompositeValue {
    ...
    @Component({LIRInstruction.OperandFlag.REG, LIRInstruction.OperandFlag.ILLEGAL}) protected AllocatableValue offset;
