...
// @formatter:off
@SyncPort(from = "https://github.com/openjdk/jdk25u/blob/c59e44a7aa2aeff0823830b698d524523b996650/src/hotspot/cpu/aarch64/stubGenerator_aarch64.cpp#L6695-L6807",
          sha1 = "5bb874220dcc4ecc6ddd2b8c71aee68236286ee2")
// @formatter:on
public final class AArch64DilithiumAlmostInverseNttOp extends AArch64LIRInstruction {

    public static final LIRInstructionClass<AArch64DilithiumAlmostInverseNttOp> TYPE = LIRInstructionClass.create(AArch64DilithiumAlmostInverseNttOp.class);
    ...
    private static final int[] OFFSETS = {0, 32, 64, 96};
    private static final int[] LEVEL_2_OFFSETS_1 = {0, 32, 64, 96, 128, 160, 192, 224};
    private static final int[] LEVEL_2_OFFSETS_2 = {16, 48, 80, 112, 144, 176, 208, 240};
    ...
    private static final Register[] VS2_BACK = {AArch64.v20, AArch64.v21, AArch64.v22, AArch64.v23};
    ...
    public AArch64DilithiumAlmostInverseNttOp(AllocatableValue resultValue, AllocatableValue coeffsValue, AllocatableValue zetasValue) {
        super(TYPE);
    ...
    private static void emitInverseNttLevel3To7(AArch64MacroAssembler masm,
                    Register coeffs,
                    Register zetas,
        ...
        for (int level = 3; level < 8; level++) {
            ...
            for (int i = 0; i < 4; i++) {
                ...
                loadVSeq8Indexed(masm, VS2, coeffs, c2Start, offsets);
                ...
                storeVSeq8Indexed(masm, VS2, coeffs, c2Start, offsets);
    ...
    public void emitCode(CompilationResultBuilder crb, AArch64MacroAssembler masm) {
        ...
        try (AArch64MacroAssembler.ScratchRegister scratch1 = masm.getScratchRegister();
            ...
            for (int i = 0; i < 1024; i += 128) {
                ...
                loadInterleavedVSeq8(masm, VS1, coeffs, tmpAddr, i, ElementSize.Word, OFFSETS);
                ...
                AArch64DilithiumSupport.emitSubAddMontMul16(masm, VS1_EVEN, VS1_ODD, VS2_FRONT, VS2_BACK, AArch64DilithiumSupport.VTMP, AArch64DilithiumSupport.VQ);
                // a0/a1 store interleaved 32 (8x4S) coefficients
                storeInterleavedVSeq8(masm, VS1, coeffs, tmpAddr, i, ElementSize.Word, OFFSETS);
            }
            ...
            for (int i = 0; i < 1024; i += 128) {
                ...
                loadInterleavedVSeq8(masm, VS1, coeffs, tmpAddr, i, ElementSize.DoubleWord, OFFSETS);
                ...
                storeInterleavedVSeq8(masm, VS1, coeffs, tmpAddr, i, ElementSize.DoubleWord, OFFSETS);
            }
            ...
            for (int i = 0; i < 1024; i += 256) {
                ...
                loadVSeq8LdrIndexed(masm, VS1, coeffs, i, LEVEL_2_OFFSETS_1);
                // c1 load 32 (8x4S) coefficients via second offsets
                loadVSeq8LdrIndexed(masm, VS2, coeffs, i, LEVEL_2_OFFSETS_2);
                // a0 = c0 + c1 n.b. clobbers vq which overlaps vs3
                addVSeq8(masm, VS3, VS1, VS2);
                // c = c0 - c1
                subVSeq8(masm, VS1, VS1, VS2);
                // store a0 32 (8x4S) coefficients via first offsets
                storeVSeq8StrIndexed(masm, VS3, coeffs, i, LEVEL_2_OFFSETS_1);
                ...
                storeVSeq8StrIndexed(masm, VS2, coeffs, i, LEVEL_2_OFFSETS_2);
            }

            // level 3-7
            emitInverseNttLevel3To7(masm, coeffs, zetas, dilithiumConsts);
