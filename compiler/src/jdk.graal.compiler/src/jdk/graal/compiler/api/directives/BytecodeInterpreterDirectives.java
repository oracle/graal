    ...
    public @interface BytecodeInterpreterHandlerConfig {
        ...
        @interface Argument {
            ...
            @interface Field {
                 ...
                 * selected template variant and do not occupy callee parameter locations. Their
                 * value at the end of a threaded handler selects the variant of the next threaded
                 * handler, and a terminating handler returns the updated value through an additional
                 * caller-side return location. When template mode is not enabled, this metadata is
                 * ignored and the field remains an ordinary expanded argument.
                 * <p>
