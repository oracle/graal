...
/**
 * Initial implementation of a vector read barrier. Currently not in use because of other issues
 * with ZGC and vector operations.
 */
public class AMD64HotSpotZVectorReadBarrierOp extends AMD64HotSpotZLoadBarrieredOp {
    ...
    public AMD64HotSpotZVectorReadBarrierOp(AVXSize size,
