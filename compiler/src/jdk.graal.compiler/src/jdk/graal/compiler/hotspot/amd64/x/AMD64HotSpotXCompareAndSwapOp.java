...
@Opcode("CAS_Z")
public final class AMD64HotSpotXCompareAndSwapOp extends AMD64HotSpotXBarrieredOp {
    public static final LIRInstructionClass<AMD64HotSpotXCompareAndSwapOp> TYPE = LIRInstructionClass.create(AMD64HotSpotXCompareAndSwapOp.class);
    ...
    public AMD64HotSpotXCompareAndSwapOp(AMD64Kind accessKind, AllocatableValue result, AMD64AddressValue address, AllocatableValue cmpValue, AllocatableValue newValue,
