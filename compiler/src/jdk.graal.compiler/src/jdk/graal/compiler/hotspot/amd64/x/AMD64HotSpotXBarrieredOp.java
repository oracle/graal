 ...
 */
public abstract class AMD64HotSpotXBarrieredOp extends AMD64LIRInstruction {
    public static final LIRInstructionClass<AMD64HotSpotXBarrieredOp> TYPE = LIRInstructionClass.create(AMD64HotSpotXBarrieredOp.class);
    ...
    protected AMD64HotSpotXBarrieredOp(LIRInstructionClass<? extends AMD64HotSpotXBarrieredOp> type, AllocatableValue result, AMD64AddressValue loadAddress, GraalHotSpotVMConfig config,
