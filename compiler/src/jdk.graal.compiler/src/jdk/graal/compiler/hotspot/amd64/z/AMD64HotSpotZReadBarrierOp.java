 ...
 */
public class AMD64HotSpotZReadBarrierOp extends AMD64HotSpotZLoadBarrieredOp {
    ...
    public AMD64HotSpotZReadBarrierOp(Variable result, AMD64AddressValue loadAddress, LIRFrameState state, GraalHotSpotVMConfig config, ForeignCallLinkage callTarget, boolean isNotStrong) {
