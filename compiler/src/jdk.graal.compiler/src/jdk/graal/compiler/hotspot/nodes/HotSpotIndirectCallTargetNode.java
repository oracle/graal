...
public final class HotSpotIndirectCallTargetNode extends IndirectCallTargetNode {
    ...
    public HotSpotIndirectCallTargetNode(ValueNode metaspaceMethod, ValueNode computedAddress, ValueNode[] arguments, StampPair returnStamp,
                    List<JavaType> signature, ResolvedJavaMethod target, Type callType, InvokeKind invokeKind) {
