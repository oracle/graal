...
import jdk.graal.compiler.nodes.gc.XBarrierSet;
import jdk.vm.ci.meta.JavaKind;
import jdk.vm.ci.meta.ResolvedJavaField;

/**
 * Specialization of {@link XBarrierSet} that adds support for read barriers on handle locations.
 */
public class HotSpotXBarrierSet extends XBarrierSet {
    public HotSpotXBarrierSet(ResolvedJavaField referentField) {
        super(referentField);
    }
