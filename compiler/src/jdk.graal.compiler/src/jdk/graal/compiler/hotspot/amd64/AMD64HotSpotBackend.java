            ...
            if (config.icSpeculatedKlassOffset == Integer.MAX_VALUE) {
                ...
                if (config.useCompressedClassPointers) {
                    ...
                    if (config.useCompactObjectHeaders) {
                        asm.movq(register, new AMD64Address(receiver, config.markOffset));
                        asm.shrq(register, config.markWordKlassShift);
                    } else {
                ...
                if (config.useCompressedClassPointers) {
                    if (config.useCompactObjectHeaders) {
                        asm.movq(temp, new AMD64Address(receiver, config.markOffset));
                        asm.shrq(temp, config.markWordKlassShift);
                    } else {
