...
public class AArch64HotSpotXReadBarrierOp extends AArch64HotSpotXBarrieredOp {
    public static final LIRInstructionClass<AArch64HotSpotXReadBarrierOp> TYPE = LIRInstructionClass.create(AArch64HotSpotXReadBarrierOp.class);

    private final MemoryOrderMode memoryOrder;
    @State protected LIRFrameState state;

    public AArch64HotSpotXReadBarrierOp(Variable result, AArch64AddressValue loadAddress, MemoryOrderMode memoryOrder, LIRFrameState state, GraalHotSpotVMConfig config,
