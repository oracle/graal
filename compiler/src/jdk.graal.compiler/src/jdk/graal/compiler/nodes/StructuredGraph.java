...
public final class StructuredGraph extends Graph implements JavaMethodContext {
     ...
     *
     * @param unusedNodes A set to mark unused nodes in the graph that should be killed. The set
     *            should be used when calling this method for multiple merges. The resulting set
     *            must be killed with
