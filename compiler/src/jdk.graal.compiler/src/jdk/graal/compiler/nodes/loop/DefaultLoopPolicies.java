...
import static jdk.graal.compiler.nodes.loop.DefaultLoopPolicies.Options.DefaultLoopFrequency;
import static jdk.graal.compiler.nodes.loop.DefaultLoopPolicies.Options.DefaultUnswitchFactor;
import static jdk.graal.compiler.nodes.loop.DefaultLoopPolicies.Options.ExactFullUnrollMaxNodes;
import static jdk.graal.compiler.nodes.loop.DefaultLoopPolicies.Options.ExactPartialUnrollMaxNodes;
import static jdk.graal.compiler.nodes.loop.DefaultLoopPolicies.Options.FullUnrollConstantCompareBoost;
...
import static jdk.graal.compiler.nodes.loop.DefaultLoopPolicies.Options.LoopUnswitchFrequencyBoost;
import static jdk.graal.compiler.nodes.loop.DefaultLoopPolicies.Options.LoopUnswitchFrequencyMaxFactor;
import static jdk.graal.compiler.nodes.loop.DefaultLoopPolicies.Options.LoopUnswitchFrequencyMinFactor;
import static jdk.graal.compiler.nodes.loop.DefaultLoopPolicies.Options.LoopUnswitchMaxIncrease;
import static jdk.graal.compiler.nodes.loop.DefaultLoopPolicies.Options.LoopUnswitchMinSplitFrequency;
import static jdk.graal.compiler.nodes.loop.DefaultLoopPolicies.Options.LoopUnswitchTrivial;
import static jdk.graal.compiler.nodes.loop.DefaultLoopPolicies.Options.UnrollMaxIterations;
