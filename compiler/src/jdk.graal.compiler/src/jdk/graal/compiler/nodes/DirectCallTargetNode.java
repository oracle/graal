...
public class DirectCallTargetNode extends LoweredCallTargetNode {
    ...
    public DirectCallTargetNode(ValueNode[] arguments, StampPair returnStamp, List<JavaType> signature, ResolvedJavaMethod target, CallingConvention.Type callType,
                    InvokeKind invokeKind) {
        this(TYPE, arguments, returnStamp, signature, target, callType, invokeKind);
    }

    protected DirectCallTargetNode(NodeClass<? extends DirectCallTargetNode> c, ValueNode[] arguments, StampPair returnStamp, List<JavaType> signature, ResolvedJavaMethod target,
