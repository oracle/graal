...
/**
 * Compiler directives node that disables write sinking of all enclosing loops.
 */
@NodeInfo(cycles = CYCLES_IGNORED, size = SIZE_IGNORED, cyclesRationale = "Directives node", sizeRationale = "Directives node")
public final class NeverWriteSinkNode extends FixedWithNextNode implements LIRLowerable {
