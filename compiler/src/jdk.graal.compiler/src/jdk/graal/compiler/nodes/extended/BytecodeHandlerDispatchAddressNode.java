 ...
 * and proxying the selected table across the exit.
 */
...
public final class BytecodeHandlerDispatchAddressNode extends FixedWithNextNode implements Lowerable {
    ...
    private ValueNode createTableBase(LoweringTool tool, StructuredGraph graph, ValueNode[] values,
        ...
        /*
         * A loop-exit proxy is an availability boundary: its original value is not valid outside
         * the loop. Select the table before the exit and proxy that result into the outer scope.
         */
