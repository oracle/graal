...
@NodeInfo(nameTemplate = "New {p#instanceClass/s}", cycles = CYCLES_8, cyclesRationale = "tlab alloc + header init", size = SIZE_8)
public class NewInstanceWithExceptionNode extends AllocateWithExceptionNode {
    ...
    public FixedNode replaceWithNonThrowing() {
        killExceptionEdge();
        NewInstanceNode newInstance = graph().add(new NewInstanceNode(instanceClass, fillContents, stateBefore));
