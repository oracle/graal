 ...
 * {@link SimplifierTool#addToWorkList(Node)} for each node that might be influenced (in terms of
 * simplification and canonicalization) by the actions performed in simplify.
 */
