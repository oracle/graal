...
public final class LinearScanOrder {
     ...
     */
    private static <T extends BasicBlock<T>> void computeLinearScanOrder(BasicBlockOrderUtils.BlockList<T> order, PriorityQueue<T> worklist, BitSet visitedBlocks) {
     ...
     */
    private static <T extends BasicBlock<T>> T addPathToLinearScanOrder(T block, BasicBlockOrderUtils.BlockList<T> order, PriorityQueue<T> worklist, BitSet visitedBlocks) {
