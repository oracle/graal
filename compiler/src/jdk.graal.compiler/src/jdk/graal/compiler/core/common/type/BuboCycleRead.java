 ...
 */
public final class BuboCycleRead extends Stamp {

    private BuboCycleRead() {
    }
    ...
    public Stamp improveWith(Stamp other) {
        assert other instanceof BuboCycleRead;
        return this;
    }
    ...
    public boolean isCompatible(Stamp stamp) {
        return stamp instanceof BuboCycleRead;
    }
    ...
    private static final BuboCycleRead instance = new BuboCycleRead();

    static BuboCycleRead getInstance() {
        return instance;
    }
}