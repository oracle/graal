 ...
 * it implements semantics that are required for the Truffle compilation to succeed. It is strongly
 * recommended to cache the result of this phase to not repeat it for every time a method is partial
 * evaluated.
 */
public final class PrePartialEvaluationSuite extends PhaseSuite<Providers> {
