...
public class HotSpotOutlineBytecodeHandlerPhase extends OutlineBytecodeHandlerPhase {
    ...
    protected FixedNode replaceInvoke(HighTierContext context, BytecodeHandlerCallSite callsite, Invoke invoke, ValueNode[] arguments) {
        ...
        ForeignCallSignature foreignCallSignature = new ForeignCallSignature(callsite.getStubName(), toJavaClass(callsite.getReturnType()), toJavaClasses(callsite.getCalleeParameterTypes()));
