...
public final class TruffleKnownHostTypes extends AbstractKnownTruffleTypes {
    ...
    public final ResolvedJavaType BytecodeInterpreterSwitchBoundary = lookupTypeOptional("com.oracle.truffle.api.HostCompilerDirectives$BytecodeInterpreterSwitchBoundary");
