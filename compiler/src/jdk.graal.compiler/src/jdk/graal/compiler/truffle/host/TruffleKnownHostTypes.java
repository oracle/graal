...
public final class TruffleKnownHostTypes extends AbstractKnownTruffleTypes {
    ...
    public final ResolvedJavaType BytecodeInterpreterThreadingExit = lookupType("com.oracle.truffle.api.HostCompilerDirectives$BytecodeInterpreterThreadingExit");
