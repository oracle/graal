...
//@formatter:on
public final class VectorConsumerProxyNode extends FloatingNode implements Canonicalizable {

    public static final NodeClass<VectorConsumerProxyNode> TYPE = NodeClass.create(VectorConsumerProxyNode.class);
    @Input(Unchecked) ValueNode consumer;

    public VectorConsumerProxyNode(ValueNode consumer) {
        super(TYPE, consumer.stamp(NodeView.DEFAULT));
        this.consumer = consumer;
    }

    @Override
    public Node canonical(CanonicalizerTool tool) {
        return consumer.isAllowedUsageType(Association) ? consumer : this;
    }
    ...
    @NodeIntrinsic
    public static native Consumer consumer(ConsumerParameter parameter);
}
