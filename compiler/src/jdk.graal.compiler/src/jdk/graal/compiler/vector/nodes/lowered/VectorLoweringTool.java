...
public interface VectorLoweringTool {

    TargetDescription getTarget();

    VectorConsumerIterator getIterator(ValueNode iterator, LowerableVectorConsumer consumer);

    void constructGraph(LowerableVectorConsumer consumer);
