...
/**
 * A {@link ClassFilter} implementation that filters classes based on whether their names start with
 * a given prefix.
 * <p>
 ...
 *
 * @param prefix the prefix to match against class names
 */
public record PrefixFilter(String prefix) implements ClassFilter {
