...
/**
 * Configuration used by {@link NativeIsolate} and by bridge classes generated by the native bridge
 * processor.
 */
public final class JNIConfig {
    ...
    /**
     * Lookups {@link JNIHotSpotMarshaller} for given type and annotation. The method first tries to
     * find a marshaller registered for the given type and annotation. If no such marshaller exists,
     * it tries to find a marshaller registered just for the given type. If there is no such
     * marshaller it throws {@link UnsupportedOperationException}.
     *
     * @param type the parameter or return type.
     * @param annotationTypes parameter or method annotation types.
     * @throws UnsupportedOperationException if there is no registered marshaller for given type.
     */
    ...
    /**
     * Lookups {@link JNIHotSpotMarshaller} for given parameterized type and annotation. The method
     * first tries to find a marshaller registered for the given type and annotation. If no such
     * marshaller exists, it tries to find a marshaller registered just for the given type. If there
     * is no such marshaller it throws {@link UnsupportedOperationException}.
     *
     * @param type the parameter or return type.
     * @param annotationTypes parameter or method annotation types.
     * @throws UnsupportedOperationException if there is no registered marshaller for given type.
    ...
    /**
     * Lookups {@link JNINativeMarshaller} for given type and annotation. The method first tries to
     * find a marshaller registered for the given type and annotation. If no such marshaller exists,
     * it tries to find a marshaller registered just for the given type. If there is no such
     * marshaller it throws {@link UnsupportedOperationException}.
     *
    ...
    /**
     * Lookups {@link JNINativeMarshaller} for given parameterized type and annotation. The method
     * first tries to find a marshaller registered for the given type and annotation. If no such
     * marshaller exists, it tries to find a marshaller registered just for the given type. If there
     * is no such marshaller it throws {@link UnsupportedOperationException}.
     *
    ...
    /**
     * Builder class to construct {@link JNIConfig} instances.
     */
    public static final class Builder {
        ...
        /**
         * Registers a {@link JNIHotSpotMarshaller} for given type.
         *
         * @param type type to register {@link JNIHotSpotMarshaller} for.
        ...
        /**
         * Registers a {@link JNINativeMarshaller} for given type.
         *
         * @param type type to register {@link JNINativeMarshaller} for.
         * @param marshaller marshaller to register.
         */
        ...
        /**
         * Registers a {@link JNIHotSpotMarshaller} for given parameterized type.
         *
         * @param type type to register {@link JNIHotSpotMarshaller} for.
         * @param marshaller marshaller to register.
         */
        ...
        /**
         * Registers a {@link JNINativeMarshaller} for given parameterized type.
         *
         * @param type type to register {@link JNINativeMarshaller} for.
         * @param marshaller marshaller to register.
         */
        ...
        /**
         * Registers a {@link JNIHotSpotMarshaller} for given type and annotation.
         *
         * @param type type to register {@link JNIHotSpotMarshaller} for.
         * @param annotationType required annotation to lookup the marshaller.
         * @param marshaller marshaller to register.
         *
         */
        ...
        /**
         * Registers a {@link JNINativeMarshaller} for given type and annotation.
         *
         * @param type type to register {@link JNIHotSpotMarshaller} for.
         * @param annotationType required annotation to lookup the marshaller.
         * @param marshaller marshaller to register.
        ...
        /**
         * Registers a callback used by {@link NativeIsolate} to attach the current thread to an
         * isolate.
         *
         * @param action a {@link LongUnaryOperator} taking {@code isolateId} as a parameter and
         *            returning {@code isolateThreadId}.
         */
        ...
        /**
         * Registers a callback used by {@link NativeIsolate} to detach the current thread from an
         * isolate.
         *
         * @param action a {@link LongUnaryOperator} taking {@code isolateThreadId} as a parameter
         *            and returning {@code 0} on success or non-zero in case of an error.
         */
        ...
        /**
         * Registers a callback used by {@link NativeIsolate} to tear down the isolate.
         *
         * @param action a {@link LongBinaryOperator} taking {@code isolateId} and
         *            {@code isolateThreadId} as a parameters, and returning {@code 0} on success or
        ...
        /**
         * Registers a callback used by {@link NativeObject} to clean objects in the native isolate
         * corresponding to garbage collected handles.
         *
         * @param action a {@link LongBinaryOperator} taking {@code isolateThreadId} and
         *            {@code handle} as a parameters, and returning {@code 0} on success or non-zero
         *            in case of an error.
         * @see NativeObject
         */
