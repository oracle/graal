...
public final class HotSpotTruffleCompiler extends TruffleCompiler {
    ...
    public static TruffleCompiler create(GraalTruffleRuntime runtime) {
        ...
        return new HotSpotTruffleCompiler(plugins, suites, lirSuites, backend, snippetReflection);
    }

    private HotSpotTruffleCompiler(Plugins plugins, Suites suites, LIRSuites lirSuites, Backend backend, SnippetReflectionProvider snippetReflection) {
    ...
    protected HotSpotPartialEvaluator createPartialEvaluator() {
        return new HotSpotPartialEvaluator(providers, config, snippetReflection, backend.getTarget().arch, ((GraalTruffleRuntime) Truffle.getRuntime()).getInstrumentation());
    }
