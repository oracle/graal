...
public class SnippetCounterNode extends FixedWithNextNode implements Lowerable {
    ...
    static class SnippetCounterSnippets implements Snippets {
        ...
        public static class Templates extends AbstractTemplates {
            ...
            Templates(OptionValues options, Iterable<DebugConfigCustomizer> customizers, Providers providers, SnippetReflectionProvider snippetReflection, TargetDescription target) {
