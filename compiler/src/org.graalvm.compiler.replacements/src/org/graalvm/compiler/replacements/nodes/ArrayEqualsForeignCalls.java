...
public final class ArrayEqualsForeignCalls {
    private static final ForeignCallDescriptor STUB_BOOLEAN_ARRAY_EQUALS = foreignCallDescriptorPointers("booleanArraysEquals");
    private static final ForeignCallDescriptor STUB_BYTE_ARRAY_EQUALS = foreignCallDescriptorPointers("byteArraysEquals");
    private static final ForeignCallDescriptor STUB_CHAR_ARRAY_EQUALS = foreignCallDescriptorPointers("charArraysEquals");
    private static final ForeignCallDescriptor STUB_SHORT_ARRAY_EQUALS = foreignCallDescriptorPointers("shortArraysEquals");
    private static final ForeignCallDescriptor STUB_INT_ARRAY_EQUALS = foreignCallDescriptorPointers("intArraysEquals");
    ...
    private static ForeignCallDescriptor foreignCallDescriptorPointers(String name) {
        return ForeignCalls.pureFunctionForeignCallDescriptor(name, boolean.class, Pointer.class, Pointer.class, int.class);
    }
