 ...
 * questions.
 */
package org.graalvm.compiler.truffle.compiler.aarch64.substitutions;
...
public class TruffleAArch64InvocationPlugins implements GraphBuilderInvocationPluginProvider {
    ...
    private static void registerExactMathPlugins(InvocationPlugins plugins, MetaAccessProvider metaAccess) {
        ...
        r.register1("truncate", float.class, new InvocationPlugin() {
            ...
            public boolean apply(GraphBuilderContext b, ResolvedJavaMethod targetMethod, Receiver receiver, ValueNode x) {
                b.addPush(JavaKind.Float, new AArch64RoundNode(x, RoundingMode.TRUNCATE));
                return true;
            }
        });
        r.register1("truncate", double.class, new InvocationPlugin() {
            @Override
            public boolean apply(GraphBuilderContext b, ResolvedJavaMethod targetMethod, Receiver receiver, ValueNode x) {
                b.addPush(JavaKind.Double, new AArch64RoundNode(x, RoundingMode.TRUNCATE));
                return true;
            }
        });
    }
