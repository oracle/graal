...
// Copied from jdk/test/micro/org/openjdk/bench/java/lang/DoubleClassCheck.java
@State(Scope.Thread)
public class DoubleClassCheckBenchmark extends BenchmarkBase {
