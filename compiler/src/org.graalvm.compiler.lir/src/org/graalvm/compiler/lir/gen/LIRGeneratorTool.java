...
public interface LIRGeneratorTool extends DiagnosticLIRGeneratorTool, ValueKindFactory<LIRKind> {
    ...
    // version of
    //
    // emitStringLatin1Inflate(Value src, Value src_ndx, Value dst, Value dst_ndx, Value len)
    // and
    // emitStringUTF16Cpmpress(Value src, Value src_ndx, Value dst, Value dst_ndx, Value len)
    //
