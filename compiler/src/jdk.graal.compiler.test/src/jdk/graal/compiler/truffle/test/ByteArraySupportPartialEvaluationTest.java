...
public class ByteArraySupportPartialEvaluationTest extends PartialEvaluationTest {
    ...
    final class GetShortNode extends AbstractTestNode {
    ...
    final class GetShortUnalignedNode extends AbstractTestNode {
        @CompilationFinal(dimensions = 1) byte[] bytes;
        final int offset;
    ...
    final class GetIntNode extends AbstractTestNode {
        @CompilationFinal(dimensions = 1) byte[] bytes;
        final int offset;
    ...
    final class GetIntUnalignedNode extends AbstractTestNode {
        @CompilationFinal(dimensions = 1) byte[] bytes;
        final int offset;
    ...
    final class GetLongNode extends LongNode {
        @CompilationFinal(dimensions = 1) byte[] bytes;
        final int offset;
    ...
    final class GetLongUnalignedNode extends LongNode {
        @CompilationFinal(dimensions = 1) byte[] bytes;
        final int offset;
    ...
    private static abstract class LongNode extends Node {
