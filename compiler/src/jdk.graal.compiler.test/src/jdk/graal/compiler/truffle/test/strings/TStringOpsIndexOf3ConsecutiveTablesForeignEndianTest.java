...
public class TStringOpsIndexOf3ConsecutiveTablesForeignEndianTest extends TStringOpsTest<ArrayIndexOfNode> {

    private Object[] constantArgs = new Object[7];
    private int strideA;

    public static List<Object[]> data() {
        return TStringOpsIndexOfConsecutiveTablesTestData.data(1, 3);
    }

    public TStringOpsIndexOf3ConsecutiveTablesForeignEndianTest() {
    ...
    protected InstalledCode getCode(final ResolvedJavaMethod installedCodeOwner, StructuredGraph graph, boolean ignoreForceCompile, boolean ignoreInstallAsDefault, OptionValues options) {
        return cacheInstalledCodeConstantStride(installedCodeOwner, graph, options, getIndexOf3ConsecutiveTablesForeignEndianIntl(), cache.get(), strideA, 0);
    }
    ...
    public void testIndexOf3ConsecutiveTablesForeignEndian() {
        testParameterized(data(), args -> {
            ...
            testIndexOf3ConsecutiveTablesForeignEndianCase(args);
        });
    }

    private void testIndexOf3ConsecutiveTablesForeignEndianCase(Object[] args) {
    ...
    protected void checkIntrinsicNode(ArrayIndexOfNode node) {
        Assert.assertEquals(LIRGeneratorTool.ArrayIndexOfVariant.FindThreeConsecutiveTablesForeignEndian, node.getVariant());
