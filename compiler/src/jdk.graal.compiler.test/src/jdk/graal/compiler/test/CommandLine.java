...
/*
 * This file is a copy of {@code src/jdk.compiler/share/classes/com/sun/tools/javac/main/CommandLine.java}.
 */
// Checkstyle: stop
...
public class CommandLine {
     ...
     * resulting arguments. A command file argument is of the form '@file' where 'file' is the name
     * of the file whose contents are to be parsed for additional arguments. The contents of the
     * command file are parsed using StreamTokenizer and the original '@file' argument replaced with
     * the resulting tokens. Recursive command files are not supported. The '@' character itself can
     * be quoted with the sequence '@@'.
     *
    ...
    /**
     * Process the given environment variable and appends any Win32-style command files for the
     * specified command line arguments and return the resulting arguments. A command file argument
     * is of the form '@file' where 'file' is the name of the file whose contents are to be parsed
     * for additional arguments. The contents of the command file are parsed using StreamTokenizer
     * and the original '@file' argument replaced with the resulting tokens. Recursive command files
     * are not supported. The '@' character itself can be quoted with the sequence '@@'.
     *
