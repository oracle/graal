...
public class IntegerSubOverflowsTest {
    ...
    public void testOverflowCheckStamp() {
        IntegerStamp s1 = IntegerStamp.create(32, Integer.MIN_VALUE, Integer.MIN_VALUE);
        IntegerStamp s2 = IntegerStamp.create(32, -1, -1);
        Assert.assertFalse(IntegerStamp.subtractionCanOverflow(s1, s2));
    }

    @Test
    public void testOverflowCheckStamp01() {
        IntegerStamp s1 = IntegerStamp.create(32, Integer.MAX_VALUE, Integer.MAX_VALUE);
        IntegerStamp s2 = IntegerStamp.create(32, Integer.MAX_VALUE, Integer.MAX_VALUE);
        Assert.assertFalse(IntegerStamp.subtractionCanOverflow(s1, s2));
    }
    ...
    public void testOverflowCheckStamp02() {
        IntegerStamp s1 = IntegerStamp.create(32, Integer.MIN_VALUE, Integer.MIN_VALUE);
        IntegerStamp s2 = IntegerStamp.create(32, Integer.MIN_VALUE, Integer.MIN_VALUE);
        Assert.assertFalse(IntegerStamp.subtractionCanOverflow(s1, s2));
    }
    ...
    public void testOverflowCheckStamp04() {
        IntegerStamp s1 = IntegerStamp.create(8, Byte.MIN_VALUE, Byte.MIN_VALUE);
        IntegerStamp s2 = IntegerStamp.create(8, -1, -1);
        Assert.assertFalse(IntegerStamp.subtractionCanOverflow(s1, s2));
    }

    @Test
    public void testOverflowCheckStamp05() {
        IntegerStamp s1 = IntegerStamp.create(8, Byte.MAX_VALUE, Byte.MAX_VALUE);
        IntegerStamp s2 = IntegerStamp.create(8, Byte.MAX_VALUE, Byte.MAX_VALUE);
        Assert.assertFalse(IntegerStamp.subtractionCanOverflow(s1, s2));
    }
    ...
    public void testOverflowCheckStamp06() {
        IntegerStamp s1 = IntegerStamp.create(8, Byte.MIN_VALUE, Byte.MIN_VALUE);
        IntegerStamp s2 = IntegerStamp.create(8, Byte.MIN_VALUE, Byte.MIN_VALUE);
        Assert.assertFalse(IntegerStamp.subtractionCanOverflow(s1, s2));
    }
    ...
    public void testOverflowCheckStamp08() {
        IntegerStamp s1 = IntegerStamp.create(64, Long.MIN_VALUE, Long.MIN_VALUE);
        IntegerStamp s2 = IntegerStamp.create(64, -1, -1);
        Assert.assertFalse(IntegerStamp.subtractionCanOverflow(s1, s2));
    }

    @Test
    public void testOverflowCheckStamp09() {
        IntegerStamp s1 = IntegerStamp.create(64, Long.MAX_VALUE, Long.MAX_VALUE);
        IntegerStamp s2 = IntegerStamp.create(64, Long.MAX_VALUE, Long.MAX_VALUE);
        Assert.assertFalse(IntegerStamp.subtractionCanOverflow(s1, s2));
    }
    ...
    public void testOverflowCheckStamp10() {
        IntegerStamp s1 = IntegerStamp.create(64, Long.MIN_VALUE, Long.MIN_VALUE);
        IntegerStamp s2 = IntegerStamp.create(64, Long.MIN_VALUE, Long.MIN_VALUE);
        Assert.assertFalse(IntegerStamp.subtractionCanOverflow(s1, s2));
    }
    ...
    public void testOverflowBIgStamps01() {
        IntegerStamp s1 = IntegerStamp.create(64, Long.MIN_VALUE, Long.MAX_VALUE);
        IntegerStamp s2 = IntegerStamp.create(64, Long.MIN_VALUE, Long.MAX_VALUE);
        Assert.assertTrue(IntegerStamp.subtractionCanOverflow(s1, s2));
    }
