...
public class OptimizeDivIntTest extends JTTTest {
    ...
    private static final int[] dividends = {
                    0,
                    1,
                    -1,
                    10,
    ...
    public static int mod(int b) {
        return a % b;
    }

    public static int divUnsigned(int b) {
        return Integer.divideUnsigned(a, b);
    }

    public static int modUnsigned(int b) {
        return Integer.remainderUnsigned(a, b);
    }

    public static int compareUnsigned(int b) {
