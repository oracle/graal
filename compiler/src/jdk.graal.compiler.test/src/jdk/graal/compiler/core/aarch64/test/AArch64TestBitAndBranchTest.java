...
public class AArch64TestBitAndBranchTest extends LIRTest {
     ...
     * {@link CompilationResultBuilder#labelWithinLIRRange(LIRInstruction, Label, int)} holds.
     */
     ...
     * {@link CompilationResultBuilder#labelWithinLIRRange(LIRInstruction, Label, int)} does not
     * hold and the code generation must be redone with large branches.
     */
