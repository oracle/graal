 ...
 * questions.
 */
package jdk.compiler.graal.phases.common.inlining.walker;

import static jdk.compiler.graal.core.common.GraalOptions.Intrinsify;
import static jdk.compiler.graal.core.common.GraalOptions.MaximumRecursiveInlining;
import static jdk.compiler.graal.core.common.GraalOptions.MegamorphicInliningMinMethodProbability;
...
import jdk.compiler.graal.phases.common.inlining.info.AssumptionInlineInfo;
import jdk.compiler.graal.phases.common.inlining.info.ExactInlineInfo;
import jdk.compiler.graal.phases.common.inlining.info.InlineInfo;
import jdk.compiler.graal.phases.common.inlining.info.MultiTypeGuardInlineInfo;
import jdk.compiler.graal.phases.common.inlining.info.TypeGuardInlineInfo;
import jdk.compiler.graal.phases.common.inlining.info.elem.Inlineable;
import jdk.compiler.graal.phases.common.inlining.policy.InliningPolicy;
