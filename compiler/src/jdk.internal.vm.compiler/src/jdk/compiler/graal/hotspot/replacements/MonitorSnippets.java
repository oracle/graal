...
import static jdk.compiler.graal.hotspot.meta.HotSpotForeignCallDescriptor.Reexecutability.NOT_REEXECUTABLE;
import static jdk.compiler.graal.hotspot.meta.HotSpotForeignCallDescriptor.Transition.SAFEPOINT;
import static jdk.compiler.graal.hotspot.meta.HotSpotForeignCallDescriptor.Transition.STACK_INSPECTABLE_LEAF;
import static jdk.compiler.graal.hotspot.nodes.AcquiredCASLockNode.mark;
import static jdk.compiler.graal.hotspot.nodes.BeginLockScopeNode.beginLockScope;
import static jdk.compiler.graal.hotspot.nodes.EndLockScopeNode.endLockScope;
import static jdk.compiler.graal.hotspot.nodes.VMErrorNode.vmError;
import static jdk.compiler.graal.hotspot.replacements.HotSpotReplacementsUtil.DISPLACED_MARK_WORD_LOCATION;
import static jdk.compiler.graal.hotspot.replacements.HotSpotReplacementsUtil.JAVA_THREAD_HOLD_MONITOR_COUNT_LOCATION;
import static jdk.compiler.graal.hotspot.replacements.HotSpotReplacementsUtil.JAVA_THREAD_LOCK_STACK_LOCATION;
import static jdk.compiler.graal.hotspot.replacements.HotSpotReplacementsUtil.JAVA_THREAD_LOCK_STACK_TOP_LOCATION;
import static jdk.compiler.graal.hotspot.replacements.HotSpotReplacementsUtil.MARK_WORD_LOCATION;
import static jdk.compiler.graal.hotspot.replacements.HotSpotReplacementsUtil.OBJECT_MONITOR_CXQ_LOCATION;
import static jdk.compiler.graal.hotspot.replacements.HotSpotReplacementsUtil.OBJECT_MONITOR_ENTRY_LIST_LOCATION;
import static jdk.compiler.graal.hotspot.replacements.HotSpotReplacementsUtil.OBJECT_MONITOR_OWNER_LOCATION;
import static jdk.compiler.graal.hotspot.replacements.HotSpotReplacementsUtil.OBJECT_MONITOR_RECURSION_LOCATION;
import static jdk.compiler.graal.hotspot.replacements.HotSpotReplacementsUtil.OBJECT_MONITOR_SUCC_LOCATION;
import static jdk.compiler.graal.hotspot.replacements.HotSpotReplacementsUtil.isCAssertEnabled;
import static jdk.compiler.graal.hotspot.replacements.HotSpotReplacementsUtil.javaThreadLockStackEndOffset;
import static jdk.compiler.graal.hotspot.replacements.HotSpotReplacementsUtil.javaThreadLockStackTopOffset;
import static jdk.compiler.graal.hotspot.replacements.HotSpotReplacementsUtil.loadWordFromObject;
import static jdk.compiler.graal.hotspot.replacements.HotSpotReplacementsUtil.lockDisplacedMarkOffset;
...
import static jdk.compiler.graal.hotspot.replacements.HotSpotReplacementsUtil.monitorMask;
import static jdk.compiler.graal.hotspot.replacements.HotSpotReplacementsUtil.objectMonitorAnonymousOwner;
import static jdk.compiler.graal.hotspot.replacements.HotSpotReplacementsUtil.objectMonitorCxqOffset;
import static jdk.compiler.graal.hotspot.replacements.HotSpotReplacementsUtil.objectMonitorEntryListOffset;
import static jdk.compiler.graal.hotspot.replacements.HotSpotReplacementsUtil.objectMonitorOwnerOffset;
import static jdk.compiler.graal.hotspot.replacements.HotSpotReplacementsUtil.objectMonitorRecursionsOffset;
import static jdk.compiler.graal.hotspot.replacements.HotSpotReplacementsUtil.objectMonitorSuccOffset;
import static jdk.compiler.graal.hotspot.replacements.HotSpotReplacementsUtil.pageSize;
...
import static jdk.compiler.graal.hotspot.replacements.HotSpotReplacementsUtil.useLightweightLocking;
import static jdk.compiler.graal.hotspot.replacements.HotSpotReplacementsUtil.useStackLocking;
import static jdk.compiler.graal.hotspot.replacements.HotSpotReplacementsUtil.verifyOop;
import static jdk.compiler.graal.hotspot.replacements.HotSpotReplacementsUtil.wordSize;
import static jdk.compiler.graal.hotspot.replacements.HotspotSnippetsOptions.ProfileMonitors;
...
import jdk.compiler.graal.hotspot.nodes.CurrentLockNode;
import jdk.compiler.graal.hotspot.nodes.MonitorCounterNode;
