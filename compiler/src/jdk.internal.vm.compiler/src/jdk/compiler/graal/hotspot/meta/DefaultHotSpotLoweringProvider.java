...
import static jdk.compiler.graal.core.common.GraalOptions.AlwaysInlineVTableStubs;
import static jdk.compiler.graal.core.common.GraalOptions.InlineVTableStubs;
import static jdk.compiler.graal.core.common.GraalOptions.OmitHotExceptionStacktrace;
import static jdk.compiler.graal.hotspot.meta.HotSpotForeignCallsProviderImpl.OSR_MIGRATION_END;
...
import jdk.compiler.graal.hotspot.replacements.AssertionSnippets;
import jdk.compiler.graal.hotspot.replacements.ClassGetHubNode;
import jdk.compiler.graal.hotspot.replacements.DigestBaseSnippets;
import jdk.compiler.graal.hotspot.replacements.FastNotifyNode;
...
import jdk.compiler.graal.hotspot.replacements.HotSpotHashCodeSnippets;
import jdk.compiler.graal.hotspot.replacements.HotSpotIsArraySnippets;
import jdk.compiler.graal.hotspot.replacements.HotSpotReplacementsUtil;
import jdk.compiler.graal.hotspot.replacements.HotSpotSerialWriteBarrierSnippets;
import jdk.compiler.graal.hotspot.replacements.HubGetClassNode;
import jdk.compiler.graal.hotspot.replacements.InstanceOfSnippets;
import jdk.compiler.graal.hotspot.replacements.KlassLayoutHelperNode;
import jdk.compiler.graal.hotspot.replacements.LoadExceptionObjectSnippets;
import jdk.compiler.graal.hotspot.replacements.LogSnippets;
import jdk.compiler.graal.hotspot.replacements.MonitorSnippets;
import jdk.compiler.graal.hotspot.replacements.ObjectCloneSnippets;
import jdk.compiler.graal.hotspot.replacements.ObjectSnippets;
import jdk.compiler.graal.hotspot.replacements.RegisterFinalizerSnippets;
import jdk.compiler.graal.hotspot.replacements.StringToBytesSnippets;
import jdk.compiler.graal.hotspot.replacements.UnsafeCopyMemoryNode;
import jdk.compiler.graal.hotspot.replacements.UnsafeSnippets;
import jdk.compiler.graal.hotspot.replacements.VirtualThreadUpdateJFRSnippets;
import jdk.compiler.graal.hotspot.GraalHotSpotVMConfig;
import jdk.compiler.graal.hotspot.HotSpotGraalRuntimeProvider;
import jdk.compiler.graal.hotspot.nodes.BeginLockScopeNode;
...
import jdk.compiler.graal.hotspot.nodes.VMErrorNode;
...
import jdk.compiler.graal.hotspot.stubs.ForeignCallSnippets;
...
import jdk.compiler.graal.nodes.debug.VerifyHeapNode;
...
import jdk.compiler.graal.nodes.extended.OSRLocalNode;
import jdk.compiler.graal.nodes.extended.OSRLockNode;
import jdk.compiler.graal.nodes.extended.OSRMonitorEnterNode;
import jdk.compiler.graal.nodes.extended.OSRStartNode;
...
import jdk.compiler.graal.replacements.IsArraySnippets;
...
import jdk.compiler.graal.replacements.arraycopy.ArrayCopyWithDelayedLoweringNode;
