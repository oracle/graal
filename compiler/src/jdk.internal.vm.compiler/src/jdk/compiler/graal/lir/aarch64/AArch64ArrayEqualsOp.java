...
import static jdk.compiler.graal.asm.aarch64.AArch64ASIMDAssembler.ASIMDInstruction.LD2_MULTIPLE_2R;
import static jdk.compiler.graal.asm.aarch64.AArch64ASIMDAssembler.ASIMDInstruction.LD4_MULTIPLE_4R;
import static jdk.compiler.graal.asm.aarch64.AArch64ASIMDAssembler.ASIMDSize.FullReg;
import static jdk.compiler.graal.asm.aarch64.AArch64ASIMDAssembler.ElementSize.fromStride;
...
import static jdk.compiler.graal.asm.aarch64.AArch64Address.createPairBaseRegisterOnlyAddress;
import static jdk.compiler.graal.asm.aarch64.AArch64Address.createStructureImmediatePostIndexAddress;
import static jdk.compiler.graal.asm.aarch64.AArch64Address.createStructureNoOffsetAddress;
