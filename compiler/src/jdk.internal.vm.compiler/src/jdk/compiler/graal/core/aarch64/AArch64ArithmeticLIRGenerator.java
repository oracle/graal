...
import static jdk.compiler.graal.lir.aarch64.AArch64BitManipulationOp.BitManipulationOpCode.BSR;
import static jdk.compiler.graal.lir.aarch64.AArch64BitManipulationOp.BitManipulationOpCode.CLZ;
import static jdk.compiler.graal.lir.aarch64.AArch64BitManipulationOp.BitManipulationOpCode.CTZ;
import static jdk.compiler.graal.lir.aarch64.AArch64BitManipulationOp.BitManipulationOpCode.POPCNT;
...
import jdk.compiler.graal.lir.aarch64.AArch64BitManipulationOp;
import jdk.compiler.graal.lir.aarch64.AArch64BitSwapOp;
import jdk.compiler.graal.lir.aarch64.AArch64Convert;
import jdk.compiler.graal.lir.aarch64.AArch64FloatToHalfFloatOp;
import jdk.compiler.graal.lir.aarch64.AArch64HalfFloatToFloatOp;
import jdk.compiler.graal.lir.aarch64.AArch64MathCopySignOp;
import jdk.compiler.graal.lir.aarch64.AArch64MathSignumOp;
import jdk.compiler.graal.lir.aarch64.AArch64Move;
import jdk.compiler.graal.lir.aarch64.AArch64Move.LoadOp;
import jdk.compiler.graal.lir.aarch64.AArch64Move.StoreOp;
import jdk.compiler.graal.lir.aarch64.AArch64Move.StoreZeroOp;
import jdk.compiler.graal.lir.aarch64.AArch64NormalizedUnsignedCompareOp;
import jdk.compiler.graal.lir.aarch64.AArch64ReinterpretOp;
import jdk.compiler.graal.lir.aarch64.AArch64RoundFloatToIntegerOp;
    ...
    public Value emitRem(Value a, Value b, LIRFrameState state) {
        if (isNumericInteger(a.getPlatformKind())) {
            ...
            switch ((AArch64Kind) a.getPlatformKind()) {
                case SINGLE:
                    ForeignCallLinkage fremCall = getLIRGen().getForeignCalls().lookupForeignCall(Backend.ARITHMETIC_FREM);
                    return getLIRGen().emitForeignCall(fremCall, state, a, b);
                case DOUBLE:
                    ForeignCallLinkage dremCall = getLIRGen().getForeignCalls().lookupForeignCall(Backend.ARITHMETIC_DREM);
