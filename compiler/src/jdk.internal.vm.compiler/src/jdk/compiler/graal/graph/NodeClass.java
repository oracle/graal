...
import static jdk.compiler.graal.core.common.Fields.translateInto;
...
import static jdk.compiler.graal.graph.Edges.translateInto;
import static jdk.compiler.graal.graph.InputEdges.translateInto;
import static jdk.compiler.graal.graph.Node.WithAllEdges;
...
import jdk.compiler.graal.graph.spi.BinaryCommutativeMarker;
import jdk.compiler.graal.graph.spi.CanonicalizableMarker;
import jdk.compiler.graal.graph.spi.NodeWithIdentity;
import jdk.compiler.graal.graph.spi.SimplifiableMarker;
...
import jdk.compiler.graal.graph.Node.EdgeVisitor;
import jdk.compiler.graal.graph.Node.Input;
import jdk.compiler.graal.graph.Node.OptionalInput;
import jdk.compiler.graal.graph.Node.Successor;
