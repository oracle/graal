...
public final class AArch64SHA1Op extends AArch64LIRInstruction {
    ...
    public void emitCode(CompilationResultBuilder crb, AArch64MacroAssembler masm) {
        ...
        try (ScratchRegister scratchReg = masm.getScratchRegister()) {
            ...
            masm.neon.ld4rVVVV(FullReg, ElementSize.Word, v0, v1, v2, v3, AArch64Address.createBaseRegisterOnlyAddress(128, rscratch1));
        }

        // load 5 words state into v6, v7
        masm.fldr(128, v6, AArch64Address.createImmediateAddress(128, AArch64Address.AddressingMode.IMMEDIATE_SIGNED_UNSCALED, state, 0));
        masm.fldr(32, v7, AArch64Address.createImmediateAddress(32, AArch64Address.AddressingMode.IMMEDIATE_SIGNED_UNSCALED, state, 16));

        Label sha1Loop = new Label();
        masm.bind(sha1Loop);
        ...
        masm.neon.ld1MultipleVVVV(FullReg, ElementSize.Word, v16, v17, v18, v19,
                        multiBlock ? AArch64Address.createStructureImmediatePostIndexAddress(LD1_MULTIPLE_4R, FullReg, ElementSize.Word, buf, 64)
                                        : AArch64Address.createBaseRegisterOnlyAddress(128, buf));
        ...
        for (int round = 0; round < 20; round++) {
            Register tmp1 = (round % 2 != 0) ? v4 : v5;
            Register tmp2 = (round % 2 != 0) ? v21 : v22;
            Register tmp3 = (round != 0) ? ((round % 2 != 0) ? v22 : v21) : v7;
            Register tmp4 = (round % 2 != 0) ? v5 : v4;
        ...
        if (multiBlock) {
            ...
            masm.branchConditionally(ConditionFlag.LE, sha1Loop);
            masm.mov(64, asRegister(resultValue), ofs); // return ofs
        }

        masm.fstr(128, v6, AArch64Address.createImmediateAddress(128, AArch64Address.AddressingMode.IMMEDIATE_SIGNED_UNSCALED, state, 0));
        masm.fstr(32, v7, AArch64Address.createImmediateAddress(32, AArch64Address.AddressingMode.IMMEDIATE_SIGNED_UNSCALED, state, 16));
    }
