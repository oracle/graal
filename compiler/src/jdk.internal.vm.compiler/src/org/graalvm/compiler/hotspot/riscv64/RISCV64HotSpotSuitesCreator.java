...
public class RISCV64HotSpotSuitesCreator extends DefaultSuitesCreator {

    public RISCV64HotSpotSuitesCreator(CompilerConfiguration compilerConfiguration, Plugins plugins) {
