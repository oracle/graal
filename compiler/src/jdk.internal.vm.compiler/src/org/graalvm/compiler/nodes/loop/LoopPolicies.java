...
public interface LoopPolicies {
    ...
    class Options {
        ...
        @Option(help = "Peel only the loop with the specific loop begin node ID for debugging purposes", type = OptionType.Debug) public static final OptionKey<Integer> PeelOnlyLoopWithNodeID = new OptionKey<>(-1);
    }
