...
/**
 * Represents a program argument that can parse its value from one or more argument strings.
 */
public abstract class Argument {
     ...
     */
    public abstract int parse(String[] args, int offset) throws InvalidArgumentException, MissingArgumentException, HelpRequestedException;

    public abstract void printUsage(HelpPrinter help);
