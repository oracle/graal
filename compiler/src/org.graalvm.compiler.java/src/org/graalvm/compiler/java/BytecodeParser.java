...
public class BytecodeParser extends CoreProvidersDelegate implements GraphBuilderContext {
    ...
    protected Invoke appendInvoke(InvokeKind initialInvokeKind, ResolvedJavaMethod initialTargetMethod, ValueNode[] args, ResolvedJavaType referencedType) {
        ...
        graph.notifyInliningDecision(invoke, false, "GraphBuilderPhase", null, null, null, "bytecode parser did not replace invoke");
                ...
                if (field instanceof ResolvedJavaField) {
                    ...
                    try (DebugCloseable context = openNodeContext(targetMethod, 1)) {
                        ...
                        if (TraceInlining.getValue(options) || debug.hasCompilationListener()) {
                            ...
                            graph.notifyInliningDecision(invoke, true, "GraphBuilderPhase", null, null, null, reason);
                        }
            ...
            if (intrinsic != null && intrinsic.isCallToOriginal(targetMethod)) {
                if (intrinsic.getOriginalMethod().isNative()) {
                    ...
                    if (logInliningDecision) {
                        graph.notifyInliningDecision(logInliningInvokable, false, "GraphBuilderPhase", null, null, null, "native method");
                    }
                    return false;
                }
                if (canInlinePartialIntrinsicExit()) {
                    ...
                    if (logInliningDecision) {
                        graph.notifyInliningDecision(logInliningInvokable, true, "GraphBuilderPhase", null, null, null, "partial intrinsic exit");
                    }
                    ...
                    if (logInliningDecision) {
                        graph.notifyInliningDecision(logInliningInvokable, false, "GraphBuilderPhase", null, null, null, "partial intrinsic exit");
                    }
                    return false;
                }
            } else {
                ...
                if (inlinedMethod.hasBytecodes()) {
                    ...
                    if (logInliningDecision) {
                        graph.notifyInliningDecision(logInliningInvokable, true, "GraphBuilderPhase", null, null, null, "inline method");
                    }
                    ...
                    if (logInliningDecision) {
                        graph.notifyInliningDecision(logInliningInvokable, false, "GraphBuilderPhase", null, null, null, "no bytecodes (abstract or native)");
                    }
                    return false;
                }
            }
