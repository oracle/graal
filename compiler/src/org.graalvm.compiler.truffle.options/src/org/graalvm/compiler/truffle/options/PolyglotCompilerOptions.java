...
public final class PolyglotCompilerOptions {
    ...
    @Option(help = "Stop partial evaluation when the graph exceeded this size (default: 400000).", usageSyntax = "[1, inf)", category = OptionCategory.INTERNAL) //
    public static final OptionKey<Integer> MaximumGraalGraphSize = new OptionKey<>(400_000);
