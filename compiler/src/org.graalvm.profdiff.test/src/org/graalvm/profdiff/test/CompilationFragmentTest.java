...
public class CompilationFragmentTest {
    ...
    public void compilationFragmentTreeCreation() throws ExperimentParserError {
        ...
        Optimization fo3 = new Optimization("Optimization3", "", EconomicMap.of("b()", 2), null);
        Optimization fo4 = new Optimization("Optimization4", "", EconomicMap.of("d()", 1, "b()", 3), null);
        Optimization fo9 = new Optimization("Optimization9", "", EconomicMap.of("z()", 6, "b()", 4), null);
