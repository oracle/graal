...
public class CompilationUnitTest {
    private static class MockCompilationUnit {
        ...
        MockCompilationUnit() {
            ...
            InliningTreeNode inliningTreeRoot = new InliningTreeNode("root", 0, true, null, null);
            InliningTreeNode method1 = new InliningTreeNode("method1", 1, true, null, null);
            InliningTreeNode method2 = new InliningTreeNode("method1", 2, true, null, null);
            InliningTreeNode method3 = new InliningTreeNode("method2", 2, true, null, null);
            InliningTreeNode method3First = new InliningTreeNode("method", 1, true, null, null);
            InliningTreeNode method3Second = new InliningTreeNode("method", 2, true, null, null);
            method3.addChild(method3Second);
            method3.addChild(method3First);
            InliningTreeNode method4 = new InliningTreeNode("method1", 3, true, null, null);
            InliningTreeNode method5 = new InliningTreeNode("method2", 3, false, null, null);
            InliningTreeNode method6 = new InliningTreeNode("method2", 3, true, null, null);
