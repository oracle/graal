...
final class ExpansionStatistics {
    ...
    void onShutdown() {
        ...
        for (Entry<CompilationTier, Map<ResolvedJavaMethod, Stats>> statsEntry : this.methodExpansionStatistics.entrySet()) {
            printHistogram(ast, statsEntry.getKey(), statsEntry.getValue(), ExpansionStatistics::formatQualifiedMethod, null, null, null, "Method");
        }
        for (Entry<CompilationTier, Map<NodeClassKey, Stats>> statsEntry : this.nodeExpansionStatistics.entrySet()) {
    ...
    private synchronized <T> void combineExpansionStatistics(CompilationTier tier, Map<CompilationTier, Map<T, Stats>> stats,
    ...
    final class TreeNode {
        ...
        private boolean isSpecializationMethod(ResolvedJavaMethod method, ConcurrentHashMap<ResolvedJavaMethod, Boolean> cache) {
            /*
