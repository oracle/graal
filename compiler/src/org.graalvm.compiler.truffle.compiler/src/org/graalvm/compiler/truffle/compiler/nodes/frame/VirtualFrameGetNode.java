...
public final class VirtualFrameGetNode extends VirtualFrameAccessorNode implements Virtualizable {
    ...
    public VirtualFrameGetNode(Receiver frame, int frameSlotIndex, JavaKind accessKind, int accessTag, VirtualFrameAccessType type, boolean useStatic) {
    ...
    public void virtualize(VirtualizerTool tool) {
        ...
        if (type == VirtualFrameAccessType.Auxiliary) {
            ...
            if (frameSlotIndex < tagVirtual.entryCount() && frameSlotIndex < dataVirtual.entryCount()) {
                ...
                if (!useStatic && (!actualTag.isConstant() || actualTag.asJavaConstant().asInt() != accessTag)) {
                    /*
