...
import static jdk.compiler.graal.asm.amd64.AMD64Assembler.AMD64BinaryArithmetic.ADC;
...
import static jdk.compiler.graal.asm.amd64.AMD64Assembler.AMD64BinaryArithmetic.SBB;
...
import static jdk.compiler.graal.asm.amd64.AMD64Assembler.AMD64MOp.DEC;
import static jdk.compiler.graal.asm.amd64.AMD64Assembler.AMD64MOp.INC;
...
import static jdk.compiler.graal.asm.amd64.AMD64Assembler.AMD64RMIOp.SHA1RNDS4;
import static jdk.compiler.graal.asm.amd64.AMD64Assembler.AMD64RMOp.ADCX;
import static jdk.compiler.graal.asm.amd64.AMD64Assembler.AMD64RMOp.ADOX;
import static jdk.compiler.graal.asm.amd64.AMD64Assembler.AMD64RMOp.IMUL;
import static jdk.compiler.graal.asm.amd64.AMD64Assembler.AMD64RMOp.SHA1MSG1;
import static jdk.compiler.graal.asm.amd64.AMD64Assembler.AMD64RMOp.SHA1MSG2;
import static jdk.compiler.graal.asm.amd64.AMD64Assembler.AMD64RMOp.SHA1NEXTE;
import static jdk.compiler.graal.asm.amd64.AMD64Assembler.AMD64RMOp.SHA256MSG1;
import static jdk.compiler.graal.asm.amd64.AMD64Assembler.AMD64RMOp.SHA256MSG2;
import static jdk.compiler.graal.asm.amd64.AMD64Assembler.AMD64RMOp.SHA256RNDS2;
import static jdk.compiler.graal.asm.amd64.AMD64Assembler.AMD64Shift.RCL;
import static jdk.compiler.graal.asm.amd64.AMD64Assembler.AMD64Shift.RCR;
...
import static jdk.compiler.graal.asm.amd64.AMD64Assembler.VexGeneralPurposeRVMOp.MULX;
import static jdk.compiler.graal.asm.amd64.AMD64Assembler.VexMRIOp.VCVTPS2PH;
import static jdk.compiler.graal.asm.amd64.AMD64Assembler.VexRMIOp.RORXL;
import static jdk.compiler.graal.asm.amd64.AMD64Assembler.VexRMIOp.RORXQ;
import static jdk.compiler.graal.asm.amd64.AMD64Assembler.VexRMOp.VCVTPH2PS;
import static jdk.compiler.graal.asm.amd64.AMD64Assembler.VexRVMIOp.VGF2P8AFFINEQB;
import static jdk.compiler.graal.core.common.NumUtil.isByte;
import static jdk.compiler.graal.core.common.NumUtil.isInt;
import static jdk.compiler.graal.core.common.NumUtil.isShiftCount;
import static jdk.compiler.graal.core.common.NumUtil.isUByte;
...
public class AMD64Assembler extends AMD64BaseAssembler {
     ...
     * {@code dst}. In {@link jdk.compiler.graal.lir.amd64.vector.AMD64VectorUnary.AVXConvertOp}, we
    ...
    public static class VexRMOp extends VexRROp {
        ...
        public static final VexRMOp VBROADCASTSS    = new VexRMOp("VBROADCASTSS",    VEXPrefixConfig.P_66, VEXPrefixConfig.M_0F38, VEXPrefixConfig.W0,  0x18, VEXOpAssertion.AVX1_AVX512F_VL,           EVEXTuple.FVM,       VEXPrefixConfig.W0);
        public static final VexRMOp VBROADCASTSD    = new VexRMOp("VBROADCASTSD",    VEXPrefixConfig.P_66, VEXPrefixConfig.M_0F38, VEXPrefixConfig.W0,  0x19, VEXOpAssertion.AVX1_256ONLY_AVX512F_VL,   EVEXTuple.FVM,       VEXPrefixConfig.W1);
        ...
        public static final VexRMOp VPBROADCASTB    = new VexRMOp("VPBROADCASTB",    VEXPrefixConfig.P_66, VEXPrefixConfig.M_0F38, VEXPrefixConfig.W0,  0x78, VEXOpAssertion.AVX2_AVX512BW_VL,          EVEXTuple.FVM,       VEXPrefixConfig.W0);
        public static final VexRMOp VPBROADCASTW    = new VexRMOp("VPBROADCASTW",    VEXPrefixConfig.P_66, VEXPrefixConfig.M_0F38, VEXPrefixConfig.W0,  0x79, VEXOpAssertion.AVX2_AVX512BW_VL,          EVEXTuple.FVM,       VEXPrefixConfig.W0);
        public static final VexRMOp VPBROADCASTD    = new VexRMOp("VPBROADCASTD",    VEXPrefixConfig.P_66, VEXPrefixConfig.M_0F38, VEXPrefixConfig.W0,  0x58, VEXOpAssertion.AVX2_AVX512F_VL,           EVEXTuple.FVM,       VEXPrefixConfig.W0);
        public static final VexRMOp VPBROADCASTQ    = new VexRMOp("VPBROADCASTQ",    VEXPrefixConfig.P_66, VEXPrefixConfig.M_0F38, VEXPrefixConfig.W0,  0x59, VEXOpAssertion.AVX2_AVX512F_VL,           EVEXTuple.FVM,       VEXPrefixConfig.W1);
    ...
    public static final class EvexGatherOp extends VexOp {
        ...
        public void emit(AMD64Assembler asm, AVXKind.AVXSize size, Register dst, AMD64Address address, Register mask, int z, int b) {
            ...
            assert size == AVXKind.AVXSize.XMM || size == AVXKind.AVXSize.YMM || size == AVXKind.AVXSize.ZMM;
