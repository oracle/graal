...
public final class AArch64Address extends AbstractAddress {
    ...
    public enum AddressingMode {
         ...
         * used. See
         * {@link #determineStructureImmediateValue(AArch64ASIMDAssembler.ASIMDInstruction, AArch64ASIMDAssembler.ASIMDSize, AArch64ASIMDAssembler.ElementSize)}
         * for more details.
         */
     ...
     * {@link #determineStructureImmediateValue(AArch64ASIMDAssembler.ASIMDInstruction, AArch64ASIMDAssembler.ASIMDSize, AArch64ASIMDAssembler.ElementSize)}
     * for what the expected value is.
     */
    public static AArch64Address createStructureImmediatePostIndexAddress(AArch64ASIMDAssembler.ASIMDInstruction instruction, AArch64ASIMDAssembler.ASIMDSize size,
                    AArch64ASIMDAssembler.ElementSize eSize, Register base, int immediate) {
