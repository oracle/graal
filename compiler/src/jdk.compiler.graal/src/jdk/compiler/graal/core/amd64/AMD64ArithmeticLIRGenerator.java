...
import static jdk.compiler.graal.asm.amd64.AMD64Assembler.AMD64BinaryArithmetic.ADD;
import static jdk.compiler.graal.asm.amd64.AMD64Assembler.AMD64BinaryArithmetic.AND;
import static jdk.compiler.graal.asm.amd64.AMD64Assembler.AMD64BinaryArithmetic.CMP;
import static jdk.compiler.graal.asm.amd64.AMD64Assembler.AMD64BinaryArithmetic.OR;
import static jdk.compiler.graal.asm.amd64.AMD64Assembler.AMD64BinaryArithmetic.SUB;
import static jdk.compiler.graal.asm.amd64.AMD64Assembler.AMD64BinaryArithmetic.XOR;
import static jdk.compiler.graal.asm.amd64.AMD64Assembler.AMD64MOp.NEG;
import static jdk.compiler.graal.asm.amd64.AMD64Assembler.AMD64MOp.NOT;
import static jdk.compiler.graal.asm.amd64.AMD64Assembler.AMD64RMOp.BSF;
import static jdk.compiler.graal.asm.amd64.AMD64Assembler.AMD64RMOp.BSR;
import static jdk.compiler.graal.asm.amd64.AMD64Assembler.AMD64RMOp.LZCNT;
import static jdk.compiler.graal.asm.amd64.AMD64Assembler.AMD64RMOp.MOV;
import static jdk.compiler.graal.asm.amd64.AMD64Assembler.AMD64RMOp.MOVSX;
import static jdk.compiler.graal.asm.amd64.AMD64Assembler.AMD64RMOp.MOVSXB;
import static jdk.compiler.graal.asm.amd64.AMD64Assembler.AMD64RMOp.MOVSXD;
import static jdk.compiler.graal.asm.amd64.AMD64Assembler.AMD64RMOp.MOVZX;
import static jdk.compiler.graal.asm.amd64.AMD64Assembler.AMD64RMOp.MOVZXB;
import static jdk.compiler.graal.asm.amd64.AMD64Assembler.AMD64RMOp.POPCNT;
import static jdk.compiler.graal.asm.amd64.AMD64Assembler.AMD64RMOp.TEST;
import static jdk.compiler.graal.asm.amd64.AMD64Assembler.AMD64RMOp.TESTB;
import static jdk.compiler.graal.asm.amd64.AMD64Assembler.AMD64RMOp.TZCNT;
import static jdk.compiler.graal.asm.amd64.AMD64Assembler.AMD64Shift.ROL;
import static jdk.compiler.graal.asm.amd64.AMD64Assembler.AMD64Shift.ROR;
import static jdk.compiler.graal.asm.amd64.AMD64Assembler.AMD64Shift.SAR;
import static jdk.compiler.graal.asm.amd64.AMD64Assembler.AMD64Shift.SHL;
import static jdk.compiler.graal.asm.amd64.AMD64Assembler.AMD64Shift.SHR;
import static jdk.compiler.graal.asm.amd64.AMD64Assembler.SSEOp.MOVSD;
import static jdk.compiler.graal.asm.amd64.AMD64Assembler.SSEOp.MOVSS;
import static jdk.compiler.graal.asm.amd64.AMD64Assembler.VexRVMOp.VADDSD;
import static jdk.compiler.graal.asm.amd64.AMD64Assembler.VexRVMOp.VADDSS;
import static jdk.compiler.graal.asm.amd64.AMD64Assembler.VexRVMOp.VDIVSD;
import static jdk.compiler.graal.asm.amd64.AMD64Assembler.VexRVMOp.VDIVSS;
import static jdk.compiler.graal.asm.amd64.AMD64Assembler.VexRVMOp.VFMADD231SD;
import static jdk.compiler.graal.asm.amd64.AMD64Assembler.VexRVMOp.VFMADD231SS;
import static jdk.compiler.graal.asm.amd64.AMD64Assembler.VexRVMOp.VMULSD;
import static jdk.compiler.graal.asm.amd64.AMD64Assembler.VexRVMOp.VMULSS;
import static jdk.compiler.graal.asm.amd64.AMD64Assembler.VexRVMOp.VORPD;
import static jdk.compiler.graal.asm.amd64.AMD64Assembler.VexRVMOp.VORPS;
import static jdk.compiler.graal.asm.amd64.AMD64Assembler.VexRVMOp.VSUBSD;
import static jdk.compiler.graal.asm.amd64.AMD64Assembler.VexRVMOp.VSUBSS;
...
import static jdk.compiler.graal.asm.amd64.AMD64Assembler.VexRVMROp.VBLENDVPD;
import static jdk.compiler.graal.asm.amd64.AMD64Assembler.VexRVMROp.VBLENDVPS;
import static jdk.compiler.graal.asm.amd64.AMD64Assembler.VexRVMROp.VPBLENDVB;
import static jdk.compiler.graal.asm.amd64.AMD64BaseAssembler.OperandSize.BYTE;
...
import static jdk.compiler.graal.asm.amd64.AMD64BaseAssembler.OperandSize.SD;
import static jdk.compiler.graal.asm.amd64.AMD64BaseAssembler.OperandSize.SS;
import static jdk.compiler.graal.asm.amd64.AMD64BaseAssembler.OperandSize.WORD;
import static jdk.compiler.graal.lir.LIRValueUtil.asConstantValue;
...
import static jdk.compiler.graal.lir.amd64.AMD64Arithmetic.DREM;
import static jdk.compiler.graal.lir.amd64.AMD64Arithmetic.FREM;
import static jdk.compiler.graal.lir.amd64.vector.AMD64VectorUnary.FloatPointClassTestOp.NEG_INF;
import static jdk.compiler.graal.lir.amd64.vector.AMD64VectorUnary.FloatPointClassTestOp.POS_INF;

import jdk.compiler.graal.asm.amd64.AMD64Assembler.AMD64BinaryArithmetic;
...
import jdk.compiler.graal.asm.amd64.AMD64Assembler.AMD64RMIOp;
import jdk.compiler.graal.asm.amd64.AMD64Assembler.AMD64RMOp;
import jdk.compiler.graal.asm.amd64.AMD64Assembler.AMD64Shift;
import jdk.compiler.graal.asm.amd64.AMD64Assembler.SSEMROp;
import jdk.compiler.graal.asm.amd64.AMD64Assembler.SSEOp;
import jdk.compiler.graal.asm.amd64.AMD64Assembler.VexFloatCompareOp;
import jdk.compiler.graal.asm.amd64.AMD64Assembler.VexGeneralPurposeRMOp;
import jdk.compiler.graal.asm.amd64.AMD64Assembler.VexGeneralPurposeRVMOp;
import jdk.compiler.graal.asm.amd64.AMD64Assembler.VexRVMOp;
import jdk.compiler.graal.asm.amd64.AMD64Assembler.VexRVMROp;
...
import jdk.compiler.graal.lir.amd64.AMD64Arithmetic.FPDivRemOp;
import jdk.compiler.graal.lir.amd64.AMD64ArithmeticLIRGeneratorTool;
import jdk.compiler.graal.lir.amd64.AMD64Binary;
import jdk.compiler.graal.lir.amd64.AMD64BinaryConsumer;
import jdk.compiler.graal.lir.amd64.AMD64BitSwapOp;
import jdk.compiler.graal.lir.amd64.AMD64ClearRegisterOp;
import jdk.compiler.graal.lir.amd64.AMD64FloatToHalfFloatOp;
import jdk.compiler.graal.lir.amd64.AMD64HalfFloatToFloatOp;
import jdk.compiler.graal.lir.amd64.AMD64MathCopySignOp;
import jdk.compiler.graal.lir.amd64.AMD64MathCosOp;
import jdk.compiler.graal.lir.amd64.AMD64MathExpOp;
import jdk.compiler.graal.lir.amd64.AMD64MathLog10Op;
import jdk.compiler.graal.lir.amd64.AMD64MathLogOp;
import jdk.compiler.graal.lir.amd64.AMD64MathPowOp;
import jdk.compiler.graal.lir.amd64.AMD64MathSignumOp;
import jdk.compiler.graal.lir.amd64.AMD64MathSinOp;
import jdk.compiler.graal.lir.amd64.AMD64MathTanOp;
import jdk.compiler.graal.lir.amd64.AMD64Move;
import jdk.compiler.graal.lir.amd64.AMD64MulDivOp;
import jdk.compiler.graal.lir.amd64.AMD64NormalizedUnsignedCompareOp;
import jdk.compiler.graal.lir.amd64.AMD64RoundFloatToIntegerOp;
import jdk.compiler.graal.lir.amd64.AMD64ShiftOp;
import jdk.compiler.graal.lir.amd64.AMD64SignExtendOp;
import jdk.compiler.graal.lir.amd64.AMD64Ternary;
import jdk.compiler.graal.lir.amd64.AMD64Unary;
import jdk.compiler.graal.lir.amd64.vector.AMD64VectorBinary;
import jdk.compiler.graal.lir.amd64.vector.AMD64VectorBinary.AVXBinaryConstFloatOp;
import jdk.compiler.graal.lir.amd64.vector.AMD64VectorBinary.AVXBinaryOp;
import jdk.compiler.graal.lir.amd64.vector.AMD64VectorBlend;
import jdk.compiler.graal.lir.amd64.vector.AMD64VectorFloatCompareOp;
import jdk.compiler.graal.lir.amd64.vector.AMD64VectorUnary;
import jdk.compiler.graal.lir.gen.ArithmeticLIRGenerator;
