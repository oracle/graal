...
import static jdk.compiler.graal.asm.amd64.AMD64MacroAssembler.ExtendMode.ZERO_EXTEND;
...
import static jdk.compiler.graal.lir.LIRValueUtil.isIntConstant;
...
import jdk.compiler.graal.lir.amd64.AMD64AESDecryptOp;
import jdk.compiler.graal.lir.amd64.AMD64AESEncryptOp;
import jdk.compiler.graal.lir.amd64.AMD64AddressValue;
import jdk.compiler.graal.lir.amd64.AMD64ArithmeticLIRGeneratorTool;
import jdk.compiler.graal.lir.amd64.AMD64ArrayCompareToOp;
import jdk.compiler.graal.lir.amd64.AMD64ArrayCopyWithConversionsOp;
import jdk.compiler.graal.lir.amd64.AMD64ArrayEqualsOp;
import jdk.compiler.graal.lir.amd64.AMD64ArrayIndexOfOp;
import jdk.compiler.graal.lir.amd64.AMD64ArrayRegionCompareToOp;
import jdk.compiler.graal.lir.amd64.AMD64BigIntegerMulAddOp;
import jdk.compiler.graal.lir.amd64.AMD64BigIntegerMultiplyToLenOp;
import jdk.compiler.graal.lir.amd64.AMD64BigIntegerSquareToLenOp;
import jdk.compiler.graal.lir.amd64.AMD64Binary;
import jdk.compiler.graal.lir.amd64.AMD64BinaryConsumer;
import jdk.compiler.graal.lir.amd64.AMD64ByteSwapOp;
import jdk.compiler.graal.lir.amd64.AMD64CacheWritebackOp;
import jdk.compiler.graal.lir.amd64.AMD64CacheWritebackPostSyncOp;
import jdk.compiler.graal.lir.amd64.AMD64CalcStringAttributesOp;
import jdk.compiler.graal.lir.amd64.AMD64Call;
import jdk.compiler.graal.lir.amd64.AMD64CipherBlockChainingAESDecryptOp;
import jdk.compiler.graal.lir.amd64.AMD64CipherBlockChainingAESEncryptOp;
import jdk.compiler.graal.lir.amd64.AMD64ControlFlow;
import jdk.compiler.graal.lir.amd64.AMD64ControlFlow.BranchOp;
import jdk.compiler.graal.lir.amd64.AMD64ControlFlow.CmpBranchOp;
import jdk.compiler.graal.lir.amd64.AMD64ControlFlow.CmpConstBranchOp;
import jdk.compiler.graal.lir.amd64.AMD64ControlFlow.CmpDataBranchOp;
import jdk.compiler.graal.lir.amd64.AMD64ControlFlow.CondMoveOp;
import jdk.compiler.graal.lir.amd64.AMD64ControlFlow.CondSetOp;
import jdk.compiler.graal.lir.amd64.AMD64ControlFlow.FloatBranchOp;
import jdk.compiler.graal.lir.amd64.AMD64ControlFlow.FloatCondMoveOp;
import jdk.compiler.graal.lir.amd64.AMD64ControlFlow.FloatCondSetOp;
import jdk.compiler.graal.lir.amd64.AMD64ControlFlow.HashTableSwitchOp;
import jdk.compiler.graal.lir.amd64.AMD64ControlFlow.RangeTableSwitchOp;
import jdk.compiler.graal.lir.amd64.AMD64ControlFlow.StrategySwitchOp;
import jdk.compiler.graal.lir.amd64.AMD64ControlFlow.TestBranchOp;
import jdk.compiler.graal.lir.amd64.AMD64ControlFlow.TestByteBranchOp;
import jdk.compiler.graal.lir.amd64.AMD64ControlFlow.TestConstBranchOp;
import jdk.compiler.graal.lir.amd64.AMD64CountPositivesOp;
import jdk.compiler.graal.lir.amd64.AMD64CounterModeAESCryptOp;
import jdk.compiler.graal.lir.amd64.AMD64EncodeArrayOp;
import jdk.compiler.graal.lir.amd64.AMD64GHASHProcessBlocksOp;
import jdk.compiler.graal.lir.amd64.AMD64HaltOp;
import jdk.compiler.graal.lir.amd64.AMD64LFenceOp;
import jdk.compiler.graal.lir.amd64.AMD64MD5Op;
import jdk.compiler.graal.lir.amd64.AMD64Move;
import jdk.compiler.graal.lir.amd64.AMD64Move.CompareAndSwapOp;
import jdk.compiler.graal.lir.amd64.AMD64Move.MembarOp;
import jdk.compiler.graal.lir.amd64.AMD64Move.StackLeaOp;
import jdk.compiler.graal.lir.amd64.AMD64PauseOp;
import jdk.compiler.graal.lir.amd64.AMD64SHA1Op;
import jdk.compiler.graal.lir.amd64.AMD64SHA256AVX2Op;
import jdk.compiler.graal.lir.amd64.AMD64SHA256Op;
import jdk.compiler.graal.lir.amd64.AMD64SHA512Op;
import jdk.compiler.graal.lir.amd64.AMD64StringLatin1InflateOp;
import jdk.compiler.graal.lir.amd64.AMD64StringUTF16CompressOp;
import jdk.compiler.graal.lir.amd64.AMD64VectorizedHashCodeOp;
import jdk.compiler.graal.lir.amd64.AMD64VectorizedMismatchOp;
import jdk.compiler.graal.lir.amd64.AMD64ZapRegistersOp;
import jdk.compiler.graal.lir.amd64.AMD64ZapStackOp;
import jdk.compiler.graal.lir.amd64.AMD64ZeroMemoryOp;
import jdk.compiler.graal.lir.amd64.vector.AMD64VectorCompareOp;
