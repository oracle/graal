 ...
 * questions.
 */
package jdk.compiler.graal.core.match;

import static jdk.compiler.graal.debug.DebugOptions.LogVerbose;
...
import jdk.compiler.graal.core.gen.NodeMatchRules;
...
public class MatchRuleRegistry {
    ...
    /**
     * Convert a list of field names into {@link Position} objects that can be used to read them
     * during a match. The names should already have been confirmed to exist in the type.
     *
     * @param nodeClass
     * @param names
