 ...
 * {@link jdk.compiler.graal.graphio.GraphOutput} specialized for your data is a matter of
 * implementing a single interface:
 *
 * {@link jdk.compiler.graal.graphio.GraphJavadocSnippets#acmeGraphStructure}
 *
 * The {@link jdk.compiler.graal.graphio.GraphStructure} interface defines the set of operations
 ...
 * provided by implementing the {@link jdk.compiler.graal.graphio.GraphStructure} operations.
 * <p>
 * The next step is to turn this graph structure into an instance of
 * {@link jdk.compiler.graal.graphio.GraphOutput}. To do so use the associated
 * {@link jdk.compiler.graal.graphio.GraphOutput.Builder builder} just like shown in the following
 * method:
 *
 ...
 * example:
 *
 * {@link jdk.compiler.graal.graphio.GraphJavadocSnippets#dump}
 *
 ...
 * <ul>
 * <li>{@linkplain jdk.compiler.graal.graphio.GraphBlocks code blocks} information</li>
 * <li>{@linkplain jdk.compiler.graal.graphio.GraphElements method and fields} information</li>
 * <li>Advanced support for {@linkplain jdk.compiler.graal.graphio.GraphTypes recognizing
 * types}</li>
 * </ul>
 * all these additional interfaces ({@link jdk.compiler.graal.graphio.GraphBlocks},
 * {@link jdk.compiler.graal.graphio.GraphElements} and
 * {@link jdk.compiler.graal.graphio.GraphTypes}) are optional - they don't have to be provided. As
 * such they can be specified via {@link jdk.compiler.graal.graphio.GraphOutput.Builder} instance
 * methods, which may, but need not be called at all. Here is an example:
 *
 * {@link jdk.compiler.graal.graphio.GraphJavadocSnippets#buildAll}
 *
