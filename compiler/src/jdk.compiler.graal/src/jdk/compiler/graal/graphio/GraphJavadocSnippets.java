...
final class GraphJavadocSnippets {
    static GraphStructure<AcmeGraph, AcmeNode, AcmeNodeType, AcmePorts> acmeGraphStructure() {
        // @formatter:off
        // BEGIN: jdk.compiler.graal.graphio.GraphJavadocSnippets#acmeGraphStructure
        ...
        // END: jdk.compiler.graal.graphio.GraphJavadocSnippets#acmeGraphStructure
    ...
    // BEGIN: jdk.compiler.graal.graphio.GraphJavadocSnippets#buildAll
    ...
    // END: jdk.compiler.graal.graphio.GraphJavadocSnippets#buildAll
    ...
    // BEGIN: jdk.compiler.graal.graphio.GraphJavadocSnippets#dump
    ...
    // END: jdk.compiler.graal.graphio.GraphJavadocSnippets#dump
