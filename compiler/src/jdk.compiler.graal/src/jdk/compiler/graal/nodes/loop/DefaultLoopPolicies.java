 ...
 * questions.
 */
package jdk.compiler.graal.nodes.loop;

import static jdk.compiler.graal.core.common.GraalOptions.LoopMaxUnswitch;
import static jdk.compiler.graal.core.common.GraalOptions.MaximumDesiredSize;
import static jdk.compiler.graal.core.common.GraalOptions.MinimumPeelFrequency;
import static jdk.compiler.graal.nodes.loop.DefaultLoopPolicies.Options.DefaultLoopFrequency;
import static jdk.compiler.graal.nodes.loop.DefaultLoopPolicies.Options.DefaultUnswitchFactor;
import static jdk.compiler.graal.nodes.loop.DefaultLoopPolicies.Options.ExactFullUnrollMaxNodes;
import static jdk.compiler.graal.nodes.loop.DefaultLoopPolicies.Options.ExactPartialUnrollMaxNodes;
import static jdk.compiler.graal.nodes.loop.DefaultLoopPolicies.Options.FullUnrollConstantCompareBoost;
import static jdk.compiler.graal.nodes.loop.DefaultLoopPolicies.Options.FullUnrollMaxIterations;
import static jdk.compiler.graal.nodes.loop.DefaultLoopPolicies.Options.FullUnrollMaxNodes;
import static jdk.compiler.graal.nodes.loop.DefaultLoopPolicies.Options.LoopUnswitchFrequencyBoost;
import static jdk.compiler.graal.nodes.loop.DefaultLoopPolicies.Options.LoopUnswitchFrequencyMaxFactor;
import static jdk.compiler.graal.nodes.loop.DefaultLoopPolicies.Options.LoopUnswitchFrequencyMinFactor;
import static jdk.compiler.graal.nodes.loop.DefaultLoopPolicies.Options.LoopUnswitchMaxIncrease;
import static jdk.compiler.graal.nodes.loop.DefaultLoopPolicies.Options.LoopUnswitchMinSplitFrequency;
import static jdk.compiler.graal.nodes.loop.DefaultLoopPolicies.Options.LoopUnswitchTrivial;
import static jdk.compiler.graal.nodes.loop.DefaultLoopPolicies.Options.UnrollMaxIterations;
...
import jdk.compiler.graal.nodes.ProfileData;
...
import jdk.compiler.graal.core.common.util.UnsignedLong;
