...
import static jdk.compiler.graal.asm.aarch64.AArch64ASIMDAssembler.ASIMDInstruction.LD1R;
import static jdk.compiler.graal.asm.aarch64.AArch64ASIMDAssembler.ASIMDInstruction.LD1_MULTIPLE_2R;
import static jdk.compiler.graal.asm.aarch64.AArch64ASIMDAssembler.ASIMDInstruction.LD1_MULTIPLE_3R;
import static jdk.compiler.graal.asm.aarch64.AArch64ASIMDAssembler.ASIMDInstruction.LD1_MULTIPLE_4R;
import static jdk.compiler.graal.asm.aarch64.AArch64ASIMDAssembler.ASIMDInstruction.ST1_MULTIPLE_4R;
import static jdk.compiler.graal.asm.aarch64.AArch64ASIMDAssembler.ASIMDSize.FullReg;
import static jdk.compiler.graal.asm.aarch64.AArch64ASIMDAssembler.ASIMDSize.HalfReg;
...
// @formatter:off
@SyncPort(from = "https://github.com/openjdk/jdk/blob/0a3a925ad88921d387aa851157f54ac0054d347b/src/hotspot/cpu/aarch64/stubGenerator_aarch64.cpp#L3973-L4195",
