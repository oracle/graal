...
import static jdk.compiler.graal.asm.aarch64.AArch64Address.isImmediateScaled;
...
import static jdk.compiler.graal.asm.aarch64.AArch64Address.AddressingMode.REGISTER_OFFSET;
