...
public class MoveResolver {
    ...
    /**
     * The number of temporary stack slots allocated to resolve cyclic moves between registers.
     */
    private static final CounterKey cycleBreakingSlotsAllocated = DebugContext.counter("LSRA[cycleBreakingSlotsAllocated]");
    /**
     * The number of register-register or register-stack move instructions generated by the
     * MoveResolver. These moves move the value of a parent interval between the locations assigned
     * to its split child intervals.
     */
    ...
    protected void setValueBlocked(Value location, int direction) {
        ...
        if (isRegister(location)) {
            ...
            throw GraalError.shouldNotReachHere("unhandled value " + location); // ExcludeFromJacocoGeneratedReport
        }
    }
