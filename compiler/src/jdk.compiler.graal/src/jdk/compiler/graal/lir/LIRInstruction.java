...
import static jdk.compiler.graal.lir.LIRInstruction.OperandFlag.COMPOSITE;
import static jdk.compiler.graal.lir.LIRInstruction.OperandFlag.CONST;
...
import static jdk.compiler.graal.lir.LIRInstruction.OperandFlag.OUTGOING;
import static jdk.compiler.graal.lir.LIRInstruction.OperandFlag.REG;
import static jdk.compiler.graal.lir.LIRInstruction.OperandFlag.STACK;
import static jdk.compiler.graal.lir.LIRInstruction.OperandFlag.UNINITIALIZED;
import static jdk.compiler.graal.lir.LIRInstruction.OperandMode.ALIVE;
import static jdk.compiler.graal.lir.LIRInstruction.OperandMode.DEF;
import static jdk.compiler.graal.lir.LIRInstruction.OperandMode.TEMP;
