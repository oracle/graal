 ...
 * questions.
 */
package jdk.compiler.graal.graph;

import static jdk.compiler.graal.graph.Graph.isNodeModificationCountsEnabled;
import static jdk.compiler.graal.graph.Node.NOT_ITERABLE;

import java.util.ArrayList;
import java.util.Iterator;

import jdk.compiler.graal.core.common.Fields;
import jdk.compiler.graal.core.common.FieldsScanner;
import jdk.compiler.graal.graph.NodeClass.EdgeInfo;
