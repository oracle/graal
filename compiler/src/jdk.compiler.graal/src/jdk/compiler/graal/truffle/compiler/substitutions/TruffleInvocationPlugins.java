 ...
 * questions.
 */
package jdk.compiler.graal.truffle.compiler.substitutions;

import static jdk.compiler.graal.lir.gen.LIRGeneratorTool.CalcStringAttributesEncoding.BMP;
import static jdk.compiler.graal.lir.gen.LIRGeneratorTool.CalcStringAttributesEncoding.LATIN1;
import static jdk.compiler.graal.lir.gen.LIRGeneratorTool.CalcStringAttributesEncoding.UTF_16;
import static jdk.compiler.graal.lir.gen.LIRGeneratorTool.CalcStringAttributesEncoding.UTF_32;
import static jdk.compiler.graal.lir.gen.LIRGeneratorTool.CalcStringAttributesEncoding.UTF_8;
import static jdk.compiler.graal.nodes.NamedLocationIdentity.getArrayLocation;
...
import jdk.compiler.graal.nodes.graphbuilderconf.InvocationPlugins.OptionalLazySymbol;
...
import jdk.compiler.graal.replacements.nodes.ArrayIndexOfMacroNode;
...
import jdk.compiler.graal.replacements.nodes.CalcStringAttributesMacroNode;
