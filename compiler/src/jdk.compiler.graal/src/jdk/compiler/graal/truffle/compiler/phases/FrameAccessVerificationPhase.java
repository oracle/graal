...
package jdk.compiler.graal.truffle.compiler.phases;
...
import jdk.compiler.graal.phases.graph.ReentrantNodeIterator;
import jdk.compiler.graal.phases.graph.ReentrantNodeIterator.LoopInfo;
import jdk.compiler.graal.phases.graph.ReentrantNodeIterator.NodeIteratorClosure;
import jdk.compiler.graal.truffle.compiler.PerformanceInformationHandler;
import jdk.compiler.graal.truffle.compiler.TruffleCompilerOptions.PerformanceWarningKind;
import jdk.compiler.graal.truffle.compiler.TruffleTierContext;
import jdk.compiler.graal.truffle.compiler.nodes.frame.NewFrameNode;
import jdk.compiler.graal.truffle.compiler.nodes.frame.VirtualFrameAccessFlags;
import jdk.compiler.graal.truffle.compiler.nodes.frame.VirtualFrameAccessType;
import jdk.compiler.graal.truffle.compiler.nodes.frame.VirtualFrameAccessVerificationNode;
import jdk.compiler.graal.truffle.compiler.nodes.frame.VirtualFrameSetNode;
