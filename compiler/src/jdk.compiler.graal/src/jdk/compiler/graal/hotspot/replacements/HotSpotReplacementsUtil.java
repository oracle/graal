...
import static jdk.compiler.graal.hotspot.meta.HotSpotForeignCallsProviderImpl.VERIFY_OOP;
...
import jdk.compiler.graal.nodes.CanonicalizableLocation;
...
import jdk.compiler.graal.nodes.extended.StoreHubNode;
import jdk.compiler.graal.nodes.memory.AddressableMemoryAccess;
