...
import static jdk.compiler.graal.core.common.GraalOptions.MinimalBulkZeroingSize;
...
import static jdk.compiler.graal.hotspot.replacements.HotSpotReplacementsUtil.CLASS_INIT_STATE_LOCATION;
import static jdk.compiler.graal.hotspot.replacements.HotSpotReplacementsUtil.CLASS_INIT_THREAD_LOCATION;
import static jdk.compiler.graal.hotspot.replacements.HotSpotReplacementsUtil.HUB_WRITE_LOCATION;
import static jdk.compiler.graal.hotspot.replacements.HotSpotReplacementsUtil.MARK_WORD_LOCATION;
import static jdk.compiler.graal.hotspot.replacements.HotSpotReplacementsUtil.PROTOTYPE_MARK_WORD_LOCATION;
import static jdk.compiler.graal.hotspot.replacements.HotSpotReplacementsUtil.TLAB_END_LOCATION;
import static jdk.compiler.graal.hotspot.replacements.HotSpotReplacementsUtil.TLAB_TOP_LOCATION;
import static jdk.compiler.graal.hotspot.replacements.HotSpotReplacementsUtil.arrayKlassOffset;
import static jdk.compiler.graal.hotspot.replacements.HotSpotReplacementsUtil.instanceKlassStateBeingInitialized;
import static jdk.compiler.graal.hotspot.replacements.HotSpotReplacementsUtil.isInstanceKlassFullyInitialized;
import static jdk.compiler.graal.hotspot.replacements.HotSpotReplacementsUtil.layoutHelperHeaderSizeMask;
import static jdk.compiler.graal.hotspot.replacements.HotSpotReplacementsUtil.layoutHelperHeaderSizeShift;
import static jdk.compiler.graal.hotspot.replacements.HotSpotReplacementsUtil.layoutHelperLog2ElementSizeMask;
import static jdk.compiler.graal.hotspot.replacements.HotSpotReplacementsUtil.layoutHelperLog2ElementSizeShift;
import static jdk.compiler.graal.hotspot.replacements.HotSpotReplacementsUtil.loadKlassFromObject;
import static jdk.compiler.graal.hotspot.replacements.HotSpotReplacementsUtil.readInstanceKlassInitState;
import static jdk.compiler.graal.hotspot.replacements.HotSpotReplacementsUtil.readInstanceKlassInitThread;
import static jdk.compiler.graal.hotspot.replacements.HotSpotReplacementsUtil.readLayoutHelper;
...
import static jdk.compiler.graal.hotspot.replacements.HotspotSnippetsOptions.ProfileAllocationsContext;
...
import static jdk.compiler.graal.replacements.ReplacementsUtil.dynamicAssert;
import static jdk.compiler.graal.replacements.ReplacementsUtil.staticAssert;
