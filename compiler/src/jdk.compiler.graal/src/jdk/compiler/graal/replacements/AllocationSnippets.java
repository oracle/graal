...
import static jdk.compiler.graal.replacements.nodes.ExplodeLoopNode.explodeLoop;

import jdk.compiler.graal.nodes.PrefetchAllocateNode;
...
import jdk.compiler.graal.replacements.nodes.ZeroMemoryNode;
...
public abstract class AllocationSnippets implements Snippets {
    ...
    private void fillContents(Word memory, FillContent fillContents, int startOffset, UnsignedWord endOffset, boolean isEndOffsetConstant, boolean maybeUnroll, boolean supportsBulkZeroing,
        ...
        } else if (ReplacementsUtil.REPLACEMENTS_ASSERTIONS_ENABLED && fillContents == FillContent.WITH_GARBAGE_IF_ASSERTIONS_ENABLED) {
