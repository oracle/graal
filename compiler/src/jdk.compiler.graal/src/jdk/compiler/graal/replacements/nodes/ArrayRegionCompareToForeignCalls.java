...
public final class ArrayRegionCompareToForeignCalls {
    private static final ForeignCallDescriptor STUB_DYNAMIC_STRIDES = ForeignCalls.pureFunctionForeignCallDescriptor("arrayRegionCompareToDynamicStrides",
                    int.class, Object.class, long.class, Object.class, long.class, int.class, int.class);
    /**
     ...
     *
     * @see #getStub(ArrayRegionCompareToNode)
     */
    public static final ForeignCallDescriptor[] STUBS = {
                    foreignCallDescriptor("arrayRegionCompareToS1S1"),
                    foreignCallDescriptor("arrayRegionCompareToS1S2"),
                    foreignCallDescriptor("arrayRegionCompareToS1S4"),
                    foreignCallDescriptor("arrayRegionCompareToS2S1"),
                    foreignCallDescriptor("arrayRegionCompareToS2S2"),
                    foreignCallDescriptor("arrayRegionCompareToS2S4"),
                    foreignCallDescriptor("arrayRegionCompareToS4S1"),
                    foreignCallDescriptor("arrayRegionCompareToS4S2"),
                    foreignCallDescriptor("arrayRegionCompareToS4S4"),
                    STUB_DYNAMIC_STRIDES,
    };

    private static ForeignCallDescriptor foreignCallDescriptor(String name) {
        return ForeignCalls.pureFunctionForeignCallDescriptor(name, int.class, Object.class, long.class, Object.class, long.class, int.class);
    }
