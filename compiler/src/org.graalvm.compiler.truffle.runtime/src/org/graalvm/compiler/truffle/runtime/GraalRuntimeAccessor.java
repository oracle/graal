...
final class GraalRuntimeAccessor extends Accessor {
    ...
    static final class GraalRuntimeSupport extends RuntimeSupport {
        ...
        /**
         * Initializes the argument profile with a custom profile without calling it. A call target
         * must never be called prior initialization of argument types. Also the argument types must
         * be final if used in combination with
