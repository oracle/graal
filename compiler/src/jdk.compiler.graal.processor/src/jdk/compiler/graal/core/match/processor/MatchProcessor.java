 ...
 * questions.
 */
package jdk.compiler.graal.core.match.processor;
 ...
 * </pre>
 */
@SupportedAnnotationTypes({"jdk.compiler.graal.core.match.MatchRule", "jdk.compiler.graal.core.match.MatchRules", "jdk.compiler.graal.core.match.MatchableNode",
                "jdk.compiler.graal.core.match.MatchableNodes"})
public class MatchProcessor extends AbstractProcessor {

    private static final String VALUE_NODE_CLASS_NAME = "jdk.compiler.graal.nodes.ValueNode";
    private static final String COMPLEX_MATCH_RESULT_CLASS_NAME = "jdk.compiler.graal.core.match.ComplexMatchResult";
    private static final String MATCHABLE_NODES_CLASS_NAME = "jdk.compiler.graal.core.match.MatchableNodes";
    private static final String MATCHABLE_NODE_CLASS_NAME = "jdk.compiler.graal.core.match.MatchableNode";
    private static final String MATCH_RULE_CLASS_NAME = "jdk.compiler.graal.core.match.MatchRule";
    private static final String MATCH_RULES_CLASS_NAME = "jdk.compiler.graal.core.match.MatchRules";
    ...
    private void createFiles(MatchRuleDescriptor info) {
        ...
        try (PrintWriter out = createSourceFile(pkg, matchStatementClassName, filer, originatingElements)) {
            ...
            out.println("import jdk.compiler.graal.core.match.*;");
            out.println("import jdk.compiler.graal.core.gen.NodeMatchRules;");
            out.println("import jdk.compiler.graal.graph.Position;");
        ...
        this.createProviderFile(pkg + "." + matchStatementClassName, "jdk.compiler.graal.core.match.MatchStatementSet", originatingElements);
    }
    ...
    public boolean doProcess(Set<? extends TypeElement> annotations, RoundEnvironment roundEnv) {
        ...
        try {
            ...
            valueType = new TypeDescriptor(valueTypeMirror, "Value", "ValueNode", "jdk.compiler.graal.nodes", Collections.emptyList(), false, false, false, false);
