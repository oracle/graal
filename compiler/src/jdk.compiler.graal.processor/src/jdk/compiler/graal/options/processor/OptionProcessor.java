 ...
 * questions.
 */
package jdk.compiler.graal.options.processor;
 ...
 */
@SupportedAnnotationTypes({"jdk.compiler.graal.options.Option"})
public class OptionProcessor extends AbstractProcessor {

    private static final String OPTION_CLASS_NAME = "jdk.compiler.graal.options.Option";
    private static final String OPTION_KEY_CLASS_NAME = "jdk.compiler.graal.options.OptionKey";
    private static final String OPTION_TYPE_CLASS_NAME = "jdk.compiler.graal.options.OptionType";
    private static final String OPTION_STABILITY_CLASS_NAME = "jdk.compiler.graal.options.OptionStability";
    private static final String OPTION_TYPE_GROUP_NAME = "jdk.compiler.graal.options.OptionGroup";
    private static final String OPTION_DESCRIPTOR_CLASS_NAME = "jdk.compiler.graal.options.OptionDescriptor";
    private static final String OPTION_DESCRIPTORS_CLASS_NAME = "jdk.compiler.graal.options.OptionDescriptors";
