...
public final class FoldHandler extends AnnotationHandler {
    ...
    static final String FOLD_CLASS_NAME = "jdk.compiler.graal.api.replacements.Fold";
    static final String INJECTED_PARAMETER_CLASS_NAME = "jdk.compiler.graal.api.replacements.Fold.InjectedParameter";
