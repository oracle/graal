...
public class InjectedDependencies implements Iterable<InjectedDependencies.Dependency> {
    ...
    private static final class InjectedStampDependency extends DependencyImpl {
        ...
        private InjectedStampDependency() {
            super("stamp", "jdk.compiler.graal.core.common.type.Stamp");
        }
    ...
    public enum WellKnownDependency implements Dependency {
        ...
        OPTIONVALUES("b.getOptions()", "jdk.compiler.graal.options.OptionValues"),
        INJECTED_STAMP(new InjectedStampDependency()),
        SNIPPET_REFLECTION(new InjectedDependency("snippetReflection", "jdk.compiler.graal.api.replacements.SnippetReflectionProvider")),
        STAMP_PROVIDER("b.getStampProvider()", "jdk.compiler.graal.nodes.spi.StampProvider"),
        INTRINSIC_CONTEXT("b.getIntrinsic()", "jdk.compiler.graal.nodes.graphbuilderconf.IntrinsicContext"),
        STRUCTURED_GRAPH("b.getGraph()", "jdk.compiler.graal.nodes.StructuredGraph");
