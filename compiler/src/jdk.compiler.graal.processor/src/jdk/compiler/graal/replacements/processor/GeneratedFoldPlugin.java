...
import static jdk.compiler.graal.replacements.processor.FoldHandler.FOLD_CLASS_NAME;
import static jdk.compiler.graal.replacements.processor.FoldHandler.INJECTED_PARAMETER_CLASS_NAME;
...
import jdk.compiler.graal.replacements.processor.InjectedDependencies.WellKnownDependency;
...
public class GeneratedFoldPlugin extends GeneratedPlugin {
    ...
    public void extraImports(AbstractProcessor processor, Set<String> imports) {
        ...
        imports.add("jdk.compiler.graal.nodes.ConstantNode");
        imports.add("jdk.compiler.graal.core.common.type.Stamp");
    }
