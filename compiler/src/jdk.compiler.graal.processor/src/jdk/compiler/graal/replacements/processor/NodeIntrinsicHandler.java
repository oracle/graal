 ...
 * questions.
 */
package jdk.compiler.graal.replacements.processor;

import static jdk.compiler.graal.processor.AbstractProcessor.getAnnotationValue;
import static jdk.compiler.graal.processor.AbstractProcessor.getAnnotationValueList;
import static jdk.compiler.graal.processor.AbstractProcessor.getSimpleName;
...
import jdk.compiler.graal.processor.AbstractProcessor;
...
public final class NodeIntrinsicHandler extends AnnotationHandler {
    ...
    static final String CONSTANT_NODE_PARAMETER_CLASS_NAME = "jdk.compiler.graal.graph.Node.ConstantNodeParameter";
    static final String MARKER_TYPE_CLASS_NAME = "jdk.compiler.graal.nodeinfo.StructuralInput.MarkerType";
    static final String GRAPH_BUILDER_CONTEXT_CLASS_NAME = "jdk.compiler.graal.nodes.graphbuilderconf.GraphBuilderContext";
    static final String STRUCTURAL_INPUT_CLASS_NAME = "jdk.compiler.graal.nodeinfo.StructuralInput";
    static final String RESOLVED_JAVA_TYPE_CLASS_NAME = "jdk.vm.ci.meta.ResolvedJavaType";
    static final String VALUE_NODE_CLASS_NAME = "jdk.compiler.graal.nodes.ValueNode";
    static final String STAMP_CLASS_NAME = "jdk.compiler.graal.core.common.type.Stamp";
    static final String NODE_CLASS_NAME = "jdk.compiler.graal.graph.Node";
    static final String NODE_INFO_CLASS_NAME = "jdk.compiler.graal.nodeinfo.NodeInfo";
    static final String NODE_INTRINSIC_CLASS_NAME = "jdk.compiler.graal.graph.Node.NodeIntrinsic";
    static final String NODE_INTRINSIC_FACTORY_CLASS_NAME = "jdk.compiler.graal.graph.Node.NodeIntrinsicFactory";
    static final String INJECTED_NODE_PARAMETER_CLASS_NAME = "jdk.compiler.graal.graph.Node.InjectedNodeParameter";
    static final String FOREIGN_CALL_DESCRIPTOR_CLASS_NAME = "jdk.compiler.graal.core.common.spi.ForeignCallDescriptor";
