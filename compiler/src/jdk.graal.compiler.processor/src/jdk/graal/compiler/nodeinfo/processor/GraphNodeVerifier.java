...
public class GraphNodeVerifier {
    ...
    public GraphNodeVerifier(AbstractProcessor processor) {
        ...
        this.Input = getTypeElement("jdk.graal.compiler.graph.Node.Input");
        this.OptionalInput = getTypeElement("jdk.graal.compiler.graph.Node.OptionalInput");
        this.Successor = getTypeElement("jdk.graal.compiler.graph.Node.Successor");
        this.Node = getTypeElement("jdk.graal.compiler.graph.Node");
        this.NodeInputList = getTypeElement("jdk.graal.compiler.graph.NodeInputList");
        this.NodeSuccessorList = getTypeElement("jdk.graal.compiler.graph.NodeSuccessorList");
