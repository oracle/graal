 ...
 * </pre>
 */
@SupportedAnnotationTypes({"jdk.graal.compiler.core.match.MatchRule", "jdk.graal.compiler.core.match.MatchRules", "jdk.graal.compiler.core.match.MatchableNode",
                "jdk.graal.compiler.core.match.MatchableNodes"})
