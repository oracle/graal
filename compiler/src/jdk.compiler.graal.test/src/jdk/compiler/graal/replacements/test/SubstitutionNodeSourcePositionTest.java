...
import static jdk.compiler.graal.core.common.GraalOptions.TrackNodeSourcePosition;
...
public class SubstitutionNodeSourcePositionTest extends ReplacementsTest {
    ...
    public void testSnippetLowering() {
        ...
        //   at jdk.compiler.graal.hotspot.replacements.WriteBarrierSnippets.serialWriteBarrier(WriteBarrierSnippets.java:140) [bci: 18]
        //   at jdk.compiler.graal.hotspot.replacements.WriteBarrierSnippets.serialPreciseWriteBarrier(WriteBarrierSnippets.java:158) [bci: 5] Substitution
        //   at jdk.compiler.graal.hotspot.replacements.WriteBarrierSnippets.serialPreciseWriteBarrier(AddressNode$Address, WriteBarrierSnippets$Counters) [bci: -1] Substitution
        //   at jdk.compiler.graal.test.replacements.compiler.SubstitutionNodeSourcePositionTest.snippetLowering(SubstitutionNodeSourcePositionTest.java:99) [bci: 3]
        // @formatter:on
        //
    ...
    public void testMethodPlugin() {
        // @formatter:off
        // Expect mappings of the form:
        //   at jdk.compiler.graal.api.directives.GraalDirectives.blackhole(int) [bci: -1]
        //   at jdk.compiler.graal.test.replacements.compiler.SubstitutionNodeSourcePositionTest.methodPlugin(SubstitutionNodeSourcePositionTest.java:109) [bci: 1]
        // @formatter:on
