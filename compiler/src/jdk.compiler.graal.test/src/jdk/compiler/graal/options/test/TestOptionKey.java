 ...
 * questions.
 */
package jdk.compiler.graal.options.test;

import static jdk.compiler.graal.options.OptionValues.asMap;
import static jdk.compiler.graal.options.OptionValues.newOptionMap;
import static jdk.compiler.graal.options.OptionsParser.parseOptionValue;
import static jdk.compiler.graal.options.test.TestOptionKey.Options.MyDeprecatedOption;
import static jdk.compiler.graal.options.test.TestOptionKey.Options.MyOption;
import static jdk.compiler.graal.options.test.TestOptionKey.Options.MyOtherOption;
import static jdk.compiler.graal.options.test.TestOptionKey.Options.MyIntegerOption;
import static jdk.compiler.graal.options.test.TestOptionKey.Options.MyLongOption;
import static jdk.compiler.graal.options.test.TestOptionKey.Options.MyBooleanOption;
import static jdk.compiler.graal.options.test.TestOptionKey.Options.MyFloatOption;
import static jdk.compiler.graal.options.test.TestOptionKey.Options.MyDoubleOption;
import static jdk.compiler.graal.options.test.TestOptionKey.Options.MyMultiEnumOption;
import static jdk.compiler.graal.options.test.TestOptionKey.Options.MySecondOption;
import static jdk.compiler.graal.options.test.TestOptionKey.TestEnum.Value2;
import static jdk.compiler.graal.options.test.TestOptionKey.TestEnum.Value3;
import static jdk.compiler.graal.options.test.TestOptionKey.TestEnum.Value4;
