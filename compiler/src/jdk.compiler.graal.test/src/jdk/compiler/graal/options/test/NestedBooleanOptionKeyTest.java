...
import static jdk.compiler.graal.options.test.NestedBooleanOptionKeyTest.Options.NestedOption0;
import static jdk.compiler.graal.options.test.NestedBooleanOptionKeyTest.Options.NestedOption1;
import static jdk.compiler.graal.options.test.NestedBooleanOptionKeyTest.Options.NestedOption2;
import static jdk.compiler.graal.options.test.NestedBooleanOptionKeyTest.Options.Parent0;
import static jdk.compiler.graal.options.test.NestedBooleanOptionKeyTest.Options.Parent1;
import static jdk.compiler.graal.options.test.NestedBooleanOptionKeyTest.Options.Parent2;
