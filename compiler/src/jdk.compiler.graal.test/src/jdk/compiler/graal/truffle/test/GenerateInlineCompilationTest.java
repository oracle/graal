...
import jdk.compiler.graal.truffle.test.GenerateInlineCompilationTestFactory.CustomNodeGen;
import jdk.compiler.graal.truffle.test.GenerateInlineCompilationTestFactory.TestChildrenNodeGen;
import jdk.compiler.graal.truffle.test.GenerateInlineCompilationTestFactory.TestDimensionsRootNodeGen;
import jdk.compiler.graal.truffle.test.GenerateInlineCompilationTestFactory.UseProfilesNodeGen;
