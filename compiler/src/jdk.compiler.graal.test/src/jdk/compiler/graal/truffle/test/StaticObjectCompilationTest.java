...
public class StaticObjectCompilationTest extends PartialEvaluationTest {
    ...
    private static void assertNoNodes(StructuredGraph graph, Class<? extends jdk.compiler.graal.graph.Node> nodeClass) {
        for (jdk.compiler.graal.graph.Node node : graph.getNodes()) {
    ...
    private static void assertCount(StructuredGraph graph, Class<? extends jdk.compiler.graal.graph.Node> nodeClass, int expected) {
