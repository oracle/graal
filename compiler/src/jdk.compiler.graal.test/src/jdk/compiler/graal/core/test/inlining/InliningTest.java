...
public class InliningTest extends GraalCompilerTest {
    ...
    public void testTracing() {
        ...
        String expectedRegex = "compilation of jdk.compiler.graal.core.test.inlining.InliningTest.traceInliningTest.*: \\R" +
                        "  at .*jdk.compiler.graal.core.test.inlining.InliningTest.traceInliningTest.*: <GraphBuilderPhase> jdk.compiler.graal.core.test.inlining.InliningTest.callTrivial.*: yes, inline method\\R" +
                        "    at .*jdk.compiler.graal.core.test.inlining.InliningTest.callTrivial.*: .*\\R" +
                        "       .*<GraphBuilderPhase> jdk.compiler.graal.core.test.inlining.InliningTest.callNonTrivial.*: .*(.*\\R)*" +
                        "       .*<InliningPhase> jdk.compiler.graal.core.test.inlining.InliningTest.callNonTrivial.*: .*(.*\\R)*";
