...
public final class SetUtil {
    ...
    /**
     * Returns the set difference of the first and second collection.
     * @param lhs the first collection
     * @param rhs the second collection
     * @param <T> the element type of the collections
     * @return the set difference of the first and the second collection
     */
