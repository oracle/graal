        ...
        for (int i = 0; i < args.size(); i++) {
            ...
            if (arg instanceof Invoke && hasSingleUsage(arg)) {
                ...
                if (callTarget instanceof MethodCallTargetNode) {
                    ...
                    } else if (m.getName().equals("linkToTargetMethod") && (m.getDeclaringClass().getName().equals("Ljava/lang/invoke/Invokers$Holder;") || m.getDeclaringClass().getName().startsWith("Ljava/lang/invoke/LambdaForm$MH"))) {
