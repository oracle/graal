...
public class AArch64MacroAssembler extends AArch64Assembler {
    ...
    public final ASIMDMacroAssembler neon;

    public AArch64MacroAssembler(TargetDescription target) {
        super(target);
        this.neon = new ASIMDMacroAssembler(this);
    }
    ...
    public void popcnt(int size, Register dst, Register src, Register vreg) {
        ...
        assert vreg.getRegisterCategory() == SIMD;

        fmov(size, vreg, src);
        neon.cnt(ASIMDSize.HalfReg, vreg, vreg);
        neon.addv(ASIMDSize.HalfReg, ASIMDAssembler.ElementSize.Byte, vreg, vreg);
        neon.umovGeneral(ASIMDAssembler.ElementSize.DoubleWord, dst, vreg, 0);
    }
    ...
    public static class ASIMDMacroAssembler extends ASIMDAssembler {
        private final AArch64MacroAssembler masm;

        public ASIMDMacroAssembler(AArch64MacroAssembler masm) {
            super(masm);
            this.masm = masm;
        }
