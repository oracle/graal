{
  ...
  microservice_benchmarks: cc.compiler_benchmark + {
    ...
    run+: [
      ...
      bench_upload,
      # shopcart-wrk
      self.benchmark_cmd + ["shopcart-wrk:mixed-tiny"]                   + hwlocBind_1C_1T   + ["--"] + self.extra_vm_args + ["-Xms32m",   "-Xmx112m",  "-XX:ActiveProcessorCount=1",  "-XX:MaxDirectMemorySize=256m", "-XX:+PrintGC", "-XX:+PrintCompilation"],
      bench_upload,
      self.benchmark_cmd + ["shopcart-wrk:mixed-small"]                  + hwlocBind_2C_2T   + ["--"] + self.extra_vm_args + ["-Xms64m",   "-Xmx224m",  "-XX:ActiveProcessorCount=2",  "-XX:MaxDirectMemorySize=512m", "-XX:+PrintGC", "-XX:+PrintCompilation"],
      bench_upload,
      self.benchmark_cmd + ["shopcart-wrk:mixed-medium"]                 + hwlocBind_4C_4T   + ["--"] + self.extra_vm_args + ["-Xms128m",  "-Xmx512m",  "-XX:ActiveProcessorCount=4",  "-XX:MaxDirectMemorySize=1024m", "-XX:+PrintGC", "-XX:+PrintCompilation"],
      bench_upload,
      ...
      bench_upload,
      self.benchmark_cmd + ["tika-wrk:odt-small"]                        + hwlocBind_2C_2T   + ["--"] + self.extra_vm_args + ["-Xms64m",   "-Xmx250m",  "-XX:ActiveProcessorCount=2", "-XX:+PrintGC", "-XX:+PrintCompilation"],
      bench_upload,
      self.benchmark_cmd + ["tika-wrk:odt-medium"]                       + hwlocBind_4C_4T   + ["--"] + self.extra_vm_args + ["-Xms128m",  "-Xmx600m",  "-XX:ActiveProcessorCount=4", "-XX:+PrintGC", "-XX:+PrintCompilation"],
      bench_upload,
      # tika-wrk pdf
      self.benchmark_cmd + ["tika-wrk:pdf-tiny"]                         + hwlocBind_1C_1T   + ["--"] + self.extra_vm_args + ["-Xms20m",   "-Xmx80m",   "-XX:ActiveProcessorCount=1", "-XX:+PrintGC", "-XX:+PrintCompilation"],
      bench_upload,
      self.benchmark_cmd + ["tika-wrk:pdf-small"]                        + hwlocBind_2C_2T   + ["--"] + self.extra_vm_args + ["-Xms40m",   "-Xmx200m",  "-XX:ActiveProcessorCount=2", "-XX:+PrintGC", "-XX:+PrintCompilation"],
      bench_upload,
      self.benchmark_cmd + ["tika-wrk:pdf-medium"]                       + hwlocBind_4C_4T   + ["--"] + self.extra_vm_args + ["-Xms80m",   "-Xmx500m",  "-XX:ActiveProcessorCount=4", "-XX:+PrintGC", "-XX:+PrintCompilation"],
      bench_upload,
      # petclinic-wrk
      self.benchmark_cmd + ["petclinic-wrk:mixed-tiny"]                  + hwlocBind_1C_1T   + ["--"] + self.extra_vm_args + ["-Xms32m",   "-Xmx100m",  "-XX:ActiveProcessorCount=1", "-XX:+PrintGC", "-XX:+PrintCompilation"],
      bench_upload,
      self.benchmark_cmd + ["petclinic-wrk:mixed-small"]                 + hwlocBind_2C_2T   + ["--"] + self.extra_vm_args + ["-Xms40m",   "-Xmx128m",  "-XX:ActiveProcessorCount=2", "-XX:+PrintGC", "-XX:+PrintCompilation"],
      bench_upload,
      self.benchmark_cmd + ["petclinic-wrk:mixed-medium"]                + hwlocBind_4C_4T   + ["--"] + self.extra_vm_args + ["-Xms80m",   "-Xmx256m",  "-XX:ActiveProcessorCount=4", "-XX:+PrintGC", "-XX:+PrintCompilation"],
      bench_upload,
