{
  ...
  microservice_benchmarks: cc.compiler_benchmark + {
    ...
    oneCore:: ["--hwloc-bind=--cpubind node:0.core:0.pu:0 --membind node:0"],
    twoCores:: ["--hwloc-bind=--cpubind node:0.core:0-1.pu:0 --membind node:0"],
    fourCores:: ["--hwloc-bind=--cpubind node:0.core:0-3.pu:0 --membind node:0"],
    sixteenCores:: ["--hwloc-bind=--cpubind node:0.core:0-15.pu:0 --membind node:0"],
    thirtyTwoThreads:: ["--hwloc-bind=--cpubind node:0.core:0-15.pu:0-1 --membind node:0"],
    run+: [
      ...
      upload,
      self.benchmark_cmd + ["shopcart-wrk:mixed-tiny"]    + self.oneCore          + ["--"] + self.extra_vm_args + ["-Xms32m",   "-Xmx112m",  "-XX:ActiveProcessorCount=1",  "-XX:MaxDirectMemorySize=256m", "-XX:+PrintGC", "-XX:+PrintCompilation"],
      upload,
      self.benchmark_cmd + ["shopcart-wrk:mixed-small"]   + self.twoCores         + ["--"] + self.extra_vm_args + ["-Xms64m",   "-Xmx224m",  "-XX:ActiveProcessorCount=2",  "-XX:MaxDirectMemorySize=512m", "-XX:+PrintGC", "-XX:+PrintCompilation"],
      upload,
      self.benchmark_cmd + ["shopcart-wrk:mixed-medium"]  + self.fourCores        + ["--"] + self.extra_vm_args + ["-Xms128m",  "-Xmx512m",  "-XX:ActiveProcessorCount=4",  "-XX:MaxDirectMemorySize=1024m", "-XX:+PrintGC", "-XX:+PrintCompilation"],
      upload,
      self.benchmark_cmd + ["shopcart-wrk:mixed-large"]   + self.sixteenCore      + ["--"] + self.extra_vm_args + ["-Xms512m",  "-Xmx3072m", "-XX:ActiveProcessorCount=16", "-XX:MaxDirectMemorySize=4096m", "-XX:+PrintGC", "-XX:+PrintCompilation"],
      upload,
      self.benchmark_cmd + ["shopcart-wrk:mixed-huge"]    + self.thirtyTwoThreads + ["--"] + self.extra_vm_args + ["-Xms1024m", "-Xmx8192m", "-XX:ActiveProcessorCount=32", "-XX:MaxDirectMemorySize=8192m", "-XX:+PrintGC", "-XX:+PrintCompilation"],
      upload,
      self.benchmark_cmd + ["tika-wrk:odt-tiny"]          + self.oneCore          + ["--"] + self.extra_vm_args + ["-Xms32m",   "-Xmx150m",  "-XX:ActiveProcessorCount=1", "-XX:+PrintGC", "-XX:+PrintCompilation"],
      upload,
      self.benchmark_cmd + ["tika-wrk:odt-small"]         + self.twoCores         + ["--"] + self.extra_vm_args + ["-Xms64m",   "-Xmx250m",  "-XX:ActiveProcessorCount=2", "-XX:+PrintGC", "-XX:+PrintCompilation"],
      upload,
      self.benchmark_cmd + ["tika-wrk:odt-medium"]        + self.fourCore         + ["--"] + self.extra_vm_args + ["-Xms128m",  "-Xmx600m",  "-XX:ActiveProcessorCount=4", "-XX:+PrintGC", "-XX:+PrintCompilation"],
      upload,
      self.benchmark_cmd + ["tika-wrk:pdf-tiny"]          + self.oneCore          + ["--"] + self.extra_vm_args + ["-Xms20m",   "-Xmx80m",   "-XX:ActiveProcessorCount=1", "-XX:+PrintGC", "-XX:+PrintCompilation"],
      upload,
      self.benchmark_cmd + ["tika-wrk:pdf-small"]         + self.twoCores         + ["--"] + self.extra_vm_args + ["-Xms40m",   "-Xmx200m",  "-XX:ActiveProcessorCount=2", "-XX:+PrintGC", "-XX:+PrintCompilation"],
      upload,
      self.benchmark_cmd + ["tika-wrk:pdf-medium"]        + self.fourCores        + ["--"] + self.extra_vm_args + ["-Xms80m",   "-Xmx500m",  "-XX:ActiveProcessorCount=4", "-XX:+PrintGC", "-XX:+PrintCompilation"],
      upload,
      self.benchmark_cmd + ["petclinic-wrk:mixed-tiny"]   + self.oneCore          + ["--"] + self.extra_vm_args + ["-Xms32m",   "-Xmx100m",  "-XX:ActiveProcessorCount=1", "-XX:+PrintGC", "-XX:+PrintCompilation"],
      upload,
      self.benchmark_cmd + ["petclinic-wrk:mixed-small"]  + self.twoCores         + ["--"] + self.extra_vm_args + ["-Xms40m",   "-Xmx128m",  "-XX:ActiveProcessorCount=2", "-XX:+PrintGC", "-XX:+PrintCompilation"],
      upload,
      self.benchmark_cmd + ["petclinic-wrk:mixed-medium"] + self.fourCores        + ["--"] + self.extra_vm_args + ["-Xms80m",   "-Xmx256m",  "-XX:ActiveProcessorCount=4", "-XX:+PrintGC", "-XX:+PrintCompilation"],
      upload,
      self.benchmark_cmd + ["petclinic-wrk:mixed-large"]  + self.sixteenCores     + ["--"] + self.extra_vm_args + ["-Xms320m",  "-Xmx1280m", "-XX:ActiveProcessorCount=16", "-XX:+PrintGC", "-XX:+PrintCompilation"],
      upload,
      self.benchmark_cmd + ["petclinic-wrk:mixed-huge"]   + self.thirtyTwoThreads + ["--"] + self.extra_vm_args + ["-Xms640m",  "-Xmx3072m", "-XX:ActiveProcessorCount=32", "-XX:+PrintGC", "-XX:+PrintCompilation"],
      upload,
