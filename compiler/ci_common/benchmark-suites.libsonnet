{
  ...
  microservice_benchmarks: cc.compiler_benchmark + {
    ...
    run+: [
      ...
      upload,
      self.benchmark_cmd + ["shopcart-wrk:mixed-tiny", "--"] +             self.extra_vm_args + ["-Xms32m",   "-Xmx112m",  "-XX:ActiveProcessorCount=1",  "-XX:MaxDirectMemorySize=256m", "-XX:+PrintGC", "-XX:+PrintCompilation"],
      upload,
      self.benchmark_cmd + ["shopcart-wrk:mixed-small", "--"] +            self.extra_vm_args + ["-Xms64m",   "-Xmx224m",  "-XX:ActiveProcessorCount=2",  "-XX:MaxDirectMemorySize=512m", "-XX:+PrintGC", "-XX:+PrintCompilation"],
      upload,
      self.benchmark_cmd + ["shopcart-wrk:mixed-medium", "--"] +           self.extra_vm_args + ["-Xms128m",  "-Xmx512m",  "-XX:ActiveProcessorCount=4",  "-XX:MaxDirectMemorySize=1024m", "-XX:+PrintGC", "-XX:+PrintCompilation"],
      upload,
      self.benchmark_cmd + ["shopcart-wrk:mixed-large", "--"] +            self.extra_vm_args + ["-Xms512m",  "-Xmx3072m", "-XX:ActiveProcessorCount=16", "-XX:MaxDirectMemorySize=4096m", "-XX:+PrintGC", "-XX:+PrintCompilation"],
      upload,
      self.benchmark_cmd + ["shopcart-wrk:mixed-huge", "--"] +             self.extra_vm_args + ["-Xms1024m", "-Xmx8192m", "-XX:ActiveProcessorCount=32", "-XX:MaxDirectMemorySize=8192m", "-XX:+PrintGC", "-XX:+PrintCompilation"],
      upload,
      self.benchmark_cmd + ["tika-wrk:odt-tiny", "--"] +                   self.extra_vm_args + ["-Xms32m",   "-Xmx150m",  "-XX:ActiveProcessorCount=1", "-XX:+PrintGC", "-XX:+PrintCompilation"],
      upload,
      self.benchmark_cmd + ["tika-wrk:odt-small", "--"] +                  self.extra_vm_args + ["-Xms64m",   "-Xmx250m",  "-XX:ActiveProcessorCount=2", "-XX:+PrintGC", "-XX:+PrintCompilation"],
      upload,
      self.benchmark_cmd + ["tika-wrk:odt-medium", "--"] +                 self.extra_vm_args + ["-Xms128m",  "-Xmx600m",  "-XX:ActiveProcessorCount=4", "-XX:+PrintGC", "-XX:+PrintCompilation"],
      upload,
      self.benchmark_cmd + ["tika-wrk:pdf-tiny", "--"] +                   self.extra_vm_args + ["-Xms20m",   "-Xmx80m",   "-XX:ActiveProcessorCount=1", "-XX:+PrintGC", "-XX:+PrintCompilation"],
      upload,
      self.benchmark_cmd + ["tika-wrk:pdf-small", "--"] +                  self.extra_vm_args + ["-Xms40m",   "-Xmx200m",  "-XX:ActiveProcessorCount=2", "-XX:+PrintGC", "-XX:+PrintCompilation"],
      upload,
      self.benchmark_cmd + ["tika-wrk:pdf-medium", "--"] +                 self.extra_vm_args + ["-Xms80m",   "-Xmx500m",  "-XX:ActiveProcessorCount=4", "-XX:+PrintGC", "-XX:+PrintCompilation"],
      upload,
      self.benchmark_cmd + ["petclinic-wrk:mixed-tiny", "--"] +            self.extra_vm_args + ["-Xms32m",   "-Xmx100m",  "-XX:ActiveProcessorCount=1", "-XX:+PrintGC", "-XX:+PrintCompilation"],
      upload,
      self.benchmark_cmd + ["petclinic-wrk:mixed-small", "--"] +           self.extra_vm_args + ["-Xms40m",   "-Xmx128m",  "-XX:ActiveProcessorCount=2", "-XX:+PrintGC", "-XX:+PrintCompilation"],
      upload,
      self.benchmark_cmd + ["petclinic-wrk:mixed-medium", "--"] +          self.extra_vm_args + ["-Xms80m",   "-Xmx256m",  "-XX:ActiveProcessorCount=4", "-XX:+PrintGC", "-XX:+PrintCompilation"],
      upload,
      self.benchmark_cmd + ["petclinic-wrk:mixed-large", "--"] +           self.extra_vm_args + ["-Xms320m",  "-Xmx1280m", "-XX:ActiveProcessorCount=16", "-XX:+PrintGC", "-XX:+PrintCompilation"],
      upload,
      self.benchmark_cmd + ["petclinic-wrk:mixed-huge", "--"] +            self.extra_vm_args + ["-Xms640m",  "-Xmx3072m", "-XX:ActiveProcessorCount=32", "-XX:+PrintGC", "-XX:+PrintCompilation"],
      upload,
