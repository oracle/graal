{
  ...
  local main_builds = [
    ...
    c.weekly     + hw.x52 + jdk8  + cc.libgraal + bench.renaissance_0_13,
    c.on_demand  + hw.x52 + jdk8  + cc.jargraal + bench.renaissance_0_13,
    ...
    c.weekly     + hw.x52 + jdk11 + cc.libgraal + bench.renaissance_0_13,
    c.on_demand  + hw.x52 + jdk11 + cc.jargraal + bench.renaissance_0_13,
    ...
    c.daily      + hw.x52 + jdk17 + cc.libgraal + bench.renaissance_0_13,
    c.weekly     + hw.x52 + jdk17 + cc.jargraal + bench.renaissance_0_13,
