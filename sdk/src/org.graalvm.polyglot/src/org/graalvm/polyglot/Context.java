...
public final class Context implements AutoCloseable {
     ...
     * <li>If the host value is an instance of {@link Boolean} then it will be interpreted as polyglot
     * {@link Value#isBoolean() boolean}.
     * <li>If the host value is a {@link Proxy polyglot proxy} then it will be interpreted according to
     * the behavior specified by the proxy. See the javadoc of the proxy subclass for further details.
     * <li>If the host value is a non-primitive {@link Value#as(Class) mapped Java value} then the it
     * will be interpreted according to the original value. For example if a guest language object was
     * mapped to {@link Map} then the original guest language object will be preserved when converting
     * to a polyglot value.
     * <li>TODO do we want to support Map here?
     * <li>If the host value is of type {@link List}, {@link Set}, {@link Collection} or
     * {@link Iterable} then it will be interpreted as value with {@link Value#hasArrayElements() array
     * elements}. The value will also be treated as {@link Value#isHostObject() host object}.
     ...
     * {@link Value#isHostObject() host object}. Host objects expose all their public java fields and
     * methods as {@link Value#getMember(String) members}. Each member is {@link Value#canExecute()
     * executable}.
     * </ol>
     * <p>
     *
