...
public final class Value extends AbstractValue {
     ...
     * <p>
     * Static members are not returned unless called on a {@link #getStaticProvider() static
     * provider}.
     *
     * @throws IllegalStateException if the context is already {@link Context#close() closed}.
    ...
    /**
     * Returns <code>true</code> if this value has a {@link #getStaticProvider() static receiver}.
     ...
     * @since 24.2
     */
    public boolean hasStaticProvider() {
        return dispatch.hasStaticReceiver(this.context, receiver);
    }

    /**
     * Returns a static provider. Static provider is an object that provides static members, i.e.
     ...
     * has declared members}, then the static provider also has (static) members and/or (static)
     * declared members.
     *
     * @throws UnsupportedOperationException if and only if the value does not
     *             {@link #hasStaticProvider() have a static provider}.
     * @throws IllegalStateException if the context is already {@link Context#close() closed}.
     * @throws PolyglotException if a guest language error occurred during execution.
     * @see #hasStaticProvider()
     * @see #getMembers()
     * @see #getDeclaredMembers()
     * @since 24.2
     */
    public Value getStaticProvider() {
