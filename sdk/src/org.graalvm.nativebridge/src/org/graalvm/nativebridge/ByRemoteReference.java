 ...
 * method return type as a reference to a foreign object that exists in the target isolate.
 *
 * <p>
 * Behavior details:
 * </p>
 * <ul>
 * <li><strong>For method parameters:</strong> The raw value of the remote reference is unboxed from
 * the proxy object and sent to the target isolate, where it is resolved to the target object, for
 * example, using {@link ReferenceHandles#resolve(long, Class)}.</li>
 * <li><strong>For method return values:</strong> A raw representation of the object is created in
 * the isolate, such as by using {@link ReferenceHandles#create(Object)}. This representation is
 * sent to the caller, where the DSL instantiates a proxy object for it.</li>
 * </ul>
 *
 * <p>
