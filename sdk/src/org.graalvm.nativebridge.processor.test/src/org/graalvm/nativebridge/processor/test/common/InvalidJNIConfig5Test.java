...
@GenerateHotSpotToNativeBridge(jniConfig = InvalidJNIConfig5Test.JNIConfigProvider.class, include = NotIncludedAutomatically.class)
abstract class InvalidJNIConfig5Test extends NativeObject implements Service {

    InvalidJNIConfig5Test(NativeIsolate isolate, long handle) {
