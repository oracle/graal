...
abstract class ForeignHandler implements Handler, ForeignObject {

    ForeignHandler() {
    }

    @Override
    public abstract void publish(@ByLocalReference(ForeignCustomLanguageDispatch.class) LanguageAPI language,
                    @ByLocalReference(ForeignRecord.class) Record record);

    @Override
    @ByRemoteReference(ForeignHandler.class)
    public abstract Handler combine(@ByRemoteReference(ForeignHandler.class) Handler h1, @ByRemoteReference(ForeignHandler.class) Handler... others);

    @Override
    @ByLocalReference(ForeignContext.class)
