...
abstract class ForeignNonCollidingOverload implements NonCollidingOverload, ForeignObject {

    @Override
    public abstract void byReferenceNonColliding(int a, @ByLocalReference(ForeignService.class) Service service);

    @Override
    public abstract void byReferenceNonColliding(String a, @ByLocalReference(ForeignNonCollidingOverload.class) NonCollidingOverload service);
}
