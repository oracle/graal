...
abstract class InvalidIsolateDeathHandler8Test implements ForeignObject, Service {

    @Override
    @IsolateDeathHandler(InvalidIsolateDeathHandler8TestHandler.class)
    @ExpectError("The handler specified by the `@IsolateDeathHandler` annotation throws a Java checked exception `IOException`, " +
                    "but the method `public abstract boolean execute()` does not declare `IOException` in its throws clause.%n" +
                    "To fix this, change `InvalidIsolateDeathHandler8TestHandler` to throw a Java unchecked exception or checked exception " +
                    "thrown by `public abstract boolean execute()` method.")
    public abstract boolean execute();
}

final class InvalidIsolateDeathHandler8TestHandler {
    @SuppressWarnings("unused")
    static void handleIsolateDeath(Object receiver, IsolateDeathException exception) throws IOException {
