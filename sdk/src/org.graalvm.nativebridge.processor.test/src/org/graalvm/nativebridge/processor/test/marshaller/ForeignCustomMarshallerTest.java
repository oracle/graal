...
@GenerateHotSpotToNativeBridge(factory = ForeignServiceFactory.class, implementation = LocalCustomMarshallerService.class)
@GenerateNativeToNativeBridge(factory = ForeignServiceFactory.class, implementation = LocalCustomMarshallerService.class)
@GenerateNativeToHotSpotBridge(factory = ForeignServiceFactory.class)
@GenerateProcessToProcessBridge(factory = ForeignServiceFactory.class, implementation = LocalCustomMarshallerService.class)
abstract class ForeignCustomMarshallerTest implements CustomMarshallerService, ForeignObject {
