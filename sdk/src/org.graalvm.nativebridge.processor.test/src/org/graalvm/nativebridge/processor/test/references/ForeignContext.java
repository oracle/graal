...
abstract class ForeignContext implements Context, ForeignObject {
    ...
    @ByRemoteReference(ForeignCustomLanguageDispatch.class)
    public abstract LanguageAPI getLanguage();
}
