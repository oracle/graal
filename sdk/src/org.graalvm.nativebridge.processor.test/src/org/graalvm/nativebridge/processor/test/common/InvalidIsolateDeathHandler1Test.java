...
@IsolateDeathHandler(InvalidIsolateDeathHandler1TestHandler.class)
@ExpectError("The class specified in the `@IsolateDeathHandler` annotation must declare an accessible static void method named `handleIsolateDeath`. " +
                ...
                "To resolve this, add the following method to InvalidIsolateDeathHandler1TestHandler:%n" +
                "  static void handleIsolateDeath(Object receiver, IsolateDeathException exception)")
abstract class InvalidIsolateDeathHandler1Test implements ForeignObject, Service {
}

final class InvalidIsolateDeathHandler1TestHandler {

    @SuppressWarnings("unused")
    static void handle(Object receiver, IsolateDeathException exception) {
