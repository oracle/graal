...
@GenerateHotSpotToNativeFactory(marshallers = TestMarshallerConfig.class, initialService = PureHotSpotToNativeService.class)
final class PureHotSpotToNative {

}

@GenerateHotSpotToNativeBridge(factory = PureHotSpotToNative.class, implementation = LocalService.class)
abstract class PureHotSpotToNativeService implements Service, ForeignObject {
