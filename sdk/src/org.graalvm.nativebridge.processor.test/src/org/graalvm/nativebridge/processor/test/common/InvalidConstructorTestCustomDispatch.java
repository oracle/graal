...
abstract class InvalidConstructorTestCustomDispatch extends CustomReceiverService {

    @SuppressWarnings("unused")
    InvalidConstructorTestCustomDispatch(int num) {
    }

    @SuppressWarnings("unused")
    InvalidConstructorTestCustomDispatch(Object obj) {
    }
