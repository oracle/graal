...
@GenerateHotSpotToNativeBridge(jniConfig = InvalidJNIConfig1Test.JNIConfigProvider.class, include = NotIncludedAutomatically.class)
abstract class InvalidJNIConfig1Test extends NativeObject implements Service {

    InvalidJNIConfig1Test(NativeIsolate isolate, long handle) {
