...
abstract class HSCollidingOverload extends HSObject implements CollidingOverload {

    HSCollidingOverload(JNI.JNIEnv env, JNI.JObject handle) {
        super(env, handle);
    }
    ...
    @ExpectError("The method generated for `public abstract void colliding(java.time.Duration[] duration)` conflicts with a generated method for an overloaded method `public abstract void colliding(Duration duration)`. " +
                    "To resolve this, make `public abstract void colliding(java.time.Duration[] duration)` final within the `HSCollidingOverload` and delegate its functionality to a new abstract method. " +
    ...
    @ExpectError("The method generated for `public abstract void byReferenceColliding(NonCollidingOverload service)` conflicts with a generated method for an overloaded method `public abstract void byReferenceColliding(Service service)`. " +
                    "To resolve this, make `public abstract void byReferenceColliding(NonCollidingOverload service)` final within the `HSCollidingOverload` and delegate its functionality to a new abstract method. " +
                    "This new method should have a unique name, the same signature, and be annotated with `@ReceiverMethod`. For more details, please refer to the `ReceiverMethod` JavaDoc.")
    public abstract void byReferenceColliding(@ByReference(NativeNonCollidingOverload.class) NonCollidingOverload service);
}
