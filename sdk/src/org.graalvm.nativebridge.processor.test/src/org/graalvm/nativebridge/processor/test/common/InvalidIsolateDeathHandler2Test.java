...
@IsolateDeathHandler(InvalidIsolateDeathHandler2TestHandler.class)
@ExpectError("The class specified in the `@IsolateDeathHandler` annotation must declare an accessible static void method named `handleIsolateDeath`. " +
                ...
                "To resolve this, add the following method to InvalidIsolateDeathHandler2TestHandler:%n" +
                "  static void handleIsolateDeath(Object receiver, IsolateDeathException exception)")
abstract class InvalidIsolateDeathHandler2Test implements ForeignObject, Service {
}

final class InvalidIsolateDeathHandler2TestHandler {

    @SuppressWarnings("unused")
    private static void handleIsolateDeath(Object receiver, IsolateDeathException exception) {
