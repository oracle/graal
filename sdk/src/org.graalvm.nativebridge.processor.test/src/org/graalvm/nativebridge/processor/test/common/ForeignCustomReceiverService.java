...
public abstract class ForeignCustomReceiverService extends CustomReceiverService {

    @CustomDispatchAccessor
    static CustomReceiverService getDispatch(ServiceAPI api) {
        return api.dispatch;
    }

    @CustomReceiverAccessor
    static Object getReceiver(ServiceAPI api) {
        return api.receiver;
    }
}
