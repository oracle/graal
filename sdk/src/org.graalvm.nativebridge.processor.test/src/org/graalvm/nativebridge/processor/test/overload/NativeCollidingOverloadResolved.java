...
abstract class NativeCollidingOverloadResolved extends NativeObject implements CollidingOverload {

    NativeCollidingOverloadResolved(NativeIsolate isolate, long handle) {
    ...
    abstract void byReferenceCollidingResolved(@ByReference(HSNonCollidingOverload.class) NonCollidingOverload service);
}
