...
abstract class NativeNonCollidingOverload extends NativeObject implements NonCollidingOverload {

    NativeNonCollidingOverload(NativeIsolate isolate, long handle) {
        super(isolate, handle);
    }

    @Override
    public abstract void byReferenceNonColliding(int a, @ByReference(HSService.class) Service service);

    @Override
    public abstract void byReferenceNonColliding(String a, @ByReference(HSNonCollidingOverload.class) NonCollidingOverload service);
}
