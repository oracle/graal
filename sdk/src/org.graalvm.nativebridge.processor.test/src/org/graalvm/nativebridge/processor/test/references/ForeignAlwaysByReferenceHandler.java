...
import org.graalvm.nativebridge.AlwaysByLocalReference;
...
@AlwaysByLocalReference(type = Context.class, startPointClass = ForeignContext.class)
@AlwaysByLocalReference(type = LanguageAPI.class, startPointClass = ForeignCustomLanguageDispatch.class)
@AlwaysByLocalReference(type = Record.class, startPointClass = ForeignRecord.class)
@AlwaysByRemoteReference(type = Handler.class, startPointClass = ForeignHandler.class)
...
abstract class ForeignAlwaysByReferenceHandler implements Handler, ForeignObject {
}
