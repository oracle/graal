...
abstract class ForeignCollidingOverloadResolved implements CollidingOverload, ForeignObject {
    ...
    abstract void byReferenceCollidingResolved(@ByLocalReference(ForeignNonCollidingOverload.class) NonCollidingOverload service);
}
