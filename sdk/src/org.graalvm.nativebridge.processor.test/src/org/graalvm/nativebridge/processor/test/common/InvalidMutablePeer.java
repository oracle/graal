...
@ExpectError("Classes with custom dispatch cannot have mutable peers. To fix this, remove the `@MutablePeer` annotation from the class.")
@MutablePeer
...
abstract class InvalidMutablePeer extends CustomReceiverService {
