...
@ExpectError("The annotated type must implement `ForeignObject`, or have a custom dispatch.%n" +
                "To bridge a class, extend the class, add implement ForeignObject interface.%n" +
                "To bridge an interface, implement the interface and ForeignObject.%n" +
...
abstract class InvalidBaseType4Test implements Service {
