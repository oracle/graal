...
import org.graalvm.nativebridge.processor.test.Service2;
...
@IsolateDeathHandler(ForeignService2Handler1.class)
abstract class ForeignServiceWithIsolateDeathHandler2 implements ForeignObject, Service2 {

    @Override
    @IsolateDeathHandler(ForeignService2Handler2.class)
    public abstract void close() throws IOException;
}

final class ForeignService2Handler1 {
...
final class ForeignService2Handler2 {
