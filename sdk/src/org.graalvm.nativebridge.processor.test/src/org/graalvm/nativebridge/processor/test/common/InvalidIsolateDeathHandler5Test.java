...
@IsolateDeathHandler(InvalidIsolateDeathHandler5TestHandler.class)
@ExpectError("The class specified in the `@IsolateDeathHandler` annotation must declare an accessible static void method named `handleIsolateDeath`. " +
                ...
                "To resolve this, add the following method to InvalidIsolateDeathHandler5TestHandler:%n" +
                "  static void handleIsolateDeath(Object receiver, IsolateDeathException exception)")
abstract class InvalidIsolateDeathHandler5Test implements ForeignObject, Service {
}

final class InvalidIsolateDeathHandler5TestHandler {

    @SuppressWarnings("unused")
    static void handleIsolateDeath(String receiver, IsolateDeathException exception) {
