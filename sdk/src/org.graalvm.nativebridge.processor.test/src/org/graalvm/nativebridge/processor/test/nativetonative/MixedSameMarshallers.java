...
@GenerateHotSpotToNativeFactory(marshallers = TestMarshallerConfig.class, initialService = MixedFactorySameMarshallersService.class)
@GenerateNativeToNativeFactory(marshallers = TestMarshallerConfig.class, initialService = MixedFactorySameMarshallersService.class)
final class MixedFactorySameMarshallers {
}

@GenerateHotSpotToNativeBridge(factory = MixedFactorySameMarshallers.class, implementation = LocalService.class)
