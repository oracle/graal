...
@GenerateNativeToNativeBridge(jniConfig = MixedNativeToNativeServiceDifferentConfigs.OtherJNIConfig.class, include = NotIncludedAutomatically.class)
abstract class MixedNativeToNativeServiceDifferentConfigs extends NativeObject implements Service {

    MixedNativeToNativeServiceDifferentConfigs(NativeIsolate isolate, long handle) {
        super(isolate, handle);
    }

    public static final class OtherJNIConfig {
