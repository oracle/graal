...
@ExpectError("Invalid service registration: The service definition `ForeignCollidingOverload` is not listed in `@GenerateProcessToProcessFactory.services` of `ForeignServiceFactory`.%n" +
                "To resolve this, include `ForeignCollidingOverload` in the `services` attribute of `@GenerateProcessToProcessFactory` in `ForeignServiceFactory`.")
...
abstract class ForeignCollidingOverload implements CollidingOverload, ForeignObject {
    ...
    @ExpectError("The method generated for `public abstract void colliding(java.time.Duration[] duration)` conflicts with a generated method for an overloaded method `public abstract void colliding(Duration duration)`. " +
                    "To resolve this, make `public abstract void colliding(java.time.Duration[] duration)` final within the `ForeignCollidingOverload` and delegate its functionality to a new abstract method. " +
    ...
    @Override
    public abstract void byReferenceColliding(@ByLocalReference(ForeignService.class) Service service);
    ...
    @ExpectError("The method generated for `public abstract void byReferenceColliding(NonCollidingOverload service)` conflicts with a generated method for an overloaded method `public abstract void byReferenceColliding(Service service)`. " +
                    "To resolve this, make `public abstract void byReferenceColliding(NonCollidingOverload service)` final within the `ForeignCollidingOverload` and delegate its functionality to a new abstract method. " +
                    "This new method should have a unique name, the same signature, and be annotated with `@ReceiverMethod`. For more details, please refer to the `ReceiverMethod` JavaDoc.")
    public abstract void byReferenceColliding(@ByLocalReference(ForeignNonCollidingOverload.class) NonCollidingOverload service);
}
