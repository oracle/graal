...
@ExpectError("Configuration mismatch: `InvalidServices3Service` is listed in `@GenerateProcessToProcessFactory.services`, but its `@GenerateProcessToProcessBridge.factory` attribute does not match `InvalidServices3Factory1`.%n" +
                "To resolve this, set `@GenerateProcessToProcessBridge.factory = InvalidServices3Factory1` in `InvalidServices3Service`.")
@GenerateProcessToProcessFactory(marshallers = TestMarshallerConfig.class, initialService = InvalidServices3Service.class, services = {InvalidServices3Service.class})
final class InvalidServices3Factory1 {
}

@GenerateProcessToProcessFactory(marshallers = TestMarshallerConfig.class, initialService = InvalidServices3Service.class, services = {InvalidServices3Service.class})
final class InvalidServices3Factory2 {
}

@GenerateProcessToProcessBridge(factory = InvalidServices3Factory2.class, implementation = LocalService.class)
