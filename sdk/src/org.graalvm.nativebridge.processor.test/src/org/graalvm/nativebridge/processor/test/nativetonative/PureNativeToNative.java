...
@GenerateNativeToNativeFactory(marshallers = TestMarshallerConfig.class, initialService = PureNativeToNativeService.class)
final class PureNativeToNative {

}

@GenerateNativeToNativeBridge(factory = PureNativeToNative.class, implementation = LocalService.class)
abstract class PureNativeToNativeService implements Service, ForeignObject {
