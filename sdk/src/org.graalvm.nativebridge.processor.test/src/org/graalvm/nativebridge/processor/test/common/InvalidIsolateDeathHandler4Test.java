...
@IsolateDeathHandler(InvalidIsolateDeathHandler4TestHandler.class)
@ExpectError("The class specified in the `@IsolateDeathHandler` annotation must declare an accessible static void method named `handleIsolateDeath`. " +
                ...
                "To resolve this, add the following method to InvalidIsolateDeathHandler4TestHandler:%n" +
                "  static void handleIsolateDeath(Object receiver, IsolateDeathException exception)")
abstract class InvalidIsolateDeathHandler4Test implements ForeignObject, Service {
}

final class InvalidIsolateDeathHandler4TestHandler {

    static void handleIsolateDeath() {
