...
@GenerateHotSpotToNativeBridge(jniConfig = InvalidJNIConfig4Test.JNIConfigProvider.class, include = NotIncludedAutomatically.class)
abstract class InvalidJNIConfig4Test extends NativeObject implements Service {

    InvalidJNIConfig4Test(NativeIsolate isolate, long handle) {
        super(isolate, handle);
    }

    static final class JNIConfigProvider {
        @SuppressWarnings("static-method")
        JNIConfig getInstance() {
            return null;
        }
    }
}
