...
@IsolateDeathHandler(InvalidIsolateDeathHandler7TestHandler.class)
@ExpectError("The class specified in the `@IsolateDeathHandler` annotation must declare an accessible static void method named `handleIsolateDeath`. " +
                ...
                "To resolve this, add the following method to InvalidIsolateDeathHandler7TestHandler:%n" +
                "  static void handleIsolateDeath(Object receiver, IsolateDeathException exception)")
abstract class InvalidIsolateDeathHandler7Test implements ForeignObject, Service {
}

final class InvalidIsolateDeathHandler7TestHandler {

    @SuppressWarnings("unused")
    static RuntimeException handleIsolateDeath(Object receiver, IsolateDeathException exception) {
        return null;
    }
}
