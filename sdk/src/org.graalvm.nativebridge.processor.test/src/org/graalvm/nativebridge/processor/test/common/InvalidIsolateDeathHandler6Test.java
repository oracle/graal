...
@IsolateDeathHandler(InvalidIsolateDeathHandler6TestHandler.class)
@ExpectError("The class specified in the `@IsolateDeathHandler` annotation must declare an accessible static void method named `handleIsolateDeath`. " +
                ...
                "To resolve this, add the following method to InvalidIsolateDeathHandler6TestHandler:%n" +
                "  static void handleIsolateDeath(Object receiver, IsolateDeathException exception)")
abstract class InvalidIsolateDeathHandler6Test implements ForeignObject, Service {
}

final class InvalidIsolateDeathHandler6TestHandler {

    @SuppressWarnings("unused")
    static void handleIsolateDeath(Object receiver, RuntimeException exception) {
