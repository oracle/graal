...
abstract class ForeignBaseReferenceService implements ForeignObject, BaseReferenceService {

    @Override
    @ByRemoteReference(ForeignObject.class)
    public abstract Object getRemoteReference();

    @Override
    public abstract void setRemoteReference(@ByRemoteReference(ForeignObject.class) Object reference);

    @Override
    @ByLocalReference(ForeignObject.class)
    public abstract Object getLocalReference();

    @Override
    public abstract void setLocalReference(@ByLocalReference(ForeignObject.class) Object reference);
}
