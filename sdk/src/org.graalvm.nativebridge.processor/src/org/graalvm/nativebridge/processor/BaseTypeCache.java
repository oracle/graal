...
public class BaseTypeCache {
    ...
    public final DeclaredType assertionError;
    public final DeclaredType clazz;
    public final DeclaredType map;
    public final DeclaredType math;
    public final DeclaredType collections;
    public final DeclaredType object;
    public final DeclaredType objects;
    public final DeclaredType string;
    public final DeclaredType suppressWarnings;
    public final DeclaredType throwable;
    public final DeclaredType runtimeException;
    public final DeclaredType override;
    public final DeclaredType list;

    public BaseTypeCache(AbstractProcessor processor) {
        ...
        DeclaredType classWildcardType = processor.typeUtils().getDeclaredType(classTypeElement, wildcardType);

        this.clazz = classWildcardType;
