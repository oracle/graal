...
import static org.graalvm.nativebridge.processor.HotSpotToNativeFactoryParser.getNativeIsolateHandler;

final class NativeToNativeFactoryParser extends AbstractFactoryParser {

    static final String GENERATE_NATIVE_TO_NATIVE_ANNOTATION = "org.graalvm.nativebridge.GenerateNativeToNativeFactory";

    private NativeToNativeFactoryParser(NativeBridgeProcessor processor, HotSpotToNativeTypeCache typeCache,
    ...
    AbstractBridgeGenerator createGenerator(DefinitionData definitionData) {
        return new NativeToNativeFactoryGenerator(this, (HotSpotToNativeFactoryDefinitionData) definitionData, getTypeCache());
    }

    static NativeToNativeFactoryParser create(NativeBridgeProcessor processor) {
        HotSpotToNativeTypeCache typeCache = new HotSpotToNativeTypeCache(processor);
        return new NativeToNativeFactoryParser(processor, typeCache, typeCache.generateNativeToNativeFactory, typeCache.generateNativeToNativeBridge);
    }
}
