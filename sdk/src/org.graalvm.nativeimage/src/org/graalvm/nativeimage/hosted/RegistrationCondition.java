 ...
 * <ul>
 * <li>{@link #typeReached} - signifies that the type must be both reachable by static analysis at
 * build time, and reached at run time.</li>
...
public interface RegistrationCondition {
    ...
    /**
     * Creates the {@code typeReached} condition, which is satisfied when the type is reached at
