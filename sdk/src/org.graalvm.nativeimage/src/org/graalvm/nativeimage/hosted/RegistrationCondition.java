 ...
 * <ul>
 * <li>{@link #typeReached} which signifies that the type must be both reachable by static analysis
 * at build time, and reached at run time.</li>
 * <li>{@link #always} is a condition that is always satisfied.</li>
 * </ul>
 * </p>
 *
