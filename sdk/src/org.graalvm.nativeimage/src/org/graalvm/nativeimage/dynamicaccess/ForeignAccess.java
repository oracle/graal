 ...
 * <p>
 * All methods in {@link ForeignAccess} require a {@link RegistrationCondition} as their first
 * parameter. Registration for foreign access will happen only if the specified condition is
 * satisfied.
 *
 * <h3>How to use</h3>
 *
...
public interface ForeignAccess {
     ...
     * {@link #registerForUpcall(RegistrationCondition, Object, Object...)}).
     * <p>
