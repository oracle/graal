 ...
 * <p>
 * All methods in {@link ResourceAccess} require a {@link RegistrationCondition} as their first
 * parameter. Resources will be registered for runtime access only if the specified condition is
 * satisfied.
 *
 * <h3>How to use</h3>
 *
 ...
 *     resources.register(RegistrationCondition.always(), "example/directory/concreteResource");
