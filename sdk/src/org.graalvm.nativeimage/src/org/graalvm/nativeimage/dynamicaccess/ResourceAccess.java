...
public interface ResourceAccess {
    ...
    /**
     * Registers the provided {@link java.util.ResourceBundle} for runtime access, if the
     * {@code condition} is satisfied. The {@code bundle} must be obtained via any version of the
     * {@link java.util.ResourceBundle#getBundle} method. A bundle created in any other way will
     * result in an error.
     * 
     * @since 25.0
     */
    void registerResourceBundle(AccessCondition condition, ResourceBundle bundle);
