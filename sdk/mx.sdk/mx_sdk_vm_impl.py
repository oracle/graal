...
def mx_register_dynamic_suite_constituents(register_project, register_distribution):
    ...
    all_artifacts_deps = ["GRAALVM", "GRAALVM_STANDALONES"] + other_graalvm_artifact_names
    register_distribution(mx.LayoutDirDistribution(
        suite=_suite,
...
def graalvm_show(args, forced_graalvm_dist=None):
    ...
    parser.add_argument('-v', '--verbose', action='store_true', help='print additional information about standalones')
    args = parser.parse_args(args)
