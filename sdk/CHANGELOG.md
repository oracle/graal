...
## Version 21.3.0
* Added the ability to share values between contexts. Please note the limitations and restrictions in the [Context](https://www.graalvm.org/sdk/javadoc/org/graalvm/polyglot/Context.html#Isolation) javadoc.
