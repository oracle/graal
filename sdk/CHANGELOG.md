...
* (GR-30473) Added a predefined [CONSTRAINED host access](https://www.graalvm.org/sdk/javadoc/org/graalvm/polyglot/HostAccess.html#CONSTRAINED) that satisfies the `SandboxPolicy#CONSTRAINED requirements`. This host access is the default value for a Context with `SandboxPolicy#CONSTRAINED`.
* (GR-30473) Added a predefined [ISOLATED host access](https://www.graalvm.org/sdk/javadoc/org/graalvm/polyglot/HostAccess.html#ISOLATED) that satisfies the `SandboxPolicy#ISOLATED requirements`. This host access is the default value for a Context with `SandboxPolicy#ISOLATED` or `SandboxPolicy#UNTRUSTED`.
