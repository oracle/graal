...
* Added [a factory method](https://www.graalvm.org/sdk/javadoc/org/graalvm/polyglot/io/FileSystem.html#newDefaultFileSystem--) creating a default `FileSystem` based on the Java NIO. The obtained instance can be used as a delegate in a decorating filesystem.
