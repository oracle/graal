...
* Added `FileSystem#allowInternalResourceAccess(FileSystem, boolean)`, allowing embedders to expose internal resources and language homes through a read-only view of the default file system when using a custom file system.
