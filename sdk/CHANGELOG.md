...
* Added sub-process output (error output) [redirection into OutputStream](http://www.graalvm.org/sdk/javadoc/org/graalvm/polyglot/io/ProcessHandler.Redirect.html#stream-java.io.OutputStream-).
