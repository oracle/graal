...
* (GR-41716) Added `HostAccess.Builder.allowMutableDefaultMappings(boolean)` to explicitly enable type coercion from guest objects to mutable Java host objects such as `java.util.Map` or `java.util.List`.
