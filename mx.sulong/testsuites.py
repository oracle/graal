...
def compileSulongSuite():
    ...
    tools.printProgress(tools.multicompileFolder(_sulongSuiteDir, _cacheDir, [tools.Tool.CLANG, tools.Tool.GCC], ['-Iinclude'], [tools.Optimization.O0], tools.ProgrammingLanguage.LLVMIR, optimizers=[tools.Tool.BB_VECTORIZE]))
