...
def _truffle_gate_runner(args, tasks):
    ...
    with Task('Static Object Model UnitTests with array-based storage', tasks) as t:
        if t: unittest(list(['--suite', 'truffle', '--enable-timing', '--verbose', '--fail-fast', '--regex', 'com.oracle.truffle.api.staticobject.test', '--', '-Dcom.oracle.truffle.api.staticobject.ArrayBasedStorage=true', '-Dcom.oracle.truffle.api.staticobject.ShapeChecks=true']))
