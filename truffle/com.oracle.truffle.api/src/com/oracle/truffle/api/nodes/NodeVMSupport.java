...
final class NodeVMSupport {
    private static final LoopNode.TVMCI SUPPORT = Truffle.getRuntime().getCapability(LoopNode.TVMCI.class);

    @SuppressWarnings(value = "deprecation")
    static void onLoopCount(Node source, int iterations) {
        if (SUPPORT != null) {
