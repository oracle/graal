...
public class SourceSectionFilterTest {
    ...
    public void testEmpty() {
        Source sampleSource = Source.newBuilder("line1\nline2\nline3\nline4").name(null).mimeType(InstrumentationTestLanguage.MIME_TYPE).build();
    ...
    private static Node source(Class<?>... tags) {
        return createNode(Source.newBuilder("foo").name(null).mimeType(InstrumentationTestLanguage.MIME_TYPE).build().createSection(null, 0, 3), tags);
    }
    ...
    public void testComplexFilter() {
        Source sampleSource1 = Source.newBuilder("line1\nline2\nline3\nline4").name(null).mimeType("mime2").build();
