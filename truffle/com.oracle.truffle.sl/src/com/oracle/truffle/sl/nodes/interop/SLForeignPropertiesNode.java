...
@AcceptMessage(value = "PROPERTIES", receiverType = SLObjectType.class, language = SLLanguage.class)
public final class SLForeignPropertiesNode extends SLPropertiesBaseNode {
    @Override
