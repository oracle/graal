...
import com.oracle.truffle.nfi.LibFFISymbolMessageResolutionFactory.SignatureCacheNodeGen;
...
class LibFFISymbolMessageResolution {
    ...
    abstract static class BindNode extends Node {
        ...
        public TruffleObject access(LibFFISymbol receiver, String method, Object[] args) {
