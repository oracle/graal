...
public class LegacyMergedLibraryTest extends AbstractLibraryTest {

    @ExportLibrary(InteropLibrary.class)
    static class LegacyMyObject extends DynamicObject implements TruffleObject {
        LegacyMyObject(Shape shape) {
            super(shape);
        }
    ...
    public void testMembers() throws UnsupportedMessageException, UnknownIdentifierException, UnsupportedTypeException {
        ...
        DynamicObject obj = new LegacyMyObject(shape);
