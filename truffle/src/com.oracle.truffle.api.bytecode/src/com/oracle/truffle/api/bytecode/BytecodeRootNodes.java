...
public abstract class BytecodeRootNodes<T extends RootNode & BytecodeRootNode> {
     ...
     * more information (e.g., sources, instrumentation or tags), may trigger a reparse to obtain
     * it.
     * <p>
     ...
     * {@link BytecodeRootNodes} unit. Reparsing and modfiying the generated bytecodes will also
     ...
     * also requires to reparse all root nodes.
     * <p>
