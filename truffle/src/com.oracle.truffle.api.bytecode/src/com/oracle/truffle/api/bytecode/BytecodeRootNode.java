...
public interface BytecodeRootNode {
    ...
    /**
     * Reads the {@code bci} stored in the frame. Note that a bytecode index is not meaningful
     * without an accompanying {@link BytecodeNode}; this node can be obtained from a stack walk.
     * <p>
