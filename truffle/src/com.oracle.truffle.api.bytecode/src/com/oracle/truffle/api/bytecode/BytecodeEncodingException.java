...
/**
 * Class representing an exception thrown by a {@link BytecodeBuilder} when the program cannot be
 * encoded, for example, when the bytecode exceeds the maximum addressable bytecode size.
 *
 * @since 24.2
 */
