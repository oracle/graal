...
public @interface GenerateBytecode {
     ...
     * <p>
     * When serialization is enabled, the generated {@link BytecodeRootNodes} class overrides
     * {@link BytecodeRootNodes#serialize}. The generated bytecode root node class also defines
     * static {@code serialize} and {@code deserialize} methods. All of these methods can be used to
     * convert bytecode nodes to and from a serialized byte array representation.
     * <p>
