...
public abstract class DynamicObject implements TruffleObject {
    ...
    public abstract static class PutNode extends Node {
        ...
        static boolean doCached(DynamicObject receiver, Object key, Object value, int mode, int propertyFlags,
                        ...
                        @Cached("newShape.getValidAssumption()") Assumption newShapeValidAssumption) {
        ...
        static boolean doUncached(DynamicObject receiver, Object key, Object value, int mode, int propertyFlags) {
            return ObsolescenceStrategy.putGeneric(receiver, key, value, propertyFlags, mode);
        }
    ...
    public abstract static class CopyPropertiesNode extends Node {
        ...
        static void doUncached(DynamicObject from, DynamicObject to) {
    ...
    public abstract static class ContainsKeyNode extends Node {
        ...
        @Specialization(replaces = "doCached")
        static boolean doUncached(DynamicObject receiver, Object key) {
    ...
    public abstract static class RemoveKeyNode extends Node {
        ...
        static boolean doCached(DynamicObject receiver, Object key,
            ...
            if (oldShape.isValid()) {
                ...
                removePropertyUncached(receiver, oldShape, cachedProperty);
            }
            return true;
        }
        ...
        static boolean doUncached(DynamicObject receiver, Object key) {
            ...
            removePropertyUncached(receiver, oldShape, existingProperty);
            return true;
        }

        @TruffleBoundary
        static boolean removePropertyUncached(DynamicObject receiver, Shape cachedShape, Property cachedProperty) {
    ...
    public abstract static class GetShapeFlagsNode extends Node {
        ...
        @Specialization(replaces = "doCached")
        static int doUncached(DynamicObject receiver) {
    ...
    public abstract static class HasShapeFlagsNode extends Node {
        ...
        @Specialization(replaces = "doCached")
        static boolean doUncached(DynamicObject receiver, int flags) {
    ...
    public abstract static class SetShapeFlagsNode extends Node {
         ...
         *
         * @param newFlags the flags to set; must be in the range from 0 to 255 (inclusive).
    ...
    public abstract static class IsSharedNode extends Node {
        ...
        @Specialization(replaces = "doCached")
        static boolean doUncached(DynamicObject receiver) {
    ...
    public abstract static class GetDynamicTypeNode extends Node {
        ...
        @Specialization(replaces = "doCached")
        static Object doUncached(DynamicObject receiver) {
    ...
    public abstract static class SetDynamicTypeNode extends Node {
        ...
        @Specialization(replaces = "doCached")
        static boolean doUncached(DynamicObject receiver, Object objectType,
                        @Bind("receiver.getShape()") Shape shape) {
    ...
    public abstract static class GetPropertyFlagsNode extends Node {
        ...
        @Specialization(replaces = "doCached")
        static int doUncached(DynamicObject receiver, Object key, int defaultValue) {
    ...
    public abstract static class SetPropertyFlagsNode extends Node {
        ...
        static boolean doCached(DynamicObject receiver, Object key, int propertyFlags,
            ...
            if (cachedProperty.getFlags() != cachedPropertyFlags) {
                if (oldShape.isValid()) {
                    ...
                    changePropertyFlagsUncached(receiver, oldShape, cachedProperty, cachedPropertyFlags);
                }
            }
            return true;
        }
        ...
        @TruffleBoundary
        @Specialization(replaces = "doCached")
        static boolean doSetPropertyFlags(DynamicObject receiver, Object key, int propertyFlags) {
            Shape oldShape = receiver.getShape();
            Property existingProperty = oldShape.getProperty(key);
            if (existingProperty == null) {
                return false;
            ...
            if (existingProperty.getFlags() != propertyFlags) {
                changePropertyFlagsUncached(receiver, oldShape, existingProperty, propertyFlags);
            }
            return true;
        }

        @TruffleBoundary
        private static void changePropertyFlagsUncached(DynamicObject receiver, Shape cachedShape, Property cachedProperty, int propertyFlags) {
    ...
    public abstract static class UpdateShapeNode extends Node {
        ...
        static boolean doUncachedValid(DynamicObject receiver,
                        @Bind("receiver.getShape()") Shape shape) {
            return false;
        }
    ...
    public abstract static class ResetShapeNode extends Node {
        ...
        static boolean doCached(DynamicObject receiver, Shape otherShape,
            ...
            return doUncached(receiver, cachedOtherShape, cachedShape);
        }

        @Specialization(replaces = "doCached")
        static boolean doUncached(DynamicObject receiver, Shape otherShape,
                        @Bind("receiver.getShape()") Shape shape) {
            if (shape == otherShape) {
                return false;
            }
    ...
    public abstract static class GetPropertyNode extends Node {
        ...
        @Specialization(replaces = "doCached")
        static Property doUncached(DynamicObject receiver, Object key) {
