...
/**
 * Helper methods per generated node class.
 */
public final class HelperMethods {

    private final Map<String, CodeExecutableElement> helperMethods = new LinkedHashMap<>();

    public void appendToClass(CodeTypeElement clazz) {
        clazz.getEnclosedElements().addAll(helperMethods.values());
        helperMethods.clear();
    }

    public void add(String name, Supplier<CodeExecutableElement> method) {
