...
public final class ExportMessageElement extends MessageContainer {

    private final ExportMessageData export;
    private final Element element;
    private final AnnotationMirror annotation;
    private NodeData specializedNode;

    public ExportMessageElement(ExportMessageData export, Element element, AnnotationMirror annotation) {
        this.export = export;
    ...
    public ExportMessageData getExport() {
        return export;
    }
