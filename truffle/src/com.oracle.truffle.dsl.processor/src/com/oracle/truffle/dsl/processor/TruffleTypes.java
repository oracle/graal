...
public class TruffleTypes {
    ...
    public static final String UncachedNode_Name = "com.oracle.truffle.api.nodes.UncachedNode";
    ...
    public final DeclaredType UncachedNode = c.getDeclaredType(UncachedNode_Name);
