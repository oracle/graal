...
final class ArrayBasedStaticShape<T> extends StaticShape<T> {
    ...
    Object getStorage(Object obj, boolean primitive) {
        Object receiverObject = cast(obj, storageClass, true);
        if (safetyChecks) {
    ...
    private boolean checkShape(Object receiverObject) {
        ArrayBasedStaticShape<?> receiverShape = cast(UNSAFE.getObject(receiverObject, (long) propertyLayout.generator.getShapeOffset()), ArrayBasedStaticShape.class, true);
