 ...
 * with a library. For example, this is used for exports that are marked to be <a href=
 * "https://www.graalvm.org/truffle/javadoc/com/oracle/truffle/api/library/ExportLibrary.html#useForAOTPriority--">used
 * for AOT</a>. On SVM we can rely that the closed world analysis registers all exports at image
