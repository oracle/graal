...
public @interface ExportLibrary {
     ...
     * automatically generates subclass of
     * {@link com.oracle.truffle.api.provider.EagerExportProvider}, that must be registered in the
     * module descriptor as a provided service. When the language is compiled using native-image
