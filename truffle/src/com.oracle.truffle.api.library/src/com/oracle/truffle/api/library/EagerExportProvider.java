 ...
 * with a library. For example, this is used for exports that are marked to
 * {@link ExportLibrary#useForAOT() used for AOT} . On SVM we can rely that the closed world
 * analysis registers all exports at a image generation time, so there is no need to use this
 * service providers.
 * <p>
