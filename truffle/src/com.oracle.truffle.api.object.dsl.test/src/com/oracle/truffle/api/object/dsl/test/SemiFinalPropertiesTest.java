...
public class SemiFinalPropertiesTest {

    @Layout
    public interface SemiFinalPropertiesTestLayout {

        DynamicObject createSemiFinalPropertiesTest(int value);

        void setValueUnsafe(DynamicObject object, int value);
