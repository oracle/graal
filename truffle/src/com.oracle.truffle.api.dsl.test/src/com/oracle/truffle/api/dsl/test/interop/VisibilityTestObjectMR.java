...
public class VisibilityTestObjectMR {

    @Resolve(message = "READ")
    public abstract static class VisibilityTestReadNode extends Node {
    ...
    @CanResolve
    public abstract static class VisibilityTestLanguageCheck extends Node {
