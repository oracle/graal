...
public class GR45885Test {

    @SuppressWarnings({"unused", "truffle-inlining"})
    abstract static class InvalidWarningTestNode extends Node {

        abstract Object execute(Object arg);

        @Specialization(guards = "arg0 == 0")
        Object s0(int arg0, @Cached @Shared InlinedConditionProfile profile0,
                        @Cached @Exclusive ConditionProfile cachedProfile0,
         ...
         */
        @Specialization
        Object s1(int arg0, @Cached @Shared InlinedConditionProfile profile0,
                        @Cached @Exclusive ConditionProfile cachedProfile0,
                        @Cached @Exclusive ConditionProfile cachedProfile1,
                        @Cached @Exclusive ConditionProfile cachedProfile2,
                        @Cached @Exclusive ConditionProfile cachedProfile3) {
