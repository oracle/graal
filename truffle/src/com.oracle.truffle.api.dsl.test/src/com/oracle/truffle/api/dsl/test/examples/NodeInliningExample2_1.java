...
import com.oracle.truffle.api.dsl.test.examples.NodeInliningExample2_1Factory.SumArrayNodeGen;
import com.oracle.truffle.api.nodes.Node;

@DisableStateBitWidthModfication
public class NodeInliningExample2_1 {
    ...
    static class MaterializedArray extends AbstractArray {
    ...
    public abstract static class SumArrayNode extends Node {
        ...
        int doCached(
            ...
            int[] store = getStore.execute(castStore);
            int sum = 0;
    ...
    public void test() {
        ...
        // 120 bytes without object inlining
        assertEquals(120, ObjectSizeEstimate.forObject(sum).getCompressedTotalBytes());
    }
