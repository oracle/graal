...
public class LegacyValueLanguageTest extends AbstractDebugTest {
    ...
    public abstract static class ValuesLanguage extends TruffleLanguage<Context> {
            ...
            switch (var) {
                ...
                default:
                    if ("null".equals(valueStr)) {
                        ...
                        value = new LegacyPropertiesMapObject(this, sourceSection);
                    }
            }
            return value;
        }
        ...
        protected Object getLanguageView(Context context, Object value) {
            return new LegacyValuesLanguageView(value, this);
        }
        ...
        public static class LegacyVarNode extends Node implements InstrumentableNode {
            ...
            LegacyVarNode(ValuesLanguage language, String name, Object value, SourceSection sourceSection) {
        ...
        @GenerateWrapper
        public static class LegacyPropNode extends ValuesLanguage.LegacyVarNode {

            private final String var;
            private final String prop;
            @Child private InteropLibrary interop = InteropLibrary.getFactory().createDispatched(5);

            LegacyPropNode(ValuesLanguage language, String var, String prop, Object value, SourceSection sourceSection) {
        ...
        static final class LegacyValuesMetaObject implements TruffleObject {

            private final ValuesLanguage language;
            private final Object original;
            private final String name;

            LegacyValuesMetaObject(ValuesLanguage language, Object original, String name) {
                this.language = language;
        ...
        static final class LegacyValuesLanguageView implements TruffleObject {

            protected final ValuesLanguage language;
            protected final Object delegate;

            LegacyValuesLanguageView(Object delegate, ValuesLanguage language) {
            ...
            Object getMetaObject() {
                return new LegacyValuesMetaObject(language, this, getTypeName());
            }
        ...
        static final class LegacyPropertiesMapObject implements TruffleObject {
            ...
            private LegacyPropertiesMapObject(ValuesLanguage language, SourceSection sourceSection) {
                this.language = language;
                this.sourceSection = sourceSection;
            }
            ...
            @TruffleBoundary
            Object getMetaObject() {
                return new LegacyValuesMetaObject(language, this, "L" + language.id + ":Map");
            }
                ...
                for (;;) {
                    ...
                    if (value instanceof LegacyPropertiesMapObject) {
                        if (value == this) {
                            ...
                            value = ((LegacyPropertiesMapObject) value).toDisplayString(allowSideEffects);
                        }
                    }
                    sb.append(key);
                    sb.append('=');
