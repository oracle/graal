...
/**
 * A test implementation of iterator interop.
 */
@ExportLibrary(InteropLibrary.class)
public final class TestIteratorObject implements TruffleObject {
    ...
    public TestIteratorObject(boolean iterable, boolean iterator, List<?> elements) {
    ...
    Object getIterator() throws UnsupportedMessageException {
        if (iterable) {
            return new TestIteratorObject(false, true, elements);
        } else if (iterator) {
            return this;
        } else {
