...
@SuppressWarnings({"static-method", "unused", "deprecation"})
public class LegacyDebugValueTest extends AbstractDebugTest {
    ...
    public void testValueAttributes() throws Throwable {
        ...
        LegacyNoAttributesTruffleObject nao = new LegacyNoAttributesTruffleObject();
        ...
        final LegacyModifiableAttributesTruffleObject mao = new LegacyModifiableAttributesTruffleObject();
    ...
    public void testCached() {
        final LegacyModifiableAttributesTruffleObject ma = new LegacyModifiableAttributesTruffleObject();
    ...
    public void testNull() {
        ProxyLanguage.setDelegate(new ProxyLanguage() {
            ...
            final class TestRootNode extends RootNode {
                @Node.Child DebugValueTest.TestBody body = new DebugValueTest.TestBody();
                private final int a;
                private final int b;
                private final int c;
    ...
    public void testHashCode() {
        ...
        hashes.add(Pair.create(new DebugValueTest.IdentityObject(42, 24), 24));
    ...
    public void testEquals() {
        ...
        equals.add(Pair.create(Pair.create(new DebugValueTest.IdentityObject("aa", 10), new DebugValueTest.IdentityObject("aa", 10)), true));
        equals.add(Pair.create(Pair.create(new DebugValueTest.IdentityObject("aa", 10), new DebugValueTest.IdentityObject("bb", 10)), false));
    ...
    public void testUnreadableEquals() {
        ...
        LegacyModifiableAttributesTruffleObject obj1 = new LegacyModifiableAttributesTruffleObject();
        obj1.setIsReadable(false);
        obj1.setIsWritable(true);
        LegacyModifiableAttributesTruffleObject obj2 = new LegacyModifiableAttributesTruffleObject();
        obj2.setIsReadable(false);
        obj2.setIsWritable(true);
        LegacyModifiableAttributesTruffleObject objReadable = new LegacyModifiableAttributesTruffleObject();
    ...
    static final class LegacyNoAttributesTruffleObject implements TruffleObject {
        ...
        Object getMembers(boolean internal) {
            return new LegacyPropertyKeysTruffleObject();
        }
    ...
    @ExportLibrary(InteropLibrary.class)
    @SuppressWarnings("truffle-abstract-export")
    static final class LegacyModifiableAttributesTruffleObject implements TruffleObject {
        ...
        Object getMembers(boolean internal) {
            if (internal || isInternal == internal) {
                ...
                return new DebugValueTest.EmptyKeysTruffleObject();
            }
        }
        ...
        public static boolean isInstance(TruffleObject obj) {
            return obj instanceof LegacyModifiableAttributesTruffleObject;
        }
     ...
     */
    @ExportLibrary(InteropLibrary.class)
    static final class LegacyPropertyKeysTruffleObject implements TruffleObject {
