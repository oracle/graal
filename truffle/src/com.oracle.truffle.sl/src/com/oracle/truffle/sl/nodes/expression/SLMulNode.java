...
public abstract class SLMulNode extends SLBinaryNode {
    ...
    public static SLBigInteger doSLBigInteger(SLBigInteger left, SLBigInteger right) {
        return new SLBigInteger(mulBoundary(left.getValue(), right.getValue()));
    }

    @TruffleBoundary(allowInlining = true)
    private static BigInteger mulBoundary(BigInteger castLeft, BigInteger castRight) {
        return castLeft.multiply(castRight);
    }
    ...
    public abstract static class SlowPathNode extends Node {
        ...
        static SLBigInteger doInteropBigInteger(Node node, Object left, Object right,
            ...
            try {
                ...
                BigInteger result = mulBoundary(castLeft, castRight);
