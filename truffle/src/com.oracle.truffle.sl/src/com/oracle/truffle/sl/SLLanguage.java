 ...
 * {@link SimpleLanguageLexer} are automatically generated by ANTLR 4 . The grammar contains
 * semantic actions that build the AST for a method. To keep these semantic actions short, they are
 * mostly calls to the {@link SLNodeFactory} that performs the actual node creation. All functions
 * found in the SL source are added to the {@link SLFunctionRegistry}, which is accessible from the
 * {@link SLContext}.
 *
 * <p>
