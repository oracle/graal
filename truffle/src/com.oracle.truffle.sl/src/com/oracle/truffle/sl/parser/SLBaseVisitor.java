...
public abstract class SLBaseVisitor extends SimpleLanguageOperationsBaseVisitor<Void> {
    ...
    protected final Map<TruffleString, RootCallTarget> functions;

    protected SLBaseVisitor(SLLanguage language, Source source, Map<TruffleString, RootCallTarget> functions) {
