...
@SuppressWarnings({"static-method", "deprecation", "truffle-abstract-export"})
public abstract class LegacyBuiltinObject implements TruffleObject {
    ...
    static class ReadMember {
        ...
        static Object doCached(LegacyBuiltinObject receiver, String member,
            ...
            return new LegacyMemberFunction(receiver, cachedEntry);
        }

        @Specialization(replaces = "doCached")
        @ExplodeLoop
        static Object doDefault(LegacyBuiltinObject receiver, String member,
            ...
            for (int i = 0; i < descriptor.members.length; i++) {
                ...
                if (hash == entry.hash && entry.name.equals(member)) {
                    return new LegacyMemberFunction(receiver, entry);
                }
            }
            CompilerDirectives.transferToInterpreter();
            throw UnknownIdentifierException.create(member);
    ...
    @NeverDefault
    static BuiltinDescriptor getDescriptorImpl(LegacyBuiltinObject object) {
    ...
    public abstract static class BuiltinNode extends Node {
        ...
        protected abstract Object execute(LegacyBuiltinObject receiver, Object... arguments) throws ArityException, UnsupportedTypeException;

        final Object executeImpl(MemberEntry member, LegacyBuiltinObject receiver, Object[] arguments) throws ArityException, UnsupportedTypeException {
            try {
                assert member != null;
    ...
    static class InvokeMember {
        ...
        @Specialization(guards = "cachedMember.equals(member)", limit = "MEMBER_NAME_CACHE_SIZE")
        @SuppressWarnings("unused")
        static Object doCached(LegacyBuiltinObject receiver, String member, Object[] arguments,
                        @Cached("member") String cachedMember,
        ...
        @Specialization(replaces = "doCached")
        @TruffleBoundary
        static Object doUncached(LegacyBuiltinObject receiver, String member, Object[] arguments,
                        @Shared("descriptor") @Cached(value = "getDescriptorImpl(receiver)", allowUncached = true) BuiltinDescriptor descriptor)
    ...
    static final class LegacyMemberFunction implements TruffleObject {

        final LegacyBuiltinObject receiver;
        final MemberEntry member;

        LegacyMemberFunction(LegacyBuiltinObject receiver, MemberEntry member) {
        ...
        @ExportMessage
        @ImportStatic(LegacyBuiltinObject.class)
        static class Execute {

            @Specialization(guards = "receiver.member == cachedMember", limit = "MEMBER_NAME_CACHE_SIZE")
            @SuppressWarnings("unused")
            static Object doCached(LegacyMemberFunction receiver, Object[] arguments,
            ...
            @Specialization(replaces = "doCached")
            @TruffleBoundary
            static Object doUncached(LegacyMemberFunction receiver, Object[] arguments)
    ...
    @ExportLibrary(InteropLibrary.class)
    static final class LegacyMembersArray implements TruffleObject {

        @CompilationFinal(dimensions = 1) private final MemberEntry[] members;

        LegacyMembersArray(MemberEntry[] members) {
    ...
    public static final class BuiltinDescriptor {
        ...
        final LegacyMembersArray membersArray;

        BuiltinDescriptor(MemberEntry[] members) {
            this.members = members;
            this.membersArray = new LegacyMembersArray(members);
        }
