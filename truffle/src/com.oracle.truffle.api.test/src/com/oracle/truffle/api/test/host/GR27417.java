...
public class GR27417 extends ProxyLanguageEnvTest {
    ...
    @Test
    public void testZoneRulesGetOffset() throws InteropException {
        InteropLibrary interop = InteropLibrary.getUncached();

        Object instantClass = asTruffleHostSymbol(java.time.Instant.class);
        Object zoneIdClass = asTruffleHostSymbol(java.time.ZoneId.class);
