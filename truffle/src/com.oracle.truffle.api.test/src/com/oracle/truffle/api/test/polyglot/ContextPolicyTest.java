...
public class ContextPolicyTest {
    ...
    @Registration(id = SINGLE_LANGUAGE, name = SINGLE_LANGUAGE, mimeType = SINGLE_LANGUAGE, contextPolicy = ContextPolicy.SINGLE)
    ...
    @Registration(id = SINGLE_REUSE_LANGUAGE, name = SINGLE_REUSE_LANGUAGE, mimeType = SINGLE_REUSE_LANGUAGE, contextPolicy = ContextPolicy.SINGLE_REUSE)
    ...
    @Registration(id = MULTIPLE_LANGUAGE, name = MULTIPLE_LANGUAGE, mimeType = MULTIPLE_LANGUAGE, contextPolicy = ContextPolicy.MULTIPLE)
