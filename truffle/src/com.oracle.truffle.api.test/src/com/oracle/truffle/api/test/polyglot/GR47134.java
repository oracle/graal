...
public class GR47134 {
    ...
    public void test() {
        try (Context ctx = Context.create()) {
            ...
            Map<?, ?> m = (Map<?, ?>) getField(getField(getField(getField(member, "context"), "lazy"), "languageInstance"), "hostToGuestCodeCache");
            Assert.assertTrue("Cache size is growing unbounded " + m.size(), m.size() < 100);
        }
    }
}
