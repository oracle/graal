...
public class ContextPreInitializationNativeImageTest {
    ...
    public static final class Language extends TruffleLanguage<TestContext> {
        ...
        final ContextThreadLocal<Integer> threadLocal = localsBuilder.createContextThreadLocal((c, t) -> 42);
        final ContextLocal<Integer> contextLocal = localsBuilder.createContextLocal((c) -> 42);
