...
public class ValueHostConversionTest extends AbstractPolyglotTest {
    ...
    public void testHostObjectIdentityRestore() {
        ...
        assertUnsupported(value, HOST_OBJECT, MEMBERS, STATIC_PROVIDER);
    }
    ...
    public void testClassProperties() {
        ...
        assertValue(recordClass, Trait.INSTANTIABLE, Trait.MEMBERS, Trait.HOST_OBJECT, Trait.META, Trait.DECLARED_MEMBERS, Trait.STATIC_PROVIDER);
    }
    ...
    public void testObjectProperties() {
        ...
        assertValue(record, Trait.MEMBERS, Trait.HOST_OBJECT, Trait.STATIC_PROVIDER);
        assertValue(record.getMetaObject(), Trait.INSTANTIABLE, Trait.MEMBERS, Trait.HOST_OBJECT, Trait.META, Trait.DECLARED_MEMBERS, Trait.STATIC_PROVIDER);
    }
