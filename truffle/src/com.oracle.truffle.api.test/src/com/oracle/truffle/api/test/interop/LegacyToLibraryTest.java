...
public class LegacyToLibraryTest {
    ...
    public void testBooleanDefault() throws Exception {
        ...
        b.is = true;
        b.as = true;
        assertTrue(isBoxed(b));
        assertEquals(true, unbox(b));

        b.is = false;
        b.as = null;
        assertFalse(isBoxed(b));
        assertThrowsUnsupportedMessage(() -> unbox(b));
    }
    ...
    private static void assertThrowsUnsupportedMessage(Callable<?> r) throws Exception {
        try {
            r.call();
    ...
    static class BooleanValue implements TruffleObject {
    ...
    @ExportLibrary(InteropLibrary.class)
    static class StringValue implements TruffleObject {
