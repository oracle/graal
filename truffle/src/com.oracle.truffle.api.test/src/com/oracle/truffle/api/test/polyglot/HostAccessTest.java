...
public class HostAccessTest extends AbstractHostAccessTest {
    ...
    public void testArrayAccessEnabled() {
        ...
        ValueAssert.assertValue(value, false, Trait.ARRAY_ELEMENTS, Trait.ITERABLE, Trait.MEMBERS, Trait.HOST_OBJECT, Trait.STATIC_PROVIDER);
    }
    ...
    private static void assertArrayAccessDisabled(Context context) {
        ...
        Value value = context.asValue(array);
        assertSame(array, value.asHostObject());
        ValueAssert.assertValue(value, false, Trait.MEMBERS, Trait.HOST_OBJECT, Trait.STATIC_PROVIDER);
    }
    ...
    private static void assertBufferAccessEnabled(Context context) {
        ...
        ValueAssert.assertValue(value, false, Trait.BUFFER_ELEMENTS, Trait.MEMBERS, Trait.HOST_OBJECT, Trait.STATIC_PROVIDER);
    }
    ...
    public void testIterableAccessEnabled() {
        ...
        assertEquals(0, value.getMemberKeys().size());
        ValueAssert.assertValue(value, false, Trait.ITERABLE, Trait.MEMBERS, Trait.HOST_OBJECT, Trait.STATIC_PROVIDER);
    ...
    public void testIteratorAccessEnabled() {
        ...
        assertEquals(0, value.getMemberKeys().size());
        ValueAssert.assertValue(value, false, Trait.ITERATOR, Trait.MEMBERS, Trait.HOST_OBJECT, Trait.STATIC_PROVIDER);
        assertIterableAccessDisabled(context);
        assertListAccessDisabled(context, false);
        assertArrayAccessDisabled(context);
    }
    ...
    public void testMapAccessEnabled() {
        ...
        assertEquals(0, value.getMemberKeys().size());
        ValueAssert.assertValue(value, false, Trait.HASH, Trait.MEMBERS, Trait.HOST_OBJECT, Trait.STATIC_PROVIDER);
        assertArrayAccessDisabled(context);
    }
    ...
    private static void assertListAccessDisabled(Context context, boolean iterableAccess) {
        ...
        Value value = context.asValue(array);
        assertSame(array, value.asHostObject());
        List<Trait> expectedTypes = new ArrayList<>(Arrays.asList(Trait.MEMBERS, Trait.HOST_OBJECT, Trait.STATIC_PROVIDER));
        if (iterableAccess) {
    ...
    static class NoArgSubclassInstantiationTestLanguage extends AbstractExecutableTestLanguage {
        ...
        protected Object execute(RootNode node, Env env, Object[] contextArguments, Object[] frameArguments) throws Exception {
            ...
            return interop.invokeMember(obj, (Object) "returnString");
        }
    }
