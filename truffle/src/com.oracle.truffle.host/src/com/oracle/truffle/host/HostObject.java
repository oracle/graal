...
final class HostObject extends HostBaseObject {
    ...
    abstract static class CompareMemberNode extends Node {
        ...
        static boolean doField(HostFieldDesc member, HostFieldDesc cachedMember) {
            return cachedMember.getType() == member.getType() && cachedMember.getName().equals(member.getName());
        }
    ...
    static class ReadMember {
        ...
        @Specialization(guards = "!receiver.isNull()")
        static Object doReadMember(HostObject receiver,
                        HostMethodDesc method) throws UnsupportedMessageException, UnknownMemberException {
            return new HostFunction(method, receiver.obj, receiver.context);
        }

        @Specialization(guards = "!receiver.isNull()")
        static Object doReadMember(HostObject receiver,
                        HostMemberClass memberClass) throws UnsupportedMessageException, UnknownMemberException {
    ...
    static class InvokeMember {
        ...
        static Object doInvokeMember(HostObject receiver,
                        ...
                        Object[] args,
                        @Bind("$node") Node node,
                        @Shared("hostExecute") @Cached HostExecuteNode executeMethod) throws UnsupportedTypeException, ArityException, UnsupportedMessageException, UnknownMemberException {
