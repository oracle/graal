...
public class HostMemberClass implements TruffleObject {
    ...
    final Object getDeclaringMetaObject(@Bind("$node") Node node) {
        return HostObject.forClass(declaringClassOf(type), HostContext.get(node));
    }
    ...
    boolean existsIn(HostObject obj) {
        return obj.isStaticClass() && obj.obj.equals(declaringClassOf(type));
    }
    ...
    @TruffleBoundary
    private static Class<?> declaringClassOf(Class<?> type) {
