...
/**
 * Used to register an optional {@link InternalResource} using a {@link ServiceLoader}. This
 * interface is not intended to be implemented directly by a language developer, rather the
 * implementation is generated by the Truffle DSL.
 *
 * @since 23.1
 */
public abstract class InternalResourceProvider {
    ...
    /**
     * An internal resource identifier. The value is derived from {@link Id#value()}.
     *
     * @since 23.1
     */
    ...
    /**
     * Creates an {@link InternalResource} instance.
     *
     * @since 23.1
     */
