...
/**
 * Support for foreign function linking. The implementation resides in the
 * {@code com.oracle.truffle.api.jdk22} project and is added as an overlay into the multi-version
 * JAR.
 */
final class ForeignUtil {
    ...
    private static RuntimeException unsupported() {
        throw new UnsupportedOperationException("Foreign access is not supported on JDK < 22.");
    }
}
