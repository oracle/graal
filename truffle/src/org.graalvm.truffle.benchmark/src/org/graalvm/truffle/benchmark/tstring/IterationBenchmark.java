...
public class IterationBenchmark extends TStringBenchmarkBase {
    ...
    public static class BenchState {
        ...
        public BenchState() {
            ...
            context.enter();
            rawIterateBytes = context.parse(TStringBenchDummyLanguage.ID, "rawIterateBytes");
            rawIterateTStringBytes = context.parse(TStringBenchDummyLanguage.ID, "rawIterateTStringBytes");
            rawIterateTStringChars = context.parse(TStringBenchDummyLanguage.ID, "rawIterateTStringChars");
        }
