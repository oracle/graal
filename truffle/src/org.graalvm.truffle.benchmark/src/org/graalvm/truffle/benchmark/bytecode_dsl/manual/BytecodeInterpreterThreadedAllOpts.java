...
public class BytecodeInterpreterThreadedAllOpts extends BaseBytecodeRootNode {
    ...
    protected BytecodeInterpreterThreadedAllOpts(TruffleLanguage<?> language, FrameDescriptor frameDescriptor, byte[] bc, int numLocals, int numConditionalBranches, Object[] constants, Node[] nodes) {
        super(language, frameDescriptor, bc, numLocals, numConditionalBranches, constants, nodes);
    }

    public static BytecodeInterpreterThreadedAllOpts create(BenchmarkLanguage language, Builder builder) {
        return new BytecodeInterpreterThreadedAllOpts(language, builder.getFrameDescriptor(), builder.getBytecode(), builder.numLocals, builder.numConditionalBranches, builder.getConstants(),
                        builder.getNodes());
    }
