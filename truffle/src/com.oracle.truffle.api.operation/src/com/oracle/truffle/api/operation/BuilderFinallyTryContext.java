...
class BuilderFinallyTryContext {
    ...
    BuilderFinallyTryContext(BuilderFinallyTryContext prev, byte[] bc, ArrayList<BuilderExceptionHandler> exceptionHandlers, ArrayList<BuilderLabelFill> labelFills,
