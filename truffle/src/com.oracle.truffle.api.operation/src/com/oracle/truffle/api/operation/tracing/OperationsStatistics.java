...
public class OperationsStatistics {
    ...
    public void write(boolean dumpInfo) {
        try {
            try {
    ...
    static final class GlobalOperationStatistics {
        ...
        public void writeDecisions(boolean dumpInfo) throws IOException {
            setNames();
            ...
            try (FileChannel ch = FileChannel.open(Path.of(decisionsFile), StandardOpenOption.WRITE, StandardOpenOption.CREATE)) {
                JSONArray result = tracer.serializeDecisions(this, dumpInfo);
                ch.truncate(0);
    ...
    private static class EnabledExecutionTracer extends ExecutionTracer {
        ...
        private static class PseudoInstruction {
            ...
            public PseudoInstruction(String name, boolean isRegular) {
                this.name = name;
        ...
        public EnabledExecutionTracer(GlobalOperationStatistics stats) {
            this.stats = stats;
        }
        ...
        public JSONArray serializeDecisions(GlobalOperationStatistics stats, boolean dumpInfo) {
            JSONArray result = new JSONArray();
            ...
            if (dumpInfo) {
                ...
                System.err.println("# For " + stats.opsClass.getSimpleName());
                System.err.println();
            }
            ...
            for (Decision dec : acceptedDecisions) {
                if (dumpInfo) {
                    System.err.println(dec.prettyPrint(stats));
                }
