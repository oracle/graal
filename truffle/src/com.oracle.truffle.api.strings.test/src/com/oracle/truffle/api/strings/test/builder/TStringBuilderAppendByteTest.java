...
public class TStringBuilderAppendByteTest extends TStringTestBase {

    @Parameter public TruffleStringBuilder.AppendByteNode node;

    @Parameters(name = "{0}")
    public static Iterable<TruffleStringBuilder.AppendByteNode> data() {
        return Arrays.asList(TruffleStringBuilder.AppendByteNode.create(), TruffleStringBuilder.AppendByteNode.getUncached());
    }
    ...
    public void testNull() throws Exception {
        expectNullPointerException(() -> node.execute(null, (byte) 0));
    }
}
