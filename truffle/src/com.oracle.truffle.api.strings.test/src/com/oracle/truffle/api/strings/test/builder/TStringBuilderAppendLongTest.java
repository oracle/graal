...
public class TStringBuilderAppendLongTest extends TStringTestBase {

    @Parameter public TruffleStringBuilder.AppendLongNumberNode node;

    @Parameters(name = "{0}")
    public static Iterable<TruffleStringBuilder.AppendLongNumberNode> data() {
        return Arrays.asList(TruffleStringBuilder.AppendLongNumberNode.create(), TruffleStringBuilder.AppendLongNumberNode.getUncached());
    }
