...
public class TStringAsTruffleStringTest extends TStringTestBase {

    @Parameter public TruffleString.AsTruffleStringNode node;

    @Parameters(name = "{0}")
    public static Iterable<TruffleString.AsTruffleStringNode> data() {
        return Arrays.asList(TruffleString.AsTruffleStringNode.create(), TruffleString.AsTruffleStringNode.getUncached());
    }
