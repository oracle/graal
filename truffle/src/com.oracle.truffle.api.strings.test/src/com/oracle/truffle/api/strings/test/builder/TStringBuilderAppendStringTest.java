...
public class TStringBuilderAppendStringTest extends TStringTestBase {

    @Parameter public TruffleStringBuilder.AppendStringNode node;

    @Parameters(name = "{0}")
    public static Iterable<TruffleStringBuilder.AppendStringNode> data() {
        return Arrays.asList(TruffleStringBuilder.AppendStringNode.create(), TruffleStringBuilder.AppendStringNode.getUncached());
    }
