...
public class TStringUTF8Tests extends TStringTestBase {
    ...
    public void testIndexOf() {
        TruffleString s1 = TruffleString.fromJavaStringUncached("aaa", UTF_8, false);
        TruffleString s2 = TruffleString.fromJavaStringUncached("a", UTF_8, false);
    ...
    public void testIndexOf3() {
        TruffleString a = TruffleString.fromJavaStringUncached("aaa", UTF_8, false);
        TruffleString b = TruffleString.fromJavaStringUncached("baa", UTF_8, false);
        Assert.assertEquals(-1, a.lastIndexOfStringUncached(b, 3, 0, UTF_8));
    }

    @Test
    public void testIndexOf4() {
        TruffleString a = TruffleString.fromJavaStringUncached("defghiabc", UTF_8, false);
        TruffleString b = TruffleString.fromJavaStringUncached("def", UTF_8, false);
        Assert.assertEquals(-1, a.lastIndexOfStringUncached(b, 9, 1, UTF_8));
    }

    @Test
    public void testIndexOf5() {
        TruffleString ts1 = TruffleString.fromJavaStringUncached("a\u00A3b\u00A3", UTF_8, false);
        TruffleString ts2 = TruffleString.fromJavaStringUncached("a\u00A3", UTF_8, false);
    ...
    public void testIndexOf6() {
        TruffleString ts1 = TruffleString.fromJavaStringUncached("<......\u043c...", UTF_8, false);
        TruffleString ts2 = TruffleString.fromJavaStringUncached("<", UTF_8, false);
