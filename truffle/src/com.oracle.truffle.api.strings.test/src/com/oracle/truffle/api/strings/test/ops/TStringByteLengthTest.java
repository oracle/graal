...
public class TStringByteLengthTest extends TStringTestBase {

    @Test
    public void testAll() throws Exception {
        forAllStrings(true, (a, array, codeRange, isValid, encoding, codepoints, byteIndices) -> {
            Assert.assertEquals(array.length, a.byteLength(encoding));
        });
    }

    @Test
    public void testNull() throws Exception {
        checkNullSE(AbstractTruffleString::byteLength);
    }
}
