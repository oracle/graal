...
public class TStringBuilderAppendIntTest extends TStringTestBase {

    @Parameter public TruffleStringBuilder.AppendIntNumberNode node;

    @Parameters(name = "{0}")
    public static Iterable<TruffleStringBuilder.AppendIntNumberNode> data() {
        return Arrays.asList(TruffleStringBuilder.AppendIntNumberNode.create(), TruffleStringBuilder.AppendIntNumberNode.getUncached());
    }
