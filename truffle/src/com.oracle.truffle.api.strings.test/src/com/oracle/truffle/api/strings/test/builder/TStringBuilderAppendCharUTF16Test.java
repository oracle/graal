...
public class TStringBuilderAppendCharUTF16Test extends TStringTestBase {

    @Parameter public TruffleStringBuilder.AppendCharUTF16Node node;

    @Parameters(name = "{0}")
    public static Iterable<TruffleStringBuilder.AppendCharUTF16Node> data() {
        return Arrays.asList(TruffleStringBuilder.AppendCharUTF16Node.create(), TruffleStringBuilder.AppendCharUTF16Node.getUncached());
    }
