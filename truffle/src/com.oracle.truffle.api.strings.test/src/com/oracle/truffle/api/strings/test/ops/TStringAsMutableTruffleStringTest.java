...
public class TStringAsMutableTruffleStringTest extends TStringTestBase {

    @Parameter public MutableTruffleString.AsMutableTruffleStringNode node;

    @Parameters(name = "{0}")
    public static Iterable<MutableTruffleString.AsMutableTruffleStringNode> data() {
        return Arrays.asList(MutableTruffleString.AsMutableTruffleStringNode.create(), MutableTruffleString.AsMutableTruffleStringNode.getUncached());
    }
