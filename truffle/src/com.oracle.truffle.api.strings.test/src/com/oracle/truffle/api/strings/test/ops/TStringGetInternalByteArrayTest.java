...
public class TStringGetInternalByteArrayTest extends TStringTestBase {

    @Parameter public TruffleString.GetInternalByteArrayNode node;

    @Parameters(name = "{0}")
    public static Iterable<TruffleString.GetInternalByteArrayNode> data() {
        return Arrays.asList(TruffleString.GetInternalByteArrayNode.create(), TruffleString.GetInternalByteArrayNode.getUncached());
    }
