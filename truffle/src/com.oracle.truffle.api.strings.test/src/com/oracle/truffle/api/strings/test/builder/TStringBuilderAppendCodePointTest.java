...
public class TStringBuilderAppendCodePointTest extends TStringTestBase {

    @Parameter public TruffleStringBuilder.AppendCodePointNode node;

    @Parameters(name = "{0}")
    public static Iterable<TruffleStringBuilder.AppendCodePointNode> data() {
        return Arrays.asList(TruffleStringBuilder.AppendCodePointNode.create(), TruffleStringBuilder.AppendCodePointNode.getUncached());
    }
