...
final class InstrumentProviderSupportImpl extends Accessor.InstrumentProviderSupport {
    ...
    @Override
    public String getInstrumentClassName(Object truffleInstrumentProvider) {
        return ((TruffleInstrumentProvider) truffleInstrumentProvider).getInstrumentClassName();
    }

    @Override
    public Object create(Object truffleInstrumentProvider) {
        return ((TruffleInstrumentProvider) truffleInstrumentProvider).create();
    }
