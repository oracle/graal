 ...
 * <p>
 * Use
 * {@link Instrumenter#attachThreadsListener(com.oracle.truffle.api.instrumentation.ThreadsListener, boolean)}
 * to register an implementation of this listener. Use {@link EventBinding#dispose()} to unregister.
 * <p>
 * The listener gets called when a thread is initialized for use in a {@link TruffleContext context}
 ...
 *
 * @see Instrumenter#attachThreadsListener(com.oracle.truffle.api.instrumentation.ThreadsListener,
 *      boolean)
 * @since 0.30
 */
