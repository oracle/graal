...
final class JCodingsDisabled implements JCodings {
    ...
    @Override
    public TruffleString transcode(AbstractTruffleString a, Object arrayA, int codePointLengthA, int targetEncoding, ConditionProfile outOfMemoryProfile, ConditionProfile nativeProfile,
