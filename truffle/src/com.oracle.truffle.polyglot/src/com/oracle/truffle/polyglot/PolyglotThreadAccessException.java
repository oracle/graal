...
final class PolyglotThreadAccessException extends Exception {
    ...
    void rethrow(PolyglotContextImpl context) {
        ...
        var consumer = context.config.threadAccessDeniedHandler;
        if (consumer != null) {
            try {
                ...
                if (context.parent != null) { // inner context
                    // inner context. no wrapping needed
                    throw another;
                } else {
            ...
            var ex = new IllegalStateException(getMessage());
