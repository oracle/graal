...
import com.oracle.truffle.nfi.LibFFIType.ClosureType;
import com.oracle.truffle.nfi.LibFFIType.EnvType;
...
class NFIContext {
    ...
    LibFFISymbol lookupSymbol(LibFFILibrary library, String name) {
