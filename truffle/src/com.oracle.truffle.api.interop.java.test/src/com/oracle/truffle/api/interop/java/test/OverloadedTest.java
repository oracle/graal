...
public class OverloadedTest extends ProxyLanguageEnvTest {
    ...
    public void callGetterAndSetter() {
        data.x = 11;
        assertEquals(22.0, JavaInteropTest.message(Message.INVOKE, obj, "x"));

        JavaInteropTest.message(Message.INVOKE, obj, "x", 10);
        assertEquals(20, data.x);

        JavaInteropTest.message(Message.INVOKE, obj, "x", new UnboxableToInt(21));
