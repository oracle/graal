...
public class InstrumentableTest {
    ...
    @com.oracle.truffle.api.instrumentation.Instrumentable(factory = TestNode1Wrapper.class)
    ...
    @com.oracle.truffle.api.instrumentation.Instrumentable(factory = TestNode2Wrapper.class)
    ...
    @com.oracle.truffle.api.instrumentation.Instrumentable(factory = TestNode3Wrapper.class)
    ...
    @com.oracle.truffle.api.instrumentation.Instrumentable(factory = TestErrorFactory.class)
    public static final class ErrorNode0 extends Node {
    }

    @ExpectError("Class must not be private to generate a wrapper.")
    @com.oracle.truffle.api.instrumentation.Instrumentable(factory = TestErrorFactory.class)
    private static class ErrorNode2 extends Node {
    }
    ...
    public void testUnexpectedResult() {
        ...
        TestExecInterceptor execInterceptor = context.getEngine().getInstruments().get("testExecInterceptorLegacy").lookup(TestExecInterceptor.class);
    ...
    @com.oracle.truffle.api.instrumentation.Instrumentable(factory = TestUnexpectedResultNodeWrapper.class)
    ...
    @TruffleLanguage.Registration(id = TestUnexpectedResultLanguage.ID, name = "", version = "", mimeType = "testUnexpectedResultLangLegacy")
    public static class TestUnexpectedResultLanguage extends InstrumentationTestLanguage {

        static final String ID = "testUnexpectedResult-lang-legacy";
    ...
    @TruffleInstrument.Registration(id = "testExecInterceptorLegacy", services = TestExecInterceptor.class)
