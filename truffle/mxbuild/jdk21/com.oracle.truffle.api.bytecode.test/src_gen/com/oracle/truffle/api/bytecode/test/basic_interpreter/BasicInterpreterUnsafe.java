...
public final class BasicInterpreterUnsafe extends BasicInterpreter {
    ...
    private BasicInterpreterUnsafe(BytecodeDSLTestLanguage language, FrameDescriptor frameDescriptor, BytecodeRootNodesImpl nodes, int maxLocals, int buildIndex, byte[] bytecodes, Object[] constants, int[] handlers, int[] locals, int[] sourceInfo, List<Source> sources, int numNodes, TagRootNode tagRoot) {
    ...
    private static final class CachedBytecodeNode extends AbstractBytecodeNode implements BytecodeOSRNode {
        ...
        private long doTagExceptional(BasicInterpreterUnsafe $root, VirtualFrame frame, byte[] bc, int bci, Throwable exception, int nodeId, int handlerSp) throws Throwable {
    ...
    public static final class Builder extends BasicInterpreterBuilder {
        ...
        public BasicInterpreter endRoot() {
            ...
            if (reparseReason != null) {
                ...
                result = new BasicInterpreterUnsafe(language, frameDescriptorBuilder.build(), nodes, maxLocals + USER_LOCALS_START_INDEX, operationData.index, bytecodes_, constants_, handlers_, locals_, sourceInfo_, sources_, numNodes_, tagRoot_);
