...
public final class BasicInterpreterWithGlobalScopes extends BasicInterpreter {
    ...
    private static final AtomicReferenceFieldUpdater<BasicInterpreterWithGlobalScopes, AbstractBytecodeNode> BYTECODE_UPDATER = AtomicReferenceFieldUpdater.newUpdater(BasicInterpreterWithGlobalScopes.class, AbstractBytecodeNode.class, "bytecode");
    ...
    protected RootNode cloneUninitialized() {
        BasicInterpreterWithGlobalScopes clone;
        synchronized(nodes){
            clone = (BasicInterpreterWithGlobalScopes) this.copy();
            clone.clones = null;
            clone.bytecode = insert(this.bytecode.cloneUninitialized());
            CloneReferenceList<BasicInterpreterWithGlobalScopes> localClones = this.clones;
            if (localClones == null) {
                this.clones = localClones = new CloneReferenceList<BasicInterpreterWithGlobalScopes>();
            }
    ...
    private BasicInterpreterWithGlobalScopes getBytecodeRootNodeImpl(int index) {
        return (BasicInterpreterWithGlobalScopes) this.nodes.getNode(index);
    }
    ...
    /**
     * Creates one or more bytecode nodes. This is the entrypoint for creating new {@link BasicInterpreterWithGlobalScopes} instances.
     *
     ...
     */
    public static BytecodeRootNodes<BasicInterpreter> create(BytecodeDSLTestLanguage language, BytecodeConfig config, BytecodeParser<com.oracle.truffle.api.bytecode.test.basic_interpreter.BasicInterpreterWithGlobalScopes.Builder> parser) {
     ...
     */
    @TruffleBoundary
    public static void serialize(DataOutput buffer, BytecodeSerializer callback, BytecodeParser<com.oracle.truffle.api.bytecode.test.basic_interpreter.BasicInterpreterWithGlobalScopes.Builder> parser) throws IOException {
    ...
    @TruffleBoundary
    private static void doSerialize(DataOutput buffer, BytecodeSerializer callback, com.oracle.truffle.api.bytecode.test.basic_interpreter.BasicInterpreterWithGlobalScopes.Builder builder, List<BasicInterpreter> existingNodes) throws IOException {
        try {
    ...
    private abstract static sealed class AbstractBytecodeNode extends BytecodeNode permits CachedBytecodeNode, UninitializedBytecodeNode {
        ...
        abstract long continueAt(BasicInterpreterWithGlobalScopes $root, VirtualFrame frame, VirtualFrame localFrame, long startState);

        final BasicInterpreterWithGlobalScopes getRoot() {
            return (BasicInterpreterWithGlobalScopes) getParent();
        }
        ...
        private final boolean validateBytecodes() {
            BasicInterpreterWithGlobalScopes root;
            byte[] bc = this.bytecodes;
            if (bc == null) {
    ...
    private static final class CachedBytecodeNode extends AbstractBytecodeNode implements BytecodeOSRNode {
        ...
        long continueAt(BasicInterpreterWithGlobalScopes $root, VirtualFrame frame, VirtualFrame localFrame, long startState) {
            byte[] bc = this.bytecodes;
        ...
        private void doYield(VirtualFrame frame, VirtualFrame localFrame, byte[] bc, int bci, int sp, BasicInterpreterWithGlobalScopes $root) {
        ...
        @InliningCutoff
        private Throwable resolveThrowable(BasicInterpreterWithGlobalScopes $root, VirtualFrame frame, int bci, Throwable throwable) {
        ...
        private long doTagExceptional(BasicInterpreterWithGlobalScopes $root, VirtualFrame frame, byte[] bc, int bci, Throwable exception, int nodeId, int handlerSp) throws Throwable {
        ...
        private long resolveControlFlowException(BasicInterpreterWithGlobalScopes $root, VirtualFrame frame, int bci, ControlFlowException cfe) throws Throwable {
    ...
    public static final class Builder extends BasicInterpreterBuilder {
        ...
        private final ArrayList<BasicInterpreterWithGlobalScopes> builtNodes;
        ...
        public BasicInterpreter endRoot() {
            ...
            BasicInterpreterWithGlobalScopes result;
            if (reparseReason != null) {
                ...
                result = new BasicInterpreterWithGlobalScopes(language, frameDescriptorBuilder, nodes, numLocals + USER_LOCALS_START_INDEX, operationData.index, bytecodes_, constants_, handlers_, locals_, sourceInfo_, sources_, numNodes_, tagRoot_);
        ...
        private void finish() {
            ...
            if (reparseReason == null) {
                nodes.setNodes(builtNodes.toArray(new BasicInterpreterWithGlobalScopes[0]));
            }
                    ...
                    switch (code) {
                        ...
                        case SerializationState.CODE_$END :
                        {
                            for (int i = 0; i < this.builtNodes.size(); i++) {
                                BasicInterpreterWithGlobalScopes node = this.builtNodes.get(i);
                        ...
                        {
                            BasicInterpreterWithGlobalScopes node = (BasicInterpreterWithGlobalScopes) endRoot();
        ...
        public String toString() {
            ...
            b.append(BasicInterpreterWithGlobalScopes.class.getSimpleName());
            b.append('.');
            b.append(com.oracle.truffle.api.bytecode.test.basic_interpreter.BasicInterpreterWithGlobalScopes.Builder.class.getSimpleName());
            b.append("[");
            b.append("at=");
        ...
        private static class OperationStackEntry {
            ...
            private String toString(com.oracle.truffle.api.bytecode.test.basic_interpreter.BasicInterpreterWithGlobalScopes.Builder builder) {
                StringBuilder b = new StringBuilder();
        ...
        private static final class DeserializationState implements DeserializerContext {
            ...
            private final ArrayList<BasicInterpreterWithGlobalScopes> builtNodes = new ArrayList<>();
    ...
    private static final class BytecodeRootNodesImpl extends BytecodeRootNodes<BasicInterpreter> {
        ...
        BytecodeRootNodesImpl(BytecodeParser<com.oracle.truffle.api.bytecode.test.basic_interpreter.BasicInterpreterWithGlobalScopes.Builder> generator, BytecodeConfig config) {
        ...
        private synchronized boolean performUpdate(long maskedEncoding) {
            ...
            BytecodeParser<com.oracle.truffle.api.bytecode.test.basic_interpreter.BasicInterpreterWithGlobalScopes.Builder> parser = getParserImpl();
            ...
            for (BasicInterpreter node : nodes) {
                builder.builtNodes.add((BasicInterpreterWithGlobalScopes) node);
            }
            parser.parse(builder);
            builder.finish();
        ...
        private void setNodes(BasicInterpreterWithGlobalScopes[] nodes) {
            if (this.nodes != null) {
                throw new AssertionError();
            }
            this.nodes = nodes;
            for (BasicInterpreterWithGlobalScopes node : nodes) {
        ...
        @SuppressWarnings("unchecked")
        private BytecodeParser<com.oracle.truffle.api.bytecode.test.basic_interpreter.BasicInterpreterWithGlobalScopes.Builder> getParserImpl() {
            return (BytecodeParser<com.oracle.truffle.api.bytecode.test.basic_interpreter.BasicInterpreterWithGlobalScopes.Builder>) super.getParser();
        }

        private boolean validate() {
            for (BasicInterpreter node : nodes) {
                ((BasicInterpreterWithGlobalScopes) node).getBytecodeNodeImpl().validateBytecodes();
            }
            return true;
        }
        ...
        public void serialize(DataOutput buffer, BytecodeSerializer callback) throws IOException {
            ...
            for (int i = 0; i < nodes.length; i++) {
                existingNodes.add((BasicInterpreterWithGlobalScopes) nodes[i]);
            }
            BasicInterpreterWithGlobalScopes.doSerialize(buffer, callback, new Builder(getLanguage(), this, BytecodeConfig.COMPLETE), existingNodes);
        }
    ...
    private static final class ContinuationRootNodeImpl extends ContinuationRootNode {
        ...
        final BasicInterpreterWithGlobalScopes root;
        final int sp;
        @CompilationFinal volatile BytecodeLocation location;

        ContinuationRootNodeImpl(TruffleLanguage<?> language, FrameDescriptor frameDescriptor, BasicInterpreterWithGlobalScopes root, int sp, BytecodeLocation location) {
