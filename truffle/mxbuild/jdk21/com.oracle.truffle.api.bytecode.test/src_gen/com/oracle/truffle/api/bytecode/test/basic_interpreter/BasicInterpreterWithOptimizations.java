 ...
 *   - Instruction c.Call
 *     kind: CUSTOM
 *     encoding: [36 : short, interpreter (const) : int, node : int]
 *     nodeType: Call
 *     signature: Object (BasicInterpreter, Object[]...)
 *   - Instruction c.AddConstantOperation
 *     kind: CUSTOM
 *     encoding: [37 : short, constantLhs (const) : int, node : int]
...
public final class BasicInterpreterWithOptimizations extends BasicInterpreter {
    ...
    private static final int COROUTINE_FRAME_INDEX = 0;
    private static final int USER_LOCALS_START_INDEX = 1;
    private static final AtomicReferenceFieldUpdater<BasicInterpreterWithOptimizations, AbstractBytecodeNode> BYTECODE_UPDATER = AtomicReferenceFieldUpdater.newUpdater(BasicInterpreterWithOptimizations.class, AbstractBytecodeNode.class, "bytecode");
    ...
    private static final Object DEFAULT_LOCAL_VALUE = (BasicInterpreter.LOCAL_DEFAULT_VALUE);
    private static final ConcurrentHashMap<Integer, Class<? extends Tag>[]> TAG_MASK_TO_TAGS = new ConcurrentHashMap<>();
    private static final ClassValue<Integer> CLASS_TO_TAG_MASK = BasicInterpreterWithOptimizations.initializeTagMaskToClass();
    ...
    private BasicInterpreterWithOptimizations(BytecodeDSLTestLanguage language, com.oracle.truffle.api.frame.FrameDescriptor.Builder builder, BytecodeRootNodesImpl nodes, int maxLocals, int buildIndex, byte[] bytecodes, Object[] constants, int[] handlers, int[] locals, int[] sourceInfo, List<Source> sources, int numNodes, TagRootNode tagRoot) {
        ...
        this.bytecode = insert(new UninitializedBytecodeNode(bytecodes, constants, handlers, locals, sourceInfo, sources, numNodes, tagRoot));
    }
    ...
    protected RootNode cloneUninitialized() {
        BasicInterpreterWithOptimizations clone;
        synchronized(nodes){
            clone = (BasicInterpreterWithOptimizations) this.copy();
            clone.clones = null;
            clone.bytecode = insert(this.bytecode.cloneUninitialized());
            CloneReferenceList<BasicInterpreterWithOptimizations> localClones = this.clones;
            if (localClones == null) {
                this.clones = localClones = new CloneReferenceList<BasicInterpreterWithOptimizations>();
            }
    ...
    private BasicInterpreterWithOptimizations getBytecodeRootNodeImpl(int index) {
        return (BasicInterpreterWithOptimizations) this.nodes.getNode(index);
    }
    ...
    /**
     * Creates one or more bytecode nodes. This is the entrypoint for creating new {@link BasicInterpreterWithOptimizations} instances.
     *
     ...
     */
    public static BytecodeRootNodes<BasicInterpreter> create(BytecodeDSLTestLanguage language, BytecodeConfig config, BytecodeParser<com.oracle.truffle.api.bytecode.test.basic_interpreter.BasicInterpreterWithOptimizations.Builder> parser) {
     ...
     */
    @TruffleBoundary
    public static void serialize(DataOutput buffer, BytecodeSerializer callback, BytecodeParser<com.oracle.truffle.api.bytecode.test.basic_interpreter.BasicInterpreterWithOptimizations.Builder> parser) throws IOException {
    ...
    @TruffleBoundary
    private static void doSerialize(DataOutput buffer, BytecodeSerializer callback, com.oracle.truffle.api.bytecode.test.basic_interpreter.BasicInterpreterWithOptimizations.Builder builder, List<BasicInterpreter> existingNodes) throws IOException {
        try {
    ...
    private abstract static sealed class AbstractBytecodeNode extends BytecodeNode permits CachedBytecodeNode, UninitializedBytecodeNode {
        ...
        abstract long continueAt(BasicInterpreterWithOptimizations $root, VirtualFrame frame, VirtualFrame localFrame, long startState);

        final BasicInterpreterWithOptimizations getRoot() {
            return (BasicInterpreterWithOptimizations) getParent();
        }
        ...
        private final boolean validateBytecodes() {
            BasicInterpreterWithOptimizations root;
            byte[] bc = this.bytecodes;
            if (bc == null) {
    ...
    private static final class CachedBytecodeNode extends AbstractBytecodeNode implements BytecodeOSRNode {
        ...
        long continueAt(BasicInterpreterWithOptimizations $root, VirtualFrame frame, VirtualFrame localFrame, long startState) {
            byte[] bc = this.bytecodes;
            ...
            loop: while (true) {
                ...
                try {
                    switch (op) {
                        ...
                        case Instructions.CLEAR_LOCAL :
                        {
                            FRAMES.setObject(frame, BYTES.getShort(bc, bci + 2 /* imm local_offset */), DEFAULT_LOCAL_VALUE);
                            bci += 4;
                            break;
                        }
                        case Instructions.EARLY_RETURN_ :
        ...
        private void doLoadLocalMat(AbstractBytecodeNode $this, Frame stackFrame, Frame frame, byte[] bc, int bci, int sp) {
            ...
            BasicInterpreterWithOptimizations localRoot = this.getRoot().getBytecodeRootNodeImpl(localRootIndex);
        ...
        private void doYield(VirtualFrame frame, VirtualFrame localFrame, byte[] bc, int bci, int sp, BasicInterpreterWithOptimizations $root) {
        ...
        @InliningCutoff
        private Throwable resolveThrowable(BasicInterpreterWithOptimizations $root, VirtualFrame frame, int bci, Throwable throwable) {
        ...
        private long doTagExceptional(BasicInterpreterWithOptimizations $root, VirtualFrame frame, byte[] bc, int bci, Throwable exception, int nodeId, int handlerSp) throws Throwable {
        ...
        private long resolveControlFlowException(BasicInterpreterWithOptimizations $root, VirtualFrame frame, int bci, ControlFlowException cfe) throws Throwable {
    ...
    private static final class UninitializedBytecodeNode extends AbstractBytecodeNode {
        ...
        UninitializedBytecodeNode(byte[] bytecodes, Object[] constants, int[] handlers, int[] locals, int[] sourceInfo, List<Source> sources, int numNodes, TagRootNode tagRoot) {
            super(bytecodes, constants, handlers, locals, sourceInfo, sources, numNodes, tagRoot);
        }
        ...
        AbstractBytecodeNode update(byte[] bytecodes_, Object[] constants_, int[] handlers_, int[] locals_, int[] sourceInfo_, List<Source> sources_, int numNodes_, TagRootNode tagRoot_) {
            ...
            return new UninitializedBytecodeNode(bytecodes__, constants__, handlers__, locals__, sourceInfo__, sources__, numNodes__, tagRoot__);
        }

        @Override
        AbstractBytecodeNode cloneUninitialized() {
            return new UninitializedBytecodeNode(Arrays.copyOf(this.bytecodes, this.bytecodes.length), this.constants, this.handlers, this.locals, this.sourceInfo, this.sources, this.numNodes, tagRoot != null ? (TagRootNode) tagRoot.deepCopy() : null);
        }
        ...
        @Override
        public String toString() {
            return String.format("BytecodeNode [name=%s, sources=%s, tier=uninitialized]", ((RootNode) getParent()).getQualifiedName(), this.sourceInfo != null);
        }
    ...
    public static final class Builder extends BasicInterpreterBuilder {
        ...
        private final ArrayList<BasicInterpreterWithOptimizations> builtNodes;
        ...
        public BasicInterpreter endRoot() {
            ...
            BasicInterpreterWithOptimizations result;
            if (reparseReason != null) {
        ...
        private void finish() {
            ...
            if (reparseReason == null) {
                nodes.setNodes(builtNodes.toArray(new BasicInterpreterWithOptimizations[0]));
            }
                    ...
                    switch (code) {
                        ...
                        case SerializationState.CODE_$END :
                        {
                            for (int i = 0; i < this.builtNodes.size(); i++) {
                                BasicInterpreterWithOptimizations node = this.builtNodes.get(i);
                        ...
                        {
                            BasicInterpreterWithOptimizations node = (BasicInterpreterWithOptimizations) endRoot();
        ...
        public String toString() {
            ...
            b.append(BasicInterpreterWithOptimizations.class.getSimpleName());
            b.append('.');
            b.append(com.oracle.truffle.api.bytecode.test.basic_interpreter.BasicInterpreterWithOptimizations.Builder.class.getSimpleName());
            b.append("[");
            b.append("at=");
        ...
        private static class OperationStackEntry {
            ...
            private String toString(com.oracle.truffle.api.bytecode.test.basic_interpreter.BasicInterpreterWithOptimizations.Builder builder) {
                StringBuilder b = new StringBuilder();
        ...
        private static class SerializationState implements SerializerContext {
            ...
            private static final short CODE_BEGIN_ENSURE_AND_GET_SOURCE_POSITION = 44 << 1;
            private static final short CODE_END_ENSURE_AND_GET_SOURCE_POSITION = (44 << 1) | 0b1;
        ...
        private static final class DeserializationState implements DeserializerContext {
            ...
            private final ArrayList<BasicInterpreterWithOptimizations> builtNodes = new ArrayList<>();
    ...
    private static final class BytecodeRootNodesImpl extends BytecodeRootNodes<BasicInterpreter> {
        ...
        BytecodeRootNodesImpl(BytecodeParser<com.oracle.truffle.api.bytecode.test.basic_interpreter.BasicInterpreterWithOptimizations.Builder> generator, BytecodeConfig config) {
        ...
        private synchronized boolean performUpdate(long maskedEncoding) {
            ...
            BytecodeParser<com.oracle.truffle.api.bytecode.test.basic_interpreter.BasicInterpreterWithOptimizations.Builder> parser = getParserImpl();
            ...
            for (BasicInterpreter node : nodes) {
                builder.builtNodes.add((BasicInterpreterWithOptimizations) node);
            }
            parser.parse(builder);
            builder.finish();
        ...
        private void setNodes(BasicInterpreterWithOptimizations[] nodes) {
            if (this.nodes != null) {
                throw new AssertionError();
            }
            this.nodes = nodes;
            for (BasicInterpreterWithOptimizations node : nodes) {
        ...
        @SuppressWarnings("unchecked")
        private BytecodeParser<com.oracle.truffle.api.bytecode.test.basic_interpreter.BasicInterpreterWithOptimizations.Builder> getParserImpl() {
            return (BytecodeParser<com.oracle.truffle.api.bytecode.test.basic_interpreter.BasicInterpreterWithOptimizations.Builder>) super.getParser();
        }

        private boolean validate() {
            for (BasicInterpreter node : nodes) {
                ((BasicInterpreterWithOptimizations) node).getBytecodeNodeImpl().validateBytecodes();
            }
            return true;
        }
        ...
        public void serialize(DataOutput buffer, BytecodeSerializer callback) throws IOException {
            ...
            for (int i = 0; i < nodes.length; i++) {
                existingNodes.add((BasicInterpreterWithOptimizations) nodes[i]);
            }
            BasicInterpreterWithOptimizations.doSerialize(buffer, callback, new Builder(getLanguage(), this, BytecodeConfig.COMPLETE), existingNodes);
        }
    ...
    private static final class Instructions {
         ...
         * signature: Object (BasicInterpreter, Object[]...)
         */
        private static final short CALL_ = 36;
        /*
         * Instruction c.AddConstantOperation
         * kind: CUSTOM
         * encoding: [37 : short, constantLhs (const) : int, node : int]
         ...
         * signature: Object (long, Object)
         */
        private static final short ADD_CONSTANT_OPERATION_ = 37;
        /*
         * Instruction c.AddConstantOperationAtEnd
         * kind: CUSTOM
         * encoding: [38 : short, constantRhs (const) : int, node : int]
         ...
         * signature: SourceSection (boolean)
         */
        private static final short ENSURE_AND_GET_SOURCE_POSITION_ = 52;
        /*
         * Instruction c.GetSourcePositions
         * kind: CUSTOM
         * encoding: [53 : short, node : int]
    ...
    private static final class Operations {
        ...
        private static final int ENSUREANDGETSOURCEPOSITION = 44;
    ...
    private static final class ContinuationRootNodeImpl extends ContinuationRootNode {
        ...
        final BasicInterpreterWithOptimizations root;
        final int sp;
        @CompilationFinal volatile BytecodeLocation location;

        ContinuationRootNodeImpl(TruffleLanguage<?> language, FrameDescriptor frameDescriptor, BasicInterpreterWithOptimizations root, int sp, BytecodeLocation location) {
