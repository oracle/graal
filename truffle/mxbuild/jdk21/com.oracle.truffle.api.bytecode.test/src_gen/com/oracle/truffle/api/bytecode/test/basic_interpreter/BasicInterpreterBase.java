    ...
    public static final class Builder extends BasicInterpreterBuilder {
        ...
        public BasicInterpreter endRoot() {
            ...
            if (reparseReason != null) {
                ...
                result = new BasicInterpreterBase(language, frameDescriptorBuilder, nodes, maxLocals + USER_LOCALS_START_INDEX, operationData.index, bytecodes_, constants_, handlers_, locals_, sourceInfo_, sources_, numNodes_, tagRoot_);
