...
public final class BasicInterpreterBase extends BasicInterpreter {

    private static final int[] EMPTY_INT_ARRAY = new int[0];
    private static final Object[] EMPTY_ARRAY = new Object[0];
    private static final BytecodeDSLAccess ACCESS = BytecodeDSLAccess.lookup(BytecodeRootNodesImpl.VISIBLE_TOKEN, false);
    ...
    private static final AtomicReferenceFieldUpdater<BasicInterpreterBase, AbstractBytecodeNode> BYTECODE_UPDATER = AtomicReferenceFieldUpdater.newUpdater(BasicInterpreterBase.class, AbstractBytecodeNode.class, "bytecode");
    ...
    private static final ClassValue<Integer> CLASS_TO_TAG_MASK = BasicInterpreterBase.initializeTagMaskToClass();
    ...
    private CloneReferenceList<BasicInterpreterBase> clones;

    private BasicInterpreterBase(BytecodeDSLTestLanguage language, FrameDescriptor frameDescriptor, BytecodeRootNodesImpl nodes, int maxLocals, int buildIndex, byte[] bytecodes, Object[] constants, int[] handlers, int[] locals, int[] sourceInfo, List<Source> sources, int numNodes, TagRootNode tagRoot) {
    ...
    protected RootNode cloneUninitialized() {
        BasicInterpreterBase clone;
        synchronized(nodes){
            clone = (BasicInterpreterBase) this.copy();
            clone.clones = null;
            clone.bytecode = insert(this.bytecode.cloneUninitialized());
            CloneReferenceList<BasicInterpreterBase> localClones = this.clones;
            if (localClones == null) {
                this.clones = localClones = new CloneReferenceList<BasicInterpreterBase>();
            }
    ...
    private BasicInterpreterBase getBytecodeRootNodeImpl(int index) {
        return (BasicInterpreterBase) this.nodes.getNode(index);
    }
    ...
    /**
     * Creates one or more bytecode nodes. This is the entrypoint for creating new {@link BasicInterpreterBase} instances.
     *
     ...
     */
    public static BytecodeRootNodes<BasicInterpreter> create(BytecodeDSLTestLanguage language, BytecodeConfig config, BytecodeParser<com.oracle.truffle.api.bytecode.test.basic_interpreter.BasicInterpreterBase.Builder> parser) {
     ...
     */
    @TruffleBoundary
    public static void serialize(DataOutput buffer, BytecodeSerializer callback, BytecodeParser<com.oracle.truffle.api.bytecode.test.basic_interpreter.BasicInterpreterBase.Builder> parser) throws IOException {
    ...
    @TruffleBoundary
    private static void doSerialize(DataOutput buffer, BytecodeSerializer callback, com.oracle.truffle.api.bytecode.test.basic_interpreter.BasicInterpreterBase.Builder builder, List<BasicInterpreter> existingNodes) throws IOException {
        try {
    ...
    private abstract static sealed class AbstractBytecodeNode extends BytecodeNode permits CachedBytecodeNode, UninitializedBytecodeNode {
        ...
        abstract long continueAt(BasicInterpreterBase $root, VirtualFrame frame, VirtualFrame localFrame, long startState);

        final BasicInterpreterBase getRoot() {
            return (BasicInterpreterBase) getParent();
        }
    ...
    private static final class CachedBytecodeNode extends AbstractBytecodeNode implements BytecodeOSRNode {
        ...
        long continueAt(BasicInterpreterBase $root, VirtualFrame frame, VirtualFrame localFrame, long startState) {
            byte[] bc = this.bytecodes;
        ...
        private void doYield(VirtualFrame frame, VirtualFrame localFrame, byte[] bc, int bci, int sp, BasicInterpreterBase $root) {
        ...
        @InliningCutoff
        private Throwable resolveThrowable(BasicInterpreterBase $root, VirtualFrame frame, int bci, Throwable throwable) {
        ...
        private long doTagExceptional(BasicInterpreterBase $root, VirtualFrame frame, byte[] bc, int bci, Throwable exception, int nodeId, int handlerSp) throws Throwable {
        ...
        private long resolveControlFlowException(BasicInterpreterBase $root, VirtualFrame frame, int bci, ControlFlowException cfe) throws Throwable {
    ...
    public static final class Builder extends BasicInterpreterBuilder {
        ...
        private final ArrayList<BasicInterpreterBase> builtNodes;
        ...
        public BasicInterpreter endRoot() {
            ...
            if (reparseReason != null) {
                ...
                result = new BasicInterpreterBase(language, frameDescriptorBuilder.build(), nodes, maxLocals + USER_LOCALS_START_INDEX, operationData.index, bytecodes_, constants_, handlers_, locals_, sourceInfo_, sources_, numNodes_, tagRoot_);
        ...
        private void finish() {
            ...
            if (reparseReason == null) {
                nodes.setNodes(builtNodes.toArray(new BasicInterpreterBase[0]));
            }
                    ...
                    switch (code) {
                        ...
                        case SerializationState.CODE_$END :
                        {
                            for (int i = 0; i < this.builtNodes.size(); i++) {
                                BasicInterpreterBase node = this.builtNodes.get(i);
                        ...
                        {
                            BasicInterpreterBase node = (BasicInterpreterBase) endRoot();
        ...
        public String toString() {
            ...
            b.append(BasicInterpreterBase.class.getSimpleName());
            b.append('.');
            b.append(com.oracle.truffle.api.bytecode.test.basic_interpreter.BasicInterpreterBase.Builder.class.getSimpleName());
            b.append("[");
            b.append("at=");
        ...
        private static class OperationStackEntry {
            ...
            private String toString(com.oracle.truffle.api.bytecode.test.basic_interpreter.BasicInterpreterBase.Builder builder) {
                StringBuilder b = new StringBuilder();
        ...
        private static final class DeserializationState implements DeserializerContext {
            ...
            private final ArrayList<BasicInterpreterBase> builtNodes = new ArrayList<>();
    ...
    private static final class BytecodeRootNodesImpl extends BytecodeRootNodes<BasicInterpreter> {
        ...
        BytecodeRootNodesImpl(BytecodeParser<com.oracle.truffle.api.bytecode.test.basic_interpreter.BasicInterpreterBase.Builder> generator, BytecodeConfig config) {
        ...
        private synchronized boolean performUpdate(long maskedEncoding) {
            ...
            BytecodeParser<com.oracle.truffle.api.bytecode.test.basic_interpreter.BasicInterpreterBase.Builder> parser = getParserImpl();
            ...
            for (BasicInterpreter node : nodes) {
                builder.builtNodes.add((BasicInterpreterBase) node);
            }
            parser.parse(builder);
            builder.finish();
        ...
        private void setNodes(BasicInterpreterBase[] nodes) {
            if (this.nodes != null) {
                throw new AssertionError();
            }
            this.nodes = nodes;
            for (BasicInterpreterBase node : nodes) {
        ...
        @SuppressWarnings("unchecked")
        private BytecodeParser<com.oracle.truffle.api.bytecode.test.basic_interpreter.BasicInterpreterBase.Builder> getParserImpl() {
            return (BytecodeParser<com.oracle.truffle.api.bytecode.test.basic_interpreter.BasicInterpreterBase.Builder>) super.getParser();
        }

        private boolean validate() {
            for (BasicInterpreter node : nodes) {
                ((BasicInterpreterBase) node).getBytecodeNodeImpl().validateBytecodes();
            }
            return true;
        }
        ...
        public void serialize(DataOutput buffer, BytecodeSerializer callback) throws IOException {
            ...
            for (int i = 0; i < nodes.length; i++) {
                existingNodes.add((BasicInterpreterBase) nodes[i]);
            }
            BasicInterpreterBase.doSerialize(buffer, callback, new Builder(getLanguage(), this, BytecodeConfig.COMPLETE), existingNodes);
        }
    ...
    private static final class ContinuationRootNodeImpl extends ContinuationRootNode {
        ...
        final BasicInterpreterBase root;
        final int sp;
        @CompilationFinal volatile BytecodeLocation location;

        ContinuationRootNodeImpl(TruffleLanguage<?> language, FrameDescriptor frameDescriptor, BasicInterpreterBase root, int sp, BytecodeLocation location) {
