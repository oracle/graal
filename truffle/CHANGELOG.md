...
* GR-31342 Implemented several new features for Truffle DSL and improved its performance:
	...
	* Added an `@GenerateCached` annotation that allows to disable the generation of cached nodes. This is useful if all usages of nodes are object inlined to save code footprint.
