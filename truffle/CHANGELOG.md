...
* GR-35913: Added `AbstractTruffleException#createDefaultExceptionStackTrace(Throwable)`, which returns the default interop representation of a throwable’s stack trace.
* GR-35913: Added `InteropLibrary#hasByteCodeIndex` and `InteropLibrary#getByteCodeIndex` to test for and retrieve the receiver’s bytecode index.
* GR-35913: Added `InteropLibrary#isInternal` to determine whether a given receiver represents an internal object.
