...
* `TruffleLanguage`s are registered in a `ServiceLoader` using the [TruffleLanguage.Provider](https://www.graalvm.org/truffle/javadoc/com/oracle/truffle/api/TruffleLanguage.Provider.html) as a service interface.
* `TruffleInstrument`s are registered in a `ServiceLoader` using the [TruffleInstrument.Provider](https://www.graalvm.org/truffle/javadoc/com/oracle/truffle/api/instrumentation/TruffleInstrument.Provider.html) as a service interface.
