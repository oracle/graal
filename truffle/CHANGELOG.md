...
* Added `TruffleSafepoint.setAllowActions` to disable thread local actions temporarily for trusted internal guest code, e.g during finalization of a context.
