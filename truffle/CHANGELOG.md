...
* Added `ThreadLocalAction` constructor that allows to configure thread local actions to be continuously performed. This allows to build debug tooling that need to gather information in every safepoint poll of a thread.
