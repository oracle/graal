...
* Added new `EncapsulatingNodeReference` class to lookup read and write write the current encapsulating node. Deprecated encapsulating node methods in `NodeUtil`.
