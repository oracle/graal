...
* Changed default context policy from MULTIPLE to SINGLE, i.e. there is one language instance per polyglot or inner context by default. This can be configured
