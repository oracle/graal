...
- `--engine.PropagateLoopCountsToLexicalSingleCaller=true|false` : Propagate call and loop count (hotness proxy) up a single caller chain to lexical scope parent. Allows certain lambda callers to get compiled sooner.
