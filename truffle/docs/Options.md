...
- `--engine.CompilerThreadStackSize=[0, inf)B|KB|MB|GB` : Set the requested stack size of Truffle compiler threads. The default value `640KB` requests a smaller compiler-thread stack.
