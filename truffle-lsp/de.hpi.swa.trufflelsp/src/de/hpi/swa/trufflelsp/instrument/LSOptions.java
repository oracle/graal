...
public final class LSOptions {
    ...
    @com.oracle.truffle.api.Option(name = "GotoDefinition.IncludeInternalSources", help = "Include sources with isInternal()==true in goto-definition search. (default:false)", category = OptionCategory.EXPERT) //
    public static final OptionKey<Boolean> IncludeInternlSourcesInDefinitionSearch = new OptionKey<>(false);
