...

{
  ...
  vm_bench_polybenchmarks_linux_build: vm_common.svm_common_linux_amd64 + vm_common.truffleruby + vm_common.graalpy + vm.custom_vm_linux + self.vm_bench_common + vm.vm_java_21 + self.polybench_hpc_linux_common + self.vm_bench_polybenchmarks_base(env='polybench-${VM_ENV}') + {
    setup+: [
  ...
  vm_bench_polybench_linux_common(env='polybench-${VM_ENV}', is_gate=false): vm_common.svm_common_linux_amd64 + vm_common.truffleruby + vm_common.graalpy + vm.custom_vm_linux + self.vm_bench_common + wabt {
    base_cmd:: ['mx', '--env', env],
