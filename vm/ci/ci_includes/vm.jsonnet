...

{
  ...
  local builds = [
    ...
    vm_common.graalvm_complete_build_deps('ce', 'darwin', 'amd64') + vm_common.darwin_deploy + vm_common.deploy_vm_darwin_amd64 + {
    ...
    vm_common.graalvm_complete_build_deps('ce', 'darwin', 'aarch64') + vm_common.darwin_deploy + vm_common.deploy_vm_darwin_aarch64 + {
