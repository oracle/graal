...

{
  ...
  local builds = [
    ...
    vm_common.darwin_deploy + vm_common.deploy_vm_darwin_amd64 + self.maven_17_21_only_native + {
     run: [ $.maven_17_21_only_native.build, $.maven_17_21_only_native.deploy(repo='lafo-maven')],
     name: 'post-merge-deploy-vm-maven-darwin-amd64',
     notify_groups:: ['deploy'],
    },
    vm_common.darwin_deploy + vm_common.deploy_vm_darwin_aarch64 + self.maven_17_21_only_native + {
     run: [ $.maven_17_21_only_native.build, $.maven_17_21_only_native.deploy(repo='lafo-maven')],
    ...
    vm_common.svm_common_windows_amd64("21") + vm_common.deploy_vm_windows + self.maven_17_21_only_native + {
     run: [ $.maven_17_21_only_native.build, $.maven_17_21_only_native.deploy(repo='lafo-maven')],
