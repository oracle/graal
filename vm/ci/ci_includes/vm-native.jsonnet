...

{
  ...
  local builds = [
    vm.vm_java_Latest + vm_common.svm_common_linux_amd64 + vm_common.sulong + vm_common.graalpy + vm.custom_vm_linux + vm_common.vm_base('linux', 'amd64', 'gate') + {
     run+: [
       ['export', 'SVM_SUITE=' + vm.svm_suite],
    ...
    vm.vm_java_21     + vm_common.vm_base('linux', 'amd64', 'daily') + truffle_unchained,
