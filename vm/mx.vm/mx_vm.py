...
mx_sdk_vm.register_vm_config('espresso-community', ['antlr4', 'ejvm', 'ellvm', 'java', 'lg', 'libpoly', 'llrc', 'llrns', 'nfi', 'nfi-libffi', 'sdk', 'sdkc', 'sdkl', 'sdkni', 'spolyglot', 'tfl', 'tfla', 'tflc'], _suite, env_file='ce-espresso')
