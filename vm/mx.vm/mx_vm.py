...
mx_sdk_vm.register_vm_config('ce', ce_components_minimal + ['icu4j', 'js', 'rgx'], _suite, dist_name='ce-js', env_file='ce-js')
mx_sdk_vm.register_vm_config('ce', ce_components_minimal + ['icu4j', 'js', 'njs', 'rgx', 'sjsvm'], _suite, dist_name='ce', env_file='ce-nodejs')
