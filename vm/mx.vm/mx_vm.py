...
mx_sdk_vm.register_vm_config('espresso-community', ['antlr4', 'ejvm', 'ellvm', 'gvm', 'java', 'llrc', 'llrns', 'nfi', 'nfi-libffi', 'nr_lib_javavm', 'sdk', 'sdkc', 'sdkl', 'sdkni', 'tfl', 'tfla', 'tflc', 'tflm'], _suite, env_file='ce-espresso')
