...
class NativeImageVM(GraalVm):
    ...
    class BenchmarkConfig:
        def __init__(self, vm, bm_suite, args):
            ...
            self.benchmark_suite_name = bm_suite.benchSuiteName(args) if len(inspect.getfullargspec(bm_suite.benchSuiteName).args) > 1 else bm_suite.benchSuiteName() # pylint: disable=deprecated-method
