...
public class GDSTokenStorageTest extends CommandTestBase {
    static final Path tstPath = Paths.get(System.getProperty(SYSPROP_USER_HOME), PATH_USER_GU, PATH_GDS_CONFIG + "test");
    ...
    public void testPropPath() {
        ...
        assertEquals(Paths.get(System.getProperty(SYSPROP_USER_HOME), PATH_USER_GU, PATH_GDS_CONFIG), pth);
    }
