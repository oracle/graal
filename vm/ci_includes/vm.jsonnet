...

{
  ...
  notify_releaser_build: vm_common.common_vm_linux + graal_common.linux_amd64 + {
    ...
    requireArtifacts: [
      ...
      {name: 'post-merge-deploy-vm-installable-java19-darwin-amd64'},
      {name: 'post-merge-deploy-vm-base-java19-darwin-amd64'},
      ...
      {name: 'post-merge-deploy-vm-base-java19-darwin-aarch64'},
      {name: 'post-merge-deploy-vm-installable-java19-darwin-aarch64'},
      ...
      {name: 'post-merge-deploy-vm-base-java19-windows-amd64'},
      {name: 'post-merge-deploy-vm-installable-java19-windows-amd64'},
