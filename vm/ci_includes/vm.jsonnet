...

{
  ...
  notify_releaser_build: vm_common.common_vm_linux + graal_common.linux_amd64 + {
    ...
    requireArtifacts: [
      ...
      {name: 'post-merge-deploy-vm-java19-linux-aarch64'},
      {name: 'ondemand-deploy-vm-base-java11-darwin-amd64'},
      {name: 'ondemand-deploy-vm-installable-java11-darwin-amd64'},
      {name: 'ondemand-deploy-vm-base-java17-darwin-amd64'},
      {name: 'ondemand-deploy-vm-installable-java19-darwin-amd64'},
      {name: 'ondemand-deploy-vm-base-java19-darwin-amd64'},
      {name: 'ondemand-deploy-vm-installable-java17-darwin-amd64'},
      {name: 'ondemand-deploy-vm-base-java11-darwin-aarch64'},
      {name: 'ondemand-deploy-vm-installable-java11-darwin-aarch64'},
      {name: 'ondemand-deploy-vm-base-java17-darwin-aarch64'},
      {name: 'ondemand-deploy-vm-installable-java17-darwin-aarch64'},
      {name: 'ondemand-deploy-vm-base-java19-darwin-aarch64'},
      {name: 'ondemand-deploy-vm-installable-java19-darwin-aarch64'},
      {name: 'ondemand-deploy-vm-base-java11-windows-amd64'},
      {name: 'ondemand-deploy-vm-installable-java11-windows-amd64'},
      {name: 'ondemand-deploy-vm-base-java17-windows-amd64'},
      {name: 'ondemand-deploy-vm-installable-java17-windows-amd64'},
      {name: 'ondemand-deploy-vm-base-java19-windows-amd64'},
      {name: 'ondemand-deploy-vm-installable-java19-windows-amd64'},
      {name: 'ondemand-deploy-vm-ruby-java11-linux-amd64'},
      {name: 'ondemand-deploy-vm-ruby-java11-darwin-amd64'},
      {name: 'ondemand-deploy-vm-ruby-java11-darwin-aarch64'},
    ],
    targets+: ['daily'],
  },
  ...
  local builds = [
    ...
    vm_common.darwin_deploy + vm_common.deploy_vm_darwin_amd64 + self.maven_11_17_only_native + {
     ...
     name: 'ondemand-deploy-vm-maven-darwin-amd64',
    },
    vm_common.darwin_deploy + vm_common.deploy_vm_darwin_aarch64 + self.maven_11_17_only_native + {
     ...
     name: 'ondemand-deploy-vm-maven-darwin-aarch64',
    },
    ...
    vm_common.svm_common_windows_amd64("11") + vm_common.deploy_vm_windows + self.maven_11_17_only_native + {
     run: [
       $.maven_11_17_only_native.build,
       $.maven_11_17_only_native.deploy + ['lafo-maven'],
     ],
     name: 'ondemand-deploy-vm-maven-windows-amd64',
    },
