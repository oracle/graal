...

{
  ...
  # Darwin/AMD64
  deploy_vm_base_java11_darwin_amd64: vm.vm_java_11_llvm + self.full_vm_build_darwin_amd64 + self.darwin_deploy + self.deploy_vm_darwin_amd64 + self.deploy_graalvm_base_darwin_amd64("java11") + {name: 'ondemand-deploy-vm-base-java11-darwin-amd64'},
  deploy_vm_installable_java11_darwin_amd64: vm.vm_java_11_llvm + self.full_vm_build_darwin_amd64 + self.darwin_deploy + self.deploy_vm_darwin_amd64 + self.deploy_graalvm_installables_darwin_amd64("java11") + {name: 'ondemand-deploy-vm-installable-java11-darwin-amd64', diskspace_required: "31GB"},
  deploy_vm_base_java17_darwin_amd64: vm.vm_java_17_llvm + self.full_vm_build_darwin_amd64 + self.darwin_deploy + self.deploy_vm_darwin_amd64 + self.deploy_graalvm_base_darwin_amd64("java17") + {name: 'ondemand-deploy-vm-base-java17-darwin-amd64'},
  deploy_vm_installable_java17_darwin_amd64: vm.vm_java_17_llvm + self.full_vm_build_darwin_amd64 + self.darwin_deploy + self.deploy_vm_darwin_amd64 + self.deploy_graalvm_installables_darwin_amd64("java17") + {name: 'ondemand-deploy-vm-installable-java17-darwin-amd64', diskspace_required: "31GB"},
  deploy_vm_base_java19_darwin_amd64: vm.vm_java_19_llvm + self.full_vm_build_darwin_amd64 + self.darwin_deploy + self.deploy_vm_darwin_amd64 + self.deploy_graalvm_base_darwin_amd64("java19") + {name: 'ondemand-deploy-vm-base-java19-darwin-amd64'},
  deploy_vm_installable_java19_darwin_amd64: vm.vm_java_19_llvm + self.full_vm_build_darwin_amd64 + self.darwin_deploy + self.deploy_vm_darwin_amd64 + self.deploy_graalvm_installables_darwin_amd64("java19") + {name: 'ondemand-deploy-vm-installable-java19-darwin-amd64', diskspace_required: "31GB"},

  # Darwin/AARCH64
  deploy_vm_base_java11_darwin_aarch64: vm.vm_java_11 + self.full_vm_build_darwin_aarch64 + self.darwin_deploy + self.deploy_vm_darwin_aarch64 + self.deploy_graalvm_base_darwin_aarch64("java11") + {name: 'ondemand-deploy-vm-base-java11-darwin-aarch64'},
  deploy_vm_installable_java11_darwin_aarch64: vm.vm_java_11 + self.full_vm_build_darwin_aarch64 + self.darwin_deploy + self.deploy_vm_darwin_aarch64 + self.deploy_graalvm_installables_darwin_aarch64("java11") + {name: 'ondemand-deploy-vm-installable-java11-darwin-aarch64', diskspace_required: "31GB"},
  deploy_vm_base_java17_darwin_aarch64: vm.vm_java_17 + self.full_vm_build_darwin_aarch64 + self.darwin_deploy + self.deploy_vm_darwin_aarch64 + self.deploy_graalvm_base_darwin_aarch64("java17") + {name: 'ondemand-deploy-vm-base-java17-darwin-aarch64'},
  deploy_vm_installable_java17_darwin_aarch64: vm.vm_java_17 + self.full_vm_build_darwin_aarch64 + self.darwin_deploy + self.deploy_vm_darwin_aarch64 + self.deploy_graalvm_installables_darwin_aarch64("java17") + {name: 'ondemand-deploy-vm-installable-java17-darwin-aarch64', diskspace_required: "31GB"},
  deploy_vm_base_java19_darwin_aarch64: vm.vm_java_19 + self.full_vm_build_darwin_aarch64 + self.darwin_deploy + self.deploy_vm_darwin_aarch64 + self.deploy_graalvm_base_darwin_aarch64("java19") + {name: 'ondemand-deploy-vm-base-java19-darwin-aarch64'},
  deploy_vm_installable_java19_darwin_aarch64: vm.vm_java_19 + self.full_vm_build_darwin_aarch64 + self.darwin_deploy + self.deploy_vm_darwin_aarch64 + self.deploy_graalvm_installables_darwin_aarch64("java19") + {name: 'ondemand-deploy-vm-installable-java19-darwin-aarch64', diskspace_required: "31GB"},

  # Windows/AMD64
  deploy_vm_base_java11_windows_amd64: vm.vm_java_11 + self.svm_common_windows_amd64("11") + self.js_windows_jdk11 + self.deploy_vm_windows_jdk11 + self.deploy_graalvm_base_windows_amd64("java11") + {name: 'ondemand-deploy-vm-base-java11-windows-amd64'},
  deploy_vm_installable_java11_windows_amd64: vm.vm_java_11 + self.svm_common_windows_amd64("11") + self.js_windows_jdk11 + self.sulong_windows + self.deploy_vm_windows_jdk11 + self.deploy_graalvm_installables_windows_amd64("java11") + {name: 'ondemand-deploy-vm-installable-java11-windows-amd64', diskspace_required: "31GB"},
  deploy_vm_base_java17_windows_amd64: vm.vm_java_17 + self.svm_common_windows_amd64("17") + self.js_windows_jdk17 + self.deploy_vm_windows_jdk17 + self.deploy_graalvm_base_windows_amd64("java17") + {name: 'ondemand-deploy-vm-base-java17-windows-amd64'},
  deploy_vm_installable_java17_windows_amd64: vm.vm_java_17 + self.svm_common_windows_amd64("17") + self.js_windows_jdk17 + self.sulong_windows + self.deploy_vm_windows_jdk17 + self.deploy_graalvm_installables_windows_amd64("java17") + {name: 'ondemand-deploy-vm-installable-java17-windows-amd64', diskspace_required: "31GB"},
  deploy_vm_base_java19_windows_amd64: vm.vm_java_19 + self.svm_common_windows_amd64("19") + self.js_windows_jdk19 + self.deploy_vm_windows_jdk19 + self.deploy_graalvm_base_windows_amd64("java19") + {name: 'ondemand-deploy-vm-base-java19-windows-amd64'},
  deploy_vm_installable_java19_windows_amd64: vm.vm_java_19 + self.svm_common_windows_amd64("19") + self.js_windows_jdk19 + self.sulong_windows + self.deploy_vm_windows_jdk19 + self.deploy_graalvm_installables_windows_amd64("java19") + {name: 'ondemand-deploy-vm-installable-java19-windows-amd64', diskspace_required: "31GB"},

  #
  # Deploy the GraalVM Ruby image (GraalVM Base + ruby - js)
  #

  deploy_vm_ruby_java11_linux_amd64: vm.vm_java_11 + self.ruby_vm_build_linux + self.linux_deploy + self.ondemand_deploy_vm_linux_amd64 + self.deploy_graalvm_ruby('linux', 'amd64', 'java11') + {name: 'ondemand-deploy-vm-ruby-java11-linux-amd64'},
  deploy_vm_ruby_java11_darwin_amd64: vm.vm_java_11 + self.ruby_vm_build_darwin_amd64 + self.darwin_deploy + self.deploy_vm_darwin_amd64 + self.deploy_graalvm_ruby('darwin', 'amd64', 'java11') + {name: 'ondemand-deploy-vm-ruby-java11-darwin-amd64'},
  deploy_vm_ruby_java11_darwin_aarch64: vm.vm_java_11 + self.ruby_vm_build_darwin_aarch64 + self.darwin_deploy + self.deploy_vm_darwin_aarch64 + self.deploy_graalvm_ruby('darwin', 'aarch64', 'java11') + {name: 'ondemand-deploy-vm-ruby-java11-darwin-aarch64'},
