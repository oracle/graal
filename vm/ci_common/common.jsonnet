...

{
  ...
  # Darwin/AMD64
  deploy_vm_base_java11_darwin_amd64: vm.vm_java_11 + self.full_vm_build_darwin_amd64 + self.darwin_deploy + self.deploy_vm_darwin_amd64 + self.deploy_graalvm_base_darwin_amd64 + {name: 'post-merge-deploy-vm-base-java11-darwin-amd64'},
  deploy_vm_installable_java11_darwin_amd64: vm.vm_java_11 + self.full_vm_build_darwin_amd64 + self.darwin_deploy + self.deploy_vm_darwin_amd64 + self.deploy_graalvm_installables_darwin_amd64 + {name: 'post-merge-deploy-vm-installable-java11-darwin-amd64'},
  deploy_vm_base_java17_darwin_amd64: vm.vm_java_17 + self.full_vm_build_darwin_amd64 + self.darwin_deploy + self.deploy_vm_darwin_amd64 + self.deploy_graalvm_base_darwin_amd64 + {name: 'post-merge-deploy-vm-base-java17-darwin-amd64'},
  deploy_vm_installable_java17_darwin_amd64: vm.vm_java_17 + self.full_vm_build_darwin_amd64 + self.darwin_deploy + self.deploy_vm_darwin_amd64 + self.deploy_graalvm_installables_darwin_amd64 + {name: 'post-merge-deploy-vm-installable-java17-darwin-amd64'},
