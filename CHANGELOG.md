...
* Added [TruffleLanguage.Registration.interactiveness()](http://lafo.ssw.uni-linz.ac.at/javadoc/truffle/latest/com/oracle/truffle/api/TruffleLanguage.Registration.html#interactiveness--) to inform about language interactive behavior. When false (the default), PolyglotEngine.eval() prints out results of interactive sources. When true, the language should perform the printing of results of execution of interactive sources itself.
