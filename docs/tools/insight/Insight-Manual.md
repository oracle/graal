...
Run it on top of [sieve.js](https://github.com/oracle/graal/blob/master/vm/benchmarks/agentscript/sieve.js).
...
insight.on("enter", onEnter, Roots())
```
Apply this script to [agent-fib.js](https://github.com/oracle/graal/blob/master/vm/tests/all/agentscript/agent-fib.js) using the following command:
...
The above Ruby script example prints out value of variable `n` when a function `minusOne` in the [agent-fib.js](https://github.com/oracle/graal/blob/master/vm/tests/all/agentscript/agent-fib.js) program is called:
```bash
...
Use the script on fifty iterations of the [sieve.js](https://github.com/oracle/graal/blob/master/vm/benchmarks/agentscript/sieve.js) sample which uses a variant of the Sieve of Erathostenes to compute one hundred thousand of prime numbers.
...
This can be demonstrated with this [sieve.js](https://github.com/oracle/graal/blob/master/vm/benchmarks/agentscript/sieve.js) algorithm to compute hundred thousand of prime numbers.
...
Get the [sieve.js](https://github.com/oracle/graal/blob/master/vm/benchmarks/agentscript/sieve.js) file and launch it as:
...
The previous picture shows the heap dump taken at the end of the `measure` function in the [sieve.js](https://github.com/oracle/graal/blob/master/vm/benchmarks/agentscript/sieve.js) script.
