...
![Heap Viewer Objects](img/HeapViewer_objects.png)
...
![Heap Viewer Objects Dominators](img/HeapViewer_objects_dominators.png)
...
![Heap Viewer Thread](img/HeapViewer_thread.png)
...
![Viewing JFR via VisualVM](img/visualvm_jfr.png)
