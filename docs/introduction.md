...
The following table lists fully supported and experimental features in Oracle GraalVM by platform.
...
Whether you are new to GraalVM and Native Image or have little experience using it, continue to [Getting Started](reference-manual/native-image/README.md).
