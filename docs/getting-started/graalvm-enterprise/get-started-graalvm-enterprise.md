...
the [Truffle language implementation framework](../../graalvm-as-a-platform/graalvm-as-a-platform.md) included, which is the case here.
...
If you are considering GraalVM Enterprise as a platform for your future language or tool implementation, go to [GraalVM Enterprise as a Platform](../../graalvm-as-a-platform/graalvm-as-a-platform.md).
