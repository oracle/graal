...
compiler, go to [Compiler](../../reference-manual/compiler.md).
...
Additionally, the image building requires large amounts of physical memory, especially if you build an image with the [Truffle language implementation framework](../../graalvm-as-a-platform/graalvm-as-a-platform.md) included, which is the case here.
...
If you are considering GraalVM as a platform for your future language or tool implementation, go to [GraalVM as a Platform](../../graalvm-as-a-platform/graalvm-as-a-platform.md).
