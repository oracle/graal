...
next: /en/graalvm/enterprise/20/docs/reference-manual/native-image/Configuration/
...
To build polyglot images, refer to the documentation in the [VM suite](https://github.com/oracle/graal/blob/master/vm/README.md).
...
If you have to debug the compiler graphs that are built as part of an image, proceed to the [debugging](https://github.com/oracle/graal/blob/master/compiler/docs/Debugging.md) page.
