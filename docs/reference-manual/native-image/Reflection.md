...
title: Reflection on Native Image
...
next: /en/graalvm/enterprise/20/docs/reference-manual/native-image/Resources/
previous: /en/graalvm/enterprise/20/docs/reference-manual/native-image/JNI/
---
