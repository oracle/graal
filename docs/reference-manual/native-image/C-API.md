...
next: /en/graalvm/enterprise/20/docs/reference-manual/native-image/ImplementingNativeMethodsInJavaWithSVM/
previous: /en/graalvm/enterprise/20/docs/reference-manual/native-image/HostedvsRuntimeOptions/
---
#  Native Image C API
