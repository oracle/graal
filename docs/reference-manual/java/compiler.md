...
Find some of the platform-independent compiler optimizations in GraalVM Community Edition [here](../../../compiler/src/jdk.internal.vm.compiler/src/jdk/compiler/graal/core/phases/CEOptimization.java).

The Graal compiler can bring performance advantages for highly-abstracted programs. For example, it includes a [partial-escape-analysis optimization](../../../compiler/src/jdk.internal.vm.compiler/src/jdk/compiler/graal/core/phases/CEOptimization.java) that can remove costly allocations of certain objects. 
