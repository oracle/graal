...
public abstract class LongArrayStoreNode extends QuickNode {
    ...
    void doForeign(StaticObject array, int index, long value,
        ...
        try {
            ...
            exceptionProfile.enter();
            throw Meta.throwExceptionWithMessage(context.getMeta().java_lang_ClassCastException, "Could not cast the long value " + value + " to the type of the foreign array elements");
