...
public abstract class ByteArrayLoadNode extends QuickNode {
    ...
    protected ByteArrayLoadNode(int top, int callerBCI) {
        super(top, callerBCI);
    }
    ...
    public final int execute(VirtualFrame frame, OperandStack stack) {
        ...
        return Bytecodes.stackEffectOf(Bytecodes.BALOAD);
    }
    ...
    byte doEspresso(StaticObject array, int index) {
        return getBytecodesNode().getInterpreterToVM().getArrayByte(index, array);
    }
