...
public abstract class AbstractGetFieldNode extends Node {
    ...
    public abstract int getField(VirtualFrame frame, OperandStack stack, BytecodeNode root, StaticObject receiver, int at, int statementIndex);
...
abstract class IntGetFieldNode extends AbstractGetFieldNode {
    ...
    @Override
    public int getField(VirtualFrame frame, OperandStack stack, BytecodeNode root, StaticObject receiver, int at, int statementIndex) {
        root.notifyFieldAccess(frame, statementIndex, field, receiver);
        BytecodeNode.putInt(stack, at, executeGetField(receiver));
        return slotCount;
    }
...
abstract class BooleanGetFieldNode extends AbstractGetFieldNode {
    ...
    public int getField(VirtualFrame frame, OperandStack stack, BytecodeNode root, StaticObject receiver, int at, int statementIndex) {
        root.notifyFieldAccess(frame, statementIndex, field, receiver);
        BytecodeNode.putInt(stack, at, executeGetField(receiver) ? 1 : 0);
        return slotCount;
    }
...
abstract class LongGetFieldNode extends AbstractGetFieldNode {
    ...
    public int getField(VirtualFrame frame, OperandStack stack, BytecodeNode root, StaticObject receiver, int at, int statementIndex) {
        root.notifyFieldAccess(frame, statementIndex, field, receiver);
        BytecodeNode.putLong(stack, at, executeGetField(receiver));
        return slotCount;
    }
...
abstract class FloatGetFieldNode extends AbstractGetFieldNode {
    ...
    public int getField(VirtualFrame frame, OperandStack stack, BytecodeNode root, StaticObject receiver, int at, int statementIndex) {
        root.notifyFieldAccess(frame, statementIndex, field, receiver);
        BytecodeNode.putFloat(stack, at, executeGetField(receiver));
        return slotCount;
    }
...
abstract class DoubleGetFieldNode extends AbstractGetFieldNode {
    ...
    public int getField(VirtualFrame frame, OperandStack stack, BytecodeNode root, StaticObject receiver, int at, int statementIndex) {
        root.notifyFieldAccess(frame, statementIndex, field, receiver);
        BytecodeNode.putDouble(stack, at, executeGetField(receiver));
        return slotCount;
    }
...
abstract class ObjectGetFieldNode extends AbstractGetFieldNode {
    ...
    public int getField(VirtualFrame frame, OperandStack stack, BytecodeNode root, StaticObject receiver, int at, int statementIndex) {
        root.notifyFieldAccess(frame, statementIndex, field, receiver);
        BytecodeNode.putObject(stack, at, executeGetField(receiver));
        return slotCount;
    }
