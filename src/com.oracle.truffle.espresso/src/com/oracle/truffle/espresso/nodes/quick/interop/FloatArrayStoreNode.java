...
public abstract class FloatArrayStoreNode extends QuickNode {
    ...
    void doForeign(StaticObject array, int index, float value,
        ...
        try {
            ...
            throw Meta.throwExceptionWithMessage(context.getMeta().java_lang_ClassCastException, "Could not cast the float value " + value + " to the type of the foreign array elements");
