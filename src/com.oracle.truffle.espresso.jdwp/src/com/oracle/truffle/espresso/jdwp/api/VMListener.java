...
public interface VMListener {
    ...
    /**
     * Determines if the field has a field modification breakpoint set.
     * If true, the caller of the method is expected to enter a probe
     * node to allow for the Truffle Debug API to suspend the execution.
    ...
    /**
     * Determines if the field has a field access breakpoint set.
     * If true, the caller of the method is expected to enter a probe
     * node to allow for the Truffle Debug API to suspend the execution.
     * @param field the field
     * @param receiver the receiving object in the field instruction
