...
jint JVM_ActiveProcessorCount(void) {
  fprintf(stderr, "Calling unimplemented mokapot JVM_ActiveProcessorCount.");
  return 666;
}
...
char *JVM_NativePath(char *pathname) {
  fprintf(stderr, "Calling unimplemented mokapot JVM_NativePath.");
  return NULL;
}

jint JVM_Open(const char *fname, jint flags, jint mode) {
  fprintf(stderr, "Calling unimplemented mokapot JVM_Open.");
  return 0;
}

jint JVM_Close(jint fd) {
  fprintf(stderr, "Calling unimplemented mokapot JVM_Close.");
  return 0;
}
...
void *JVM_RawMonitorCreate(void) {
  fprintf(stderr, "Calling unimplemented mokapot JVM_RawMonitorCreate.");
  return NULL;
}
...
jint JVM_RawMonitorEnter(void *mon) {
  fprintf(stderr, "Calling unimplemented mokapot JVM_RawMonitorEnter.");
  return 0;
}

void JVM_RawMonitorExit(void *mon) {
  fprintf(stderr, "Calling unimplemented mokapot JVM_RawMonitorExit.");
