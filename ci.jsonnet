...
local graalvm_installables(ee) = {
  ...
  local base_cmd_line = ['mx', '--dynamicimports=' + dynamic_imports, '--native-images=espresso,lib:espresso', '--exclude-components=elau,nju,npi', '--disable-installables=ni,niee,nil,llp'],
