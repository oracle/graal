...
To build Truffle-based images please refer to the documentation in the [VM suite](https://github.com/oracle/graal/blob/master/vm/README.md).
...
If you have to debug the compiler graphs that are built as part of building an image, proceed to the [debugging](https://github.com/oracle/graal/blob/master/compiler/docs/Debugging.md) page.
