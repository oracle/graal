...
* (GR-53998) Remove support for the previously deprecated options `PlatformInterfaceCompatibilityMode` and `RunReachabilityHandlersConcurrently`. The options remain, but no longer have any effect.
