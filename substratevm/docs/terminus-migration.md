...
| -------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------- | --- |
| `RuntimeReflection`                                                                          | JVMCI-based replacement APIs                                                                             | Use Terminus-safe registration paths instead of host reflection state. |
| `RuntimeJNIAccess`                                                                           | JVMCI-based replacement APIs                                                                             | Prefer guest-aware access paths. |
| `RuntimeProxyCreation`                                                                       | JVMCI-based replacement APIs                                                                             | Avoid assuming host reflection ownership. |
| `JNIAccess`                                                                                  | `JVMCIJNIAccess`                                                                                         | Same class name pattern with `JVMCI` prefix. |
| `AccessCondition`                                                                            | `ReflectiveAccess`                                                                                       | Use the JVMCI-aware variant. |
| `JNIRuntimeAccess`                                                                           | `JVMCIRuntimeJNIAccess`                                                                                  | Note the naming change: `JNIRuntime` vs `RuntimeJNI`. |
...
| `Class.getDeclaredConstructor()`                                                             | `JVMCIReflectionUtil` constructor helpers                                                                | Same uniqueness caveat as method lookup. |
| `Class.getConstructors()`                                                                    | `JVMCIReflectionUtil` constructor helpers                                                                | Keep lookup in JVMCI space. |
