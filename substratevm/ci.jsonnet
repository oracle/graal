{
  ...
  builds: [
    ...
    darwin_jdk17      + gate("darwin-js", "build,js") + clone_js_benchmarks,
    darwin_jdk17      + gate("darwin-js-quickbuild", "build,js_quickbuild") + clone_js_benchmarks,
    linux_amd64_jdk11 + gate("build-ce-11", "build,helloworld,test,nativeimagehelp,muslcbuild") + maven + svm_unittest + t("30:00") + musl_toolchain,
    ...
    windows_jdk17     + gate("windows-basics", "build,helloworld,test,svmjunit") + svm_unittest + t("1:30:00"),
    windows_jdk17     + gate("windows-basics-quickbuild", "build,helloworld_quickbuild,test_quickbuild,svmjunit_quickbuild") + svm_unittest + t("1:30:00"),
  ],
}
