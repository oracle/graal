...
def gen_fallbacks():
    ...
    def write_fallbacks(required_fallbacks):
        ...
        with open(jvm_fallbacks_path, mode='w') as fallback_file:
            fallback_file.write('/* Fallback implementations autogenerated by ' + basename(__file__) + ' */\n\n')
            fallback_file.write('#include <jni.h>\n')
            function_stub = '''
...
'''
            for name in required_fallbacks.keys():
                fallback_file.write(function_stub.format(name))
