...
TERMINUS_HELLO_WORLD_EXPECTED_FAILURE = """
    ...
    at org.graalvm.nativeimage.builder/com.oracle.svm.hosted.SVMHost.checkType(SVMHost.java:740)
    at org.graalvm.nativeimage.pointsto/com.oracle.graal.pointsto.meta.AnalysisUniverse.createType(AnalysisUniverse.java:241)
