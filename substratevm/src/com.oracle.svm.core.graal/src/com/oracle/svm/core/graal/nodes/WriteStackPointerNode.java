...
/**
 * Writes the stack pointer. Note that this is very dangerous. You have to know what you are doing.
 */
@NodeInfo(cycles = NodeCycles.CYCLES_1, size = NodeSize.SIZE_1)
public final class WriteStackPointerNode extends FixedWithNextNode implements LIRLowerable {
    public static final NodeClass<WriteStackPointerNode> TYPE = NodeClass.create(WriteStackPointerNode.class);

    @Input protected ValueNode value;

    public WriteStackPointerNode(ValueNode value) {
