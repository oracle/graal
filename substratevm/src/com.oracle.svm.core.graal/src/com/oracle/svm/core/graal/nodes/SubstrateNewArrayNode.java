...
public class SubstrateNewArrayNode extends NewArrayNode {
    ...
    public SubstrateNewArrayNode(ResolvedJavaType elementType, ValueNode length, boolean fillContents, FrameState stateBefore) {
    ...
    protected VirtualArrayNode createVirtualArrayNode(int constantLength) {
        return new SubstrateVirtualArrayNode(elementType(), constantLength);
    }

    @Override
    protected ConstantNode defaultElementValue() {
        /*
         * Arrays that have a Word type need to get the primitive 0 initial value during escape
