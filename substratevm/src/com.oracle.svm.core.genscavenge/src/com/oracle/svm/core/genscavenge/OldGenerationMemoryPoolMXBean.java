 ...
 */
public final class OldGenerationMemoryPoolMXBean extends AbstractMemoryPoolMXBean {
    ...
    public MemoryUsage getUsage() {
        ...
        return new MemoryUsage(UNDEFINED_MEMORY_USAGE, used, used, maxHeap - maxYoung);
    }
}
