...
public final class GCImpl implements GC {
    ...
    private static final int WORD_SIZE = ConfigurationValues.getTarget().wordSize;
    private final GlobalHandlesBucketCallback GLOBAL_CALLBACK = new GlobalHandlesBucketCallback(greyToBlackObjRefVisitor);
    ...
    static final class GlobalHandlesBucketCallback implements ObjectHandlesImpl.BucketCallback {
        ...
        private GlobalHandlesBucketCallback(GreyToBlackObjRefVisitor v) {
            this.v = v;
        }
    ...
    private void scanFromRoots() {
        ...
        try {
            ...
            try {
                blackenStackRoots();
                blackenThreadLocals();
                JNIObjectHandles.scanGlobalHandleBuckets(GLOBAL_CALLBACK);
