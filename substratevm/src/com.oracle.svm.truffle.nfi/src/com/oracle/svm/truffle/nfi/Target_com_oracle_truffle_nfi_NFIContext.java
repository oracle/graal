...
@TargetClass(className = "com.oracle.truffle.nfi.NFIContext", onlyWith = TruffleNFIFeature.IsEnabled.class)
final class Target_com_oracle_truffle_nfi_NFIContext {
    ...
    @Alias
    native Target_com_oracle_truffle_nfi_ClosureNativePointer createClosureNativePointer(long nativeClosure, long codePointer, CallTarget callTarget,
                    Target_com_oracle_truffle_nfi_LibFFISignature signature);
    ...
    static class RTLDAccessor {
        ...
        static int getRTLD_GLOBAL(@SuppressWarnings("unused") Target_com_oracle_truffle_nfi_NFIContext ctx) {
            return Dlfcn.RTLD_GLOBAL();
        }

        static int getRTLD_LOCAL(@SuppressWarnings("unused") Target_com_oracle_truffle_nfi_NFIContext ctx) {
            return Dlfcn.RTLD_LOCAL();
        }

        static int getRTLD_LAZY(@SuppressWarnings("unused") Target_com_oracle_truffle_nfi_NFIContext ctx) {
            return Dlfcn.RTLD_LAZY();
        }

        static int getRTLD_NOW(@SuppressWarnings("unused") Target_com_oracle_truffle_nfi_NFIContext ctx) {
    ...
    @Substitute
    Target_com_oracle_truffle_nfi_ClosureNativePointer allocateClosureObjectRet(Target_com_oracle_truffle_nfi_LibFFISignature signature, CallTarget callTarget) {
        return NativeClosure.prepareClosure(this, signature, callTarget, NativeClosure.INVOKE_CLOSURE_OBJECT_RET.getFunctionPointer());
    }

    @Substitute
    Target_com_oracle_truffle_nfi_ClosureNativePointer allocateClosureStringRet(Target_com_oracle_truffle_nfi_LibFFISignature signature, CallTarget callTarget) {
        return NativeClosure.prepareClosure(this, signature, callTarget, NativeClosure.INVOKE_CLOSURE_STRING_RET.getFunctionPointer());
    }

    @Substitute
    Target_com_oracle_truffle_nfi_ClosureNativePointer allocateClosureBufferRet(Target_com_oracle_truffle_nfi_LibFFISignature signature, CallTarget callTarget) {
        return NativeClosure.prepareClosure(this, signature, callTarget, NativeClosure.INVOKE_CLOSURE_BUFFER_RET.getFunctionPointer());
    }

    @Substitute
    Target_com_oracle_truffle_nfi_ClosureNativePointer allocateClosureVoidRet(Target_com_oracle_truffle_nfi_LibFFISignature signature, CallTarget callTarget) {
    ...
    long prepareSignature(Target_com_oracle_truffle_nfi_LibFFIType retType, Target_com_oracle_truffle_nfi_LibFFIType... args) {
    ...
    @Substitute
    @SuppressWarnings("static-method")
    long prepareSignatureVarargs(Target_com_oracle_truffle_nfi_LibFFIType retType, int nFixedArgs, Target_com_oracle_truffle_nfi_LibFFIType... args) {
        CifData data = PrepareHelper.prepareArgs(args);
