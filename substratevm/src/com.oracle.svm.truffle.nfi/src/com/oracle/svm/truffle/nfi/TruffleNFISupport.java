...
public abstract class TruffleNFISupport {
    ...
    public TruffleContextHandle createContextHandle(Target_com_oracle_truffle_nfi_backend_libffi_NFIContext context) {
        return (TruffleContextHandle) contextHandles.create(context);
    }

    public Target_com_oracle_truffle_nfi_backend_libffi_NFIContext resolveContextHandle(TruffleContextHandle handle) {
        return (Target_com_oracle_truffle_nfi_backend_libffi_NFIContext) contextHandles.get((ObjectHandle) handle);
    }
    ...
    protected static Target_com_oracle_truffle_nfi_backend_libffi_NFIContext getContext(long nativeContext) {
        TruffleNFISupport truffleNFISupport = ImageSingletons.lookup(TruffleNFISupport.class);
