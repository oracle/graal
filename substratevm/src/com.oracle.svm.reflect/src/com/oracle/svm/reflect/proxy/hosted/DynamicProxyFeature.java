...
public final class DynamicProxyFeature implements Feature {
    ...
    public static class Options {
        ...
        public static final HostedOptionKey<String[]> DynamicProxyConfigurationFiles = new HostedOptionKey<>(new String[0]);
        ...
        public static final HostedOptionKey<String[]> DynamicProxyConfigurationResources = new HostedOptionKey<>(new String[0]);
    }
