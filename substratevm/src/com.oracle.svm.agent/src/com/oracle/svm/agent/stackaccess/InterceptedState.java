...
public abstract class InterceptedState {
    ...
    public abstract JNIMethodId getCallerMethod(int depth);

    public abstract JNIMethodId[] getFullStackTraceOrNull();

    public JNIObjectHandle getCallerClass(int depth) {
        return Support.getMethodDeclaringClass(getCallerMethod(depth));
    }
