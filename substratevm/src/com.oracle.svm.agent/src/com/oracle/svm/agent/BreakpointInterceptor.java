...
final class BreakpointInterceptor {
    ...
    private static List<String> predefineClassRules;
     ...
     * {@link sun.instrument.InstrumentationImpl#transform(Module, ClassLoader, String, Class, ProtectionDomain, byte[], boolean)}.
     *
    ...
    private static void onClassFileLoadHook(@SuppressWarnings("unused") JvmtiEnv jvmti, JNIEnvironment jni, @SuppressWarnings("unused") JNIObjectHandle classBeingRedefined,
        ...
        if (experimentalInstrumentSupport) {
            ...
            if (!predefineClassRules.isEmpty()) {
                for (String predefineClassRule : predefineClassRules) {
    ...
    public static void onLoad(JvmtiEnv jvmti, JvmtiEventCallbacks callbacks, Tracer writer, NativeImageAgent nativeImageTracingAgent,
        ...
        BreakpointInterceptor.predefineClassRules = predefineClassRules;
