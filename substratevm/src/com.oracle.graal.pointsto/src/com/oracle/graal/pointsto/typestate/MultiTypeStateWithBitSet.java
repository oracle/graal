...
public non-sealed class MultiTypeStateWithBitSet extends MultiTypeState {
    ...
    public MultiTypeStateWithBitSet(boolean canBeNull, BitSet typesBitSet, int typesCount) {
    ...
    protected MultiTypeStateWithBitSet(boolean canBeNull, MultiTypeStateWithBitSet other) {
    ...
    @Override
    public final boolean containsType(int typeId) {
        return typesBitSet.get(typeId);
    }
    ...
    public TypeState forCanBeNull(PointsToAnalysis bb, boolean resultCanBeNull) {
        if (resultCanBeNull == this.canBeNull()) {
            ...
            return PointsToStats.registerTypeState(bb, new MultiTypeStateWithBitSet(resultCanBeNull, this));
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        MultiTypeStateWithBitSet that = (MultiTypeStateWithBitSet) o;
