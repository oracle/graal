...
public final class BytecodeSensitiveAnalysisPolicy extends AnalysisPolicy {
    ...
    public TypeState forContextInsensitiveTypeState(PointsToAnalysis bb, TypeState state) {
        if (state.isEmpty() || state.isNull()) {
            ...
            if (state instanceof SingleTypeState) {
                ...
                return multiTypeState(bb, multiState.canBeNull(), typesBitSet, objectsArray);
            }
        }
    }
    ...
    public MultiTypeState multiTypeState(PointsToAnalysis bb, boolean canBeNull, BitSet typesBitSet, AnalysisObject... objects) {
        return new ContextSensitiveMultiTypeState(bb, canBeNull, typesBitSet, objects);
    }
    ...
    public TypeState doUnion(PointsToAnalysis bb, SingleTypeState state1, SingleTypeState state2) {
        ...
        if (s1.exactType().equals(s2.exactType())) {
            ...
            TypeState result = new ContextSensitiveMultiTypeState(bb, resultCanBeNull, typesBitSet, resultObjects);
            PointsToStats.registerUnionOperation(bb, s1, s2, result);
            return result;
        }
    }
    ...
    public TypeState doUnion(PointsToAnalysis bb, MultiTypeState state1, SingleTypeState state2) {
        ...
        if (s1.containsType(s2.exactType())) {
            ...
            MultiTypeState result = new ContextSensitiveMultiTypeState(bb, resultCanBeNull, s1.bitSet(), resultObjects);
            ...
            MultiTypeState result = new ContextSensitiveMultiTypeState(bb, resultCanBeNull, typesBitSet, resultObjects);
            PointsToStats.registerUnionOperation(bb, s1, s2, result);
            return result;
        }
    }
    ...
    private TypeState doUnion0(PointsToAnalysis bb, ContextSensitiveMultiTypeState s1, ContextSensitiveMultiTypeState s2, boolean resultCanBeNull) {
        ...
        if (s1.lastTypeId() < s2.firstTypeId()) {
            ...
            MultiTypeState result = new ContextSensitiveMultiTypeState(bb, resultCanBeNull, resultTypesBitSet, resultObjects);
            PointsToStats.registerUnionOperation(bb, s1, s2, result);
            return result;
    ...
    private TypeState doUnion2(PointsToAnalysis bb, ContextSensitiveMultiTypeState s1, ContextSensitiveMultiTypeState s2, boolean resultCanBeNull, int startId1, int startId2) {
        try (UnsafeArrayListClosable<AnalysisObject> resultObjectsClosable = getTLArrayList(doUnion2TL, s1.objects.length + s2.objects.length)) {
            ...
            MultiTypeState result = new ContextSensitiveMultiTypeState(bb, resultCanBeNull, resultTypesBitSet, resultObjects.copyToArray(new AnalysisObject[resultObjects.size()]));
        ...
        try (ListUtils.UnsafeArrayListClosable<AnalysisObject> tlArrayClosable = ListUtils.getTLArrayList(intersectionArrayListTL, 256)) {
            ...
            if (totalLength == 0) {
                ...
                if (TypeStateUtils.holdsSingleTypeState(objects, objects.length)) {
                    ...
                    MultiTypeState result = new ContextSensitiveMultiTypeState(bb, resultCanBeNull, resultTypesBitSet, objects);
    ...
    public TypeState doSubtraction(PointsToAnalysis bb, MultiTypeState state1, SingleTypeState state2) {
        ...
        if (s1.containsType(s2.exactType())) {
            ...
            if (resultObjects.length == 1) {
                ...
                return new ContextSensitiveMultiTypeState(bb, resultCanBeNull, resultTypesBitSet, resultObjects);
            }
        ...
        try (ListUtils.UnsafeArrayListClosable<AnalysisObject> tlArrayClosable = ListUtils.getTLArrayList(intersectionArrayListTL, 256)) {
            ...
            if (totalLength == 0) {
                ...
                if (TypeStateUtils.holdsSingleTypeState(objects, totalLength)) {
                     ...
                     * <= s1.
                     */
                    return new ContextSensitiveMultiTypeState(bb, resultCanBeNull, resultTypesBitSet, objects);
                }
            }
        }
    }
