...
public class SimulatedHeapTracing {
    ...
    public static final SimulatedHeapTracing instance = CausalityExport.getActivationStatus() != CausalityExport.Level.DISABLED ? new Impl() : new SimulatedHeapTracing();
