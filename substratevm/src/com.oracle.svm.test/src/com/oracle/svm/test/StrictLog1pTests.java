...
/**
 * This test is based on test/jdk/java/lang/StrictMath/Log1pTests.java from JDK 11 tag jdk-11+28.
 */
public class StrictLog1pTests {
    ...
    public void testLog1p() {
        ...
        for (double[] testCase : testCases) {
            Assert.assertEquals(testCase[1], StrictMath.log1p(testCase[0]), 0);
        }
    }
}
