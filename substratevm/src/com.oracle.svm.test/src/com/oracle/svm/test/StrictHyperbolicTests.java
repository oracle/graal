...
/**
 * This test is based on test/jdk/java/lang/StrictMath/HyperbolicTests.java from JDK 11 tag jdk-11+28.
 */
public class StrictHyperbolicTests {
    ...
    public void testSinh() {
        ...
        for (double[] testCase: testCases) {
            Assert.assertEquals(testCase[1], StrictMath.sinh(testCase[0]), 0);
        }
    }
    ...
    public void testCosh() {
        ...
        for (double[] testCase: testCases) {
            Assert.assertEquals(testCase[1], StrictMath.cosh(testCase[0]), 0);
        }
    }
    ...
    public void testTanh() {
        ...
        for (double[] testCase: testCases) {
            Assert.assertEquals(testCase[1], StrictMath.tanh(testCase[0]), 0);
        }
    }
}
