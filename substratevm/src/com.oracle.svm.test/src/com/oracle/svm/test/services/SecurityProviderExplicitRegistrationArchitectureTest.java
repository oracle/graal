...
public class SecurityProviderExplicitRegistrationArchitectureTest {
    ...
    public void instantiatedProvidersHaveClassKeyedAcquisitionKinds() {
        ...
        SecurityProviderRuntimeState.ProviderInfo supplied = SecurityProviderRuntimeState.getProviderInfo(new SameNameApplicationSuppliedProvider());
    ...
    public static final class SameNameApplicationSuppliedProvider extends Provider {
        private static final long serialVersionUID = 1L;

        public SameNameApplicationSuppliedProvider() {
            super(REGISTERED_PROVIDER_NAME, "1.0", "Application-supplied provider sharing a registered provider name");
        }
    }
}
