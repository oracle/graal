...
import com.oracle.svm.jfr.JfrChunkWriter;
...
public class JFRFileParser {
    ...
    private static long parseConstantPoolsHeader(RecordingInput input, long constantPoolPosition) throws IOException {
        ...
        assertTrue("Constant pool size is invalid!", input.readInt() > 0); // Size of constant pools.
        assertEquals(JfrChunkWriter.CONSTANT_POOL_TYPE_ID, input.readLong()); // Constant pools region ID.
    ...
    private static class Positions {
        ...
        public Positions(long constantPoolPosition, long metadataPositions) {
