...
/**
 * This test is based on test/jdk/java/lang/StrictMath/Log10Tests.java from JDK 11 tag jdk-11+28.
 */
public class StrictLog10Tests {
    @Test
    public void testLog10() {
        ...
        for (double[] testCase: testCases) {
            Assert.assertEquals(testCase[1], StrictMath.log10(testCase[0]), 0);
        }
    }
}
