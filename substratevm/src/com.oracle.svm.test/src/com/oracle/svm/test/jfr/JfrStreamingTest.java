...
abstract class JfrStreamingTest extends JfrTest {
    ...
    protected void startStream() throws InterruptedException {
        stream.startAsync();
    ...
    protected void closeStream() throws InterruptedException {
        ...
        event.commit();
        stream.awaitTermination(Duration.ofMillis(TIMEOUT_MILLIS));
