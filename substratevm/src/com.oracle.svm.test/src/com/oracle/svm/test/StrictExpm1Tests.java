...
/**
 * This test is based on test/jdk/java/lang/StrictMath/Expm1Tests.java from JDK 11 tag jdk-11+28.
 */
public class StrictExpm1Tests {
    ...
    public void testExpm1() {
        ...
        for (double[] testCase : testCases) {
            Assert.assertEquals(testCase[1], StrictMath.expm1(testCase[0]), 0);
        }
    }
}
