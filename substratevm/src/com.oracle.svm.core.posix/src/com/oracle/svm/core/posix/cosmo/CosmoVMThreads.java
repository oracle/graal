...
import com.oracle.svm.core.posix.cosmo.headers.Sched;
...
public final class CosmoVMThreads extends VMThreads {
    ...
    public static CosmoVMThreads singleton() {
        return (CosmoVMThreads) ImageSingletons.lookup(VMThreads.class);
    }
    ...
    protected OSThreadId getCurrentOSThreadId() {
        int result = CosmoLibCHelper.getThreadId();
    ...
    protected void joinNoTransition(OSThreadHandle osThreadHandle) {
        ...
        CosmoUtils.checkStatusIs0(Pthread.pthread_join_no_transition(pthread, Word.nullPointer()), "Pthread.joinNoTransition");
    }
    ...
    public static class PosixThreadLookup extends ThreadLookup {
        ...
        public ComparableWord getThreadIdentifier() {
            ...
            return CosmoVMThreads.singleton().getCurrentOSThreadHandle();
        }
