...
import com.oracle.svm.core.posix.cosmo.headers.Locale;
import com.oracle.svm.core.posix.cosmo.headers.Pwd;
import com.oracle.svm.core.posix.cosmo.headers.Pwd.passwd;
import com.oracle.svm.core.posix.cosmo.headers.Pwd.passwdPointer;
...
public class CosmoUtils {
    ...
    @TargetClass(value = FileDescriptor.class, onlyWith = CosmoLibCSupplier.class)
    ...
    @TargetClass(className = "java.lang.ProcessImpl", onlyWith = CosmoLibCSupplier.class)
    ...
    public static int clock_gettime(int clock_id, Time.timespec ts) {
        return Time.NoTransitions.clock_gettime(clock_id, ts);
    }
    // Checkstyle: resume
