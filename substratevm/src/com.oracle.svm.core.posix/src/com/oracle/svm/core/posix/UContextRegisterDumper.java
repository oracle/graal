...
public interface UContextRegisterDumper extends RegisterDumper {
    void dumpRegisters(Log log, ucontext_t uContext, boolean printLocationInfo);
    ...
    @Override
    default void dumpRegisters(Log log, Context context, boolean printLocationInfo) {
        dumpRegisters(log, (ucontext_t) context, printLocationInfo);
    }
