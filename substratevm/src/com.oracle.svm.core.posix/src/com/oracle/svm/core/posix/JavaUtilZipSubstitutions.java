...
public final class JavaUtilZipSubstitutions {
    ...
    static final class Target_java_util_zip_Adler32 {
        ...
        // Adler32.c-Java_java_util_zip_Adler32_updateByteBuffer(JNIEnv *env, jclass cls, jint
        // adler,
        @Substitute
    ...
    static final class Target_java_util_zip_CRC32 {
        ...
        private long deflateBytesBytes(long addr,
            ...
            try (PinnedObject inputPinned = PinnedObject.create(inputArray)) {
                try (PinnedObject outputPinned = PinnedObject.create(outputArray)) {
                    return Util_java_util_zip_Deflater_JDK11OrLater.doDeflate(addr, inputPinned.addressOfArrayElement(inputOff), inputLen, outputPinned.addressOfArrayElement(outputOff), outputLen,
                                    flush,
                                    params);
                }
            }
    ...
    static final class Util_java_util_zip_Deflater {
    ...
    static final class Util_java_util_zip_Deflater_JDK11OrLater {
    ...
    static final class Util_java_util_zip_Deflater_JDK8OrEarlier {
    ...
    static final class Util_java_util_zip_Inflater_JDK11OrLater {
    ...
    static final class Util_java_util_zip_Inflater_JDK8OrEarlier {
        static int update(Object obj, int len, z_stream strm) {
            Target_java_util_zip_Inflater instance = SubstrateUtil.cast(obj, Target_java_util_zip_Inflater.class);
            instance.off += instance.len - strm.avail_in();
            instance.len = strm.avail_in();
    ...
    static final class Util_java_util_zip_Inflater {
