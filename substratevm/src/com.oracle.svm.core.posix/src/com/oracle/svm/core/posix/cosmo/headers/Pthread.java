...
public class Pthread {
    ...
    @CFunction
    public static native int pthread_setname_np(com.oracle.svm.core.posix.cosmo.headers.Pthread.pthread_t target_thread, CCharPointer name);

    @CFunction(transition = Transition.NO_TRANSITION)
    public static native int pthread_getcpuclockid(com.oracle.svm.core.posix.cosmo.headers.Pthread.pthread_t pthread, CIntPointer clock_id);

    @CFunction(transition = Transition.NO_TRANSITION)
    public static native int pthread_condattr_setclock(com.oracle.svm.core.posix.cosmo.headers.Pthread.pthread_condattr_t attr, int clock_id);
}
