...
public class MuslLibC implements LibCBase {
    ...
    public void prepare(Path directory) {
        String useMuslCFlag = SubstrateOptionsParser.commandArgument(LibCFeature.LibCOptions.UseMuslC, "+");
    ...
    public void setUpSpecFile(Path directory) {
        ...
        String muslPath = Paths.get(LibCFeature.LibCOptions.UseMuslC.getValue()).toAbsolutePath().toString();
