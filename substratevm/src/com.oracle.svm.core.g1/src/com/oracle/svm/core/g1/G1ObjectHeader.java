...
public class G1ObjectHeader extends ObjectHeader {
    ...
    @Fold
    public static G1ObjectHeader get() {
        return (G1ObjectHeader) G1Heap.get().getObjectHeader();
    }
    ...
    public int constantHeaderSize() {
        return SubstrateOptions.useCompressedReferences() ? Long.BYTES : Integer.BYTES;
    }
