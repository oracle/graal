...
/**
 * This class contains all methods that native-image uses for calling G1 C++ code. It is essential
 * to use the correct kind of transition as we will either end up with deadlocks or incorrect
 * behavior otherwise. In the G1 C++ code, the expected transition for each method is documented in
 * more detail. So, when changing the transition of a method, make sure to update that documentation
 * as well.
 *
 * The method {@link #parseOptions} passes a version to G1. This is used to verify if the
 * native-image really uses a compatible version of G1. We increment this version whenever we change
 * any method below.
 */
...
public class G1Library {
    ...
    public static native G1InitState create(IsolateThread isolateThread, Pointer heapBase,
                    int closedImageHeapRegions, int openImageHeapRegions, Word imageHeapRegionTypes, Word imageHeapRegionFreeSpaces,
                    Word imageHeapBlockOffsetTable, UnsignedWord imageHeapBlockOffsetTableSize,
                    ...
                    Word classesAssumedReachableForCodeUnloading, Word performanceData, boolean closedTypeWorld,
                    ...
                    CFunctionPointer collectForAllocationOp, CFunctionPointer executePauseRemark, CFunctionPointer executePauseCleanup,
                    CFunctionPointer collectFullOp, CFunctionPointer verifyHeapOp, CFunctionPointer tryInitiateConcMarkOp,
    ...
    @CFunction(value = "svm_g1gc_update_option_value", transition = Transition.NO_TRANSITION)
    public static native void updateOptionValue(Word optionName, long value);

    @CFunction(value = "svm_g1gc_teardown", transition = Transition.NO_TRANSITION)
    public static native boolean tearDown();

    @CFunction(value = "svm_g1gc_attach_thread", transition = Transition.NO_TRANSITION)
    public static native void attachThread(IsolateThread thread);

    @CFunction(value = "svm_g1gc_detach_thread", transition = Transition.NO_TRANSITION)
    public static native void detachThread(IsolateThread thread);

    @CFunction(value = "svm_g1gc_retire_tlab", transition = Transition.NO_TRANSITION)
    public static native void retireTlab();

    @CFunction(value = "svm_g1gc_prepare_for_safepoint", transition = Transition.NO_TRANSITION)
    public static native void prepareForSafepoint();

    @CFunction(value = "svm_g1gc_end_safepoint", transition = Transition.NO_TRANSITION)
    public static native void endSafepoint();

    @CFunctionOptions(transition = CFunctionOptions.Transition.TO_VM)
    @CFunction(value = "svm_g1gc_collect")
    public static native void collect(int gcCause);

    @CFunction(value = "svm_g1gc_execute_vm_operation_prologue", transition = Transition.TO_NATIVE)
    public static native boolean executeVMOperationPrologue(NativeGCVMOperationData data);

    @CFunction(value = "svm_g1gc_execute_vm_operation_main", transition = Transition.TO_NATIVE)
    public static native void executeVMOperationMain(NativeGCVMOperationData data);

    @CFunction(value = "svm_g1gc_execute_vm_operation_epilogue", transition = Transition.TO_NATIVE)
    public static native void executeVMOperationEpilogue(NativeGCVMOperationData data);

    @CFunctionOptions(transition = CFunctionOptions.Transition.TO_VM)
    @CFunction(value = "svm_g1gc_allocate_instance")
    ...
    @CFunctionOptions(transition = CFunctionOptions.Transition.TO_VM)
    @CFunction(value = "svm_g1gc_allocate_pod")
    public static native Word allocatePod(Word hub, int length);

    @CFunction(value = "svm_g1gc_pin_object", transition = Transition.NO_TRANSITION)
    public static native void pinObject(Word object);

    @CFunction(value = "svm_g1gc_unpin_object", transition = Transition.NO_TRANSITION)
    public static native void unpinObject(Word object);

    @CFunction(value = "svm_g1gc_pre_write_barrier", transition = Transition.NO_TRANSITION)
    public static native void preWriteBarrierStub(Word object);

    @CFunction(value = "svm_g1gc_post_write_barrier", transition = Transition.NO_TRANSITION)
    public static native void postWriteBarrierStub(Word cardAddress);

    @CFunction(value = "svm_g1gc_array_range_pre_write_barrier", transition = Transition.NO_TRANSITION)
    public static native void arrayRangePreWriteBarrier(Word start, UnsignedWord length);

    @CFunction(value = "svm_g1gc_array_range_post_write_barrier", transition = Transition.NO_TRANSITION)
    public static native void arrayRangePostWriteBarrier(Word start, UnsignedWord length);

    @CFunction(value = "svm_g1gc_dirty_all_references_of", transition = Transition.NO_TRANSITION)
    public static native void dirtyAllReferencesOf(Word obj);

    @CFunction(value = "svm_g1gc_verify_oop", transition = Transition.NO_TRANSITION)
    public static native void verifyOop(Word object);

    @CFunction(value = "svm_g1gc_validate_object", transition = Transition.NO_TRANSITION)
    public static native boolean validateObject(Word parent, Word child);

    @CFunction(value = "svm_g1gc_log_printf", transition = Transition.NO_TRANSITION)
    public static native void logPrintf(Word format, long v1, long v2, long v3);

    @CFunction(value = "svm_g1gc_millis_since_last_whole_heap_examined", transition = Transition.NO_TRANSITION)
    public static native long getMillisSinceLastWholeHeapExamined();

    @CFunction(value = "svm_g1gc_has_reference_pending_list", transition = Transition.TO_NATIVE)
    public static native boolean hasReferencePendingList();

    @CFunctionOptions(transition = CFunctionOptions.Transition.TO_VM)
    @CFunction(value = "svm_g1gc_get_and_clear_reference_pending_list")
    public static native Word getAndClearReferencePendingList();

    @CFunction(value = "svm_g1gc_get_reference_pending_list_wakeup_count", transition = Transition.NO_TRANSITION)
    public static native long getReferencePendingListWakeupCount();

    @CFunction(value = "svm_g1gc_wait_for_reference_pending_list", transition = Transition.TO_NATIVE)
    public static native boolean waitForReferencePendingList(long initialWakeupCount);

    @CFunction(value = "svm_g1gc_wake_up_reference_pending_list_waiters", transition = Transition.TO_NATIVE)
    public static native void wakeUpReferencePendingListWaiters();

    @CFunction(value = "svm_g1gc_get_region_boundaries", transition = Transition.TO_NATIVE)
    public static native void getRegionBoundaries(G1RegionBoundaries regionBoundaries);

    @CFunction(value = "svm_g1gc_register_object_fields", transition = Transition.NO_TRANSITION)
    public static native void registerObjectFields(CodeInfo codeInfo);

    @CFunction(value = "svm_g1gc_register_code_constants", transition = Transition.NO_TRANSITION)
    public static native void registerCodeConstants(CodeInfo codeInfo);

    @CFunction(value = "svm_g1gc_register_frame_metadata", transition = Transition.NO_TRANSITION)
    public static native void registerFrameMetadata(CodeInfo codeInfo);

    @CFunction(value = "svm_g1gc_register_deopt_metadata", transition = Transition.NO_TRANSITION)
    ...
    @CFunction(value = "svm_g1gc_get_region_info", transition = Transition.NO_TRANSITION)
    public static native boolean getRegionInfo(int regionIndex, G1RegionInfo result);

    @CFunction(value = "svm_g1gc_get_thread_allocated_memory", transition = Transition.NO_TRANSITION)
    public static native long getThreadAllocatedMemory(IsolateThread isolateThread);

    @CFunctionOptions(transition = CFunctionOptions.Transition.TO_VM)
    @CFunction(value = "svm_g1gc_get_used_memory")
    public static native long getUsedMemory();

    @CFunctionOptions(transition = CFunctionOptions.Transition.TO_VM)
    @CFunction(value = "svm_g1gc_get_free_memory")
    public static native long getFreeMemory();

    @CFunction(value = "svm_g1gc_get_total_memory", transition = Transition.NO_TRANSITION)
    public static native long getTotalMemory();

    @CFunction(value = "svm_g1gc_get_max_memory", transition = Transition.NO_TRANSITION)
    public static native long getMaxMemory();

    @CFunction(value = "svm_g1gc_get_used_memory_after_last_gc", transition = Transition.NO_TRANSITION)
