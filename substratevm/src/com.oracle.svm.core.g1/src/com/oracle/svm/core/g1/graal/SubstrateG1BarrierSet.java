 ...
 */
public class SubstrateG1BarrierSet extends G1BarrierSet {
    public SubstrateG1BarrierSet(ResolvedJavaType objectArrayType, ResolvedJavaField referentField) {
        // Deferred init barriers are unconditionally enabled on SVM
        super(objectArrayType, referentField, true);
    }
