...
import com.oracle.svm.core.g1.G1PerfData.G1AgeTablePerfData;
import com.oracle.svm.core.g1.G1PerfData.G1CollectorPerfData;
import com.oracle.svm.core.g1.G1PerfData.G1GCCausesPerfData;
import com.oracle.svm.core.g1.G1PerfData.G1GCPolicyPerfData;
import com.oracle.svm.core.g1.G1PerfData.G1GenerationPerfData;
import com.oracle.svm.core.g1.G1PerfData.G1SpacePerfData;
import com.oracle.svm.core.g1.G1PerfData.G1TLABPerfData;
...
public class G1AccessedFields {
    static final AccessedClass[] ACCESSED_CLASSES = {
                    ...
                    new AccessedClass(G1TLABPerfData.class,
                                    new InstanceField("allocThreads", FieldAccessKind.READ, USE_PERF_DATA),
                                    new InstanceField("fills", FieldAccessKind.READ, USE_PERF_DATA),
                                    new InstanceField("maxFills", FieldAccessKind.READ, USE_PERF_DATA),
                                    new InstanceField("alloc", FieldAccessKind.READ, USE_PERF_DATA),
                                    new InstanceField("gcWaste", FieldAccessKind.READ, USE_PERF_DATA),
                                    new InstanceField("maxGcWaste", FieldAccessKind.READ, USE_PERF_DATA),
                                    new InstanceField("refillWaste", FieldAccessKind.READ, USE_PERF_DATA),
                                    new InstanceField("maxRefillWaste", FieldAccessKind.READ, USE_PERF_DATA),
                                    new InstanceField("slowAlloc", FieldAccessKind.READ, USE_PERF_DATA),
                                    new InstanceField("maxSlowAlloc", FieldAccessKind.READ, USE_PERF_DATA)),
                    new AccessedClass(G1GCPolicyPerfData.class,
                                    new InstanceField("desiredSurvivorSize", FieldAccessKind.READ, USE_PERF_DATA),
                                    new InstanceField("gcTimeLimitExceeded", FieldAccessKind.READ, USE_PERF_DATA),
                                    new InstanceField("maxTenuringThreshold", FieldAccessKind.READ, USE_PERF_DATA),
                                    new InstanceField("tenuringThreshold", FieldAccessKind.READ, USE_PERF_DATA)),
                    new AccessedClass(G1GCCausesPerfData.class,
                                    new InstanceField("cause", FieldAccessKind.READ, USE_PERF_DATA),
                                    new InstanceField("lastCause", FieldAccessKind.READ, USE_PERF_DATA)),
                    new AccessedClass(G1CollectorPerfData.class,
                                    new InstanceField("invocations", FieldAccessKind.READ, USE_PERF_DATA),
                                    new InstanceField("lastEntryTime", FieldAccessKind.READ, USE_PERF_DATA),
                                    new InstanceField("lastExitTime", FieldAccessKind.READ, USE_PERF_DATA),
                                    new InstanceField("time", FieldAccessKind.READ, USE_PERF_DATA)),
                    new AccessedClass(G1SpacePerfData.class,
                                    new InstanceField("capacity", FieldAccessKind.READ, USE_PERF_DATA),
                                    new InstanceField("initCapacity", FieldAccessKind.READ, USE_PERF_DATA),
                                    new InstanceField("maxCapacity", FieldAccessKind.READ, USE_PERF_DATA),
                                    new InstanceField("used", FieldAccessKind.READ, USE_PERF_DATA)),
                    new AccessedClass(G1GenerationPerfData.class,
                                    new InstanceField("capacity", FieldAccessKind.READ, USE_PERF_DATA),
                                    new InstanceField("maxCapacity", FieldAccessKind.READ, USE_PERF_DATA),
                                    new InstanceField("minCapacity", FieldAccessKind.READ, USE_PERF_DATA),
                                    new InstanceField("spaces", FieldAccessKind.READ, USE_PERF_DATA)),
                    new AccessedClass(G1AgeTablePerfData.class,
                                    new InstanceField("table", FieldAccessKind.READ, USE_PERF_DATA)),
                    new AccessedClass(G1PerfData.G1CpuTimePerfData.class,
                                    new InstanceField("gcTotal", FieldAccessKind.READ, USE_PERF_DATA),
                                    new InstanceField("gcParallelWorkers", FieldAccessKind.READ, USE_PERF_DATA),
                                    new InstanceField("gcConcMark", FieldAccessKind.READ, USE_PERF_DATA),
                                    new InstanceField("gcConcRefine", FieldAccessKind.READ, USE_PERF_DATA),
                                    new InstanceField("gcService", FieldAccessKind.READ, USE_PERF_DATA)),
                    new AccessedClass(G1PerfData.class,
                                    new InstanceField("tlab", FieldAccessKind.READ, USE_PERF_DATA),
                                    new InstanceField("gcPolicy", FieldAccessKind.READ, USE_PERF_DATA),
                                    new InstanceField("gcCauses", FieldAccessKind.READ, USE_PERF_DATA),
                                    new InstanceField("collectors", FieldAccessKind.READ, USE_PERF_DATA),
                                    new InstanceField("generations", FieldAccessKind.READ, USE_PERF_DATA),
                                    new InstanceField("ageTable", FieldAccessKind.READ, USE_PERF_DATA),
                                    new InstanceField("cpuTime", FieldAccessKind.READ, USE_PERF_DATA)),
