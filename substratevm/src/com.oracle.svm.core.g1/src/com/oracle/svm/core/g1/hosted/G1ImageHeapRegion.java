 ...
 */
public class G1ImageHeapRegion {
    private final G1RegionType type;
    private final long startOffset;
    private int used;

    public G1ImageHeapRegion(G1RegionType type, long startOffset) {
        this.type = type;
    ...
    public void allocate(ImageHeapObject info) {
        ...
        int regionSize = G1HeapRegionSize.getValue();
    ...
    public G1RegionType getType() {
        return type;
    }

    public void increaseUsed(int size) {
        assert size > 0 && used + size <= G1HeapRegionSize.getValue() : size;
        used += size;
    }
    ...
    public int getRemainingSpace() {
        return G1HeapRegionSize.getValue() - used;
    }
}
