...
import static com.oracle.objectfile.elf.dwarf.constants.DwarfAttribute.DW_AT_abstract_origin;
import static com.oracle.objectfile.elf.dwarf.constants.DwarfAttribute.DW_AT_accessibility;
import static com.oracle.objectfile.elf.dwarf.constants.DwarfAttribute.DW_AT_artificial;
import static com.oracle.objectfile.elf.dwarf.constants.DwarfAttribute.DW_AT_bit_size;
import static com.oracle.objectfile.elf.dwarf.constants.DwarfAttribute.DW_AT_byte_size;
import static com.oracle.objectfile.elf.dwarf.constants.DwarfAttribute.DW_AT_call_file;
import static com.oracle.objectfile.elf.dwarf.constants.DwarfAttribute.DW_AT_call_line;
import static com.oracle.objectfile.elf.dwarf.constants.DwarfAttribute.DW_AT_comp_dir;
import static com.oracle.objectfile.elf.dwarf.constants.DwarfAttribute.DW_AT_containing_type;
import static com.oracle.objectfile.elf.dwarf.constants.DwarfAttribute.DW_AT_count;
import static com.oracle.objectfile.elf.dwarf.constants.DwarfAttribute.DW_AT_data_location;
import static com.oracle.objectfile.elf.dwarf.constants.DwarfAttribute.DW_AT_data_member_location;
import static com.oracle.objectfile.elf.dwarf.constants.DwarfAttribute.DW_AT_decl_file;
import static com.oracle.objectfile.elf.dwarf.constants.DwarfAttribute.DW_AT_decl_line;
import static com.oracle.objectfile.elf.dwarf.constants.DwarfAttribute.DW_AT_declaration;
import static com.oracle.objectfile.elf.dwarf.constants.DwarfAttribute.DW_AT_encoding;
import static com.oracle.objectfile.elf.dwarf.constants.DwarfAttribute.DW_AT_external;
import static com.oracle.objectfile.elf.dwarf.constants.DwarfAttribute.DW_AT_hi_pc;
import static com.oracle.objectfile.elf.dwarf.constants.DwarfAttribute.DW_AT_inline;
import static com.oracle.objectfile.elf.dwarf.constants.DwarfAttribute.DW_AT_language;
import static com.oracle.objectfile.elf.dwarf.constants.DwarfAttribute.DW_AT_linkage_name;
import static com.oracle.objectfile.elf.dwarf.constants.DwarfAttribute.DW_AT_location;
import static com.oracle.objectfile.elf.dwarf.constants.DwarfAttribute.DW_AT_low_pc;
import static com.oracle.objectfile.elf.dwarf.constants.DwarfAttribute.DW_AT_name;
import static com.oracle.objectfile.elf.dwarf.constants.DwarfAttribute.DW_AT_null;
import static com.oracle.objectfile.elf.dwarf.constants.DwarfAttribute.DW_AT_object_pointer;
import static com.oracle.objectfile.elf.dwarf.constants.DwarfAttribute.DW_AT_ranges;
import static com.oracle.objectfile.elf.dwarf.constants.DwarfAttribute.DW_AT_specification;
import static com.oracle.objectfile.elf.dwarf.constants.DwarfAttribute.DW_AT_stmt_list;
import static com.oracle.objectfile.elf.dwarf.constants.DwarfAttribute.DW_AT_type;
import static com.oracle.objectfile.elf.dwarf.constants.DwarfAttribute.DW_AT_use_UTF8;

import static com.oracle.objectfile.elf.dwarf.constants.DwarfForm.DW_FORM_addr;
import static com.oracle.objectfile.elf.dwarf.constants.DwarfForm.DW_FORM_data1;
import static com.oracle.objectfile.elf.dwarf.constants.DwarfForm.DW_FORM_data2;
import static com.oracle.objectfile.elf.dwarf.constants.DwarfForm.DW_FORM_data4;
import static com.oracle.objectfile.elf.dwarf.constants.DwarfForm.DW_FORM_expr_loc;
import static com.oracle.objectfile.elf.dwarf.constants.DwarfForm.DW_FORM_flag;
import static com.oracle.objectfile.elf.dwarf.constants.DwarfForm.DW_FORM_null;
import static com.oracle.objectfile.elf.dwarf.constants.DwarfForm.DW_FORM_ref4;
import static com.oracle.objectfile.elf.dwarf.constants.DwarfForm.DW_FORM_ref_addr;
import static com.oracle.objectfile.elf.dwarf.constants.DwarfForm.DW_FORM_sec_offset;
import static com.oracle.objectfile.elf.dwarf.constants.DwarfForm.DW_FORM_strp;

import static com.oracle.objectfile.elf.dwarf.constants.DwarfHasChildren.DW_CHILDREN_no;
import static com.oracle.objectfile.elf.dwarf.constants.DwarfHasChildren.DW_CHILDREN_yes;
...
import static com.oracle.objectfile.elf.dwarf.constants.DwarfTag.DW_TAG_array_type;
import static com.oracle.objectfile.elf.dwarf.constants.DwarfTag.DW_TAG_base_type;
import static com.oracle.objectfile.elf.dwarf.constants.DwarfTag.DW_TAG_class_type;
import static com.oracle.objectfile.elf.dwarf.constants.DwarfTag.DW_TAG_compile_unit;
import static com.oracle.objectfile.elf.dwarf.constants.DwarfTag.DW_TAG_constant;
import static com.oracle.objectfile.elf.dwarf.constants.DwarfTag.DW_TAG_formal_parameter;
import static com.oracle.objectfile.elf.dwarf.constants.DwarfTag.DW_TAG_inheritance;
import static com.oracle.objectfile.elf.dwarf.constants.DwarfTag.DW_TAG_inlined_subroutine;
import static com.oracle.objectfile.elf.dwarf.constants.DwarfTag.DW_TAG_member;
import static com.oracle.objectfile.elf.dwarf.constants.DwarfTag.DW_TAG_namespace;
import static com.oracle.objectfile.elf.dwarf.constants.DwarfTag.DW_TAG_pointer_type;
import static com.oracle.objectfile.elf.dwarf.constants.DwarfTag.DW_TAG_structure_type;
import static com.oracle.objectfile.elf.dwarf.constants.DwarfTag.DW_TAG_subprogram;
import static com.oracle.objectfile.elf.dwarf.constants.DwarfTag.DW_TAG_subrange_type;
import static com.oracle.objectfile.elf.dwarf.constants.DwarfTag.DW_TAG_typedef;
import static com.oracle.objectfile.elf.dwarf.constants.DwarfTag.DW_TAG_union_type;
import static com.oracle.objectfile.elf.dwarf.constants.DwarfTag.DW_TAG_unspecified_type;
import static com.oracle.objectfile.elf.dwarf.constants.DwarfTag.DW_TAG_variable;
...
public class DwarfAbbrevSectionImpl extends DwarfSectionImpl {
    ...
    public DwarfAbbrevSectionImpl(DwarfDebugInfo dwarfSections) {
        ...
        super(dwarfSections, DW_ABBREV_SECTION, DW_RANGES_SECTION);
    }
    ...
    private int writeCompileUnitAbbrev(@SuppressWarnings("unused") DebugContext context, AbbrevCode abbrevCode, byte[] buffer, int p) {
        ...
        pos = writeHasChildren(DW_CHILDREN_yes, buffer, pos);
        pos = writeAttrType(DW_AT_language, buffer, pos);
        pos = writeAttrForm(DW_FORM_data1, buffer, pos);
        pos = writeAttrType(DW_AT_use_UTF8, buffer, pos);
        ...
        if (abbrevCode == AbbrevCode.CLASS_UNIT_2) {
            pos = writeAttrType(DW_AT_ranges, buffer, pos);
            pos = writeAttrForm(DW_FORM_sec_offset, buffer, pos);
    ...
    private int writePrimitiveTypeAbbrev(@SuppressWarnings("unused") DebugContext context, byte[] buffer, int p) {
        ...
        pos = writeHasChildren(DW_CHILDREN_no, buffer, pos);
    ...
    private int writeNamespaceAbbrev(@SuppressWarnings("unused") DebugContext context, byte[] buffer, int p) {
        ...
        pos = writeTag(DW_TAG_namespace, buffer, pos);
        pos = writeHasChildren(DW_CHILDREN_yes, buffer, pos);
        pos = writeAttrType(DW_AT_name, buffer, pos);
        pos = writeAttrForm(DW_FORM_strp, buffer, pos);
        /*
    ...
    private int writeClassConstantAbbrev(@SuppressWarnings("unused") DebugContext context, byte[] buffer, int p) {
        ...
        pos = writeTag(DW_TAG_constant, buffer, pos);
        pos = writeHasChildren(DW_CHILDREN_no, buffer, pos);
        pos = writeAttrType(DW_AT_name, buffer, pos);
        pos = writeAttrForm(DW_FORM_strp, buffer, pos);
        /* We may not have a file and line for a field. */
    ...
    private int writeArrayDataTypeAbbrev(@SuppressWarnings("unused") DebugContext context, AbbrevCode abbrevCode, byte[] buffer, int p) {
        ...
        pos = writeHasChildren((hasChildren ? DW_CHILDREN_yes : DW_CHILDREN_no), buffer, pos);
    ...
    private int writeArraySubrangeTypeAbbrev(@SuppressWarnings("unused") DebugContext context, byte[] buffer, int p) {
        ...
        pos = writeTag(DW_TAG_subrange_type, buffer, pos);
        pos = writeHasChildren(DW_CHILDREN_no, buffer, pos);
        pos = writeAttrType(DW_AT_count, buffer, pos);
        pos = writeAttrForm(DW_FORM_data4, buffer, pos);
        /*
         * Now terminate.
         */
    ...
    private int writeInlinedSubroutineAbbrev(byte[] buffer, int p, boolean withChildren) {
        ...
        pos = writeHasChildren(withChildren ? DW_CHILDREN_yes : DW_CHILDREN_no, buffer, pos);
        pos = writeAttrType(DW_AT_abstract_origin, buffer, pos);
        pos = writeAttrForm(DW_FORM_ref4, buffer, pos);
        pos = writeAttrType(DW_AT_low_pc, buffer, pos);
        pos = writeAttrForm(DW_FORM_addr, buffer, pos);
