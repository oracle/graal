...
public class CVRegisterUtil {
     ...
     * In release mode, return -1 so caller can emit a warning and continue.
     * In debug mode, throw an assert.
     *
     * This can (and has) happened when Graal is enhanced to use more registers
     * but there is no test for that in the test suite.
     */
