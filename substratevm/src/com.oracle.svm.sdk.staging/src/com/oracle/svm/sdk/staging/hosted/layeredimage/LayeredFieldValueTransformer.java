 ...
 * {@code FieldValueTransformerWithReceiverBasedAvailability}, also allows for the value to be
...
public abstract class LayeredFieldValueTransformer<T> {
    ...
    public boolean isUpdateAvailable(@SuppressWarnings("unused") T receiver) {
        throw new IllegalStateException("LayeredFieldValueTransformer#isUpdateAvailable not implemented");
    }
    ...
    public Result update(@SuppressWarnings("unused") T receiver) {
        throw new IllegalStateException("LayeredFieldValueTransformer#update not implemented");
    }
}
