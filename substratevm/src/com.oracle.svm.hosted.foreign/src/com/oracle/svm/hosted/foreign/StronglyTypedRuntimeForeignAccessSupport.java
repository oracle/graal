...
public interface StronglyTypedRuntimeForeignAccessSupport extends RuntimeForeignAccessSupport {
    ...
    @FunctionalInterface
    interface Recorder {
        void apply(RegistrationCondition condition, FunctionDescriptor desc, Linker.Option... options);
    }

    @FunctionalInterface
    interface DirectUpcallRecorder {
        void apply(RegistrationCondition condition, MethodHandle target, FunctionDescriptor desc, Linker.Option... options);
    }
    ...
    static StronglyTypedRuntimeForeignAccessSupport make(Recorder forDowncalls, Recorder forUpcalls, DirectUpcallRecorder forDirectUpcalls) {
        return new StronglyTypedRuntimeForeignAccessSupport() {
            @Override
            public void registerForDowncall(RegistrationCondition condition, FunctionDescriptor desc, Linker.Option... options) {
                forDowncalls.apply(condition, desc, options);
            }

            @Override
            public void registerForUpcall(RegistrationCondition condition, FunctionDescriptor desc, Linker.Option... options) {
                forUpcalls.apply(condition, desc, options);
            }

            @Override
            public void registerForDirectUpcall(RegistrationCondition condition, MethodHandle target, FunctionDescriptor fd, Linker.Option... options) {
    ...
    @Override
    default void registerForDowncall(RegistrationCondition condition, Object descO, Object... optionsO) {
        registerForDowncall(condition, castDesc(descO), castOptions(optionsO));
    }

    void registerForDowncall(RegistrationCondition condition, FunctionDescriptor desc, Linker.Option... options);

    @Override
    default void registerForUpcall(RegistrationCondition condition, Object descO, Object... optionsO) {
        registerForUpcall(condition, castDesc(descO), castOptions(optionsO));
    }

    void registerForUpcall(RegistrationCondition condition, FunctionDescriptor desc, Linker.Option... options);

    default void registerForDirectUpcall(RegistrationCondition condition, MethodHandle target, Object desc, Object... options) {
        registerForDirectUpcall(condition, target, castDesc(desc), castOptions(options));
    }

    void registerForDirectUpcall(RegistrationCondition condition, MethodHandle target, FunctionDescriptor desc, Linker.Option... options);
}
