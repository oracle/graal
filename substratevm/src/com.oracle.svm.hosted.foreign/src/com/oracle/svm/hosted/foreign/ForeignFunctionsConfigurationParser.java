...
public class ForeignFunctionsConfigurationParser extends ForeignConfigurationParser<FunctionDescriptor, Linker.Option[]> {
    ...
    @Override
    protected void registerDowncall(RegistrationCondition configurationCondition, FunctionDescriptor descriptor, Option[] options) {
        accessSupport.registerForDowncall(RegistrationCondition.always(), descriptor, (Object[]) options);
    }

    @Override
    protected void registerUpcall(RegistrationCondition configurationCondition, FunctionDescriptor descriptor, Option[] options) {
        accessSupport.registerForUpcall(RegistrationCondition.always(), descriptor, (Object[]) options);
    }
    ...
    protected void registerDirectUpcallWithDescriptor(String className, String methodName, FunctionDescriptor descriptor, Option[] options) {
        ...
        accessSupport.registerForDirectUpcall(RegistrationCondition.always(), target, descriptor, (Object[]) options);
    }
    ...
    protected void registerDirectUpcallWithoutDescriptor(String className, String methodName, EconomicMap<String, Object> optionsMap) {
        ...
        for (Pair<FunctionDescriptor, MethodHandle> pair : descriptors) {
            ...
            try {
                accessSupport.registerForDirectUpcall(RegistrationCondition.always(), pair.getRight(), pair.getLeft(), (Object[]) options);
