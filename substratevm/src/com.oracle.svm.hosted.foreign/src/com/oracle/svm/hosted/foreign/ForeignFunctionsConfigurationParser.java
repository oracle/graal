...
public class ForeignFunctionsConfigurationParser extends ForeignConfigurationParser<FunctionDescriptor, Linker.Option[]> {
    ...
    protected void registerDowncall(AccessCondition configurationCondition, FunctionDescriptor descriptor, Option[] options) {
        accessSupport.registerForDowncall(AccessCondition.alwaysTrue(), descriptor, (Object[]) options);
    }

    @Override
    protected void registerUpcall(AccessCondition configurationCondition, FunctionDescriptor descriptor, Option[] options) {
        accessSupport.registerForUpcall(AccessCondition.alwaysTrue(), descriptor, (Object[]) options);
    }
    ...
    protected void registerDirectUpcallWithDescriptor(String className, String methodName, FunctionDescriptor descriptor, Option[] options) {
        ...
        accessSupport.registerForDirectUpcall(AccessCondition.alwaysTrue(), target, descriptor, (Object[]) options);
    }
    ...
    protected void registerDirectUpcallWithoutDescriptor(String className, String methodName, EconomicMap<String, Object> optionsMap) {
        ...
        for (Pair<FunctionDescriptor, MethodHandle> pair : descriptors) {
            ...
            try {
                accessSupport.registerForDirectUpcall(AccessCondition.alwaysTrue(), pair.getRight(), pair.getLeft(), (Object[]) options);
