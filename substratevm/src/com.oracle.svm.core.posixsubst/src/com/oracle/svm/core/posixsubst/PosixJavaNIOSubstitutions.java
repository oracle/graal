...
import static com.oracle.svm.core.posixsubst.headers.Errno.EAGAIN;
import static com.oracle.svm.core.posixsubst.headers.Errno.ECANCELED;
import static com.oracle.svm.core.posixsubst.headers.Errno.EINTR;
import static com.oracle.svm.core.posixsubst.headers.Errno.EINVAL;
import static com.oracle.svm.core.posixsubst.headers.Errno.ENOENT;
import static com.oracle.svm.core.posixsubst.headers.Errno.ENOMEM;
import static com.oracle.svm.core.posixsubst.headers.Errno.ENOTCONN;
import static com.oracle.svm.core.posixsubst.headers.Errno.ENOTSOCK;
import static com.oracle.svm.core.posixsubst.headers.Errno.ENOTSUP;
import static com.oracle.svm.core.posixsubst.headers.Errno.EOPNOTSUPP;
import static com.oracle.svm.core.posixsubst.headers.Errno.ERANGE;
import static com.oracle.svm.core.posixsubst.headers.Errno.ESRCH;
import static com.oracle.svm.core.posixsubst.headers.Errno.errno;
import static com.oracle.svm.core.posixsubst.headers.Fcntl.F_GETFL;
import static com.oracle.svm.core.posixsubst.headers.Fcntl.F_RDLCK;
import static com.oracle.svm.core.posixsubst.headers.Fcntl.F_SETFL;
import static com.oracle.svm.core.posixsubst.headers.Fcntl.F_SETLK;
import static com.oracle.svm.core.posixsubst.headers.Fcntl.F_SETLKW;
import static com.oracle.svm.core.posixsubst.headers.Fcntl.F_UNLCK;
import static com.oracle.svm.core.posixsubst.headers.Fcntl.F_WRLCK;
import static com.oracle.svm.core.posixsubst.headers.Fcntl.O_NONBLOCK;
import static com.oracle.svm.core.posixsubst.headers.Fcntl.fcntl;
import static com.oracle.svm.core.posixsubst.headers.Fcntl.open;
import static com.oracle.svm.core.posixsubst.headers.Grp.getgrgid_r;
import static com.oracle.svm.core.posixsubst.headers.Grp.getgrnam_r;
import static com.oracle.svm.core.posixsubst.headers.Pwd.getpwnam_r;
import static com.oracle.svm.core.posixsubst.headers.Pwd.getpwuid_r;
...
import static com.oracle.svm.core.posixsubst.headers.Stat.lstat;
import static com.oracle.svm.core.posixsubst.headers.Stat.mkdir;
import static com.oracle.svm.core.posixsubst.headers.Stat.mknod;
import static com.oracle.svm.core.posixsubst.headers.Stdio.EOF;
import static com.oracle.svm.core.posixsubst.headers.Stdio.fopen;
import static com.oracle.svm.core.posixsubst.headers.Uio.readv;
import static com.oracle.svm.core.posixsubst.headers.Uio.writev;
...
import static com.oracle.svm.core.posixsubst.headers.Unistd._SC_GETGR_R_SIZE_MAX;
import static com.oracle.svm.core.posixsubst.headers.Unistd._SC_GETPW_R_SIZE_MAX;
import static com.oracle.svm.core.posixsubst.headers.Unistd._SC_IOV_MAX;
import static com.oracle.svm.core.posixsubst.headers.Unistd.access;
import static com.oracle.svm.core.posixsubst.headers.Unistd.chown;
...
import static com.oracle.svm.core.posixsubst.headers.Unistd.fdatasync;
import static com.oracle.svm.core.posixsubst.headers.Unistd.fsync;
import static com.oracle.svm.core.posixsubst.headers.Unistd.ftruncate;
import static com.oracle.svm.core.posixsubst.headers.Unistd.lchown;
import static com.oracle.svm.core.posixsubst.headers.Unistd.link;
import static com.oracle.svm.core.posixsubst.headers.Unistd.lseek;
import static com.oracle.svm.core.posixsubst.headers.Unistd.pathconf;
import static com.oracle.svm.core.posixsubst.headers.Unistd.pipe;
import static com.oracle.svm.core.posixsubst.headers.Unistd.pread;
import static com.oracle.svm.core.posixsubst.headers.Unistd.pwrite;
import static com.oracle.svm.core.posixsubst.headers.Unistd.read;
import static com.oracle.svm.core.posixsubst.headers.Unistd.readlink;
import static com.oracle.svm.core.posixsubst.headers.Unistd.rmdir;
import static com.oracle.svm.core.posixsubst.headers.Unistd.symlink;
import static com.oracle.svm.core.posixsubst.headers.Unistd.sysconf;
import static com.oracle.svm.core.posixsubst.headers.Unistd.unlink;
import static com.oracle.svm.core.posixsubst.headers.Unistd.write;
import static com.oracle.svm.core.posixsubst.headers.darwin.DarwinSendfile.sendfile;
import static com.oracle.svm.core.posixsubst.headers.linux.LinuxSendfile.sendfile;
import static com.oracle.svm.core.posixsubst.headers.linux.Mntent.getmntent_r;
import static com.oracle.svm.core.posixsubst.headers.linux.Mntent.setmntent;
...
import com.oracle.svm.core.posixsubst.headers.Stdio;
...
import com.oracle.svm.core.posixsubst.headers.Fcntl.flock;
import com.oracle.svm.core.posixsubst.headers.Grp.group;
import com.oracle.svm.core.posixsubst.headers.Grp.groupPointer;
import com.oracle.svm.core.posixsubst.headers.Pwd.passwd;
import com.oracle.svm.core.posixsubst.headers.Pwd.passwdPointer;
import com.oracle.svm.core.posixsubst.headers.Socket.sockaddr;
import com.oracle.svm.core.posixsubst.headers.Stdio.FILE;
import com.oracle.svm.core.posixsubst.headers.Uio.iovec;
import com.oracle.svm.core.posixsubst.headers.linux.Mntent;
import com.oracle.svm.core.posixsubst.headers.linux.Mntent.mntent;
