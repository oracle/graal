...
/**
 * A feature that enables outlining Truffle interpreter bytecode handlers.
 */
public class TruffleBytecodeInterpreterFeature implements InternalFeature {
    ...
    public void registerGraphBuilderPlugins(Providers providers, GraphBuilderConfiguration.Plugins plugins, ParsingReason reason) {
        plugins.appendNodePlugin(new TruffleBytecodeHandlerInvokePlugin(registeredBytecodeHandlers, stubHolder));
    }
