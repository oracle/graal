...
public final class TruffleFeature implements com.oracle.svm.core.graal.GraalFeature {
    ...
    private static void initializeTruffleReflectively(ClassLoader imageClassLoader) {
        ...
        invokeStaticMethod("org.graalvm.polyglot.impl.HomeFinder", "initializeNativeImageState", Collections.emptyList());
    }
    ...
    public void cleanup() {
        ...
        invokeStaticMethod("org.graalvm.polyglot.impl.HomeFinder", "resetNativeImageState", Collections.emptyList());
    }
