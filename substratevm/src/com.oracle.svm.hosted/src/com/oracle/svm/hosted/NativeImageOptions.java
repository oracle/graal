...
public class NativeImageOptions {
    ...
    @Option(help = "Comma separated list of CPU features that will be enabled while building the " +
                    ...
                    "SSE4_2, POPCNT, LZCNT, TSC, TSCINV, TSCINV_BIT, AVX, AVX2, AES, ERMS, CLMUL, BMI1, " +
                    "BMI2, RTM, ADX, AVX512F, AVX512DQ, AVX512PF, AVX512ER, AVX512CD, AVX512BW, AVX512VL, " +
                    "SHA, FMA, VZEROUPPER, AVX512_VPOPCNTDQ, AVX512_VPCLMULQDQ, AVX512_VAES, AVX512_VNNI, " +
                    "FLUSH, FLUSHOPT, CLWB, AVX512_VBMI2, AVX512_VBMI, HV. " +
                    "On AArch64, FP and ASIMD are enabled by default. Available features are: " +
                    "EVTSTRM, AES, PMULL, SHA1, SHA2, CRC32, LSE, DCPOP, SHA3, SHA512, SVE, SVE2, " +
                    "STXR_PREFETCH, A53MAC", type = User)//
