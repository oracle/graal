 ...
 * is formed from the lambda capture site. If no capture site can be found or resolved, for example
 * for a lambda created by explicitly invoking a lambda metafactory, the name uses the signature of
