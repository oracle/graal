...
public class LambdaMetaFactoryRewriteVisitor extends ClassVisitor {
    ...
    public LambdaMetaFactoryRewriteVisitor(String moduleName, ClassLoader loader, String className, ClassWriter writer) {
        super(ASM7, writer);
    ...
    private boolean instrumentationSupported() {
        ...
        } else if (ClassInitializationTrackingVisitor.getJavaVersion() > 8) {
