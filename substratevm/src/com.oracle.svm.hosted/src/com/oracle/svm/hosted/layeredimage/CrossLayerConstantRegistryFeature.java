...
import static com.oracle.svm.hosted.layeredimage.CrossLayerConstantRegistryFeature.INVALID;
import static com.oracle.svm.hosted.layeredimage.CrossLayerConstantRegistryFeature.NULL_CONSTANT_ID;
...
public class CrossLayerConstantRegistryFeature implements InternalFeature, CrossLayerConstantRegistry {
    ...
    @Override
    public JavaConstant registerFutureHeapConstant(String keyName, ResolvedJavaType futureType) {
        assert futureType != null;
        var imageHeapConstant = ImageHeapRelocatableConstant.create((AnalysisType) futureType, keyName);
