...
public class JDKInitializationFeature implements Feature {
    ...
    public void afterRegistration(AfterRegistrationAccess access) {
        ...
        RuntimeClassInitialization.initializeAtBuildTime("jdk.jfr", "Core JDK classes are initialized at build time for better performance");
        ...
        RuntimeClassInitialization.initializeAtBuildTime("org.jcp.xml.dsig.internal.dom.XMLDSigRI", "Required for sun.security.jca");
