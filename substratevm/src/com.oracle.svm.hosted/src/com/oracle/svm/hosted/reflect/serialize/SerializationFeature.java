    ...
    public void register(AccessCondition condition, Class<?> serializationTargetClass) {
        ...
        registerConditionalConfiguration(condition, (cnd) -> {
            ...
            if (denyRegistry.isAllowed(serializationTargetClass)) {
                ...
                if (superclass != null) {
                    ImageSingletons.lookup(RuntimeReflectionSupport.class).registerAllDeclaredConstructorsQuery(AccessCondition.alwaysTrue(), true, superclass);
                    ImageSingletons.lookup(RuntimeReflectionSupport.class).registerMethodLookup(AccessCondition.alwaysTrue(), superclass, "writeReplace");
                    ImageSingletons.lookup(RuntimeReflectionSupport.class).registerMethodLookup(AccessCondition.alwaysTrue(), superclass, "readResolve");
                }
