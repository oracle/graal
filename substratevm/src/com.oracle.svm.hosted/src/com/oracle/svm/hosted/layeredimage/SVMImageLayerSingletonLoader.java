...
public class SVMImageLayerSingletonLoader {
    ...
    KeyValueLoader createKVMap(int keyStoreId) {
        ...
        return new KeyValueLoaderImpl(keyStore, snapshot);
    }
    ...
    public Map<Object, Set<Class<?>>> loadImageSingletons(Function<SingletonTrait[], Object> forbiddenObjectCreator) {
        ...
        for (ImageSingletonObject.Reader obj : snapshot.getSingletonObjects()) {
            ...
            curIdx++;
            KeyValueLoader kvMap = createKVMap(obj.getKeyStoreId());
            ...
            try {
                ...
                result = instance.createFromLoader(kvMap);
    ...
    public KeyValueLoader getImageSingletonLoader(Class<?> key) {
        assert hasRegistrationCallback(key);
        return createKVMap(singletonKeyToRegistrationCallbackKeyStoreId.get(key));
    }
    ...
    public static class KeyValueLoaderImpl implements KeyValueLoader {
        ...
        KeyValueLoaderImpl(UnmodifiableEconomicMap<String, Object> keyStore, SharedLayerSnapshotCapnProtoSchemaHolder.SharedLayerSnapshot.Reader snapshotReader) {
