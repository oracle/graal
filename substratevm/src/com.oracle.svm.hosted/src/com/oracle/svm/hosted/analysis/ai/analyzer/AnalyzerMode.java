...
public enum AnalyzerMode {
    ...
    INTER_ANALYZE_FROM_ALL_ENTRY_POINTS;
    ...
    public boolean isInterProcedural() {
        return this == INTER_ANALYZE_FROM_MAIN_ONLY || this == INTER_ANALYZE_FROM_ALL_ENTRY_POINTS;
    }

    public boolean isMainOnly() {
        return this == INTRA_ANALYZE_MAIN_ONLY || this == INTER_ANALYZE_FROM_MAIN_ONLY;
    }
}
