...
public class JNIAccessFeature implements Feature {
    ...
    public void afterRegistration(AfterRegistrationAccess arg) {
        ...
        ReflectionConfigurationParser<RegistrationCondition, Class<?>> parser = ConfigurationParserUtils.create(ConfigurationFile.JNI, true, conditionResolver, runtimeSupport, null, null, null,
        ...
        ReflectionConfigurationParser<RegistrationCondition, Class<?>> legacyParser = ConfigurationParserUtils.create(ConfigurationFile.JNI, false, conditionResolver, runtimeSupport, null, null,
                        null,
                        access.getImageClassLoader());
    ...
    private final class JNIRuntimeAccessibilitySupportImpl extends ConditionalConfigurationRegistry
        ...
        @Override
        public void registerClassLookup(RegistrationCondition condition, String jniName) {
            try {
