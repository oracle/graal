...
public class RegistryAdapter implements ReflectionConfigurationParserDelegate<AccessCondition, Class<?>> {
    ...
    public static RegistryAdapter create(ReflectionRegistry registry, RuntimeProxyCreationSupport proxyRegistry, RuntimeSerializationSupport<AccessCondition> serializationSupport,
