...
public class RegistryAdapter implements ReflectionConfigurationParserDelegate<RegistrationCondition, Class<?>> {
    ...
    public static RegistryAdapter create(ReflectionRegistry registry, RuntimeProxyCreationSupport proxyRegistry, RuntimeSerializationSupport<RegistrationCondition> serializationSupport,
    ...
    public final void registerField(RegistrationCondition condition, Class<?> type, String fieldName, boolean allowWrite, boolean jniAccessible) throws NoSuchFieldException {
        try {
    ...
    @Override
    public boolean registerAllMethodsWithName(RegistrationCondition condition, boolean queriedOnly, boolean jniAccessible, Class<?> type, String methodName) {
        boolean found = false;
    ...
    @Override
    public boolean registerAllConstructors(RegistrationCondition condition, boolean queriedOnly, boolean jniAccessible, Class<?> type) {
    ...
    @Override
    public final void registerMethod(RegistrationCondition condition, boolean queriedOnly, Class<?> type, String methodName, List<Class<?>> methodParameterTypes, boolean jniAccessible)
    ...
    @Override
    public final void registerConstructor(RegistrationCondition condition, boolean queriedOnly, Class<?> type, List<Class<?>> methodParameterTypes, boolean jniAccessible)
                    throws NoSuchMethodException {
        Class<?>[] parameterTypesArray = getParameterTypes(methodParameterTypes);
        try {
