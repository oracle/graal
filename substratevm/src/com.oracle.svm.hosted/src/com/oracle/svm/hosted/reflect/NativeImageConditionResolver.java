...
public class NativeImageConditionResolver implements ConfigurationConditionResolver<RegistrationCondition> {
    ...
    @Override
    public TypeResult<RegistrationCondition> resolveCondition(UnresolvedConfigurationCondition unresolvedCondition) {
    ...
    @Override
    public RegistrationCondition alwaysTrue() {
        return RegistrationCondition.always();
    }
}
