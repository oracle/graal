...
public class RemovingUnneededClassInitNodesPhase extends Phase {
    ...
    protected void run(StructuredGraph graph) {
        RemovingUnneededClassInitClosure removingUnneededClassInitClosure = new RemovingUnneededClassInitClosure();
        ControlFlowGraph cfg = ControlFlowGraph.compute(graph, true, true, true, false);
        removingUnneededClassInitClosure.removeUnneededNodes(removingUnneededClassInitClosure, cfg.getStartBlock());
