...
public class CFunctionFeature implements GraalFeature {
    ...
    // NOTE: substitution processor is added in NativeImageGenerator.
    ...
    public void beforeCompilation(BeforeCompilationAccess access) {
        if (warnCFunctionsWithTransition != null) {
            ...
            for (String s : warnCFunctionsWithTransition) {
    ...
    void warnRuntimeCompilationReachableCFunctionWithTransition(CFunctionCallStubMethod method) {
        if (Options.WarnCFunctionsWithTransition.getValue()) {
            ...
            warnCFunctionsWithTransition.add(method.format("%H.%n(%p)"));
        }
    }
}
