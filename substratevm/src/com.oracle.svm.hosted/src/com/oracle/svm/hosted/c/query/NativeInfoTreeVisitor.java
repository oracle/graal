...
public abstract class NativeInfoTreeVisitor extends InfoTreeVisitor {
    ...
    protected NativeInfoTreeVisitor(NativeLibraries nativeLibs) {
        this.nativeLibs = nativeLibs;
    }

    protected final void addError(String msg, Object... context) {
        nativeLibs.addError(msg, context);
    }

    protected final int getSizeInBytes(JavaKind kind) {
        return nativeLibs.getTarget().arch.getPlatformKind(kind).getSizeInBytes();
    }
