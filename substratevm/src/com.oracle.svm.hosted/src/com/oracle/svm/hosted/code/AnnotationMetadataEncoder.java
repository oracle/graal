...
public final class AnnotationMetadataEncoder {
     ...
     * {@link TypeAnnotation.LocationInfo#parseLocationInfo(ByteBuffer)}.
     */
    ...
    public static <T> void encodeArray(UnsafeArrayTypeWriter buf, T[] elements, Consumer<T> encoder) {
        encodeList(buf, Arrays.asList(elements), encoder);
    }

    public static <T> void encodeList(UnsafeArrayTypeWriter buf, List<T> elements, Consumer<T> encoder) {
