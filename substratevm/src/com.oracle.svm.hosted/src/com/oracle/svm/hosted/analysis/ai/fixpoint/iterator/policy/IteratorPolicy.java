 ...
 */
public record IteratorPolicy(int maxJoinIterations, int maxWidenIterations, IterationStrategy strategy) {
    public static final IteratorPolicy DEFAULT_CONCURRENT = new IteratorPolicy(10, 10, IterationStrategy.CONCURRENT);
    public static final IteratorPolicy DEFAULT_SEQUENTIAL = new IteratorPolicy(10, 20, IterationStrategy.SEQUENTIAL);
