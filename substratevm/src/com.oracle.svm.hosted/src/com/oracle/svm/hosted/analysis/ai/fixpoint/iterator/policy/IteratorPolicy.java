...
public record IteratorPolicy(int maxJoinIterations,
    ...
    public static final IteratorPolicy DEFAULT_FORWARD_WTO = new IteratorPolicy(10, 10, WideningOverflowPolicy.ERROR, IteratorStrategy.WTO, IteratorDirection.FORWARD);
