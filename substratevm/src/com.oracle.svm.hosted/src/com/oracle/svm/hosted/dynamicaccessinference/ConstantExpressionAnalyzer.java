...
final class ConstantExpressionAnalyzer extends AbstractInterpreter<ConstantExpressionAnalyzer.Value> {
    ...
    private static class NotACompileTimeConstant implements Value {
    ...
    private static class CompileTimeValueConstant<T> extends CompileTimeConstant {
    ...
    private static class CompileTimeArrayConstant<T> extends CompileTimeConstant {
