...
import com.oracle.svm.sdk.staging.hosted.layeredimage.LayeredClassInitialization;
...
public class LayeredStaticFieldSupport extends LayeredClassInitialization {
    ...
    @Override
    public void initializeClassInAppLayer(Class<?> c, MetaAccessProvider meta) {
    ...
    static class LayeredCallbacks extends SingletonLayeredCallbacksSupplier {
        ...
        public SingletonTrait getLayeredCallbacksTrait() {
            return new SingletonTrait(SingletonTraitKind.LAYERED_CALLBACKS, new SingletonLayeredCallbacks<LayeredStaticFieldSupport>() {
                @Override
                public LayeredPersistFlags doPersist(KeyValueWriter writer, LayeredStaticFieldSupport singleton) {
                    ...
                    HostedUniverse hUniverse = ((SVMImageLayerWriter.KeyValueWriterImpl) writer).getHostedUniverse();
    ...
    static class SingletonInstantiator implements SingletonLayeredCallbacks.LayeredSingletonInstantiator<LayeredStaticFieldSupport> {
        ...
        @Override
        public LayeredStaticFieldSupport createFromLoader(KeyValueLoader loader) {
