...
public class ReachabilityExport {
    ...
    private static class Type {
        ...
        public final ArrayList<Pair<String, ReachabilityExport.Field>> fields = new ArrayList<>();
        ...
        EconomicMap<String, Object> serialize() {
            ...
            for (Pair<String, ReachabilityExport.Field> f : fields) {
    ...
    public ReachabilityExport(AnalysisUniverse universe, Function<AnalysisMethod, Integer> compilations) {
