...
public class AnnotationSubstitutionProcessor extends SubstitutionProcessor {
    ...
    private void handleMethodInAliasClass(Executable annotatedMethod, Class<?> originalClass) {
        ...
        if (deleteAnnotation != null) {
            ...
            /** Put a special Substitution for {@link Alias#noSubstitution()} case. This substitution has the same annotated and original.*/
            ...
            if (!substitutions.containsKey(original) || substitutions.get(original) == original || substitutions.get(original) == target) {
                ...
                if (substitutions.containsKey(original)) {
                    ...
                    if (existingItem != original && existingItem != target) {
                        ...
                        // newly incoming substitute method is for agent support, keep the existing one.
