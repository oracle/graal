    ...
    static class LayeredCallbacks extends SingletonLayeredCallbacksSupplier {
        ...
        public SingletonTrait getLayeredCallbacksTrait() {
            return new SingletonTrait(SingletonTraitKind.LAYERED_CALLBACKS, new SingletonLayeredCallbacks<LayeredFieldValueTransformerSupport>() {
                @Override
                public LayeredPersistFlags doPersist(KeyValueWriter writer, LayeredFieldValueTransformerSupport singleton) {
                ...
                @Override
                public void onSingletonRegistration(KeyValueLoader loader, LayeredFieldValueTransformerSupport singleton) {
