...
import static com.oracle.svm.hosted.layeredimage.SVMImageLayerSnapshotUtil.CLASS_INIT_NAME;
import static com.oracle.svm.hosted.layeredimage.SVMImageLayerSnapshotUtil.CONSTRUCTOR_NAME;
import static com.oracle.svm.hosted.layeredimage.SVMImageLayerSnapshotUtil.PERSISTED;
...
import com.oracle.svm.hosted.layeredimage.SharedLayerSnapshotCapnProtoSchemaHolder.PersistedAnalysisMethod.WrappedMethod.WrappedMember;
...
import com.oracle.svm.hosted.layeredimage.SharedLayerSnapshotCapnProtoSchemaHolder.PersistedAnalysisType.WrappedType.SerializationGenerated;
...
import com.oracle.svm.hosted.layeredimage.SharedLayerSnapshotCapnProtoSchemaHolder.PrimitiveValue;
...
public class SVMImageLayerLoader extends ImageLayerLoader {
    ...
    private Annotation[] getAnnotations(StructList.Reader<SharedLayerSnapshotCapnProtoSchemaHolder.PersistedAnnotation.Reader> reader) {
        return CapnProtoAdapters.toArray(reader, this::getAnnotation, Annotation[]::new);
    }

    private Annotation getAnnotation(SharedLayerSnapshotCapnProtoSchemaHolder.PersistedAnnotation.Reader a) {
