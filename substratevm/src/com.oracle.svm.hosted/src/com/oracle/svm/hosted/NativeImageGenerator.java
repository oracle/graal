...
import static jdk.compiler.graal.hotspot.JVMCIVersionCheck.OPEN_LABSJDK_RELEASE_URL_PATTERN;
import static jdk.compiler.graal.replacements.StandardGraphBuilderPlugins.registerInvocationPlugins;
...
import jdk.compiler.graal.replacements.MethodHandleWithExceptionPlugin;
import jdk.compiler.graal.replacements.NodeIntrinsificationProvider;
