 ...
 * New summaries are created in the provided {@link SummaryFactory} and then checked for subsumption in {@link SummaryRepository}.
...
public interface Summary<Domain extends AbstractDomain<Domain>> {
     ...
     * {@link SummaryFactory} Implementations can choose to keep only the relevant information from the
