...
public class SVMImageLayerSnapshotUtil {
    ...
    static final ResolvedJavaType DYNAMIC_HUB = GraalAccess.get().lookupType(DynamicHub.class);
    ...
    static final ResolvedJavaType DYNAMIC_HUB_COMPANION = GraalAccess.get().lookupType(DynamicHubCompanion.class);
    ...
    static final ResolvedJavaType STRING = GraalAccess.get().lookupType(String.class);
    static final ResolvedJavaType ENUM = GraalAccess.get().lookupType(Enum.class);
    ...
    private static void makeStaticFieldIds(ObjectCopier.Encoder encoder, ObjectCopier.ObjectPath objectPath, Object object) {
        ResolvedJavaField staticField = GraalAccess.get().lookupField(encoder.getExternalValues().get(object));
