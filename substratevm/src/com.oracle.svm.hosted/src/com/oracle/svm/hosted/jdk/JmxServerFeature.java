...
public class JmxServerFeature implements InternalFeature {
    ...
    private static void registerJMXAgentResources() {
        ...
        resourcesRegistry.addResourceBundles(AccessCondition.alwaysTrue(),
    ...
    private static void configureProxy(BeforeAnalysisAccess access) {
        ...
        dynamicProxySupport.addProxyClass(AccessCondition.alwaysTrue(), access.findClassByName("java.rmi.Remote"),
                        access.findClassByName("java.rmi.registry.Registry"));

        dynamicProxySupport.addProxyClass(AccessCondition.alwaysTrue(), access.findClassByName("javax.management.remote.rmi.RMIServer"));
    }
