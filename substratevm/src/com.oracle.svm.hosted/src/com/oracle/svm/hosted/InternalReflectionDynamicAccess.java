...
public class InternalReflectionDynamicAccess implements ReflectionDynamicAccess {
    ...
    public void register(RegistrationCondition condition, Class<?>... classes) {
        register(condition, false, classes);
    }
    ...
    public void registerUnsafeAllocated(RegistrationCondition condition, Class<?>... classes) {
        register(condition, true, classes);
    }
    ...
    public Class<?> registerProxy(RegistrationCondition condition, Class<?>... interfaces) {
        return ImageSingletons.lookup(RuntimeProxyCreationSupport.class).registerProxyClass(RegistrationCondition.always(), interfaces);
    }

    private void register(RegistrationCondition condition, boolean unsafe, Class<?>... classes) {
        for (Class<?> clazz : classes) {
            rrsInstance.register(condition, unsafe, clazz);
