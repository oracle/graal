...
import com.oracle.svm.hosted.layeredimage.SharedLayerSnapshotCapnProtoSchemaHolder.SharedLayerSnapshot.Reader;
...
public final class HostedImageLayerBuildingSupport extends ImageLayerBuildingSupport {
    ...
    private HostedImageLayerBuildingSupport(ImageClassLoader imageClassLoader,
                    ...
                    int layerNumber, WriteLayerArchiveSupport writeLayerArchiveSupport, LoadLayerArchiveSupport loadLayerArchiveSupport, Function<Class<?>, SingletonTrait[]> singletonTraitInjector) {
        super(buildingImageLayer, buildingInitialLayer, buildingApplicationLayer, layerNumber);
    ...
    public static HostedImageLayerBuildingSupport initialize(HostedOptionValues values, ImageClassLoader imageClassLoader, Path builderTempDir) {
        ...
        } else if (buildingInitialLayer) {
            layerNumber = MultiLayeredImageSingleton.INITIAL_LAYER_NUMBER;
        } else {
            layerNumber = snapshot.getNextLayerNumber();
        }
        HostedImageLayerBuildingSupport imageLayerBuildingSupport = new HostedImageLayerBuildingSupport(imageClassLoader, snapshot, graphs, buildingImageLayer,
                        buildingInitialLayer, buildingFinalLayer, layerNumber, writeLayerArchiveSupport, loadLayerArchiveSupport, singletonTraitInjector);
