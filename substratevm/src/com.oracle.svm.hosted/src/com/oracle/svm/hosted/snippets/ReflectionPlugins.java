...
public final class ReflectionPlugins {
        ...
        r.register(new RequiredInvocationPlugin("forName", String.class) {
            ...
            public boolean apply(GraphBuilderContext b, ResolvedJavaMethod targetMethod, Receiver receiver, ValueNode nameNode) {
                Predicate<ConstantExpressionRegistry> strictModeRoutine = (registry) -> {
                    ...
                    return processClassForName(b, targetMethod, className, true);
                };
        ...
        r.register(new RequiredInvocationPlugin("forName", String.class, boolean.class, ClassLoader.class) {
            ...
            public boolean apply(GraphBuilderContext b, ResolvedJavaMethod targetMethod, Receiver receiver, ValueNode nameNode, ValueNode initializeNode, ValueNode classLoaderNode) {
                ...
                Predicate<ConstantExpressionRegistry> strictModeRoutine = (registry) -> {
                    ...
                    return processClassForName(b, targetMethod, className, initialize);
                };
                BooleanSupplier graphModeRoutine = () -> {
                    Object className = unbox(b, nameNode, JavaKind.Object);
     ...
     */
    private boolean processClassForName(GraphBuilderContext b, ResolvedJavaMethod targetMethod, Object classNameValue, Object initializeValue) {
         ...
         */
        Object[] argValues = targetMethod.getParameters().length == 1 ? new Object[]{className} : new Object[]{className, initialize, InferredDynamicAccessLoggingFeature.ignoredArgument()};
    ...
    private Object getReceiverFromRegistry(ConstantExpressionRegistry registry, GraphBuilderContext b, ResolvedJavaMethod targetMethod) {
    ...
    private Object getArgumentFromRegistry(ConstantExpressionRegistry registry, GraphBuilderContext b, ResolvedJavaMethod targetMethod, int index) {
    ...
    private Object[] getArgumentsFromRegistry(ConstantExpressionRegistry registry, GraphBuilderContext b, ResolvedJavaMethod targetMethod) {
