...
public class VMThreadMTFeature implements GraalFeature {
    ...
    private static ValueNode currentThread(GraphBuilderContext b, boolean usedForAddress) {
        ...
        /*
         * In entry point functions when reading the thread pointer a ReadRegisterFixedNode should
         * be emitted so that the register read doesn't get hoisted above the location where the
         * thread pointer gets set.
         */
