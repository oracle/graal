...
public class ReflectionFeature implements InternalFeature, ReflectionSubstitutionSupport {
    ...
    public void duringSetup(DuringSetupAccess a) {
        ...
        RuntimeSerializationSupport<RegistrationCondition> serializationSupport = RuntimeSerializationSupport.singleton();
        ...
        ReflectionConfigurationParser<RegistrationCondition, Class<?>> parser = ConfigurationParserUtils.create(ConfigurationFile.REFLECTION, true, conditionResolver, reflectionData, proxyRegistry,
        ...
        ReflectionConfigurationParser<RegistrationCondition, Class<?>> legacyParser = ConfigurationParserUtils.create(ConfigurationFile.REFLECTION, false, conditionResolver, reflectionData,
        ...
        for (Class<?> primitiveClass : PRIMITIVE_CLASSES) {
            ClassForNameSupport.currentLayer().registerNegativeQuery(RegistrationCondition.always(), primitiveClass.getName());
        }
