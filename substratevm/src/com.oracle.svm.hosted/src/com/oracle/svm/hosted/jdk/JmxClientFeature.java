...
public class JmxClientFeature extends JNIRegistrationUtil implements InternalFeature {
    ...
    // seems like the serialization is the same for both client and server, maybe we
    ...
    private static void configureReflection(BeforeAnalysisAccess access) {
        String[] classes = new String[]{
                        ...
                        "com.sun.crypto.provider.ARCFOURCipher", "com.sun.crypto.provider.ChaCha20Cipher$ChaCha20Poly1305",
                        "com.sun.crypto.provider.DESCipher", "com.sun.crypto.provider.DESedeCipher",
                        "com.sun.crypto.provider.DHParameters",
                        "com.sun.crypto.provider.HmacCore$HmacSHA256",
                        "com.sun.jndi.url.rmi.rmiURLContextFactory", // Unique to client
                        "com.sun.management.GcInfo", "com.sun.management.VMOption",
                        "com.sun.management.internal.OperatingSystemImpl", "java.rmi.MarshalledObject", "java.rmi.Remote",
                        "java.rmi.dgc.Lease", "java.rmi.dgc.VMID", "java.rmi.registry.Registry", "java.rmi.server.ObjID",
                        "java.rmi.server.RemoteObject", "java.rmi.server.RemoteStub", "java.rmi.server.UID",
                        ...
                        "javax.management.ObjectName", "javax.management.openmbean.OpenType",
                        ...
                        "jdk.management.jfr.FlightRecorderMXBean", "jdk.management.jfr.ConfigurationInfo",
                        "jdk.management.jfr.EventTypeInfo", "jdk.management.jfr.RecordingInfo",
                        "jdk.management.jfr.SettingDescriptorInfo", "sun.rmi.registry.RegistryImpl_Skel",
                        "sun.rmi.registry.RegistryImpl_Stub", "sun.rmi.server.UnicastRef2",
                        "sun.rmi.server.UnicastRef", // Unique to client
                        "sun.rmi.transport.DGCImpl", "sun.rmi.transport.DGCImpl_Skel", "sun.rmi.transport.DGCImpl_Skel",
                        "sun.rmi.transport.DGCImpl_Stub"
        };

        String[] methods = new String[]{
                        "com.sun.management.GcInfo", "com.sun.management.VMOption",
                        "java.rmi.registry.Registry", "jdk.management.jfr.FlightRecorderMXBean",
                        "java.lang.management.MemoryUsage", "java.lang.management.MonitorInfo",
                        "java.lang.management.ThreadInfo", "javax.management.remote.rmi.RMIConnectionImpl_Stub",
                        "javax.management.remote.rmi.RMIServer", "javax.management.remote.rmi.RMIServerImpl_Stub",
                        "javax.management.remote.rmi.RMIConnection", "javax.management.remote.rmi.RMIConnection",
                        "jdk.management.jfr.ConfigurationInfo", "jdk.management.jfr.EventTypeInfo",
                        "jdk.management.jfr.RecordingInfo", "jdk.management.jfr.SettingDescriptorInfo",
                        "sun.rmi.registry.RegistryImpl_Stub", "sun.rmi.server.UnicastRef2", "sun.rmi.server.UnicastRef",
                        "sun.rmi.transport.DGCImpl", "sun.rmi.transport.DGCImpl_Skel", "sun.rmi.transport.DGCImpl_Stub"
        };

        String[] fields = new String[]{"com.sun.management.GcInfo"};

        String[] constructors = new String[]{"com.sun.jndi.url.rmi.rmiURLContextFactory",
                        ...
                        "sun.rmi.server.UnicastRef2", "sun.rmi.server.UnicastRef", "sun.rmi.transport.DGCImpl_Skel"
        };

        for (String clazz : classes) {
            Class<?> c = access.findClassByName(clazz);
            if (c == null) {
                continue;
            }
