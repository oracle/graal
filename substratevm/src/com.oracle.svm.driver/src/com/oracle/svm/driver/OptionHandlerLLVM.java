...
public class OptionHandlerLLVM extends TruffleOptionHandler {

    @Override
    public String getInfo() {
        return "build truffle-based llvm (sulong) image";
    }
    ...
    String getLauncherClass() {
        return "com.oracle.graalvm.launcher.llvm.LLVMLauncher";
    }
    ...
    public void applyTruffleLanguageOptions(ImageBuilderConfig config, Path... truffleLanguageJars) {
        ...
        Path truffleDir = config.getRootDir().resolve(Paths.get("jre", "lib", "truffle").toString());
    ...
    void applyTruffleLanguageShellOptions(ImageBuilderConfig config) {
        ...
        config.addImageBuilderArgs("-H:Name=lli");
    }
}
