...
/**
 * Represents a fast thread local variable of the primitive type {@code boolean}. See
 * {@link FastThreadLocalFactory} for details and restrictions of VM thread local variables.
 */
@SuppressWarnings({"unused", "static-method"})
public final class FastThreadLocalBoolean extends FastThreadLocal {

    @Platforms(Platform.HOSTED_ONLY.class)
    FastThreadLocalBoolean(String name) {
        super(name);
    }
