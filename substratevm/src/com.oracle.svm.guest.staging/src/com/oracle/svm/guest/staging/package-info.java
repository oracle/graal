 ...
 * into {@code com.oracle.svm.guest}. It is important that this project only depends on content that
 * should be in the guest. In particular, there should be not dependencies on builder code.
 */
