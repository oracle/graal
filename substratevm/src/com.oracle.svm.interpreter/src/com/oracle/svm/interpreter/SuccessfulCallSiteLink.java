...
/**
 * An entry in a {@link ResolvedInvokeDynamicConstant} containing an {@linkplain #getInvoker()
 * invoker} and an {@linkplain #getUnboxedAppendix() appendix} that should be used to perform the
 * call.
 */
public final class SuccessfulCallSiteLink implements CallSiteLink {
    ...
    private final Object unboxedAppendix;

    SuccessfulCallSiteLink(InterpreterResolvedJavaMethod method, int bci, InterpreterResolvedJavaMethod invoker, Object unboxedAppendix) {
        this.method = method;
        this.bci = bci;
    ...
    public Object getUnboxedAppendix() {
