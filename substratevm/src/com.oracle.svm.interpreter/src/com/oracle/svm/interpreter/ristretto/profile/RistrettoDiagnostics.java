...
public class RistrettoDiagnostics {

    public static final AtomicLong DeoptimizationsTaken = new AtomicLong();

    public static final AtomicLong InvalidatedCode = new AtomicLong();
