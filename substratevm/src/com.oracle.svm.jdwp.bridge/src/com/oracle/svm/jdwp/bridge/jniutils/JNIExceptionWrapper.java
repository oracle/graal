...
import static com.oracle.svm.jdwp.bridge.jniutils.JNIUtil.ExceptionCheck;
import static com.oracle.svm.jdwp.bridge.jniutils.JNIUtil.ExceptionClear;
import static com.oracle.svm.jdwp.bridge.jniutils.JNIUtil.ExceptionDescribe;
import static com.oracle.svm.jdwp.bridge.jniutils.JNIUtil.ExceptionOccurred;
import static com.oracle.svm.jdwp.bridge.jniutils.JNIUtil.GetObjectClass;
import static com.oracle.svm.jdwp.bridge.jniutils.JNIUtil.GetStaticMethodID;
import static com.oracle.svm.jdwp.bridge.jniutils.JNIUtil.IsSameObject;
import static com.oracle.svm.jdwp.bridge.jniutils.JNIUtil.NewGlobalRef;
import static com.oracle.svm.jdwp.bridge.jniutils.JNIUtil.Throw;
import static com.oracle.svm.jdwp.bridge.jniutils.JNIUtil.createArray;
import static com.oracle.svm.jdwp.bridge.jniutils.JNIUtil.createHSArray;
import static com.oracle.svm.jdwp.bridge.jniutils.JNIUtil.createHSString;
import static com.oracle.svm.jdwp.bridge.jniutils.JNIUtil.createString;
import static com.oracle.svm.jdwp.bridge.jniutils.JNIUtil.encodeMethodSignature;
import static com.oracle.svm.jdwp.bridge.jniutils.JNIUtil.findClass;
import static com.oracle.svm.jdwp.bridge.jniutils.JNIUtil.getBinaryName;
import static com.oracle.svm.jdwp.bridge.jniutils.JNIUtil.getJVMCIClassLoader;
...
import com.oracle.svm.jdwp.bridge.jniutils.JNICalls.JNICall;
...
public final class JNIExceptionWrapper extends RuntimeException {
    ...
    private static final String HS_ENTRYPOINTS_CLASS = "com.oracle.svm.jdwp.bridge.jniutils.JNIExceptionWrapperEntryPoints";
    ...
    private static volatile JClass entryPointsClass;
    ...
    public static void wrapAndThrowPendingJNIException(JNIEnv env, ExceptionHandler exceptionHandler) {
        ...
        if (ExceptionCheck(env)) {
            ...
            if (tracingAt(2) && exception.isNonNull()) {
    ...
    private static StackTraceElement[] getJNIExceptionStackTrace(JNIEnv env, JObject throwableHandle) {
        byte[] serializedStackTrace = createArray(env, (JByteArray) callGetStackTrace(env, throwableHandle));
    ...
    private static JThrowable updateStackTrace(JNIEnv env, JThrowable throwableHandle, StackTraceElement[] mergedStackTrace) {
        ...
        return callUpdateStackTrace(env, throwableHandle, createHSArray(env, bout.toByteArray()));
    }
     ...
     * {@link #wrapAndThrowPendingJNIException(JNIEnv)} or
     * {@link #wrapAndThrowPendingJNIException(JNIEnv, ExceptionHandler)} in {@code stackTrace}.
     *
    ...
    private static JClass getEntryPoints(JNIEnv env) {
        JClass res = entryPointsClass;
        if (res.isNull()) {
            String binaryName = getBinaryName(HS_ENTRYPOINTS_CLASS);
            JClass entryPoints = findClass(env, binaryName);
