...
public final class InvokeOptions {
    ...
    public static boolean singleThreaded(int flags) {
        return (flags & INVOKE_SINGLE_THREADED) != 0;
    }

    public static boolean nonVirtual(int flags) {
        return (flags & INVOKE_NONVIRTUAL) != 0;
    }
}
