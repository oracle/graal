 ...
 * @since 19.0
 */
@CPointerTo(nameOfCType = "int64_t")
public interface CInt64Pointer extends PointerBase {
     ...
     * @since 19.0
     */
    CInt64Pointer addressOf(int index);
     ...
     * @since 19.0
     */
    CInt64Pointer addressOf(SignedWord index);
}
