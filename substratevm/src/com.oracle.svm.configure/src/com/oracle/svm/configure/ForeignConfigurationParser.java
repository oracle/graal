...
public abstract class ForeignConfigurationParser<FD, LO> extends ConfigurationParser {
    ...
    private void parseAndRegisterForeignCall(Object call, boolean forUpcall) {
        ...
        if (forUpcall) {
            ...
            try {
                registerUpcall(RegistrationCondition.always(), descriptor, upcallOptions);
            } catch (Exception e) {
            ...
            try {
                registerDowncall(RegistrationCondition.always(), descriptor, downcallOptions);
            } catch (Exception e) {
                handleRegistrationError(e, map);
            }
        }
    ...
    protected abstract void registerDowncall(RegistrationCondition configurationCondition, FD descriptor, LO options);

    protected abstract void registerUpcall(RegistrationCondition configurationCondition, FD descriptor, LO options);
