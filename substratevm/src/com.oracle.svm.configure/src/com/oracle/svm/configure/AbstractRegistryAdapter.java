...
public abstract class AbstractRegistryAdapter implements ReflectionConfigurationParserDelegate<ConditionalElement<Class<?>>> {
    protected final ReflectionRegistry registry;

    protected AbstractRegistryAdapter(ReflectionRegistry registry) {
        this.registry = registry;
    }

    protected abstract TypeResult<Class<?>> findClass(String name);

    protected abstract TypeResult<Class<?>> findClass(String name, boolean allowPrimitives);
    ...
    public TypeResult<ConfigurationCondition> resolveCondition(String typeName) {
        ...
        TypeResult<Class<?>> clazz = findClass(canonicalizedName);
    ...
    public TypeResult<ConditionalElement<Class<?>>> resolveType(ConfigurationCondition condition, String typeName, boolean allowPrimitives) {
        ...
        TypeResult<Class<?>> clazz = findClass(name, allowPrimitives);
    ...
    protected static Class<?>[] getParameterTypes(List<ConditionalElement<Class<?>>> methodParameterTypes) {
