...
public interface VMEventListener extends VMListener {
    ...
    void addBreakpointRequest(int requestId, Collection<BreakpointInfo> infos);

    void removeBreakpointRequest(int requestId);

    void addStepRequest(int requestId, long threadId, SteppingInfo info);

    void removeStepRequest(int requestId);
