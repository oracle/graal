...
public class StandaloneAnalysisMetaAccess extends AnalysisMetaAccess {
    public StandaloneAnalysisMetaAccess(AnalysisUniverse analysisUniverse, MetaAccessProvider originalMetaAccess) {
        super(analysisUniverse, originalMetaAccess);
    }

    @Override
    public int getArrayIndexScale(JavaKind elementKind) {
        // It's not necessary to do constant folding for standalone analysis. Simply return -1 to
