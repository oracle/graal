...
@AutomaticFeature
public class JLine3Feature implements Feature {
...
// "org.fusesource.jansi.internal.Kernel32$INPUT_RECORD");
    ...
    Class<?> terminalBuilderClass;

    @Override
    public boolean isInConfiguration(IsInConfigurationAccess access) {
        terminalBuilderClass = access.findClassByName("org.jline.terminal.TerminalBuilder");
        /* Feature is only active when JLine3 is on the classpath. */
        return terminalBuilderClass != null;
    }
    ...
    public void beforeAnalysis(BeforeAnalysisAccess access) {
        Object[] createMethods = Arrays.stream(terminalBuilderClass.getDeclaredMethods())
...
// .forEach(initMethod -> access.registerReachabilityHandler(a -> registerJNIFields(initMethod),
// initMethod));
// }
    }
    ...
    private static void registerTerminalConstructor(DuringAnalysisAccess access) {
         ...
         * class.
         */
        Class<?> terminalClass = access.findClassByName(Platform.includedIn(Platform.WINDOWS.class) ? "org.jline.terminal.impl.jansi.win.JansiWinSysTerminal" : "org.jline.terminal.impl.PosixSysTerminal");
