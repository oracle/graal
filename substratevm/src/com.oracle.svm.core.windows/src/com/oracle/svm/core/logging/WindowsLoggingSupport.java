...
final class WindowsLoggingSupport implements LoggingSupport {
    ...
    public String hostname() {
        int capacity = WindowsFileNames.maxComputernameLength() + 1;
    ...
    private static final class WindowsFileNames {
        @CConstant("MAX_COMPUTERNAME_LENGTH")
        public static native int maxComputernameLength();

        @CConstant("MOVEFILE_REPLACE_EXISTING")
        public static native int movefileReplaceExisting();
