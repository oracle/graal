...
import static com.oracle.svm.core.graal.llvm.util.LLVMUtils.getLLVMIntCond;
import static com.oracle.svm.core.graal.llvm.util.LLVMUtils.getLLVMRealCond;
...
public class LLVMIRBuilder {
    ...
    public LLVMValueRef buildInlineGetRegister(String registerName) {
        LLVMValueRef getRegister = buildInlineAsm(functionType(rawPointerType()), LLVMTargetSpecific.get().getRegisterInlineAsm(registerName),
    ...
    public LLVMValueRef buildInlineJump(LLVMValueRef address) {
        LLVMValueRef jump = buildInlineAsm(functionType(voidType(), rawPointerType()), LLVMTargetSpecific.get().getJumpInlineAsm(), "r", true, false);
