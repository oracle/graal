...
public final class NewTypeSnippets extends TypeSnippets {
    ...
    public static void registerLowerings(RuntimeConfiguration runtimeConfig, OptionValues options, Iterable<DebugHandlersFactory> factories, Providers providers,
        ...
        new NewTypeSnippets(options, runtimeConfig, factories, providers, snippetReflection, lowerings);
    }

    private NewTypeSnippets(OptionValues options, RuntimeConfiguration runtimeConfig, Iterable<DebugHandlersFactory> factories, Providers providers, SnippetReflectionProvider snippetReflection,
                    Map<Class<? extends Node>, NodeLoweringProvider<?>> lowerings) {
    ...
    protected class InstanceOfLowering extends InstanceOfSnippetsTemplates implements NodeLoweringProvider<FloatingNode> {
        ...
        private final SnippetTemplate.SnippetInfo instanceOf = snippet(NewTypeSnippets.class, "instanceOfSnippet");
        ...
        protected SnippetTemplate.Arguments makeArguments(InstanceOfUsageReplacer replacer, LoweringTool tool) {
            ...
            if (typeReference.isExact()) {
                ...
                short typeCheckStart = hub.getTypeCheckStart();
                short typeCheckRange = hub.getTypeCheckRange();
                short typeCheckSlot = hub.getTypeCheckSlot();
                ...
                args.add("falseValue", replacer.falseValue);
                args.addConst("allowsNull", node.allowsNull());
                args.add("start", typeCheckStart);
                args.add("range", typeCheckRange);
                args.add("slot", typeCheckSlot);
    ...
    protected class InstanceOfDynamicLowering extends InstanceOfSnippetsTemplates implements NodeLoweringProvider<FloatingNode> {
        ...
        private final SnippetTemplate.SnippetInfo instanceOfDynamic = snippet(NewTypeSnippets.class, "instanceOfDynamicSnippet");
    ...
    protected class ClassIsAssignableFromLowering extends InstanceOfSnippetsTemplates implements NodeLoweringProvider<FloatingNode> {
        private final SnippetTemplate.SnippetInfo assignableTypeCheck = snippet(NewTypeSnippets.class, "classIsAssignableFromSnippet");
