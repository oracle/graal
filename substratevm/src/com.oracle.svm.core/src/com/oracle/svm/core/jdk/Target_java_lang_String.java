...
/** Substitution target for {@link String}. */
@TargetClass(String.class)
public final class Target_java_lang_String {

    @Alias
    public Target_java_lang_String(@SuppressWarnings("unused") byte[] value, @SuppressWarnings("unused") byte coder) {
    }
    ...
    @Alias
    public native void getBytes(byte[] destination, int destinationBegin, byte coder);
