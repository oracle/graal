...
/**
 * This is used in a special case of {@code BootstrapMethodInvoker.invoke}
 * ({@code info.getClass() == int[].class}) which is not currently used in SVM.
 * <p>
 * These substitutions cut paths that would lead to useless code being included and some deleted
 * methods being reached.
 */
@TargetClass(className = "java.lang.invoke.BootstrapMethodInvoker", innerClass = "VM_BSCI", onlyWith = RuntimeClassLoading.WithRuntimeClassLoading.class)
