...
public class Errno {
    ...
    @CConstant
    @Platforms({DeprecatedPlatform.LINUX_SUBSTITUTION.class, DeprecatedPlatform.DARWIN_SUBSTITUTION.class, InternalPlatform.LINUX_JNI.class, InternalPlatform.DARWIN_JNI.class})
