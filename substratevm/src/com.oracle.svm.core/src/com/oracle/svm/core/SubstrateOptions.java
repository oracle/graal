        ...
        protected void onValueUpdate(EconomicMap<OptionKey<?>, Object> values, String oldValue, String newValue) {
            if ("llvm".equals(newValue)) {
                ...
                if (isLLVMBackendMissing) {
                    throw UserError.abort("The LLVM backend for GraalVM Native Image is missing and needs to be build from source. For instructions, please see https://github.com/oracle/graal/blob/master/docs/reference-manual/native-image/LLVMBackend.md.");
                }
