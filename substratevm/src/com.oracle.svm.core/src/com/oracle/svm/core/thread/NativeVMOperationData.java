...
/**
 * Holds the mutable state that is necessary for the execution of a {@link NativeVMOperation}. This
 * is used in situations when we can't allocate Java objects (e.g., when a garbage collection is
 * required).
 */
@RawStructure
