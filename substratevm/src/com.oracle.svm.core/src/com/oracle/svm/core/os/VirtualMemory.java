...
/**
 * Primitive operations for virtual memory management.
 */
public interface VirtualMemory {
    ...
    static VirtualMemory get() {
        return ImageSingletons.lookup(VirtualMemory.class);
    }
     ...
     */
    @Uninterruptible(reason = "May be called from uninterruptible code.")
