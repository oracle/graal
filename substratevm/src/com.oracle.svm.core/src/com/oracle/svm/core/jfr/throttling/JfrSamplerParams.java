...
class JfrSamplerParams {
    ...
    public void initializeFrom(JfrSamplerParams other) {
        this.samplePointsPerWindow = other.samplePointsPerWindow;
        this.windowDurationMs = other.windowDurationMs;
        this.windowLookbackCount = other.windowLookbackCount;
