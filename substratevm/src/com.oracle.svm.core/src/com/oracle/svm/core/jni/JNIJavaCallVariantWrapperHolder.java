...
/** Holder class for generated {@code JNIJavaCallVariantWrapperMethod} code. */
@InternalVMMethod
public final class JNIJavaCallVariantWrapperHolder {
    ...
    public static ConstantPool getConstantPool(MetaAccessProvider metaAccess) {
        return metaAccess.lookupJavaType(JNIJavaCallVariantWrapperHolder.class).getDeclaredConstructors(false).getFirst().getConstantPool();
    }
