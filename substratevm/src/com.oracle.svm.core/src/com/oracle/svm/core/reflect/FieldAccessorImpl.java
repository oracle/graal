...
/**
 * Package-private implementation of the FieldAccessor interface which has access to all classes and
 * all fields, regardless of language restrictions. See MagicAccessorImpl.
 */
