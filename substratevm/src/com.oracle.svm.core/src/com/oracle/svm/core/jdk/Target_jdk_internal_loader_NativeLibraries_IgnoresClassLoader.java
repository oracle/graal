...
final class Target_jdk_internal_loader_NativeLibraries_IgnoresClassLoader {

    // needs to be explicitly deleted (GR-58623)
    @Delete @SuppressWarnings("unused") static final boolean $assertionsDisabled = false;

    @Substitute
    public static Target_jdk_internal_loader_NativeLibraries_IgnoresClassLoader newInstance(@SuppressWarnings("unused") ClassLoader loader) {
        return new Target_jdk_internal_loader_NativeLibraries_IgnoresClassLoader();
    }
