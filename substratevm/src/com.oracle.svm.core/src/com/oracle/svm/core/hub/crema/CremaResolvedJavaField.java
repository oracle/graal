...
public interface CremaResolvedJavaField extends ResolvedJavaField {
    ...
    /**
     * Tests if the given Field is a trusted final field and it cannot be modified reflectively
     * regardless of the value of its accessible flag.
     *
     * @return true iff the field is a trusted final
     */
    ...
    /**
     * Retrieves the generic signature of this field.
     *
