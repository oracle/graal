...
final class LogFileStreamOutput extends LogOutput {
    ...
    LogFileStreamOutput(boolean isStderr) {
        super(isStderr ? "stderr" : "stdout", isStderr ? new VMMutex("LogOutput.stderr") : new VMMutex("LogOutput.stdout"));
    ...
    protected boolean writeRaw(CCharPointer bytes, UnsignedWord length) {
        ...
        return LoggingSupport.singleton().write(isStderr, bytes, length);
    }
