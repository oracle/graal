...
public class WebImageWasmLMSuitesCreator extends WebImageSuitesCreator {
    @Override
    protected PhaseSuite<HighTierContext> createHighTier(OptionValues options) {
        return new WebImageWasmLMHighTier(options);
    }

    @Override
    protected PhaseSuite<MidTierContext> createMidTier(OptionValues options) {
        return new WebImageWasmLMMidTier(options);
    }

    @Override
    protected PhaseSuite<LowTierContext> createLowTier(OptionValues options) {
        return new WebImageWasmLMLowTier(options);
    }
}
