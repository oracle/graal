...
public class WebImageJSJNINativeCallWrapperSubstitutionProcessor extends SubstitutionProcessor {
    private final Map<ResolvedJavaMethod, WebImageJSJNINativeCallWrapperMethod> callWrappers = new ConcurrentHashMap<>();
