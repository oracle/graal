...
public class SingleThreadedAtomicsFeature implements InternalFeature {

    @Override
    public void beforeAnalysis(BeforeAnalysisAccess a) {
        BeforeAnalysisAccessImpl access = (BeforeAnalysisAccessImpl) a;
        for (SnippetRuntime.SubstrateForeignCallDescriptor descriptor : SingleThreadedAtomics.FOREIGN_CALLS) {
            access.registerAsRoot((AnalysisMethod) descriptor.findMethod(access.getMetaAccess()), true, "WASM thread atomics support, registered in " + SingleThreadedAtomicsFeature.class);
        }
    }
