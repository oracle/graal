...
public class WebImageJSHighTier extends WebImageHighTier {
    @SuppressWarnings("this-escape")
    public WebImageJSHighTier(OptionValues options) {
        appendPhase(new RemoveInterceptJSInvokePhase());

        appendPhase(new NormalizationPhase());
        ...
        if (WebImageOptions.AnalyzeCompoundConditionals.getValue(options)) {
            appendPhase(new IncrementalCompoundConditionalPhase());
        }
