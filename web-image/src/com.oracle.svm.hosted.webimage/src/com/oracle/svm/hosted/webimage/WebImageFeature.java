...
public class WebImageFeature implements InternalFeature {
    ...
    public void duringSetup(DuringSetupAccess a) {
        ...
        if (entryPointConfig != null) {
            ...
            ReflectionConfigurationParser<RegistrationCondition, Class<?>> parser = ConfigurationParserUtils.create(ConfigurationFile.REFLECTION, false, conditionResolver, entryPointsData, null,
