...
/**
 * This class holds static methods used by {@code internal-error.js}.
 */
public class JSInternalErrors {
    public static Error shouldNotReachHere(String msg) {
        if (msg == null || msg.isEmpty()) {
            throw error("should not reach here");
        } else {
            throw error("should not reach here: " + msg);
        }
    }

    public static Error unimplemented(String msg) {
        if (msg == null || msg.isEmpty()) {
    ...
    public static void guarantee(boolean condition, String msg) {
        if (!condition) {
            throw error("failed to guarantee: " + msg);
        }
    }
}
