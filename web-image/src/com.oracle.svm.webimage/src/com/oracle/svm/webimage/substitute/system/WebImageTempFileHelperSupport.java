...
public class WebImageTempFileHelperSupport {
    ...
    Path createTempFile(Path dir, String prefix, String suffix, FileAttribute<?>[] attrs) throws IOException {
        return Target_java_nio_file_TempFileHelper_Web.createTempFile(dir, prefix, suffix, attrs);
    }

    Path createTempDirectory(Path dir, String prefix, FileAttribute<?>[] attrs) throws IOException {
        return Target_java_nio_file_TempFileHelper_Web.createTempDirectory(dir, prefix, attrs);
    }
}
